...
ameba_set(c_CMPT_PYTEST_DIR       ${c_COMPONENT_DIR}/utils/pytest)
...
macro(ameba_reset_global_define)
    ...
    ameba_set(c_CMPT_IMG3_DIR ${c_COMPONENT_DIR}/soc/common/image3)
    ameba_set(c_CMPT_DONGLE_LIB_DIR ${c_COMPONENT_DIR}/soc/common/dongle_lib)
    ...
    ameba_set(c_CMPT_BOOTLOADER_NS_LIB_DIR ${c_CMPT_SOC_DIR}/lib/bootloader_ns)

    if(DEFINED EXTERN_DIR AND NOT "${EXTERN_DIR}" STREQUAL "")
      set(c_AXF2BIN_RUN python    ${c_BASEDIR}/tools/scripts/axf2bin.py --mp ${c_MP} --extern-dir ${EXTERN_DIR})
    else()
