...
In this example, the control of the AT command module via USB is simply demonstrated. In the example, the input to USB is sourced from the UART interface, and the return output from the AT command module is sent to the UART interface.
