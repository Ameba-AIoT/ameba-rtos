...
int example_raw_ppe_auto_reload(void)
{
	if (rtos_task_create(NULL, "ppe_auto_reload", (rtos_task_t)ppe_auto_reload, NULL, (3072), (1)) != RTK_SUCCESS) {
		RTK_LOGS(NOTAG, RTK_LOG_ERROR, "Cannot create ppe_auto_reload demo task\n\r");
	}
