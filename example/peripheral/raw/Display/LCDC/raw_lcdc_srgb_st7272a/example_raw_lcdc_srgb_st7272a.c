...
static void lcdc_pinmux_config(void)
{
	...
	Pinmux_Config(_PA_6, PINMUX_FUNCTION_LCD_D0);   /*D0 - B0*/
	Pinmux_Config(_PA_8, PINMUX_FUNCTION_LCD_D1);   /*D1*/
	Pinmux_Config(_PA_7, PINMUX_FUNCTION_LCD_D2);   /*D2*/
	Pinmux_Config(_PA_10, PINMUX_FUNCTION_LCD_D3);  /*D3*/
	Pinmux_Config(_PA_11, PINMUX_FUNCTION_LCD_D4);  /*D4*/
	Pinmux_Config(_PA_9, PINMUX_FUNCTION_LCD_D5);   /*D5*/
	Pinmux_Config(_PA_17, PINMUX_FUNCTION_LCD_D6);  /*D6*/
	Pinmux_Config(_PA_16, PINMUX_FUNCTION_LCD_D7);  /*D7 - B7 */

	Pinmux_Config(_PB_21, PINMUX_FUNCTION_LCD_RGB_HSYNC);   /* HSYNC*/
	Pinmux_Config(_PB_17, PINMUX_FUNCTION_LCD_RGB_VSYNC);   /* VSYNC*/
	Pinmux_Config(_PB_14, PINMUX_FUNCTION_LCD_RGB_DCLK);    /* DCLK*/

	Pinmux_Config(_PA_14, PINMUX_FUNCTION_LCD_RGB_DE); /* DE */
}
...
int example_raw_lcdc_srgb_st7272a(void)
{
