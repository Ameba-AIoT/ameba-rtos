...
- On RTL8735C, connect as below
  - Connect `SPI_MOSI (_PF_6)` [Master] to `SPI_MOSI (_PC_8)`  [Slave]
  - Connect `SPI_MISO (_PF_5)` [Master] to `SPI_MISO (_PE_7)`  [Slave]
  - Connect `SPI_SCLK (_PF_4)` [Master] to `SPI_SCLK (_PC_6)`  [Slave]
