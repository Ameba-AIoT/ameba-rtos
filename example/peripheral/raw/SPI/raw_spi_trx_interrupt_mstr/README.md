...
1. This example is the **master** role of the SPI interrupt dual-board test.
2. It uses SPI0 as master with interrupt-driven data transfer.
3. It must work together with `raw_spi_trx_interrupt_slv` on another board.
...
2. Build and flash `raw_spi_trx_interrupt_slv` onto the slave board first.
