...
- On RTL8735C, connect as below
  - Connect `SPI_MOSI (_PC_8)`  [Master] to `SPI1_MOSI (_PF_6)`  [Slave]
  - Connect `SPI_MISO (_PE_7)`  [Master] to `SPI1_MISO (_PF_5)`  [Slave]
  - Connect `SPI_SCLK (_PC_6)`  [Master] to `SPI1_SCLK (_PF_4)`  [Slave]
  - Connect `SPI_CS (_PC_9)`    [Master] to `SPI1_CS (_PF_7)`    [Slave]
