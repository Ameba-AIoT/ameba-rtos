...
/*
 * This is the SLAVE board of the dual-board SPI interrupt test.
 * Both boards use the same SPI0 pins, connected pin-to-pin.
 * Must pair with mbed_spi_trx_interrupt_mstr.
 */
...
extern int example_mbed_spi_trx_interrupt_slave(void);
#endif
