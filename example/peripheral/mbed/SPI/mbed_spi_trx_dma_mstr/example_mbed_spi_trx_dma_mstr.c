...
void spi_dma_task(void)
{
	...
	/* Init SPI0 as Master (dual-board: this board is the master, DMA mode)
	...
	/**
	 * Phase 1: Full-duplex (Master write/read, DMA)
	 */
	...
	/**
	 * Phase 2: Master read (Slave write) - unidirectional, DMA
	 */
