...
1. This example is the **master** role of the mbed SPI DMA dual-board test.
2. It uses SPI0 as master with DMA-driven data transfer.
3. It must work together with `mbed_spi_trx_dma_slv` on another board.
...
2. Build and flash `mbed_spi_trx_dma_slv` onto the slave board first.
