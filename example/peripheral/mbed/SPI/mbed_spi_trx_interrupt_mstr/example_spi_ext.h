...
/*
 * This is the MASTER board of the dual-board SPI interrupt test.
 * Both boards use the same SPI0 pins, connected pin-to-pin.
 * Must pair with mbed_spi_trx_interrupt_slv.
 */
...
#define SPI_MOSI  _PA_16
#define SPI_MISO  _PA_17
#define SPI_SCLK  _PA_18
#define SPI_CS    _PA_19
...
extern int example_mbed_spi_trx_interrupt_master(void);
#endif
