...
1. This example is the **master** role of the mbed SPI polling dual-board test.
2. It uses SPI0 as master to perform full-duplex and unidirectional data transfer.
3. It must work together with `mbed_spi_trx_polling_slv` on another board.
...
2. Build and flash `mbed_spi_trx_polling_slv` onto the slave board first.
