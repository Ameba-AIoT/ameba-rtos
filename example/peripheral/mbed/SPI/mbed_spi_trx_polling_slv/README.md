...
1. This example is the **slave** role of the mbed SPI polling dual-board test.
2. It uses SPI0 as slave to perform full-duplex and unidirectional data transfer.
3. It must work together with `mbed_spi_trx_polling_mstr` on another board.
...
2. This example is the slave-side; the master-side is `mbed_spi_trx_polling_mstr`.
