...
void spi_dma_task(void)
{
	...
	/* Init SPI0 as Slave (dual-board: this board is the slave, DMA mode) */
	...
	/**
	 * Phase 1: Full-duplex (Slave read/write, DMA)
	 */
	...
	/**
	 * Phase 2: Slave write (Master read) - unidirectional, DMA
	 */
...
/**
  ...
  * @retval None
  */
int example_mbed_spi_trx_dma_slave(void)
{
