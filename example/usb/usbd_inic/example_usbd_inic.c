...
static void example_usbd_inic_thread(void *param)
{
...
#ifdef CONFIG_WHC_ETH
	rtos_sema_create(&inic_eth_bulk_in_sema, 0, 1);
#endif
	...
	ret = rtos_task_create(&wifi_bulk_in_task, "usbd_inic_wifi_bulk_in_thread",
	...
	ret = rtos_task_create(&bt_bulk_in_task, "usbd_inic_bt_bulk_in_thread",
...
void example_usbd_inic(void)
{
	...
	ret = rtos_task_create(&task, "usbd_inic_thread", example_usbd_inic_thread, NULL,
