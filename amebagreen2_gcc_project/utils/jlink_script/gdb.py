...
CMAKE_GDB = '/opt/rtk-toolchain/asdk-12.3.1/linux/newlib/bin/arm-none-eabi-gdb'
...
APP_BASE_NAME = 'amebagreen2_app'
CONFIG_FILE = 'menuconfig/.config_km4tz'
CUT_TYPE = 'acut'
BIN_MAP = [
            ['amebagreen2_app', 'FlashFileSize'],
            ['amebagreen2_boot', 'XIPBootSize'],
            ['ap_image2_all_en_tag', 'AP_GCM_Tag_Size'],
            ['np_image2_all_en_tag', 'NP_GCM_Tag_Size']
          ]
...
if len(sys.argv) > 1 and sys.argv[1] == 'debug':
    ...
    if FPGA == True:
        print('\033[32m============== gdb load rom ================\033[0m')
