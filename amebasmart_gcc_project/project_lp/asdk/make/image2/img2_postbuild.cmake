...
execute_process(
    ...
    COMMAND ${CMAKE_OBJCOPY} -j .psram_image2.text.data -Obinary ${c_SDK_IMAGE_TARGET_FOLDER}/target_pure_img2.axf ${c_SDK_IMAGE_TARGET_FOLDER}/psram_image2.bin
    COMMAND ${CMAKE_OBJCOPY} -j .ram_retention.text -j .ram_retention.entry -Obinary ${c_SDK_IMAGE_TARGET_FOLDER}/target_pure_img2.axf ${c_SDK_IMAGE_TARGET_FOLDER}/ram_retention.bin
)
...
execute_process(
	...
	COMMAND ${PADTOOL} ${c_SDK_IMAGE_TARGET_FOLDER}/psram_image2.bin 32
    COMMAND ${PADTOOL} ${c_SDK_IMAGE_TARGET_FOLDER}/xip_image2.bin 32
)


execute_process(
    # COMMAND ${PREPENDTOOL} ${c_SDK_IMAGE_TARGET_FOLDER}/ram_retention.bin  __retention_entry_func__  ${c_SDK_IMAGE_TARGET_FOLDER}/target_img2.map
    COMMAND ${PREPENDTOOL} ${c_SDK_IMAGE_TARGET_FOLDER}/sram_2.bin  __sram_image2_start__  ${c_SDK_IMAGE_TARGET_FOLDER}/target_img2.map
    COMMAND ${PREPENDTOOL} ${c_SDK_IMAGE_TARGET_FOLDER}/psram_image2.bin  __psram_image2_start__  ${c_SDK_IMAGE_TARGET_FOLDER}/target_img2.map
...
execute_process(
    COMMAND ${CMAKE_COMMAND} -E cat ${c_SDK_IMAGE_TARGET_FOLDER}/xip_image2_prepend.bin ${c_SDK_IMAGE_TARGET_FOLDER}/sram_2_prepend.bin ${c_SDK_IMAGE_TARGET_FOLDER}/psram_image2_prepend.bin
    OUTPUT_FILE ${c_SDK_IMAGE_TARGET_FOLDER}/km0_image2_all.bin
)
execute_process(
    COMMAND ${PADTOOL} ${c_SDK_IMAGE_TARGET_FOLDER}/km0_image2_all.bin 4096
)
execute_process(
    COMMAND ${IMAGETOOL} ${c_SDK_IMAGE_TARGET_FOLDER}/km0_image2_all.bin ${BUILD_TYPE}
...
if(CONFIG_FATFS_WITHIN_APP_IMG)
    if(EXISTS ${KM4_PROJECT_DIR}/asdk/image/km0_km4_ca32_app.bin AND EXISTS ${c_SOC_PROJECT_DIR}/fatfs.bin)
        ...
        execute_process(
            COMMAND ${PREPENDTOOL} ${c_SOC_PROJECT_DIR}/fatfs.bin  VFS1_FLASH_BASE_ADDR  ${c_SDK_IMAGE_TARGET_FOLDER}/target_img2.map
        )
        execute_process(
