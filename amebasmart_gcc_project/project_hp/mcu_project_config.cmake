...
macro(ameba_mcu_project_custom_config)
    ...
    if(CONFIG_LINK_ROM_SYMB)
        ...
        if(CONFIG_AMEBASMART_B_CUT)
            ameba_set(d_LINK_ROM_SYMBOL_NS    ${d_SDK_LD_DIR}/ameba_rom_symbol_acut.ld)
            ameba_set(d_LINK_ROM_SYMBOL_S     ${d_SDK_LD_DIR}/ameba_rom_symbol_bcut_s.ld)
        endif()
    else()
        ameba_set(d_LINK_ROM_LIB ${ROM_LIB_DIR}/rom.a)
        ameba_set(d_LINK_ROM_LIB_NS ${ROM_LIB_DIR}/rom_ns.a)
    endif()
    ameba_list_append(d_LINK_ROM_SYMBOL_NS    ${d_SDK_LD_DIR}/ameba_rom_symbol_stdlib.ld)
endmacro()
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ #
