...
################
Usage() {
    echo "Usage: $0 [Image2 Name] [Boot Image Name][option]"
}
...
if [ "$IMAGE_FILENAME_NEW" == "km0_km4_app_ns.bin" ] || [ "$IMAGE_FILENAME_NEW" == "km0_km4_ca32_app_ns.bin" ]; then
...
if [ "$IMAGE_FILENAME_NEW" == "km0_km4_app.bin" ] || [ "$IMAGE_FILENAME_NEW" == "km0_km4_ca32_app.bin" ] \
	|| [ "$IMAGE_FILENAME_NEW" == "km0_km4_app_ns.bin" ] || [ "$IMAGE_FILENAME_NEW" == "km0_km4_ca32_app_ns.bin" ]; then
    MakeFixedWidthHeaderString $OTA_SIGN   8  HEADER_FINAL 0
    MakeFixedWidthHeaderString $HEADER_LEN   8  HEADER_FINAL 1
    MakeFixedWidthHeaderString $CHECKSUM    8  HEADER_FINAL 1
