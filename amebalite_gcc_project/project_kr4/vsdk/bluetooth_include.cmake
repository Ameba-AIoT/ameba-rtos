...
if(CONFIG_BT_ZEPHYR)
    ...
    if(CONFIG_BT_BLE_ONLY)
        list(APPEND GLOBAL_IFLAGS ${BLEDIR}/rtk_stack/platform/amebalite/lib/kr4/ble_only)
    elseif(CONFIG_BT_DUAL_MODE)
        list(APPEND GLOBAL_IFLAGS ${BLEDIR}/rtk_stack/platform/amebalite/lib/kr4/dual_mode)
    endif()
