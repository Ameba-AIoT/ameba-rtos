...
if [ -f $IMAGE_TARGET_FOLDER/kr4_image2_all.bin ]; then 
	FLASHFILENAME="$IMAGE_TARGET_FOLDER/kr4_image2_all.bin";
...
#set boot code size
FLASHFILENAME="$IMAGE_TARGET_FOLDER/kr4_boot_all.bin" 
FLASH_FILE_SIZE=$(stat -c %s $FLASHFILENAME)
