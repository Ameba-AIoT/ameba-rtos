...
if (CONFIG_MP_SHRINK)
    ...
    execute_process(COMMAND ${CMAKE_OBJCOPY} -j .ram_image1.entry  -j .ram_image1.text -j .ram_image1.data -Obinary ${IMAGE_TARGET_FOLDER}/target_pure_loader.axf ${IMAGE_TARGET_FOLDER}/ram_1.bin)
endif()
...
if (CONFIG_MP_SHRINK)
    execute_process(COMMAND ${PADTOOL} ${IMAGE_TARGET_FOLDER}/entry_1.bin 992)
else()
    execute_process(COMMAND ${PADTOOL} ${IMAGE_TARGET_FOLDER}/ram_1.bin 32)
    execute_process(COMMAND ${PADTOOL} ${IMAGE_TARGET_FOLDER}/xip_boot.bin 32)
endif()


if (CONFIG_MP_SHRINK)
    execute_process(COMMAND ${PREPENDTOOL} ${IMAGE_TARGET_FOLDER}/entry_1.bin  __ram_start_table_start__  ${IMAGE_TARGET_FOLDER}/target_loader.map)
    execute_process(COMMAND ${PREPENDTOOL} ${IMAGE_TARGET_FOLDER}/ram_1.bin  __ram_image1_text_start__  ${IMAGE_TARGET_FOLDER}/target_loader.map)
    execute_process(
