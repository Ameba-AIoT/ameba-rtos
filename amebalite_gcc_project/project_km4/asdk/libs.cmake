...
if(CONFIG_BT)
    if(CONFIG_BT_AUDIO_CODEC_SUPPORT)
        list(APPEND LINK_THIRD_APP_LIB ${APP_LIB_DIR}/lib_btcodec.a ${APP_LIB_DIR}/lib_btaudiosync.a)
    endif()

    if(NOT CONFIG_BT_ZEPHYR)
        if(CONFIG_BT_BLE_ONLY)
            list(APPEND LINK_THIRD_APP_LIB ${BASEDIR}/component/bluetooth/rtk_stack/platform/amebalite/lib/km4/ble_only/btgap.a)
        elseif(CONFIG_BT_DUAL_MODE)
            list(
                APPEND LINK_THIRD_APP_LIB
                ${BASEDIR}/component/bluetooth/rtk_stack/platform/amebalite/lib/km4/dual_mode/btgap.a
                ${BASEDIR}/component/bluetooth/rtk_stack/platform/amebalite/lib/km4/bt_mgr.a
            )
        endif()

        list(
            APPEND LINK_THIRD_APP_LIB
            ${BASEDIR}/component/bluetooth/rtk_stack/platform/amebalite/lib/km4/leaudio.a
            ${BASEDIR}/component/bluetooth/rtk_stack/platform/amebalite/lib/km4/ble_mgr.a
            ${BASEDIR}/component/bluetooth/rtk_stack/platform/amebalite/lib/km4/sysm.a
        )

        if(CONFIG_BT_MESH_PROVISIONER_SUPPORT OR CONFIG_BT_MESH_DEVICE_SUPPORT)
            list(APPEND LINK_THIRD_APP_LIB ${BASEDIR}/component/bluetooth/rtk_stack/src/mesh/lib/amebalite/km4/btmesh.a)
        endif()
    endif()
endif()
