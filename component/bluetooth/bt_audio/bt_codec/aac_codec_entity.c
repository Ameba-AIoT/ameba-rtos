...
static uint16_t aac_decoder_process_data(void *p_entity, uint8_t *data, uint32_t size, struct dec_codec_buffer *decode_buffer, uint32_t *ppcm_size,
...
static uint16_t aac_encoder_process_data(void *p_entity, int16_t *data, uint32_t size, struct enc_codec_buffer *pencoder_buffer, uint8_t *p_frame_num,
...
static uint16_t aac_audio_handle_media_data_packet(void *p_entity, uint8_t *packet, uint16_t size, uint32_t *pframe_size, uint8_t *pframe_num,
