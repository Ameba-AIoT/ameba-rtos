...
void *audio_lc3_codec_cfg(int sample_rate, uint8_t frame_duration, uint8_t channel_num, uint8_t bits_per_audio_sample_dec_, uint8_t bits_per_audio_sample_enc_,
						  int compress_bytes);
