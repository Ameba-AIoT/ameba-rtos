...
#define DBG_BT_COEX(fmt, arg...) printk(KERN_INFO "rtk_btcoex: " fmt "\n" , ## arg)
#define DBG_BT_COEX_DUMP(_str, _buf, _len)  print_hex_dump(KERN_DEBUG, _str , DUMP_PREFIX_OFFSET, 16, 1, _buf, _len, true)
