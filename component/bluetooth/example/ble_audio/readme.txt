...
1.CAP Initiator
    ...
    1.9 release unicast stream                      AT+BLEBAP=unicast,client,release,0
    1.10 release stream session                     AT+BLEBAP=unicast,client,stream_release,0
    1.11 mcs server send data：MEDIA_PLAYER_NAME    AT+BLECAP=initiator,mcp,send,0x2B93
    1.12 mcs server send data：TRACK_TITLE          AT+BLECAP=initiator,mcp,send,0x2B97
    1.13 mcs server send data：TRACK_DURATION       AT+BLECAP=initiator,mcp,send,0x2B98,value
    1.14 mcs server send data：TRACK_POSITION       AT+BLECAP=initiator,mcp,send,0x2B99,value
    1.15 mcs server send data：TRACK_CHANGED        AT+BLECAP=initiator,mcp,send,0x2B96
    1.16 start broadcast stream                     AT+BLEBAP=broadcast,source,start
    1.17 stop broadcast stream                      AT+BLEBAP=broadcast,source,stop
...
1.TMAP unicast media sender
    ...
    1.8 release unicast stream                                      AT+BLEBAP=unicast,client,release,<group id>
    1.9 release stream session                                      AT+BLEBAP=unicast,client,stream_release,<group id>
    1.10 vcs client set mute by group                               AT+BLECAP=commander,vcp,gmute,<group_id>,<mute_state> -->group_id is 0, mute_state is 0,1 (0:not mute, 1:mute)
    1.11 vcs client set unmute by group                             AT+BLECAP=commander,vcp,gmute,<group_id>,<mute_state> -->group_id is 0, mute_state is 0,1 (0:not mute, 1:mute)
    1.12 vcs client change volume by group                          AT+BLECAP=commander,vcp,gvolume,<group_id>,<volume_setting> -->group_id is 0, volume_setting is 0~255
    1.13 vcs client get volume state                                AT+BLECAP=commander,vcp,get,<conn_handle>
    1.14 vcs client write opcode: Relative Volume Down              AT+BLECAP=commander,vcp,write,<conn_handle>,0
    1.15 vcs client write opcode: Relative Volume Up                AT+BLECAP=commander,vcp,write,<conn_handle>,1
    1.16 vcs client write opcode: Unmute/Relative Volume Down       AT+BLECAP=commander,vcp,write,<conn_handle>,2
    1.17 vcs client write opcode: Unmute/Relative Volume Up         AT+BLECAP=commander,vcp,write,<conn_handle>,3
    1.18 vcs client write opcode: Set Absolute Volume               AT+BLECAP=commander,vcp,write,<conn_handle>,4,<volume_setting> 
    1.19 vcs client write opcode:Unmute                             AT+BLECAP=commander,vcp,write,<conn_handle>,5
    1.20 vcs client write opcode: Mute                              AT+BLECAP=commander,vcp,write,<conn_handle>,6
    1.21 vocs client get char value                                 AT+BLECAP=commander,vocs,get_char,<conn_handle>
    1.22 vocs client get srv data                                   AT+BLECAP=commander,vocs,get_srv,<conn_handle>
    1.23 vocs client write output description                       AT+BLECAP=commander,vocs,wdes,<conn_handle>,<srv instance id>,<des_str>
    1.24 vocs client write opcode: Set Volume Offset                AT+BLECAP=commander,vocs,write,<conn_handle>,1,<volume_offset>
    1.25 vocs client write opcode by group: Set Volume Offset       AT+BLECAP=commander,vocs,gwrite,<group_index>,1,<volume_offset>
    1.26 mcs server send data：MEDIA_PLAYER_NAME                    AT+BLECAP=initiator,mcp,send,<uuid>,{<value>}
    1.27 mcs server send data：TRACK_TITLE                          AT+BLECAP=initiator,mcp,send,<uuid>,{<value>}
    1.28 mcs server send data：TRACK_DURATION                       AT+BLECAP=initiator,mcp,send,<uuid>,{<value>}
    1.29 mcs server send data：TRACK_POSITION                       AT+BLECAP=initiator,mcp,send,<uuid>,{<value>}
    1.30 mcs server send data：TRACK_CHANGED                        AT+BLECAP=initiator,mcp,send,0x2B96
...
1.GMAP Unicast Game Gateway
    ...
    1.24 vocs client write opcode: Set Volume Offset                  AT+BLECAP=commander,vocs,write,<conn_handle>,1,<volume_offset>
    1.25 vocs client write opcode by group: Set Volume Offset         AT+BLECAP=commander,vocs,gwrite,<group_index>,1,<volume_offset>
    1.26 mics client set unmute by group                              AT+BLECAP=commander,micp,gmute,<group_idx>,0
    1.27 mics client set mute by group                                AT+BLECAP=commander,micp,gmute,<group_idx>,1
    1.28 mics client set unmute                                       AT+BLECAP=commander,micp,set_mute,<conn_handle>,0
    1.29 mics client set mute                                         AT+BLECAP=commander,micp,set_mute,<conn_handle>,1
    1.30 mics client get mute                                         AT+BLECAP=commander,micp,get_mute,<conn_handle>
    1.31 aics client get char value                                   AT+BLECAP=commander,aics,get_char,<conn_handle>
    1.32 aics client get srv data                                     AT+BLECAP=commander,aics,get_srv,<conn_handle>
    1.33 aics client write opcode:SET_GAIN_SETTING                    AT+BLECAP=commander,aics,write,<conn_handle>,1,<gaining_setting>
    1.34 aics client write opcode:UNMUTE                              AT+BLECAP=commander,aics,write,<conn_handle>,2
    1.35 aics client write opcode:MUTE                                AT+BLECAP=commander,aics,write,<conn_handle>,3
    1.36 aics client write opcode:SET_MANUAL_GAIN_MODE                AT+BLECAP=commander,aics,write,<conn_handle>,4
    1.37 aics client write opcode by group:SET_AUTOMATIC_GAIN_MODE    AT+BLECAP=commander,aics,write,<conn_handle>,5
    1.38 aics client write opcode by group:SET_GAIN_SETTING           AT+BLECAP=commander,aics,gwrite,0,1,<gaining_setting>
    1.39 aics client write opcode by group:UNMUTE                     AT+BLECAP=commander,aics,gwrite,0,2
    1.40 aics client write opcode by group:MUTE                       AT+BLECAP=commander,aics,gwrite,0,3
    1.41 aics client write opcode by group:SET_MANUAL_GAIN_MODE       AT+BLECAP=commander,aics,gwrite,0,4
    1.42 aics client write opcode by group:SET_AUTOMATIC_GAIN_MODE    AT+BLECAP=commander,aics,gwrite,0,5
