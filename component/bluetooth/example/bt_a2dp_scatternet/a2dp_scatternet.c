...
//  rtk_bt_audio_track_add((float)DEFAULT_AUDIO_LEFT_VOLUME, (float)DEFAULT_AUDIO_RIGHT_VOLUME, paac_decoder_t->channels, paac_decoder_t->sample_freq, 0, NULL, true);
