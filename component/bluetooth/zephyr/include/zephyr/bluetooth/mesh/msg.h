 ...
 *  @ref bt_mesh_msg_ack_ctx_rx calls.
 *
 *  @param ack Acknowledged message context to deinitialize.
 */
static inline void bt_mesh_msg_ack_ctx_deinit(struct bt_mesh_msg_ack_ctx *ack)
{
	k_sem_deinit(&ack->sem);
}
#endif
