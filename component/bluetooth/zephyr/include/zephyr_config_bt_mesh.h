...
#endif
#define CONFIG_BT_MESH_PB_ADV_TRANS_PDU_RETRANSMIT_COUNT  2  // range:0~7, 7 if BT_MESH_PB_ADV_USE_RELAY_SETS
#define CONFIG_BT_MESH_PB_ADV_TRANS_ACK_RETRANSMIT_COUNT    4  // range:0~7
...
#endif
#if defined(CONFIG_BT_MESH_BLOB_SRV) && CONFIG_BT_MESH_BLOB_SRV
...
#endif
#if defined(CONFIG_BT_MESH_BLOB_CLI) && CONFIG_BT_MESH_BLOB_CLI
...
#if ((defined(CONFIG_BT_MESH_BLOB_SRV) && CONFIG_BT_MESH_BLOB_SRV) || (defined(CONFIG_BT_MESH_BLOB_CLI) && CONFIG_BT_MESH_BLOB_CLI)) && 0
#define CONFIG_BT_MESH_BLOB_IO_FLASH  1
#endif

#if CONFIG_BT_MESH_MODEL_EXTENSIONS && (defined(CONFIG_BT_MESH_BLOB_SRV) && CONFIG_BT_MESH_BLOB_SRV)
#define CONFIG_BT_MESH_DFU_SRV  1
#endif

#if CONFIG_BT_MESH_MODEL_EXTENSIONS && (defined(CONFIG_BT_MESH_BLOB_CLI) && CONFIG_BT_MESH_BLOB_CLI)
...
#endif
#if defined(CONFIG_BT_MESH_DFU_SLOTS) && CONFIG_BT_MESH_DFU_SLOTS
#define CONFIG_BT_MESH_DFU_SLOT_CNT  1
#endif

#if (defined(CONFIG_BT_MESH_BLOB_SRV) && CONFIG_BT_MESH_BLOB_SRV) && (defined(CONFIG_BT_MESH_DFU_CLI) && CONFIG_BT_MESH_DFU_CLI)
#define CONFIG_BT_MESH_DFD_SRV  1
#if defined(CONFIG_BT_MESH_DFD_SRV) && CONFIG_BT_MESH_DFD_SRV
