...
typedef enum {
	...
	RTK_BT_PROFILE_BAP      =  BIT6,
	RTK_BT_PROFILE_CAP      =  BIT7,
	RTK_BT_PROFILE_SPP      =  BIT8,
	RTK_BT_PROFILE_RFC      =  BIT9,
	RTK_BT_PROFILE_HFP      =  BIT10,
	RTK_BT_PROFILE_PBAP     =  BIT11,
	RTK_BT_PROFILE_MESH     =  BIT12,
	RTK_BT_PROFILE_HID      =  BIT13,
	RTK_BT_PROFILE_TMAP     =  BIT14,
	RTK_BT_PROFILE_GMAP     =  BIT15,
} rtk_bt_profile_t;
...
typedef enum {
	...
	RTK_BT_LE_ISO_ACT_CIG_GET_CONN_HANDLE,
