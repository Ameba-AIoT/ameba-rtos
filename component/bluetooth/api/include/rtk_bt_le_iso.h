...
typedef struct {
	...
	rtk_bt_le_iso_data_path_direction_t
	data_path_direction;/**< Specify the direction for which the data path is being configured. @ref rtk_bt_le_iso_data_path_direction_t.
...
typedef struct {
	uint16_t iso_conn_handle;                                    /**< Connection handle of ISO. */
	rtk_bt_le_iso_data_path_direction_flag_t
	data_path_direction;/**< Specify which directions are to have the data path removed. @ref rtk_bt_le_iso_data_path_direction_flag_t.
 ...
 * @brief     Bluetooth LE ISO management get acl conn handle.
 */
typedef struct {
	uint16_t cis_conn_handle;       /**< Connection handle of the CIS */
	uint16_t *p_conn_handle;        /**< Connection handle */
} rtk_bt_le_iso_cig_get_conn_handle_param_t;
