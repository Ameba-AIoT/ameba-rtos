 ...
 * @brief     Bluetooth LE AUDIO GMAP Role.
 */
typedef enum {
...
typedef struct {
	...
	uint8_t num_subgroups;
	rtk_bt_le_audio_broadcast_source_subgroup_param_t
	subgroup[RTK_BT_LE_AUDIO_BROADCASTER_SUBGROUP_MAX_NUM]; /**<@ ref rtk_bt_le_audio_broadcast_source_subgroup_param_t*/
...
typedef struct {
	...
	rtk_bt_le_audio_unicast_ase_qos_t *p_snk_ase_qos;                    /**< sink ase qos config. @ref rtk_bt_le_audio_unicast_ase_qos_t */
	rtk_bt_le_audio_unicast_ase_qos_t *p_src_ase_qos;                /**< source ase qos config. @ref rtk_bt_le_audio_unicast_ase_qos_t */
 ...
 *            - Others: Failed
 */
uint16_t rtk_bt_le_audio_pacs_get_bis_array_by_sync_info(uint16_t conn_handle, rtk_bt_le_audio_sync_handle_t sync_handle, uint8_t filter,
