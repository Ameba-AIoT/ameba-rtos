...
typedef enum
{
    ...
    MESH_TRANS_LPN_POLL_ACK_TIMER_ID = 17,
#if MESH_PRB
    MESH_PRIVATE_BEACON_TIMER_ID = 100,
    MESH_PRIVATE_BEACON_RANDOM_UPDATE_TIMER_ID,
    MESH_PRIVATE_SERVICE_TIMER_ID,
    MESH_PRIVATE_SERVICE_ID_TIMER_ID,
#endif
} mesh_timer_id_t;
...
typedef enum
{
    ...
    MESH_TRANS_LPN_POLL_ACK_TIMEOUT = 23,
#if MESH_PRB
    MESH_PRIVATE_BEACON_TIMEOUT = 100,
    MESH_PRIVATE_BEACON_RANDOM_UPDATE_TIMEOUT,
...
#if MESH_SW_TIMER_TYPE == 1
#define MESH_SW_TIMER_ENTER_CRITICAL()              plt_sched_suspend()
#define MESH_SW_TIMER_EXIT_CRITICAL()               plt_sched_resume()
#define MESH_SW_TIMER_CHECK(exp)                    if(exp)
#else
#define MESH_SW_TIMER_ENTER_CRITICAL()
#define MESH_SW_TIMER_EXIT_CRITICAL()
#define MESH_SW_TIMER_CHECK(exp)
#endif
