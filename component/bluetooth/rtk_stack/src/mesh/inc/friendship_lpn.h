...
typedef enum
{
    ...
    LPN_REQ_REASON_FRND_ALREADY_EXIST_OR_ESTABLISHING,
...
/**
  * @brief get friend index of established friendship from network key index
  * @param[in] net_key_index: the network key index
  * @return friend index
  * @retval >=0: friend index
  * @retval <0: friend not found
  */
int16_t lpn_get_frnd_idx(uint16_t net_key_index);
