...
} _PACKED4_ pb_adv_start_t, *pb_adv_start_p;

typedef struct
{
    uint8_t data[MESH_PB_ADV_CONTINUE_DATA_SIZE]; // variable length
} _PACKED4_ pb_adv_continue_t, *pb_adv_continue_p;
...
{
    uint8_t dev_uuid[16];
} _PACKED4_ pb_adv_link_open_t, *pb_adv_link_open_p;
...
} _PACKED4_ pb_adv_link_close_t, *pb_adv_link_close_p;
...
} _PACKED4_ pb_adv_bearer_ctrl_t, *pb_adv_bearer_ctrl_p;
...
} _PACKED4_ pb_adv_payload_t, *pb_adv_payload_p;
...
} _PACKED4_ pb_adv_pkt_t, *pb_adv_pkt_p;
