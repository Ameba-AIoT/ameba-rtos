...
} _PACKED4_ prov_oob_info_t, *prov_oob_info_p;
...
{
    uint8_t attn_dur;
} _PACKED4_ prov_invite_t, *prov_invite_p;
...
} _PACKED4_ prov_capabilities_t, *prov_capabilities_p;
...
} _PACKED4_ prov_start_t, *prov_start_p;

typedef struct
{
    uint8_t public_key[64];
} _PACKED4_ prov_public_key_t, *prov_public_key_p;
...
typedef struct
{
    ...
    uint8_t mic[8];
} _PACKED4_ prov_data_t, *prov_data_p; //!< big endian
...
} _PACKED4_ prov_failed_t, *prov_failed_p;
...
} _PACKED4_ prov_pdu_t, *prov_pdu_p;
