...
/* Add Includes here */
#ifndef __USER_CMD_PARSE_H
#define __USER_CMD_PARSE_H
...
extern void user_cmd_init(char *s);
/* deinitiate command interface struct */
extern void user_cmd_deinit(void);
/* collect user command from Data UART strings */
extern bool user_cmd_collect(uint8_t *pdata, uint8_t len, const user_cmd_table_entry_t *pcmd_table);
/** @} */
/** @} */
