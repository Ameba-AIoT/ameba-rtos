...
} _PACKED4_ rmt_prov_scan_caps_get_t;
...
} _PACKED4_ rmt_prov_scan_caps_status_t;

typedef struct
{
    uint8_t opcode[ACCESS_OPCODE_SIZE(MESH_MSG_RMT_PROV_SCAN_GET)];
} _PACKED4_ rmt_prov_scan_get_t;
...
typedef struct
{
    ...
    uint8_t timeout;
    uint8_t uuid[16];
} _PACKED4_ rmt_prov_scan_start_t;

typedef struct
{
    uint8_t opcode[ACCESS_OPCODE_SIZE(MESH_MSG_RMT_PROV_SCAN_STOP)];
} _PACKED4_ rmt_prov_scan_stop_t;
...
typedef struct
{
    ...
    uint8_t scanned_items_limit;
    uint8_t timeout;
} _PACKED4_ rmt_prov_scan_status_t;
...
typedef struct
{
    ...
    uint8_t oob[2];
    uint8_t uri_hash[4];
} _PACKED4_ rmt_prov_scan_report_t;
...
} _PACKED4_ rmt_prov_link_status_t;
...
typedef struct
{
    ...
    uint8_t pdu[0];
} _PACKED4_ rmt_prov_pdu_report_t;
