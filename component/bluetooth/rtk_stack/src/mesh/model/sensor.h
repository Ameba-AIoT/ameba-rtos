...
} _PACKED4_ sensor_column_status_t;
...
} _PACKED4_ sensor_series_status_t;

typedef struct
{
    uint8_t opcode[ACCESS_OPCODE_SIZE(MESH_MSG_SENSOR_CADENCE_GET)];
    uint16_t property_id;
} _PACKED4_ sensor_cadence_get_t;
...
typedef struct
{
    ...
    uint16_t property_id;
    uint8_t cadence[0];
} _PACKED4_ sensor_cadence_status_t;

typedef struct
{
    uint8_t opcode[ACCESS_OPCODE_SIZE(MESH_MSG_SENSOR_SETTINGS_GET)];
    uint16_t property_id;
} _PACKED4_ sensor_settings_get_t;
...
} _PACKED4_ sensor_settings_status_t;
...
typedef struct
{
    ...
    uint16_t property_id;
    uint16_t setting_property_id;
} _PACKED4_ sensor_setting_get_t;
...
typedef struct
{
    ...
    uint16_t setting_property_id;
    uint8_t setting[0];
} _PACKED4_ sensor_setting_set_t;
...
typedef struct
{
    ...
    uint16_t setting_property_id;
    uint8_t setting[0];
} _PACKED4_ sensor_setting_status_t;
...
#define SENSOR_SERVER_GET_SETTINGS                       	   9 //!< @ref sensor_server_get_settings_t
#define SENSOR_SERVER_GET_SETTING                       	   10 //!< @ref sensor_server_get_setting_t
...
} sensor_server_get_descriptor_num_t;

typedef struct {
	uint16_t property_id;
	uint16_t descriptor_num;
	sensor_descriptor_t *descriptor;
} sensor_server_get_descriptor_t;
