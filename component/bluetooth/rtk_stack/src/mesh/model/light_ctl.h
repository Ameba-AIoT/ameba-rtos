...
typedef struct
{
    ...
    /* If the Transition Time field is present, the Delay field shall also be present;
       otherwise these fields shall not be present. */
    uint8_t delay; //!< Message execution delay in 5 millisecond steps
} _PACKED4_ light_ctl_temperature_set_t;
...
typedef struct
{
    ...
    generic_transition_time_t remaining_time;
} _PACKED4_ light_ctl_temperature_stat_t;
...
typedef struct
{
    ...
    uint16_t range_min;
    uint16_t range_max;
} _PACKED4_ light_ctl_temperature_range_set_t;
...
typedef struct
{
    ...
    uint16_t range_min;
    uint16_t range_max;
} _PACKED4_ light_ctl_temperature_range_stat_t;

typedef struct
{
    uint8_t opcode[ACCESS_OPCODE_SIZE(MESH_MSG_LIGHT_CTL_DEFAULT_GET)];
} _PACKED4_ light_ctl_default_get_t;
...
typedef struct
{
    ...
    uint16_t temperature; //!< The color temperature of white light in Kelvin
    int16_t delta_uv;
} _PACKED4_ light_ctl_default_set_t;
...
typedef struct
{
    ...
    uint16_t temperature; //!< The color temperature of white light in Kelvin
    int16_t delta_uv;
} _PACKED4_ light_ctl_default_stat_t;
/** @} */
