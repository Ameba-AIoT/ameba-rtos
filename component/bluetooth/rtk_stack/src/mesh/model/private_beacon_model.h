...
} _PACKED4_ private_beacon_get_t;
...
} _PACKED4_ private_beacon_set_t;
...
} _PACKED4_ private_node_identity_set_t;
...
typedef struct
{
    ...
    uint16_t net_key_index;
    uint8_t private_identity;
} _PACKED4_ private_node_identity_status_t;
