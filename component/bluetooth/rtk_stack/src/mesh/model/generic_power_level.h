...
} _PACKED4_ generic_power_level_get_t;
...
} _PACKED4_ generic_power_level_set_t;
...
typedef struct
{
    ...
    uint16_t range_min;
    uint16_t range_max;
} _PACKED4_ generic_power_range_set_t, *generic_power_range_set_p;
...
typedef struct
{
    ...
    uint16_t range_min;
    uint16_t range_max;
} _PACKED4_ generic_power_range_stat_t, *generic_power_range_stat_p;
/** @} */
