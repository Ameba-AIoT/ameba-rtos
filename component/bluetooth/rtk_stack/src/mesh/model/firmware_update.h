...
} _PACKED4_ fw_update_info_get_t;
...
} _PACKED4_ fw_update_info_status_t;
...
} _PACKED4_ fw_update_fw_metadata_check_t;
...
typedef struct
{
    ...
    uint8_t addi_info : 5;
    uint8_t fw_image_idx;
} _PACKED4_ fw_update_fw_metadata_status_t;

typedef struct
{
    uint8_t opcode[ACCESS_OPCODE_SIZE(MESH_MSG_FW_UPDATE_GET)];
} _PACKED4_ fw_update_get_t;
