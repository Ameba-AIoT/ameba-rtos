...
} _PACKED4_ generic_user_property_set_t;
...
typedef struct
{
    ...
    uint8_t property_access;
    uint8_t property_value[0]; //!< variable length
} _PACKED4_ generic_admin_property_set_t;
...
typedef struct
{
    ...
    uint16_t property_id;
    uint8_t property_access;
} _PACKED4_ generic_manufacturer_property_set_t;
...
typedef struct
{
    ...
    uint8_t property_access;
    uint8_t property_value[0]; //!< variable length
} _PACKED4_ generic_manufacturer_property_status_t;
...
} _PACKED4_ generic_client_properties_get_t;

typedef struct
{
    uint8_t opcode[ACCESS_OPCODE_SIZE(MESH_MSG_GENERIC_CLIENT_PROPERTIES_STATUS)];
    uint16_t property_ids[0]; //!< variable length
} _PACKED4_ generic_client_properties_status_t;
...
#define GENERIC_PROPERTY_SERVER_IDS_VALUE_GET                              		7 //!< @ref generic_property_server_num_ids_value_get_t

typedef struct {
	bool pdb;//check wehther pdb is NULL
	uint8_t property_access;
	uint16_t value_len;
} generic_property_server_para_t;

typedef struct {
    uint16_t property_id;
	generic_property_server_para_t pvalue;
} generic_property_server_para_get_t;

typedef struct {
	uint16_t property_id;
	uint16_t value_len;
	uint8_t *pproperty_value;
} generic_property_server_value_get_t;

typedef struct {
	bool pdb;//check wehther pdb is NULL
	uint8_t num_ids;
} generic_property_server_num_ids_t;

typedef struct {
	generic_property_server_num_ids_t pvalue;
} generic_property_server_num_ids_get_t;

typedef struct {
	uint8_t num_ids;
	uint16_t *property_ids;
} generic_property_server_num_ids_value_get_t;
