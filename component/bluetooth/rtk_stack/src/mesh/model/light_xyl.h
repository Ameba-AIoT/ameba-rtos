...
} _PACKED4_ light_xyl_range_set_t;
...
typedef struct
{
    ...
    uint16_t xyl_y_range_min;
    uint16_t xyl_y_range_max;
} _PACKED4_ light_xyl_range_status_t;
/** @} */
