...
#define F_BT_LE_5_2_ISOC_TEST_MODE_CIS_SUPPORT         (F_BT_LE_5_2_ISOC_CIS_SUPPORT && F_BT_LE_5_2_ISOC_TEST_MODE_SUPPORT && 1)
#define F_BT_LE_5_2_ISOC_TEST_MODE_CIS_CENTRAL_SUPPORT (F_BT_LE_5_2_ISOC_CIS_CENTRAL_SUPPORT && F_BT_LE_5_2_ISOC_TEST_MODE_CIS_SUPPORT && 1)
#define F_BT_LE_5_2_ISOC_TEST_MODE_BIS_SUPPORT         (F_BT_LE_5_2_ISOC_BIS_SUPPORT && F_BT_LE_5_2_ISOC_TEST_MODE_SUPPORT && 1)
#define F_BT_LE_5_2_ISOC_TEST_MODE_BIS_BROADCASTER_SUPPORT  (F_BT_LE_5_2_ISOC_BIS_BROADCASTER_SUPPORT && F_BT_LE_5_2_ISOC_TEST_MODE_BIS_SUPPORT && 1)
#define F_BT_LE_5_2_ISOC_TEST_MODE_BIS_RECEIVER_SUPPORT  (F_BT_LE_5_2_ISOC_BIS_RECEIVER_SUPPORT && F_BT_LE_5_2_ISOC_TEST_MODE_BIS_SUPPORT && 1)
...
#define F_BT_LE_GATT_CCCD_DATA_PENDING           (F_BT_LE_GATT_SERVER_SUPPORT && 0)
