 ...
 * ble_audio_def.h
 *
 * \brief  Define Broadcast_ID and code length.
 *
 * \ingroup LEA_LIB_Exported_Macros
 */
#define BROADCAST_ID_LEN                      3      /**< Length of Broadcast_ID. */
#define BROADCAST_CODE_LEN                    16     /**< Length of Broadcast_Code. */

/**
 * ble_audio_def.h
 *
 * \brief  Define Broadcast_Name AD type.
 *
 * \ingroup LEA_LIB_Exported_Macros
 */
...
typedef enum
{
    ...
    AUDIO_INPUT_AMBIENT             = 0x07,     /**< Transparency/Pass-through. */
} T_AUDIO_INPUT_TYPE;
/**
