...
#define LE_AUDIO_GMAS_SUPPORT 1
...
#define LE_AUDIO_CAS_CLIENT_SUPPORT  1
#define LE_AUDIO_TMAS_CLIENT_SUPPORT 1
#define LE_AUDIO_HAS_CLIENT_SUPPORT  1
#define LE_AUDIO_GMAS_CLIENT_SUPPORT 1

#define LE_AUDIO_UNICAST_CLIENT_ROLE      (LE_AUDIO_PACS_CLIENT_SUPPORT && LE_AUDIO_ASCS_CLIENT_SUPPORT)
#define LE_AUDIO_UNICAST_SERVER_ROLE      (LE_AUDIO_PACS_SUPPORT && LE_AUDIO_ASCS_SUPPORT)
#define LE_AUDIO_BROADCAST_SOURCE_ROLE    1
#define LE_AUDIO_BROADCAST_SINK_ROLE      (LE_AUDIO_PACS_SUPPORT && 1)
#define LE_AUDIO_SCAN_DELEGATOR_ROLE      (LE_AUDIO_BASS_SUPPORT)
#define LE_AUDIO_BROADCAST_ASSISTANT_ROLE (LE_AUDIO_BASS_CLIENT_SUPPORT)

#define LE_AUDIO_BAP_SUPPORT (LE_AUDIO_UNICAST_CLIENT_ROLE || LE_AUDIO_UNICAST_SERVER_ROLE || \
                              LE_AUDIO_BROADCAST_SOURCE_ROLE || LE_AUDIO_BROADCAST_SINK_ROLE || \
                              LE_AUDIO_SCAN_DELEGATOR_ROLE || LE_AUDIO_BROADCAST_ASSISTANT_ROLE)
...
#define LE_AUDIO_GROUP_SUPPORT      (LE_AUDIO_VCS_CLIENT_SUPPORT || LE_AUDIO_ASCS_CLIENT_SUPPORT || \
                                     LE_AUDIO_CSIS_CLIENT_SUPPORT || LE_AUDIO_BASS_CLIENT_SUPPORT)
