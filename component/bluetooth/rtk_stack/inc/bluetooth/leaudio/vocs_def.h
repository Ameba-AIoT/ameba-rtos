 ...
 *
 * \brief  Define VOCS service and characteristic UUID.
 *
 * \ingroup VOCS_Def_Exported_Macros
 * @{
 */
#define GATT_UUID_VOCS                           0x1845   /**< Volume Offset Control Service. */
 ...
 *
 * \brief  Define VOCS service CCCD flags.
 *
 * \ingroup VOCS_Def_Exported_Macros
 * @{
 */
 ...
 * vocs_def.h
 *
 * \brief  Volume Offset Control Point opcodes.
 *
