...
#define SHELL_TASK_FUNC_STACK_SIZE (CONFIG_SHELL_TASK_STACK_BASIC_SIZE + CONTEXT_SAVE_SIZE_WITH_MARGIN)
...
#ifdef CONFIG_LONGER_CMD
_LONG_CALL_ void shell_array_init(u8  *pArrayToInit,  u16  ArrayLen,  u8  InitValue);
#else
