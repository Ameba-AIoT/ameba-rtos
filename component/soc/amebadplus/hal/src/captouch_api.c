...
/* group: MBED_CAPTOUCH Exported Types */
...
static const PinMap PinMap_CTC[] = {
	{PB_19,			CapTouch_0,		PINMUX_FUNCTION_CAP_TOUCH},
	{PB_18,			CapTouch_1,		PINMUX_FUNCTION_CAP_TOUCH},
	{PB_17,			CapTouch_2,		PINMUX_FUNCTION_CAP_TOUCH},
	{PB_16,			CapTouch_3,		PINMUX_FUNCTION_CAP_TOUCH},
	{NC,			NC,				0}
};
...
/* group: MBED_CAPTOUCH Exported Functions */
/* Since all the members in the group are static which will not be extracted to the doxygen doc,
   original comment has been deleted to avoid there is nothing displayed under the group. */
