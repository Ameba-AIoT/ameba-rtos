...
#define PWM_TIMER			8 	// hhh
#define PWM_CHANNEL_MAX		8 	// yyyy
...
/**
  ...
  * @return Check result:
  *         - 0: The pin is available for all PWM channels.
  *         - 1: The pin is available for PWM channel 0/1/2/3.
  *         - 2: The pin is available for PWM channel 4/5/6/7.
  *         - NC: The pin does not have PWM out functionality.
  */
...
void pwmout_init(pwmout_t *obj, PinName pin)
{
	...
	if (pwm_chcheck == NC) {
		printf("PinName error: pwm channel of PinName doesn't exist!\n");
