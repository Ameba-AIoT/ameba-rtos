...
volatile pwr_lmt_regu_remap pwrlmt_regu_remapping_1v8[1] = {{0}};

volatile u8 array_len_of_pwrlmt_regu_remapping_1v8 = sizeof(pwrlmt_regu_remapping_1v8) / sizeof(pwr_lmt_regu_remap);
...
const s8 tx_pwr_limit_2g_fcc_1v8[4][14] = {
	...
	{56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 16, 127}, /*OFDM*/
	{56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 52, 12, 127}, /*HT_B20*/
	{127, 127, 56, 56, 56, 56, 56, 56, 56, 52, 44, 127, 127, 127}  /*HT_B40*/
};
...
const s8 tx_pwr_limit_2g_ww_1v8[4][14] = {
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 52, 60}, /*CCK*/
	{56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 48, 44, 16, 127}, /*OFDM*/
	{56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 48, 42, 12, 127}, /*HT_B20*/
	{127, 127, 52, 56, 56, 56, 52, 46, 44, 44, 44, 127, 127, 127}  /*HT_B40*/
};
...
s8 wifi_hal_phy_get_power_limit_value_1v8(u8 regulation, u8 band, u8 limit_rate, u8 chnl_idx, boolean is_shape)
{
	s8 power_limit = 127;
	s8 tx_shape_idx = -1;
