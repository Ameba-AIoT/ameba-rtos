...
const s8 tx_pwr_limit_2g_fcc[4][14] = {
	{80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 76, 66, 60, 127}, /*CCK*/
	{70, 74, 76, 76, 76, 76, 76, 76, 72, 68, 66, 58, 16, 127}, /*OFDM*/
	{64, 68, 72, 76, 76, 76, 76, 72, 68, 64, 60, 54, 12, 127}, /*HT_B20*/
	{127, 127, 66, 68, 68, 68, 64, 60, 56, 54, 44, 127, 127, 127}  /*HT_B40*/
};
const s8 tx_pwr_limit_5g_fcc[3][28] = {
	{72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 66, 72, 72, 72, 72, 72, 72, 72, 72, 72}, /*OFDM*/
	{72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 68, 72, 72, 72, 72, 72, 72, 72, 72, 72}, /*HT_B20*/
	{72, 72, 72, 62, 58, 72, 72, 72, 72, 72, 72, 72, 72, 72}  /*HT_B40*/
};
...
const s8 tx_pwr_limit_5g_mkk[3][28] = {
	{64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 127, 127, 127, 127, 127, 127, 127, 127, 127}, /*OFDM*/
	{64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 127, 127, 127, 127, 127, 127, 127, 127, 127}, /*HT_B20*/
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 127, 127, 127, 127, 127}  /*HT_B40*/
};
...
const s8 tx_pwr_limit_2g_ww[4][14] = {
	...
	{68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 66, 58, 16, 127}, /*OFDM*/
	{64, 68, 68, 68, 68, 68, 68, 68, 68, 64, 60, 54, 12, 127}, /*HT_B20*/
	{127, 127, 64, 64, 64, 64, 64, 60, 56, 54, 44, 127, 127, 127}  /*HT_B40*/
};
const s8 tx_pwr_limit_5g_ww[3][28] = {
	{62, 62, 62, 52, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 70, 38, 38, 38, 38, 38, 38, 38, 72}, /*OFDM*/
	{62, 62, 62, 52, 60, 60, 60, 60, 6, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 70, 38, 38, 38, 38, 38, 38, 38, 72}, /*HT_B20*/
	{54, 60, 60, 52, 56, 56, 56, 60, 60, 66, 38, 38, 38, 72}  /*HT_B40*/
};
