...
/** @defgroup SPI_BAUDR
 * @brief Baud Rate Select Register
 * @{
 **/
...
/** @defgroup SPI_TXFTLR
 * @brief Transmit FIFO Threshold Level Register
 * @{
 **/
...
/** @defgroup SPI_RXFTLR
 * @brief Receive FIFO Threshold Level Register
 * @{
 **/
...
typedef struct {
	...
	__IO uint32_t RSVD1[3];                               /*!<  Reserved,  Address offset:0xF4-0xFC */
	__I  uint32_t SPI_DUMMY;                              /*!< SPI DUMMY REGISTER,  Address offset: 0x100 */
} SPI_TypeDef;
/** @} */
/* AUTO_GEN_END */
