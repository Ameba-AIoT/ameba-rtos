...
_LONG_CALL_ void DATA_FLASH_Config(SPIC_TypeDef *spi_flash, FLASH_InitTypeDef *FLASH_InitStruct);
...
_LONG_CALL_ u32 DATA_FLASH_PLLInit_ClockDiv(FlashDivInt_E Div);
...
_LONG_CALL_ u32 DATA_FLASH_CalibrationNew(FLASH_InitTypeDef *FLASH_InitStruct, u8 SpicBitMode, u8 new_calibration_end, u8 CalStep, u8 SpicClkDelay,
		u8 StartIdx);
_LONG_CALL_ u32 DATA_FLASH_CalibrationNewCmd(u32 NewStatus);
_LONG_CALL_ void DATA_FLASH_CalibrationPLLPSCmd(u32 NewStatus);
_LONG_CALL_ u32 DATA_FLASH_CalibrationPhaseIdx(u8 phase_idx);
_LONG_CALL_ void DATA_FLASH_CalibrationPLLPS_Shift(u32 phase_sel);
