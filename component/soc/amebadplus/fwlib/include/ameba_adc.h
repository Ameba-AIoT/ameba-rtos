 ...
 * @{
 **/
#define ADC_BIT_IN_TYPE_CH10                ((u32)0x00000001 << 10)          /*!<R 0  This bit reflects which kind of input type channel 10 is. Since channel 10 is a fixed internal channel. */
...
#define ADC_BIT_IN_TYPE_CH6                 ((u32)0x00000001 << 6)          /*!<R 0  This bit reflects which kind of input type channel 6 is. Since channel 6 is a fixed single-end input channel. */
#define ADC_BIT_IN_TYPE_CH5                 ((u32)0x00000001 << 5)          /*!<R/W 0  This bit controls channel 5 input type. If it's set to differential types (value of this bit is 1), channel 4 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 5 is single-end input. 1: ADC channel 5 is differential input which is paired with channel 4. */
#define ADC_BIT_IN_TYPE_CH4                 ((u32)0x00000001 << 4)          /*!<R/W 0  This bit controls channel 4 input type. If it's set to differential types (value of this bit is 1), channel 5 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 4 is single-end input. 1: ADC channel 4 is differential input which is paired with channel 5. */
#define ADC_BIT_IN_TYPE_CH3                 ((u32)0x00000001 << 3)          /*!<R/W 0  This bit controls channel 3 input type. If it's set to differential types (value of this bit is 1), channel 2 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 3 is single-end input. 1: ADC channel 3 is differential input which is paired with channel 2. */
#define ADC_BIT_IN_TYPE_CH2                 ((u32)0x00000001 << 2)          /*!<R/W 0  This bit controls channel 2 input type. If it's set to differential types (value of this bit is 1), channel 3 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 2 is single-end input. 1: ADC channel 2 is differential input which is paired with channel 3. */
#define ADC_BIT_IN_TYPE_CH1                 ((u32)0x00000001 << 1)          /*!<R/W 0  This bit controls channel 1 input type. If it's set to differential types (value of this bit is 1), channel 0 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 1 is single-end input. 1: ADC channel 1 is differential input which is paired with channel 0. */
#define ADC_BIT_IN_TYPE_CH0                 ((u32)0x00000001 << 0)          /*!<R/W 0  This bit controls channel 0 input type. If it's set to differential types (value of this bit is 1), channel 1 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 0 is single-end input. 1: ADC channel 0 is differential input which is paired with channel 1. */
/** @} */
...
#define ADC_MASK_COMP_CTRL_CH9              ((u32)0x00000003 << 18)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH9(x)                (((u32)((x) & 0x00000003) << 18))
#define ADC_GET_COMP_CTRL_CH9(x)            ((u32)(((x >> 18) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH8              ((u32)0x00000003 << 16)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH8(x)                (((u32)((x) & 0x00000003) << 16))
#define ADC_GET_COMP_CTRL_CH8(x)            ((u32)(((x >> 16) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH7              ((u32)0x00000003 << 14)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH7(x)                (((u32)((x) & 0x00000003) << 14))
#define ADC_GET_COMP_CTRL_CH7(x)            ((u32)(((x >> 14) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH6              ((u32)0x00000003 << 12)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH6(x)                (((u32)((x) & 0x00000003) << 12))
#define ADC_GET_COMP_CTRL_CH6(x)            ((u32)(((x >> 12) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH5              ((u32)0x00000003 << 10)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH5(x)                (((u32)((x) & 0x00000003) << 10))
#define ADC_GET_COMP_CTRL_CH5(x)            ((u32)(((x >> 10) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH4              ((u32)0x00000003 << 8)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH4(x)                (((u32)((x) & 0x00000003) << 8))
#define ADC_GET_COMP_CTRL_CH4(x)            ((u32)(((x >> 8) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH3              ((u32)0x00000003 << 6)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH3(x)                (((u32)((x) & 0x00000003) << 6))
#define ADC_GET_COMP_CTRL_CH3(x)            ((u32)(((x >> 6) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH2              ((u32)0x00000003 << 4)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH2(x)                (((u32)((x) & 0x00000003) << 4))
#define ADC_GET_COMP_CTRL_CH2(x)            ((u32)(((x >> 4) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH1              ((u32)0x00000003 << 2)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
#define ADC_COMP_CTRL_CH1(x)                (((u32)((x) & 0x00000003) << 2))
#define ADC_GET_COMP_CTRL_CH1(x)            ((u32)(((x >> 2) & 0x00000003)))
#define ADC_MASK_COMP_CTRL_CH0              ((u32)0x00000003 << 0)          /*!<R/W 0h  The function is the same as BIT_ADC_COMP_CTRL_CH10. */
 ...
 * @{
 **/
#define ADC_BIT_FIFO_EMPTY                  ((u32)0x00000001 << 2)          /*!<R 1  0: FIFO in ADC is not empty. 1: FIFO in ADC is empty. */
#define ADC_BIT_FIFO_FULL_REAL              ((u32)0x00000001 << 1)          /*!<R 0  0: FIFO in ADC is not real full. 1: FIFO in ADC is real full. */
...
#define ADC_BIT_IT_COMP_CH10_EN             ((u32)0x00000001 << 18)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH9_EN              ((u32)0x00000001 << 17)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH8_EN              ((u32)0x00000001 << 16)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH7_EN              ((u32)0x00000001 << 15)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH6_EN              ((u32)0x00000001 << 14)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH5_EN              ((u32)0x00000001 << 13)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH4_EN              ((u32)0x00000001 << 12)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH3_EN              ((u32)0x00000001 << 11)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH2_EN              ((u32)0x00000001 << 10)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
#define ADC_BIT_IT_COMP_CH1_EN              ((u32)0x00000001 << 9)          /*!<R/W 0h  The function is the same as BIT_ADC_IT_COMP_CH0_EN */
...
#define ADC_BIT_IT_CHCV_END_EN              ((u32)0x00000001 << 2)          /*!<R/W 0h  This bit controls the interrupt is enabled or not when a particular channel conversion is done. refer to reg_adc_it_chno_con. 0: This interrupt is disabled. 1: This interrupt is enabled. */
 ...
 * @{
 **/
#define ADC_MASK_FULL_LVL                   ((u32)0x0000003F << 0)          /*!<R/W 0h  This field defines the FIFO full entry threshold level and it's used for FIFO full interrupt. It should be set according to ADC FIFO depth. A value of 0 sets the threshold for 1 entry, and a value of 15 sets the threshold for 16 entries. */
 ...
 * @{
 **/
#define ADC_BIT_DAT_RDY_CHx                 ((u32)0x00000001 << 21)          /*!<R 0  This bit indicates that a conversion is done. Every time a conversion is done, this bit should be set to 1 and it would be cleared to 0 when a read operation of reg_adc_data_chx. */
#define ADC_BIT_DAT_OVW_CHx                 ((u32)0x00000001 << 20)          /*!<R 0  This bit indicates that there is a data overwritten situation in bit_adc_data_global taking place. A data overwritten situation is that a former conversion data is NOT read before a new conversion is written to data field. It would be cleared to 0 when a read operation of reg_adc_data_chx. 0: There is no data overwritten case. 1: There is a data overwritten case. */
#define ADC_MASK_NUM_CHx                    ((u32)0x0000000F << 16)          /*!<RP 0  This field contains the newest conversion data of channel x [19:16]: which channel in channel list the data belongs to, only valid when bit_adc_ch_unmask=1 */
#define ADC_NUM_CHx(x)                      (((u32)((x) & 0x0000000F) << 16))
#define ADC_GET_NUM_CHx(x)                  ((u32)(((x >> 16) & 0x0000000F)))
#define ADC_MASK_DATA_CHx                   ((u32)0x0000FFFF << 0)          /*!<RP 0  This field contains the newest conversion data of channel x [15:0]: newest data */
 ...
 * @{
 **/
#define ADC_BIT_DAT_RDY_GLOBAL              ((u32)0x00000001 << 21)          /*!<R 0  This bit indicates that a conversion is done. Every time a conversion is done, this bit should be set to 1 and it would be cleared to 0 when a read operation of reg_adc_data_global */
#define ADC_BIT_DAT_OVW_GLOBAL              ((u32)0x00000001 << 20)          /*!<R 0  This bit indicates that there is a data overwritten situation in bit_adc_data_global taking place. A data overwritten situation is that a former conversion data is NOT read before a new conversion is written to data field. 0: there is no data overwritten case. 1: there is a data overwritten case. */
#define ADC_MASK_CH_NUM_GLOBAL              ((u32)0x0000000F << 16)          /*!<RP 0  This field contains the newest conversion data of channel in the list. [19:16]: which channel in channel list the data belongs to, only valid when bit_adc_ch_unmask=1 */
#define ADC_CH_NUM_GLOBAL(x)                (((u32)((x) & 0x0000000F) << 16))
#define ADC_GET_CH_NUM_GLOBAL(x)            ((u32)(((x >> 16) & 0x0000000F)))
#define ADC_MASK_DATA_GLOBAL                ((u32)0x0000FFFF << 0)          /*!<RP 0  This field contains the newest conversion data of channel in the list. [15:0]: newest data */
 ...
 * @{
 **/
#define ADC_MASK_FLR                        ((u32)0x0000003F << 0)          /*!<R 0  This field records the current ADC FIFO entry number. */
 ...
 * @{
 **/
#define ADC_MASK_DUMMY_CHN_SCNT             ((u32)0x0001FFFF << 15)          /*!<R/W 0h  Dummy channel time counter. In auto mode, ADC shares the dummy channel for Cap-Touch. This register controls the time of dummy channel, the unit is 4MHz. */
#define ADC_DUMMY_CHN_SCNT(x)               (((u32)((x) & 0x0001FFFF) << 15))
#define ADC_GET_DUMMY_CHN_SCNT(x)           ((u32)(((x >> 15) & 0x0001FFFF)))
#define ADC_MASK_SETTLE_CTC_TO_ADC          ((u32)0x0000000F << 4)          /*!<R/W 0h  Settle count for sample data from Cap-Touch to ADC, the unit is ADC sample clock. 0: means no need to settle */
#define ADC_SETTLE_CTC_TO_ADC(x)            (((u32)((x) & 0x0000000F) << 4))
#define ADC_GET_SETTLE_CTC_TO_ADC(x)        ((u32)(((x >> 4) & 0x0000000F)))
#define ADC_MASK_CLK_DIV                    ((u32)0x00000007 << 0)          /*!<R/W 3h  This field defines clock driver level of ADC module. The source clock is OSC4M. A value of 0 is for clock divided by 4. A value of 1 is for clock divided by 8. A value of 2 is for clock divided by 16. A value of 3 is for clock divided by 24. A value of 4 is for clock divided by 32. A value of 5 is for clock divided by 64. A value of 6 is for clock divided by 128. */
#define ADC_CLK_DIV(x)                      (((u32)((x) & 0x00000007) << 0))
#define ADC_GET_CLK_DIV(x)                  ((u32)(((x >> 0) & 0x00000007)))
/** @} */

/** @defgroup ADC_OVERSAMPLE
 * @brief ADC Oversample Register
 * @{
 **/
#define ADC_MASK_OSF                        ((u32)0x00000007 << 6)          /*!<R/W 0  Oversampling right shift 000: no shift 001: shift 1-bit 010: shift 2-bit 011: shift 3-bit 100: shift 4-bit */
#define ADC_OSF(x)                          (((u32)((x) & 0x00000007) << 6))
#define ADC_GET_OSF(x)                      ((u32)(((x >> 6) & 0x00000007)))
#define ADC_MASK_OSR                        ((u32)0x00000007 << 3)          /*!<R/W 0  Oversample ratio 000: 2x 001: 4x 010: 8x 011: 16x 100: 32x 101: 64x 110: 128x 111: 256x */
#define ADC_OSR(x)                          (((u32)((x) & 0x00000007) << 3))
#define ADC_GET_OSR(x)                      ((u32)(((x >> 3) & 0x00000007)))
#define ADC_BIT_OV_MODE                     ((u32)0x00000001 << 1)          /*!<R/W 0  Oversample mode 1: All oversampling conversions done in regular sequence 0: All oversampling conversions done in staggered sequence */
#define ADC_BIT_OS_EN                       ((u32)0x00000001 << 0)          /*!<R/W 0  Oversample enable 1: enable 0: disable */
/** @} */
...
typedef struct {
	...
	__IO uint32_t RSVD0;                                  /*!<  Reserved,  Address offset:0x44 */
	...
	__IO uint32_t ADC_DATA_CHx[11];                       /*!< ADC CHANNEL x DATA REGISTER,  Address offset: 0x070-0x098 */
	__IO uint32_t ADC_DATA_GLOBAL;                        /*!< ADC GLOBAL DATA REGISTER,  Address offset: 0x09C */
	...
	__IO uint32_t ADC_CLK_DIV;                            /*!< ADC CLOCK DIVIDER REGISTER,  Address offset: 0x0A8 */
	__IO uint32_t ADC_OVERSAMPLE;                         /*!< ADC OVERSAMPLE REGISTER,  Address offset: 0x0AC */
	...
	__IO uint32_t ADC_DUMMY;                              /*!< ADC DUMMY REGISTER,  Address offset: 0x0B8 */
} ADC_TypeDef;
/** @} */
/* AUTO_GEN_END */
...
/**
  ...
  */
typedef struct {
	u8 ADC_OpMode;				/*!< Specify ADC operation mode.
	...
	u8 ADC_Cvlist[16];				/*!< Specify the ADC channel conversion order. Each member should be
									the channel index */

	u8 ADC_ClkDiv;				/*!< Specify ADC clock divider.
									This parameter can be a value of @ref ADC_Clk_Divider */

	u8 ADC_RxThresholdLevel;		/*!< Specify the receive FIFO threshold level.
							    		When the number of rx FIFO entries is greater than or equal to this
							     		value +1, the receive FIFO full interrupt is triggered. */

	u8  ADC_SpecialCh;			/*!< Specify ADC particular channel. This parameter defines that ADC module
	...
	u32 ADC_ChanInType; 		/*!< Specify CH0~5 input type. Default all channels are in single-end mode.
