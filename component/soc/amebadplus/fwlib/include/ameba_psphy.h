...
#define PSPHY_GET_CFG_CAL_NBDR_OVF(x)	((u32)(((x >> 16) & 0x00000001)))
...
#define PSPHY_GET_CFG_CAL_NBDR_ALMOST(x)((u32)(((x >> 15) & 0x00000001)))
...
#define PSPHY_GET_CFG_CAL_ERR_UNSURE(x)((u32)(((x >> 14) & 0x00000001)))
...
#define PSPHY_GET_CFG_CAL_ERR_ALREADY(x)((u32)(((x >> 13) & 0x00000001)))
...
#define PSPHY_GET_CFG_CAL_ERR_ALMOST(x)((u32)(((x >> 12) & 0x00000001)))
 ...
 * @{
 **/
#define PSPHY_MASK_PRE_CAL_PHASE        ((u32)0x0000000F << 28)          /*!<R/W 4'h0  one-hot phase select, 4-tap delay line to adjust rwds phase before calibration for large freq range or skew can be set to 0, bypassing the default 1-tap delay */
