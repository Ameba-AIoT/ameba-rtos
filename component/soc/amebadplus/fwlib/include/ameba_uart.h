 ...
 * @{
 **/
#define RUART_BIT_INT_PEND                ((u32)0x00000001 << 0)          /*!<R 0x1  * 0: pending, and the IR contents may be used as a pointer to the appropriate interrupt service routine. * 1: no interrupt is pending. */
/** @} */
 ...
 * @{
 **/
#define RUART_BIT_DLAB                    ((u32)0x00000001 << 7)          /*!<R/W 0x0  Divisor Latch Access bit, and control the accessibility of the DLL, DLM and IER registers * 0: The divisor latches not accessible; IER accessible * 1: The divisor latches accessible; DLL and DLM accessible Note: THR/RBR don't care the value of this bit. */
...
#define RUART_BIT_MODEM_INT               ((u32)0x00000001 << 11)          /*!<R 0  This bit is only set when Modem status is pending. 1: Modem interrupt */
...
#define RUART_BIT_RXFIFO_ERR              ((u32)0x00000001 << 7)          /*!<R 0  Uart_rx_error, depending on the FIFO control register (FCR) bit[0] * 0: cleared when the CPU reads the LSR, if there are no subsequent errors in the FIFO. * 1: parity error, overrun error, framing error or break indication in the FIFO. */
...
#define RUART_MASK_R_CYCNUM_PERBIT_OSC    ((u32)0x000FFFFF << 9)          /*!<R/W/ES 0x0  Indicate the average OSC clock cycle number of one bit, for Rx path OSC clock NOTE: SW sets the initial value, and HW updates it depending on the monitor result. */
...
#define RUART_MASK_R_CYCNUM_PERBIT_XTAL   ((u32)0x000FFFFF << 0)          /*!<R/W/ES 0x0  Indicate the fractional xtal clock cycle number of one bit, for Rx path XTAL clock NOTE: SW sets the initial value, and HW updates it depending on the monitor result. */
...
#define RUART_BIT_DMA_MODE                ((u32)0x00000001 << 3)          /*!<R/W 0x0  Support DMA mode (co-operate with DW DDMA in the data path) */
...
typedef struct {
	...
	__I  uint32_t DUMMY;                                  /*!< UART DUMMY REGISTER,  Address offset: 0x060 */
} UART_TypeDef;
/** @} */
/* AUTO_GEN_END */
...
/**
  ...
  */
typedef struct {
	u32 DmaModeCtrl;	/*!< Specify the uart DMA mode state.
							This parameter can be ENABLE or DISABLE. */

	u32 WordLen;		/*!< Specify the UART word length.
							This parameter can be a value of @ref UART_Word_Length. */

	u32 StopBit;		/*!< Specify the UART stop bit number.
							This parameter can be a value of @ref UART_Stop_Bit. */

	u32 Parity;			/*!< Specify the UART parity.
							This parameter can be a value of @ref UART_Parity_Enable. */

	u32 ParityType;		/*!< Specify the UART parity type.
							This parameter can be a value of @ref UART_Parity_Type. */

	u32 StickParity;	/*!< Specify the UART stick parity.
							This parameter can be a value of @ref UART_Stick_Parity_Type. */

	u32 FlowControl;	/*!< Specify the UART auto flow control.
							This parameter can be ENABLE or DISABLE. */

	u32 RxFifoTrigLevel;	/*!< Specify the UART rx fifo trigger level.
							This parameter can be a value of @ref UART_Rx_FIFO_Trigger_Level. */

	u32 RxErReportCtrl;		/*!< Specify the UART rx error report control.
							This parameter can be a value of @ref UART_Rx_Err_Report. */

	u32 RxTimeOutCnt;		/*!< Specify the UART rx time out counter.
 ...
 */
typedef struct {
	u32 UART_IrDARxInv;		/*!< Specify the uart irda rx invert control.
								This parameter can be ENABLE or DISABLE.
	...
	u32 UART_IrDATxInv;		/*!< Specify the uart irda tx invert control.
								This parameter can be ENABLE or DISABLE.
								ENABLE: invert the irda output signal.
								DISABLE: does't invert the irda output signal.
								@note This parameter is only used in IrDA mode. */

	u32 UART_UpperShift;	/*!< Specify the uart irda tx pulse right edge shift direction.
								This parameter can be a value of @ref UART_IRDA_Pulse_Shift. */

	u32 UART_UpperShiftVal;	/*!< Specify the uart irda tx pulse right edge shift value in the given direction.
								This parameter can be a number between 0x0000 and 0x7fff. */

	u32 UART_LowShift;		/*!< Specify the uart irda tx pulse left edge shift direction.
								This parameter can be a value of @ref UART_IRDA_Pulse_Shift. */

	u32 UART_LowShiftVal;	/*!< Specify the uart irda tx pulse left edge shift value in the given direction.
								This parameter can be a number between 0x0000 and 0x7fff. */

	u32 UART_RxFilterThres;	/*!< Specify the uart irda rx filter threshold.
								This parameter can be a number between 0x0000 and 0x7fff
								@note This parameter is only used in IrDA mode. */

	u32 UART_RxFilterCmd;	/*!< Specify the uart irda rx filter control.
								This parameter can be ENABLE or DISABLE.
...
/* Exported functions --------------------------------------------------------*/
/* UART_Normal_Functions UART Normal Functions */
...
/* UART_DMA_functions UART DMA Functions */
...
/* UART_IRDA_functions UART IRDA Functions */
...
/* UART_External_functions UART External Functions */
