...
#define SEC_BIT_USB_CLK_CAL_EN                   ((u32)0x00000001 << 30)          /*!<R/W 0  SoC clock calibration for USB 0: disable 1: enable */
...
#define SEC_MASK_SW_RSVD_0                       ((u32)0x00000003 << 22)          /*!<R/W 0  Reserved for SW usage */
#define SEC_SW_RSVD_0(x)                         ((u32)(((x) & 0x00000003) << 22))
#define SEC_GET_SW_RSVD_0(x)                     ((u32)(((x >> 22) & 0x00000003)))
#define SEC_BIT_BOOT_CNT_LMT_EN                  ((u32)0x00000001 << 21)          /*!<R/W 0  Enable boot cnt limit. 0'b0: disable 0'b1: enable */
#define SEC_BIT_BOOT_SEL_FLASH                   ((u32)0x00000001 << 20)          /*!<R/W 0  Boot select. Boot from internal flash or external flash. 0'b0: internal flash 0'b1: external flash */
 ...
 * @{
 **/
#define SEC_BIT_BOOT_VOL_SEL                     ((u32)0x00000001 << 31)          /*!<R/W 0  BOOT Voltage Selection: 0'b0: 0.9V 0'b1: 1.0V */
#define SEC_MASK_SW_RSVD6                        ((u32)0x7FFFFFFF << 0)          /*!<R/W 0  RSVD for SW usage */
...
#define SEC_BIT_ROM_PATCH_LWE1                   ((u32)0x00000001 << 2)          /*!<PROT/R 1'b1  ROM patch write protection(protect Low 256bits) : 500-51f */
#define SEC_BIT_ROM_PATCH_LWE2                   ((u32)0x00000001 << 3)          /*!<PROT/R 1'b1  ROM patch write protection(protect Low 256bits) : 520-53f */
#define SEC_BIT_ROM_PATCH_LWE3                   ((u32)0x00000001 << 4)          /*!<PROT/R 1'b1  ROM patch write protection(protect Low 256bits) : 540-55f */
#define SEC_BIT_ROM_PATCH_LWE4                   ((u32)0x00000001 << 5)          /*!<PROT/R 1'b1  ROM patch write protection(protect Low 256bits): 560-57f */
#define SEC_BIT_ROM_PATCH_LWE5                   ((u32)0x00000001 << 6)          /*!<PROT/R 1'b1  ROM patch write protection(protect low 1Kbits) :580-5ff */
#define SEC_BIT_ROM_PATCH_HWE                    ((u32)0x00000001 << 7)          /*!<PROT/R 1'b1  ROM patch write protection (protect High 2Kbits) */
/** @} */
...
#define SEC_BIT_SWTRIG_UART_DOWNLOAD_DISABLE            ((u32)0x00000001 << 14)
