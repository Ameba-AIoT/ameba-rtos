...
#define AUD_BIT_AD_0_EQ_EN                   ((u32)0x00000001 << 16)          /*!<R/W 0  ADC channel 0 EQ clock enable */
#define AUD_BIT_AD_1_EQ_EN                   ((u32)0x00000001 << 17)          /*!<R/W 0  ADC channel 1 EQ clock enable */
/** @} */
...
#define AUD_MASK_I2S_0_DATA_CH_SEL_TX        ((u32)0x00000003 << 18)          /*!<R/W 0  I2S 0 Tx channel data 2'b00: L/R 2'b01: R/L 2'b10: L/L 2'b11: R/R */
#define AUD_I2S_0_DATA_CH_SEL_TX(x)          (((u32)((x) & 0x00000003) << 18))
#define AUD_GET_I2S_0_DATA_CH_SEL_TX(x)      ((u32)(((x >> 18) & 0x00000003)))
#define AUD_BIT_I2S_0_MASTER_SEL             ((u32)0x00000001 << 20)          /*!<R/W 0  I2S 0 master source selection 1'b0: internal SPORT 1'b1: external I2S */
/** @} */
...
#define AUD_BIT_I2S_0_DATA_CH4_RX_DISABLE    ((u32)0x00000001 << 28)          /*!<R/W 0  I2S 0 Rx channel data channel 4 1: disable 0: enable */
#define AUD_BIT_I2S_0_DATA_CH5_RX_DISABLE    ((u32)0x00000001 << 29)          /*!<R/W 0  I2S 0 Rx channel data channel 5 1: disable 0: enable */
#define AUD_BIT_I2S_0_DATA_CH6_RX_DISABLE    ((u32)0x00000001 << 30)          /*!<R/W 0  I2S 0 Rx channel data channel 6 1: disable 0: enable */
#define AUD_BIT_I2S_0_DATA_CH7_RX_DISABLE    ((u32)0x00000001 << 31)          /*!<R/W 0  I2S 0 Rx channel data channel 7 1: disable 0: enable */
/** @} */
