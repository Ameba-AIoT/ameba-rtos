 ...
 * @{
 **/
#define LOGUART_BIT_INTR_MASK_KM4           ((u32)0x00000001 << 1)          /*!<R/W 0x1  mask loguart interrupt to km4 1:unmask 0:mask */
#define LOGUART_INTR_MASK_KM4(x)            ((u32)(((x) & 0x00000001) << 1))
#define LOGUART_BIT_INTR_MASK_KM0           ((u32)0x00000001 << 0)          /*!<R/W 0x1  mask loguart interrupt to km0 1:unmask 0:mask */
#define LOGUART_INTR_MASK_KM0(x)            ((u32)(((x) & 0x00000001) << 0))
/** @} */
/** @} */
...
/**
  ...
  */
typedef struct {
	u32	DmaModeCtrl;	/*!< Specify the LOGUART DMA mode state.
										This parameter can be ENABLE or DISABLE. */

	u32	WordLen;		/*!< Specify the LOGUART word length.
										This parameter can be a value of @ref LOGUART_Word_Length. */

	u32	StopBit;		/*!< Specify the LOGUART stop bit number.
										This parameter can be a value of @ref LOGUART_Stop_Bit. */

	u32	Parity;			/*!< Specify the LOGUART parity.
										This parameter can be a value of @ref LOGUART_Parity_Enable. */

	u32	ParityType;		/*!< Specify the LOGUART parity type.
										This parameter can be a value of @ref LOGUART_Parity_Type. */

	u32	StickParity;	/*!< Specify the LOGUART stick parity.
										This parameter can be a value of @ref LOGUART_Stick_Parity_Type. */

	u32	FlowControl;	/*!< Specify the LOGUART auto flow control.
										This parameter can be ENABLE or DISABLE. */

	u32	RxFifoTrigLevel;	/*!< Specify the LOGUART rx fifo trigger level.
										This parameter can be a value of @ref LOGUART_Rx_FIFO_Trigger_Level. */

	u32	RxErReportCtrl;		/*!< Specify the LOGUART rx error report control.
										This parameter can be a value of @ref LOGUART_Rx_Err_Report. */

	u32 RxTimeOutCnt;	/*!< Specify the LOGUART rx time out counter.
										This parameter can be a number between 0x00 and 0xffff. */
	/* AGG function*/
	u32 AGGEn; 		 /*!< Specify the Tx AGG control.
										This parameter can be ENABLE or DISABLE. */

	u32 P1En;		/*!< Specify the Tx Path1 control.
										This parameter can be ENABLE or DISABLE. */

	u32 P2En;		/*!< Specify the Tx Path2 control.
										This parameter can be ENABLE or DISABLE. */

	u32 P3En;		/*!< Specify the Tx Path3 control.
										This parameter can be ENABLE or DISABLE. */

	u32 P4En;		/*!< Specify the Tx Path4 control.
										This parameter can be ENABLE or DISABLE. */

	u32 RPEn;		/*!< Specify the Tx Relay Path control.
										This parameter can be ENABLE or DISABLE. */

	u32 AGGTH;		/*!< Specify the AGG threshold.
										This parameter can be a value of @LOGUART_AGG_Threshold_Level. */

	u32 AGGTO;		/*!< Specify the AGG timeout.
										This parameter can be a number between 0x00 and 0x3fff. */

	u32 AGG_SYNC_PAT;		/*!< Specify the AGG packet start.
...
/**
  ...
  */
typedef struct {
	u32	WordLen;		/*!< Specify the LOGUART Relay Path word length.
										This parameter can be a value of @ref LOGUART_Word_Length. */

	u32	StopBit;		/*!< Specify the LOGUART Relay Path stop bit number.
										This parameter can be a value of @ref LOGUART_Stop_Bit. */

	u32	Parity;			/*!< Specify the LOGUART Relay Path parity.
										This parameter can be a value of @ref LOGUART_Parity_Enable. */

	u32	ParityType;		/*!< Specify the LOGUART Relay Path parity type.
										This parameter can be a value of @ref LOGUART_Parity_Type. */

	u32	StickParity;	/*!< Specify the LOGUART Relay Path stick parity.
										This parameter can be a value of @ref LOGUART_Stick_Parity_Type. */

	u32	RxErReportCtrl;		/*!< Specify the LOGUART Relay Path rx error report control.
										This parameter can be a value of @ref LOGUART_Rx_Err_Report. */
