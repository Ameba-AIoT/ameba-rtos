 ...
 * @{
 **/
#define I2C_BIT_R_LP_WAKE_2              ((u32)0x00000001 << 13)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_LP_WAKE_1              ((u32)0x00000001 << 12)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_GEN_CALL               ((u32)0x00000001 << 11)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_START_DET              ((u32)0x00000001 << 10)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_STOP_DET               ((u32)0x00000001 << 9)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_ACTIVITY               ((u32)0x00000001 << 8)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_RX_DONE                ((u32)0x00000001 << 7)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_TX_ABRT                ((u32)0x00000001 << 6)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_RD_REQ                 ((u32)0x00000001 << 5)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_TX_EMPTY               ((u32)0x00000001 << 4)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_TX_OVER                ((u32)0x00000001 << 3)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_RX_FULL                ((u32)0x00000001 << 2)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_RX_OVER                ((u32)0x00000001 << 1)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
#define I2C_BIT_R_RX_UNDER               ((u32)0x00000001 << 0)          /*!<R 0x0  Refer to I2C Raw Interrupt Status Register (IC_RAW_INTR_STAT) for a detailed description of this bit. */
/** @} */
 ...
 * @{
 **/
#define I2C_BIT_M_LP_WAKE_2              ((u32)0x00000001 << 13)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_LP_WAKE_1              ((u32)0x00000001 << 12)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_GEN_CALL               ((u32)0x00000001 << 11)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_START_DET              ((u32)0x00000001 << 10)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_STOP_DET               ((u32)0x00000001 << 9)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_ACTIVITY               ((u32)0x00000001 << 8)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_RX_DONE                ((u32)0x00000001 << 7)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_TX_ABRT                ((u32)0x00000001 << 6)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_RD_REQ                 ((u32)0x00000001 << 5)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_TX_EMPTY               ((u32)0x00000001 << 4)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_TX_OVER                ((u32)0x00000001 << 3)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_RX_FULL                ((u32)0x00000001 << 2)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_RX_OVER                ((u32)0x00000001 << 1)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
#define I2C_BIT_M_RX_UNDER               ((u32)0x00000001 << 0)          /*!<R/W 0x0  This bit masks the corresponding interrupt status bit in the IC_INTR_STAT register. */
/** @} */
 ...
 * @{
 **/
#define I2C_BIT_LP_WAKE_2                ((u32)0x00000001 << 13)          /*!<R 0x0  Set when address SAR_2 matches with address sending on I2C BUS. */
#define I2C_BIT_LP_WAKE_1                ((u32)0x00000001 << 12)          /*!<R 0x0  Set when address SAR matches with address sending on I2C BUS. */
#define I2C_BIT_GEN_CALL                 ((u32)0x00000001 << 11)          /*!<R 0x0  Set only when a General Call address is received and it is acknowledged. */
#define I2C_BIT_START_DET                ((u32)0x00000001 << 10)          /*!<R 0x0  Indicate whether a START or RESTART condition has occurred on the I2C interface regardless of whether I2C is operating in slave or master mode. */
#define I2C_BIT_STOP_DET                 ((u32)0x00000001 << 9)          /*!<R 0x0  Indicate whether a STOP condition has occurred on the I2C interface regardless of whether I2C is operating in slave or master mode. */
 ...
 * @{
 **/
#define I2C_BIT_CLR_TX_ABRT              ((u32)0x00000001 << 0)          /*!<R 0x0  Read this register to clear the TX_ABRT interrupt (bit[6]) of IC_RAW_INTR_STAT register and the IC_TX_ABRT_SOURCE register. This also releases the TxFIFO from the flushed/reset state, allowing more writes to the Tx FIFO. */
/** @} */
 ...
 * @{
 **/
#define I2C_BIT_CLR_STOP_DET             ((u32)0x00000001 << 0)          /*!<R 0x0  Read this register to clear the STOP_DET interrupt (bit[9]) of IC_RAW_INTR_STAT register. */
/** @} */
 ...
 * @{
 **/
#define I2C_BIT_CLR_START_DET            ((u32)0x00000001 << 0)          /*!<R 0x0  Read this register to clear the START_DET interrupt (bit[10]) of IC_RAW_INTR_STAT register. */
/** @} */
 ...
 * @{
 **/
#define I2C_BIT_CLR_GEN_CALL             ((u32)0x00000001 << 0)          /*!<R 0x0  Read this register to clear the GEN_CALL interrupt (bit[11]) of IC_RAW_INTR_STAT register. */
/** @} */
 ...
 * @{
 **/
#define I2C_BIT_ABRT_SLV_ARBLOST         ((u32)0x00000001 << 14)          /*!<R 0x0  * 1: Slave losts the bus while transmitting data to a remote master. IC_TX_ABRT_SOURCE[12] is set at the same time. */
#define I2C_BIT_ABRT_SLVFLUSH_TXFIFO     ((u32)0x00000001 << 13)          /*!<R 0x0  * 1: Slave has received a read command and some data exists in the TXFIFO so the slave issues a TX_ABRT interrupt to flush old data in Tx FIFO. */
...
#define I2C_BIT_ABRT_SBYTE_ACKDET        ((u32)0x00000001 << 7)          /*!<R 0x0  * 1: Master has send a START Byte and the START Byte was acknowledged (wrong behavior). */
...
#define I2C_BIT_ABRT_GCALL_READ          ((u32)0x00000001 << 5)          /*!<R 0x0  * 1: I2C in master mode sents a General Call but the user programmed the byte following the General Call to be a read from the bus. */
#define I2C_BIT_ABRT_GCALL_NOACK         ((u32)0x00000001 << 4)          /*!<R 0x0  * 1: I2C in master mode sents a General Call and no slave on the bus acknowledged the General Call. */
 ...
 * @brief I2C Receive Data Level Register
 * @{
 **/
...
#define I2C_BIT_DMODE_ENABLE             ((u32)0x00000001 << 0)          /*!<WA0 0x0  * 1: Set to enable DMA mode, cleared when transfer is done */
/** @} */
 ...
 * @brief Sample Delay Register
 * @{
 **/
#define I2C_MASK_IC_OUT_SMP_DLY          ((u32)0x00000007 << 0)          /*!<R/W 0x2  Delay cycles for sample of master derived SCL value. The sample of master derived SCL is used for slave stretch. Slave stretch is valid when master drive SCL High, but slave drive SCL low. Valid value of IC_OUT_SMP_DLY is 0-7. Inicate a delay of 1 to 8 cycles. */
 ...
 * @{
 **/
#define I2C_BIT_IC_CLR_ADDR_MATCH        ((u32)0x00000001 << 0)          /*!<R 0x0  Read this register to clear the slave mode address match interrupt (bit[13:12]) of IC_RAW_INTR_STAT register. */
/** @} */
...
typedef struct {
	...
	__IO uint32_t IC_DMA_RDLR;                            /*!< I2C RECEIVE DATA LEVEL REGISTER,  Address offset: 0x090 */
	...
	__IO uint32_t IC_OUT_SMP_DLY;                         /*!< SAMPLE DELAY REGISTER,  Address offset: 0x0B4 */
	...
	__I  uint32_t IC_DUMMY;                               /*!< IC DUMMY REGISTER,  Address offset: 0x100 */
} I2C_TypeDef;
/** @} */
/* AUTO_GEN_END */
/// @endcond
...
/** @defgroup I2C_Clock I2C Clock
  ...
  */
/* default: 40M */
#define I2C0_1_IPCLK			XTAL_ClkGet()  /*!< I2C0/I2C1 IP clock frequency in Hz. */
/**
  * @}
  */
