...
#define IR_MASK_TX_DUTY_NUM                  ((u32)0x00000FFF << 16)          /*!<R/W 0x0  Duty cycle setting for modulation frequency For example: for 1/3 duty cycle, IR_DUTY_NUM = (IR_DIV_NUM+1)/3 Note: Set this value equal to IR_DIV_NUM to generate 100% duty waveform. */
...
#define IR_BIT_RX_START_MODE                 ((u32)0x00000001 << 27)          /*!<R/W 0x0  *0: Manual mode, IR_RX_MAN_START control *1: Auto-mode, Trigger-mode control */
...
typedef struct {
	...
	__I  uint32_t IR_VERSION;                             /*!< IR VERSION REGISTER,  Address offset: 0x02C */
	__I  uint32_t IR_DUMMY;                               /*!< IR DUMMY REGISTER,  Address offset: 0x030 */
} IR_TypeDef;
/** @} */
/* AUTO_GEN_END */
