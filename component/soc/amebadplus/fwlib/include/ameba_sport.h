...
/** @addtogroup AUDIO_SPORT
  ...
  *****************************************************************************************
  * audio sport:
  * 	- Base Address: AUDIO_SPORT0_DEV,AUDIO_SPORT1_DEV
  * 	- Source clk: 40MHz
  ...
  *			RCC_PeriphClockCmd(APBPeriph_SPORTx, APBPeriph_SPORTx_CLOCK, ENABLE); for SPORT0/SPORT1
  *         RCC_PeriphClockSource_SPORT(AUDIO_SPORTx_DEV, CKSL_I2S_XTAL40M);
  *         RCC_PeriphClockSource_SPORT(AUDIO_SPORTx_DEV, CKSL_I2S_CPUPLL);
  *         PLL_I2Sx_CLK(ENABLE, x); for CLK_98P304M/CLK_45P1584M
  *
  ...
  *			AUDIO_SP_Init(x, SP_DIR_TX, &SP_InitStruct);
  *
  *      5. According to audio codec transfer direction, start Tx or Rx or both path
  *		start Tx path:
  *			AUDIO_SP_DmaCmd(AUDIO_SPORTx_DEV, ENABLE);
  *			AUDIO_SP_TxStart(AUDIO_SPORTx_DEV, ENABLE);
  *		start Rx path:
  *			AUDIO_SP_DmaCmd(AUDIO_SPORTx_DEV, ENABLE);
  *			AUDIO_SP_RxStart(AUDIO_SPORTx_DEV, ENABLE);
  *
 ...
 * @{
 **/
#define SP_MASK_REG_MUX                ((u32)0xFFFFFFFF << 0)          /*!<R/W 0xFFFFFFFF  Mux of register write with different base address of the same SPORT. This field can be set as different value with four different base address in one SPORT, but other registers share the same value with four different base address in one SPORT. */
 ...
 * @{
 **/
#define SP_MASK_MCLK_SEL               ((u32)0x00000003 << 30)          /*!<R/W 0x0  Not used, refer to 0x64 2’b00: MCLK output=dsp_src_clk/4 2’b01: MCLK output=dsp_src_clk/2 2’b10/2’b11: MCLK output=dsp_src_clk */
 ...
 * @{
 **/
#define SP_BIT_RX_FIFO_1_REG_1_EN      ((u32)0x00000001 << 31)          /*!<R/W 0  1’b1: Enable last two channels of RX_FIFO_1. Only enable when RX_FIFO_1_REG_1_EN = 1. */
#define SP_BIT_RX_FIFO_1_REG_0_EN      ((u32)0x00000001 << 30)          /*!<R/W 0  1’b1: Enable first two channels of RX_FIFO_1. Only enable when RX_FIFO_0_REG_0_EN = 1. */
#define SP_BIT_RX_FIFO_0_REG_1_EN      ((u32)0x00000001 << 29)          /*!<R/W 0  1’b1: Enable last two channels of RX_FIFO_0. Only enable when RX_FIFO_0_REG_0_EN = 1. */
#define SP_BIT_RX_FIFO_0_REG_0_EN      ((u32)0x00000001 << 28)          /*!<R/W 1  1’b1: Enable first two channels of RX_FIFO_0. Disable 0x0008[28] ~ Disable 0x0008[31] at the same time to reset Rx FIFO. */
#define SP_BIT_TX_FIFO_1_REG_1_EN      ((u32)0x00000001 << 27)          /*!<R/W 0  1’b1: Enable last two channels of TX_FIFO_1. Only enable when TX_FIFO_1_REG_0_EN = 1. */
#define SP_BIT_TX_FIFO_1_REG_0_EN      ((u32)0x00000001 << 26)          /*!<R/W 0  1’b1: Enable first two channels of TX_FIFO_1. Only enable when TX_FIFO_0_REG_0_EN = 1. */
#define SP_BIT_TX_FIFO_0_REG_1_EN      ((u32)0x00000001 << 25)          /*!<R/W 0  1’b1: Enable last two channels of TX_FIFO_0. Only enable when TX_FIFO_0_REG_0_EN = 1. */
#define SP_BIT_TX_FIFO_0_REG_0_EN      ((u32)0x00000001 << 24)          /*!<R/W 1  1’b1: Enable first two channels of TX_FIFO_0. Disable 0x0008[24] ~ Disable 0x0008[27] at the same time to reset Tx FIFO. */
...
#define SP_BIT_MULTI_IO_EN_RX          ((u32)0x00000001 << 3)          /*!<R/W 1  1’b1: Enable multi-IO of Rx 1’b0: Disable multi-IO of Rx */
#define SP_BIT_MULTI_IO_EN_TX          ((u32)0x00000001 << 2)          /*!<R/W 1  1’b1: Enable multi-IO of Tx 1’b0: Disable multi-IO of Tx */
...
#define SP_BIT_RX_DSP_CLEAR_INT_1      ((u32)0x00000001 << 8)          /*!<R/W 0  For DSP mode (bypass GDMA), F/W writes 1’b1 and then 1’b0 to clear Rx interrupt. Note: Rx interrupt is to indicate that DSP can get audio data from RX_FIFO_1. */
#define SP_BIT_TX_DSP_CLEAR_INT_1      ((u32)0x00000001 << 7)          /*!<R/W 0  For DSP mode (bypass GDMA), F/W writes 1’b1 and then 1’b0 to clear TX interrupt. Note: Tx interrupt is to indicate that DSP can write audio data to TX_FIFO_1. */
...
#define SP_BIT_RX_DSP_CLEAR_INT_0      ((u32)0x00000001 << 1)          /*!<R/W 0  For DSP mode (bypass GDMA), F/W writes 1’b1 and then 1’b0 to clear Rx interrupt. Note: Rx interrupt is to indicate that DSP can get audio data from RX_FIFO_0. */
#define SP_BIT_TX_DSP_CLEAR_INT_0      ((u32)0x00000001 << 0)          /*!<R/W 0  For DSP mode (bypass GDMA), F/W writes 1’b1 and then 1’b0 to clear Tx interrupt. Note: Tx interrupt is to indicate that DSP can write audio data to TX_FIFO_0. */
/** @} */
 ...
 * @{
 **/
#define SP_BIT_RESET_STATE             ((u32)0x00000001 << 31)          /*!<R 0  1’b1: sp_reset is enabled. 1’b0: sp_reset is disabled. */
#define SP_MASK_RX_DEPTH_CNT_1         ((u32)0x0000003F << 24)          /*!<R 0x0  RX_FIFO_1 depth counter status (MIC path) */
#define SP_RX_DEPTH_CNT_1(x)           (((u32)((x) & 0x0000003F) << 24))
#define SP_GET_RX_DEPTH_CNT_1(x)       ((u32)(((x >> 24) & 0x0000003F)))
#define SP_MASK_TX_DEPTH_CNT_1         ((u32)0x0000003F << 16)          /*!<R 0x0  TX_FIFO_1 depth counter status (SPK path) */
#define SP_TX_DEPTH_CNT_1(x)           (((u32)((x) & 0x0000003F) << 16))
#define SP_GET_TX_DEPTH_CNT_1(x)       ((u32)(((x >> 16) & 0x0000003F)))
#define SP_MASK_RX_DEPTH_CNT_0         ((u32)0x0000003F << 8)          /*!<R 0x0  RX_FIFO_0 depth counter status (MIC path) */
#define SP_RX_DEPTH_CNT_0(x)           (((u32)((x) & 0x0000003F) << 8))
#define SP_GET_RX_DEPTH_CNT_0(x)       ((u32)(((x >> 8) & 0x0000003F)))
#define SP_MASK_TX_DEPTH_CNT_0         ((u32)0x0000003F << 0)          /*!<R 0x0  TX_FIFO_0 depth counter status (SPK path) */
...
#define SP_MASK_DUMMY1                 ((u32)0x00000003 << 14)          /*!<R/W 0x0  - */
#define SP_DUMMY1(x)                   (((u32)((x) & 0x00000003) << 14))
#define SP_GET_DUMMY1(x)               ((u32)(((x >> 14) & 0x00000003)))
 ...
 * @{
 **/
#define SP_BIT_RX_FIFO_EMPTY_0         ((u32)0x00000001 << 31)          /*!<R 1  1: RX_FIFO_0 is empty */
#define SP_BIT_TX_FIFO_EMPTY_0         ((u32)0x00000001 << 30)          /*!<R 1  1: TX_FIFO_0 is empty */
#define SP_BIT_RX_FIFO_FULL_0          ((u32)0x00000001 << 29)          /*!<R 0  1: RX_FIFO_0 is full */
#define SP_BIT_TX_FIFO_FULL_0          ((u32)0x00000001 << 28)          /*!<R 0  1: TX_FIFO_0 is full */
#define SP_BIT_RX_FIFO_EMPTY_1         ((u32)0x00000001 << 27)          /*!<R 1  1: RX_FIFO_1 is empty */
#define SP_BIT_TX_FIFO_EMPTY_1         ((u32)0x00000001 << 26)          /*!<R 1  1: TX_FIFO_1 is empty */
#define SP_BIT_RX_FIFO_FULL_1          ((u32)0x00000001 << 25)          /*!<R 0  1: RX_FIFO_1 is full */
#define SP_BIT_TX_FIFO_FULL_1          ((u32)0x00000001 << 24)          /*!<R 0  1: TX_FIFO_1 is full */
#define SP_BIT_TX_I2S_IDLE_1           ((u32)0x00000001 << 13)          /*!<R 0  1: Tx is working but FIFO_1 is empty. */
#define SP_BIT_RX_FIFO_EMPTY_INTR_1    ((u32)0x00000001 << 12)          /*!<R 0  1: RX_FIFO_1 is empty (MIC path) */
#define SP_BIT_TX_FIFO_EMPTY_INTR_1    ((u32)0x00000001 << 11)          /*!<R 0  1: TX_FIFO_1 is empty (SPK path) */
#define SP_BIT_RX_FIFO_FULL_INTR_1     ((u32)0x00000001 << 10)          /*!<R 0  1: RX_FIFO_1 is full (MIC path) */
#define SP_BIT_TX_FIFO_FULL_INTR_1     ((u32)0x00000001 << 9)          /*!<R 0  1: TX_FIFO_1 is full (SPK path) */
...
#define SP_BIT_RX_FIFO_EMPTY_INTR_0    ((u32)0x00000001 << 5)          /*!<R 0  1: RX_FIFO_0 is empty (MIC path) */
#define SP_BIT_TX_FIFO_EMPTY_INTR_0    ((u32)0x00000001 << 4)          /*!<R 0  1: TX_FIFO_0 is empty (SPK path) */
#define SP_BIT_RX_FIFO_FULL_INTR_0     ((u32)0x00000001 << 3)          /*!<R 0  1: RX_FIFO_0 is full (MIC path) */
#define SP_BIT_TX_FIFO_FULL_INTR_0     ((u32)0x00000001 << 2)          /*!<R 0  1: TX_FIFO_0 is full (SPK path) */
...
#define SP_BIT_DUMMY3                  ((u32)0x00000001 << 27)          /*!<R/W 0  - */
...
#define SP_BIT_DUMMY4                  ((u32)0x00000001 << 15)          /*!<R/W 0  - */
...
#define SP_BIT_DUMMY5                  ((u32)0x00000001 << 4)          /*!<R/W 0  - */
...
#define SP_MASK_DUMMY6                 ((u32)0x00000003 << 27)          /*!<R/W 0x0   */
#define SP_DUMMY6(x)                   (((u32)((x) & 0x00000003) << 27))
#define SP_GET_DUMMY6(x)               ((u32)(((x >> 27) & 0x00000003)))
...
#define SP_MASK_INT_ENABLE_MCU_1       ((u32)0x000000FF << 8)          /*!<R/W 0x0  Bit8]: for the interrupt of “sp_ready_to_tx” Bit9]: for the interrupt of “sp_ready_to_rx” Bit10]: for the interrupt of “tx_fifo_full_intr” Bit11]: for the interrupt of “rx_fifo_full_intr” Bit12]: for the interrupt of “tx_fifo_empty_intr” Bit13]: for the interrupt of “rx_fifo_empty_intr” Bit14]: for the interrupt of “tx_i2s_idle” Bit15]: reserved */
#define SP_INT_ENABLE_MCU_1(x)         (((u32)((x) & 0x000000FF) << 8))
#define SP_GET_INT_ENABLE_MCU_1(x)     ((u32)(((x >> 8) & 0x000000FF)))
#define SP_MASK_INT_ENABLE_MCU_0       ((u32)0x000000FF << 0)          /*!<R/W 0x0  Bit0]: for the interrupt of “sp_ready_to_tx” Bit1]: for the interrupt of “sp_ready_to_rx” Bit2]: for the interrupt of “tx_fifo_full_intr” Bit3]: for the interrupt of “rx_fifo_full_intr” Bit4]: for the interrupt of “tx_fifo_empty_intr” Bit5]: for the interrupt of “rx_fifo_empty_intr” Bit6]: for the interrupt of “tx_i2s_idle” Bit7]: reserved */
...
#define SP_MASK_DIRECT_REG_2_SEL       ((u32)0x0000001F << 12)          /*!<R/W 0x0  5’h1c: TDM_RX_CH2 */
...
#define SP_MASK_DIRECT_REG_1_SEL       ((u32)0x0000001F << 6)          /*!<R/W 0x0  5’h1c: TDM_RX_CH1 */
...
#define SP_MASK_DIRECT_REG_0_SEL       ((u32)0x0000001F << 0)          /*!<R/W 0x0  5’h1c: TDM_RX_CH0 */
...
#define SP_MASK_DIRECT_REG_6_SEL       ((u32)0x0000001F << 12)          /*!<R/W 0x0  5’h1c: TDM_RX_CH6 */
...
#define SP_MASK_DIRECT_REG_5_SEL       ((u32)0x0000001F << 6)          /*!<R/W 0x0  5’h1c: TDM_RX_CH5 */
...
#define SP_MASK_DIRECT_REG_4_SEL       ((u32)0x0000001F << 0)          /*!<R/W 0x0  5’h1c: TDM_RX_CH4 */
...
#define SP_MASK_RX_FIFO_0_REG_1_L_SEL  ((u32)0x0000001F << 16)          /*!<R/W 0x2   */
...
#define SP_MASK_RX_FIFO_0_REG_0_R_SEL  ((u32)0x0000001F << 8)          /*!<R/W 0x1   */
...
#define SP_MASK_RX_FIFO_0_REG_0_L_SEL  ((u32)0x0000001F << 0)          /*!<R/W 0x0   */
...
#define SP_MASK_RX_FIFO_1_REG_1_L_SEL  ((u32)0x0000001F << 16)          /*!<R/W 0x6   */
...
#define SP_MASK_RX_FIFO_1_REG_0_R_SEL  ((u32)0x0000001F << 8)          /*!<R/W 0x5   */
...
#define SP_MASK_RX_FIFO_1_REG_0_L_SEL  ((u32)0x0000001F << 0)          /*!<R/W 0x4   */
 ...
 * @{
 **/
#define SP_BIT_CLR_RX_SPORT_RDY        ((u32)0x00000001 << 31)          /*!<WA0 0  X = (tx_sport_compare_val). When counter equal X. SPORT will send tx_sport_interrupt to DSP. FW should take care X={32~8191} */
#define SP_BIT_EN_RX_SPORT_INTERRUPT   ((u32)0x00000001 << 30)          /*!<R/W 0  Enable rx sport interrupt. */
#define SP_MASK_DUMMY16                ((u32)0x00000007 << 27)          /*!<R/W 0x0   */
#define SP_DUMMY16(x)                  (((u32)((x) & 0x00000007) << 27))
#define SP_GET_DUMMY16(x)              ((u32)(((x >> 27) & 0x00000007)))
...
/** @defgroup SP_MCLK
 * @brief SPORT MCLK Register
 * @{
 **/
#define SP_BIT_MCLK_MI_NI_UPDATE       ((u32)0x00000001 << 31)          /*!<R/W 0  1’b1: to update “mi” and “ni” to get the new clock rate. This bit will be reset automatically when the update is done */
 ...
 * @{
 **/
#define SP_MASK_TX_FIFO_0_WR_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<W 0x0  TX_FIFO_0 write address */
 ...
 * @{
 **/
#define SP_MASK_RX_FIFO_0_RD_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  RX_FIFO_0 read address */
 ...
 * @{
 **/
#define SP_MASK_TX_FIFO_1_WR_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<W 0x0  TX_FIFO_1 write address */
 ...
 * @{
 **/
#define SP_MASK_RX_FIFO_1_RD_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  RX_FIFO_1 read address */
...
typedef struct {
	...
	__IO uint32_t SP_SR_TX_BCLK;                          /*!< SPORT TX BCLK REGISTER,  Address offset: 0x001C */
	...
	__IO uint32_t SP_MCLK;                                /*!< SPORT MCLK REGISTER,  Address offset: 0x0064 */
	__IO uint32_t RSVD4[486];                              /*!<  Reserved,  Address offset:0x68-0x7FC */
...
typedef struct {
	...
	u32 SP_SelClk;		   /*AUDIO SPORT clock sources, 40M/CPU PLL */
