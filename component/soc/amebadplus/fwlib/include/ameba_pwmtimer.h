 ...
 * @{
 **/
#define TIM_BIT_CNT_EN       ((u32)0x00000001 << 16)          /*!<R 0x0  Counter working status * 0: Counter is stopped * 1: Counter is working */
...
/** @defgroup DIER
 * @brief TIM interrupt enable register
 * @{
 **/
#define TIM_BIT_UIE7         ((u32)0x00000001 << 23)          /*!<R/W 0x0  Enable channel 7 update interrupt */
#define TIM_BIT_UIE6         ((u32)0x00000001 << 22)          /*!<R/W 0x0  Enable channel 6 update interrupt */
...
#define TIM_BIT_CC7IE        ((u32)0x00000001 << 8)          /*!<R/W 0x0  Enable Capture/Compare 7 interrupt */
#define TIM_BIT_CC6IE        ((u32)0x00000001 << 7)          /*!<R/W 0x0  Enable Capture/Compare 6 interrupt */
 ...
 * @{
 **/
#define TIM_BIT_UG_DONE      ((u32)0x00000001 << 31)          /*!<R 0x1  UG operation status This bit is cleared by hardware when the UG bit in the TIMx_EGR register is set. When the UG operation is done, hardware sets this bit to '1'. So, software can poll this bit to see the UG operation status. */
#define TIM_BIT_UIF7         ((u32)0x00000001 << 23)          /*!<RW1C 0x0  Refer to UIF0 description */
#define TIM_BIT_UIF6         ((u32)0x00000001 << 22)          /*!<RW1C 0x0  Refer to UIF0 description */
...
#define TIM_BIT_UIF0         ((u32)0x00000001 << 16)          /*!<RW1C 0x0  Update interrupt flag of channel 0 This flag is set by hardware when the UIE0 bit in the TIMx_EGR register is set, and update interrupt of channel 0 happens. */
#define TIM_BIT_CC7IF        ((u32)0x00000001 << 8)          /*!<RW1C 0x0  Refer to CC0IF description */
#define TIM_BIT_CC6IF        ((u32)0x00000001 << 7)          /*!<RW1C 0x0  Refer to CC0IF description */
 ...
 * @{
 **/
#define TIM_BIT_CC7G         ((u32)0x00000001 << 8)          /*!<WA0 0x0  Refer to CC0G description */
#define TIM_BIT_CC6G         ((u32)0x00000001 << 7)          /*!<WA0 0x0  Refer to CC0G description */
 ...
 * @{
 **/
#define TIM_MASK_ARR         ((u32)0x0000FFFF << 0)          /*!<R/W 0xFFFF  The value to be loaded in the actual auto-reload register. It can be preloaded by setting ARPE bit in the TIM_CR register. */
 ...
 * @{
 **/
#define TIM_BIT_OPM_DLx      ((u32)0x00000001 << 29)          /*!<R/W 0x0  One-pulse mode default level 0: Default level is 0 1: Default level is 1 This bit takes effect only in PWM output one-pulse mode. */
#define TIM_BIT_CCxM         ((u32)0x00000001 << 27)          /*!<R/W 0x0  CCx working mode * 0: PWM mode * 1: Input capture mode */
#define TIM_BIT_CCxP         ((u32)0x00000001 << 26)          /*!<R/W 0x0  CCx channel configured as output: * 0: OCx active high * 1: OCx active low CCx channel configured as input: * 0: Positive edge of TRGI is active for capture * 1: Negative edge of TRGI is active for capture */
...
#define TIM_MASK_SYNCPHASEx  ((u32)0x0000FFFF << 0)          /*!<R/W 0x0  The deviation value of channel x to the reference counter */
 ...
 * @{
 **/
#define TIM_MASK_CNTx        ((u32)0x0000FFFF << 0)          /*!<R 0x0  Phase counter value of channel x */
...
typedef struct {
	...
	__IO uint32_t CCRx[8];                                /*!< TIM CAPTURE/COMPARE REGISTER x Register,  Address offset: 0x24-0x40 */
	__IO uint32_t PSYNCx[8];                              /*!< TIM PHASE SYNCHRONIZATION REGISTER x Register,  Address offset: 0x44-0x60 */
	__I  uint32_t PHASECNTx[8];                           /*!< TIM PHASE COUNTER REGISTER x Register,  Address offset: 0x64-0x80 */
	__IO uint32_t PWM_DUMMY;                              /*!< TIMER PWM DUMMY REGISTER,  Address offset: 0x84 */
} RTIM_TypeDef;
/** @} */
/* AUTO_GEN_END */
/// @endcond
...
/** @defgroup TIM_Peripheral_Count TIM Peripheral Count
  * @{
  */
#define TimerNum	12   /*!< Total number of TIM peripherals. */
/** @} */
