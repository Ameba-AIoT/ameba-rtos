 ...
 * @{
 **/
#define WDG_MASK_PRER    ((u32)0x000000FF << 16)          /*!<R/WE 63h  Prescaler counter, configuration only allowed before WDG enable IWDG: 0x63 System WDG: 0x1F */
...
/** @defgroup WDG_Peripheral_Definitions
  * @{
  */
#define IS_SYETEM_WDG_PERIPH(PERIPH) (((PERIPH) == KM0_WDG_DEV) || ((PERIPH) == KM4_S_WDG_DEV) || ((PERIPH) == KM4_NS_WDG_DEV))
