...
#define XTAL_BIT_XMD_DONE                ((u32)0x00000001 << 9)          /*!<R 0  xmd change ok status */
#define XTAL_BIT_CKRDY                   ((u32)0x00000001 << 8)          /*!<R 0  xtal clock ready status */
#define XTAL_MASK_STATE                  ((u32)0x0000000F << 4)          /*!<R 0  0 to 1 Enable xtal */
 ...
 * @{
 **/
#define XTAL_MASK_SC_INIT                ((u32)0x0000007F << 24)          /*!<R/W 0000000  0: reduce cap, 1: increase cap. (220fF per unit) [efuse for BT only ] 有外掛電容設全0 */
#define XTAL_SC_INIT(x)                  (((u32)((x) & 0x0000007F) << 24))
#define XTAL_GET_SC_INIT(x)              ((u32)(((x >> 24) & 0x0000007F)))
#define XTAL_MASK_SC_XO                  ((u32)0x0000007F << 17)          /*!<R/W 1000000  1: reduce cap, 0: increase cap. (220fF per unit) [efuse for BT only ] */
#define XTAL_SC_XO(x)                    (((u32)((x) & 0x0000007F) << 17))
#define XTAL_GET_SC_XO(x)                ((u32)(((x >> 17) & 0x0000007F)))
#define XTAL_MASK_SC_XI                  ((u32)0x0000007F << 10)          /*!<R/W 1000000  1: reduce cap, 0: increase cap. (220fF per unit) [efuse for BT only ] */
 ...
 * @{
 **/
#define XTAL_MASK_SEL_TOK_FST            ((u32)0x00000007 << 29)          /*!<R/W 0  used for HP2NM or NM2HP xtal起振过程 reg value: cycles / 40MHz / 26MHz 000: 2^10 / 0.025m / 0.05 001: 2^11 / 0.05m / 0.1m 010: 2^12 / 0.1m / 0.2m 011: 2^13 / 0.2m / 0.3m 100: 2^14 / 0.4m / 0.6m 101: 2^15 / 0.8m / 1.2m 110: 2^16 / 1.6m / 2.5m 111: 2^17 / 3.2m / 4.9m xtal mode switch过程 reg value: cycles / 40MHz / 26MHz 000: 2^10 / 0.0125m / 0.025 001: 2^11 / 0.025m / 0.05m 010: 2^12 / 0.05m / 0.1m 011: 2^13 / 0.1m / 0.2m 100: 2^14 / 0.2m / 0.3m 101: 2^15 / 0.4m / 0.6m 110: 2^16 / 0.8m / 1.25m 111: 2^17 / 1.6m / 2.45m */
#define XTAL_SEL_TOK_FST(x)              (((u32)((x) & 0x00000007) << 29))
#define XTAL_GET_SEL_TOK_FST(x)          ((u32)(((x >> 29) & 0x00000007)))
#define XTAL_MASK_DUMMY                  ((u32)0x00000003 << 12)          /*!<R/W 0  Dummy control bits */
#define XTAL_DUMMY(x)                    (((u32)((x) & 0x00000003) << 12))
#define XTAL_GET_DUMMY(x)                ((u32)(((x >> 12) & 0x00000003)))
#define XTAL_BIT_EN_XTAL_BDRF            ((u32)0x00000001 << 11)          /*!<R/W 1  Balance dynamic RF for duty cycle */
#define XTAL_MASK_GM_MANUAL              ((u32)0x0000001F << 5)          /*!<R/W 11111  Gm manual at EN_XTAL_AAC_DIGI=0 */
#define XTAL_GM_MANUAL(x)                (((u32)((x) & 0x0000001F) << 5))
#define XTAL_GET_GM_MANUAL(x)            ((u32)(((x >> 5) & 0x0000001F)))
#define XTAL_BIT_EN_XTAL_AAC_GM          ((u32)0x00000001 << 4)          /*!<R/W 0  1: enable xtal aac gm control */
#define XTAL_BIT_EN_XTAL_DRV_IQK_BCN     ((u32)0x00000001 << 3)          /*!<R/W 1  IQKPLL enable clock source control, 1:enable, 0: gate */
#define XTAL_BIT_EN_XTAL_DRV_DIGI_DIV2   ((u32)0x00000001 << 2)          /*!<R/W 0  IQKPLL enable clock source control, 1:enable, 0: gate */
 ...
 * @{
 **/
#define XTAL_MASK_OFF_DUMMY1             ((u32)0x0000003F << 4)          /*!<R/W 0  HW used only */
#define XTAL_OFF_DUMMY1(x)               (((u32)((x) & 0x0000003F) << 4))
#define XTAL_GET_OFF_DUMMY1(x)           ((u32)(((x >> 4) & 0x0000003F)))
#define XTAL_MASK_BG_T_OPTION            ((u32)0x00000007 << 1)          /*!<R/W 11  BG options */
#define XTAL_BG_T_OPTION(x)              (((u32)((x) & 0x00000007) << 1))
#define XTAL_GET_BG_T_OPTION(x)          ((u32)(((x >> 1) & 0x00000007)))
#define XTAL_BIT_OFF_DUMMY0              ((u32)0x00000001 << 0)          /*!<R/W 0  HW used only */
/** @} */
...
#define XTAL_MASK_VREF_MANUAL            ((u32)0x0000001F << 6)          /*!<R/W/ES 11111  VREF manual at EN_XTAL_PDCK_DIGI=0 When pdck done, it will auto set this value to pdck result */
...
#define XTAL_BIT_RESET_N_PDCK            ((u32)0x00000001 << 1)          /*!<R/W 0  PDCK digital circuit reset (low to high),not used */
/** @} */
 ...
 * @{
 **/
#define XTAL_MASK_XAACK_AAC_MODE         ((u32)0x00000003 << 30)          /*!<R/W 11  11: XTAL_AACK_PK_SEL=<11>’s XTAL_GM_OUT3 10: XTAL_AACK_PK_SEL=<10>’s XTAL_GM_OUT2 01: XTAL_AACK_PK_SEL=<01>’s XTAL_GM_OUT1 00: XTAL_AACK_PK_SEL=<00>’s XTAL_GM_OUT0 */
...
#define XTAL_BIT_RESET_N_AAC             ((u32)0x00000001 << 1)          /*!<R/W 0  AAC digital circuit reset (low to high) Default=0, 有EN_AAC 才會放開 (not used) */
/** @} */
...
#define XTAL_BIT_SCAN_MODE_XMD           ((u32)0x00000001 << 25)          /*!<R/W 0  1:scan mode */
...
#define XTAL_MASK_OV_UNIT                ((u32)0x00000007 << 7)          /*!<R/W 1  overlap time settling cycles (4M CLK) 000: 10us 001: 20us 010: 40us 011: 80us 100: 160us 101: 320us 110: 640us 111: 1280us */
...
#define XTAL_BIT_RESET_N_XMD             ((u32)0x00000001 << 1)          /*!<R/W 1  Decoder digital circuit reset (low to high) Default 1&POR 再給reset_n. (not used) */
/** @} */
 ...
 * @{
 **/
#define XTAL_MASK_OV_RATIO_FST           ((u32)0x00000003 << 30)          /*!<R/W 0  overlap unit times (4M CLK), used for HP2NM or NM2HP 00: 128us 01: 256us 10: 512us 11: 1024us */
...
#define XTAL_BIT_AUTO_PDCK               ((u32)0x00000001 << 1)          /*!<R/W/ES 1  Auto PDCK enable signal. If set this bit, arbiter will do PDCK before XTAL enter LPS mode. Once PDCK done , this bit will auto set 0 */
...
#define XTAL_BASE ((XTAL_TypeDef *) (0x41008400))
