...
/** @defgroup GDMA_Msize GDMA Msize
  * @{
  */
#define MsizeOne							        ((u32)0x00000000)  /*!< Burst transaction length of 1 data item. */
#define MsizeFour							        ((u32)0x00000001)  /*!< Burst transaction length of 4 data items. */
#define MsizeEight							      ((u32)0x00000002)  /*!< Burst transaction length of 8 data items. */
#define MsizeSixteen						      ((u32)0x00000003)  /*!< Burst transaction length of 16 data items. */
#define Msize32								        ((u32)0x00000004)  /*!< Burst transaction length of 32 data items. */
#define Msize64								        ((u32)0x00000005)  /*!< Burst transaction length of 64 data items. */
#define Msize128							        ((u32)0x00000006)  /*!< Burst transaction length of 128 data items. */
#define Msize256							        ((u32)0x00000007)  /*!< Burst transaction length of 256 data items. */
...
/** @defgroup GDMA_Interrupt_Type GDMA Interrupt Type
  * @{
  */
#define TransferType							    ((u32)0x00000001)  /*!< Transfer complete interrupt type. */
#define BlockType							        ((u32)0x00000002)  /*!< Block transfer complete interrupt type. */
#define ErrType								        ((u32)0x000000010)  /*!< Transfer error interrupt type. */
...
/** @defgroup GDMA_Reload_Definition GDMA Reload Definition
  * @{
  */
#define CLEAN_RELOAD_SRC					    ((u32)0x00000001)  /*!< Clean automatic source reload. */
#define CLEAN_RELOAD_DST					    ((u32)0x00000002)  /*!< Clean automatic destination reload. */
#define CLEAN_RELOAD_SRC_DST				  ((u32)0x00000003)  /*!< Clean both source and destination reload. */
/**
  * @}
  */
...
#define GDMA_HANDSHAKE_INTERFACE_SPIC_TX		    (10)  /*!< Handshake interface for SPIC TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPIC_RX		    (11) /*!< Handshake interface for SPIC RX. */

#define GDMA_HANDSHAKE_INTERFACE_SPORT0F0_TX	  (12) /*!< Handshake interface for SPORT0 FIFO0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT0F1_TX	  (13) /*!< Handshake interface for SPORT0 FIFO1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT0F0_RX	  (14) /*!< Handshake interface for SPORT0 FIFO0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT0F1_RX	  (15) /*!< Handshake interface for SPORT0 FIFO1 RX. */

#define GDMA_HANDSHAKE_INTERFACE_SPORT1F0_TX	  (16) /*!< Handshake interface for SPORT1 FIFO0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT1F1_TX	  (17) /*!< Handshake interface for SPORT1 FIFO1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT1F0_RX	  (18) /*!< Handshake interface for SPORT1 FIFO0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT1F1_RX	  (19) /*!< Handshake interface for SPORT1 FIFO1 RX. */

#define GDMA_HANDSHAKE_INTERFACE_LEDC_TX		    (20) /*!< Handshake interface for LEDC TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C0_TX		    (21) /*!< Handshake interface for I2C0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C0_RX		    (22) /*!< Handshake interface for I2C0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_TX		    (23) /*!< Handshake interface for I2C1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_RX		    (24) /*!< Handshake interface for I2C1 RX. */


#define GDMA_HANDSHAKE_INTERFACE_Zigbee_TX		  (NULL) /*!< Handshake interface for Zigbee TX. */
#define GDMA_HANDSHAKE_INTERFACE_Zigbee_RX		  (NULL) /*!< Handshake interface for Zigbee RX. */
