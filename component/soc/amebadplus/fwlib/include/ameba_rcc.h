...
/** @defgroup PSRAM_Clock_Source_define
  * @{
  */
#define BIT_LSYS_CKSL_PSRAM_CPUPLL		0x1
#define BIT_LSYS_CKSL_PSRAM_LBUS		0x0
/**
  * @}
  */
...
//#define UART_RX_CLK_XTAL_20M	((u32)0x00000002) // RSVD for internal test only
/**
  * @}
  */
...
//#define LOGUART_CLK_XTAL_20M	((u32)0x00000002) // RSVD for internal test only
/**
  * @}
  */
...
_LONG_CALL_ void RCC_PeriphClockSource_UART_ROM(UART_TypeDef *UARTx, u32 Source);
...
_LONG_CALL_ void RCC_PeriphClockSource_LOGUART_ROM(u32 Source);
