 ...
 * @{
 **/
#define WLAFE_BIT_ISO_SEL                    ((u32)0x00000001 << 10)          /*!<R/W 1  Option to enable isolation of wlafe when power off WLAFE 1: enable ,0x00[7]will be written 1 when wlafe power off 0: disable ,0x00[7]will keep 0 when wlafe power off */
#define WLAFE_BIT_ISO_WLAFE                  ((u32)0x00000001 << 7)          /*!<R/W 1  isolation signal */
#define WLAFE_BIT_HW_EN_RFAFE_2REGU          ((u32)0x00000001 << 6)          /*!<R/W 0  control 3.3V power reset of wl rfafe, need level shift to 3.3V by regu */
#define WLAFE_BIT_HW_EN_RFAFE                ((u32)0x00000001 << 5)          /*!<R/W 0  core power reset of wl rfafe */
...
#define WLAFE_BIT_VPLUSE_LDO_DAC             ((u32)0x00000001 << 11)          /*!<R/W 0  For DAC(WL DAC LDO) */
#define WLAFE_BIT_VPLUSE_LDO_ADC             ((u32)0x00000001 << 10)          /*!<R/W 0  For ADC(WL ADC LDO and RSSI ADC LDO) */
#define WLAFE_MASK_SW_LDO_OUT                ((u32)0x00000003 << 8)          /*!<R/W 00  Ldo voltage 00/01/10/11: 0.85V/0.9V/0.95V/1V (ADDA LDO) */
 ...
 * @{
 **/
#define WLAFE_BIT_WL_FUNEN_WLRF_SEL          ((u32)0x00000001 << 19)          /*!<R/W 0  1: select ANAPOW_RFC_NM as ANAPAR_RFC[7:0],used when RFAFE is active 0: select ANAPOW_RFC_LPS as ANAPAR_RFC[7:0],,used when RFAFE is power off */
#define WLAFE_MASK_ANAPOW_RFC_LPS            ((u32)0x000000FF << 11)          /*!<R/W 01100101  wlan power rf control */
...
#define WLAFE_MASK_ANAPOW_RFC_NM             ((u32)0x000000FF << 0)          /*!<R/W 11111111  wlan power rf control */
...
#define WLAFE_BIT_WLRFC_RETAIN_EN            ((u32)0x00000001 << 2)          /*!<R/W 1  1: backup(save) 0: restore this reg is usleless in lite,because no retention dff used in rfc */
#define WLAFE_BIT_WLRFC_PWC_SEL              ((u32)0x00000001 << 3)          /*!<R/W 1  Option to turn off wlrfc pwr cut 1: enable 0: disable */
#define WLAFE_BIT_CKRFC_EN                   ((u32)0x00000001 << 4)          /*!<R/W 1  1: enable WLRFC clock; 0: gated */
#define WLAFE_MASK_WLRFC_CLK_SEL             ((u32)0x00000007 << 5)          /*!<R/WPD 011  rfc clock divider, it is based on 320m wlpll 0: div1 1: div2 2: div3 3/other: divider by this value + 1,(default is 3:80M) */
...
#define WLAFE_MASK_DCK_WAVE_OFSP_CR          ((u32)0x000000FF << 17)          /*!<R/W 00111111  id[7:0] or qd[7:0] = wave_mid_val + wave_ofs_val */
...
#define WLAFE_MASK_DCK_WAVE_OFSN_CR          ((u32)0x000000FF << 17)          /*!<R/W 00111111   */
 ...
 * @{
 **/
#define WLAFE_MASK_DCK_DOS_MANU_I_BT         ((u32)0x0000003F << 18)          /*!<R/W 000000  DOS_I[5:0] by manual */
#define WLAFE_DCK_DOS_MANU_I_BT(x)           (((u32)((x) & 0x0000003F) << 18))
#define WLAFE_GET_DCK_DOS_MANU_I_BT(x)       ((u32)(((x >> 18) & 0x0000003F)))
#define WLAFE_MASK_DCK_DOS_MANU_Q_BT         ((u32)0x0000003F << 12)          /*!<R/W 000000  DOS_Q[5:0] by manual */
#define WLAFE_DCK_DOS_MANU_Q_BT(x)           (((u32)((x) & 0x0000003F) << 12))
#define WLAFE_GET_DCK_DOS_MANU_Q_BT(x)       ((u32)(((x >> 12) & 0x0000003F)))
#define WLAFE_MASK_DCK_KOS_EN_MANU_Q_BT      ((u32)0x0000003F << 6)          /*!<R/W 000000  KOS_EN_Q[5:0] by manual */
#define WLAFE_DCK_KOS_EN_MANU_Q_BT(x)        (((u32)((x) & 0x0000003F) << 6))
#define WLAFE_GET_DCK_KOS_EN_MANU_Q_BT(x)    ((u32)(((x >> 6) & 0x0000003F)))
#define WLAFE_MASK_DCK_KOS_EN_MANU_I_BT      ((u32)0x0000003F << 0)          /*!<R/W 000000  KOS_EN_I[5:0] by manual */
...
typedef struct {
	...
	__IO uint32_t WLAFE_DUMMY;                            /*!<  Register,  Address offset: 0x0018 */
	...
	__IO uint32_t WLAFE_ANAPAR_DCK_BT;                    /*!<  Register,  Address offset: 0x003C */
} WLAFE_TypeDef;

#define WLAFE_BASE ((WLAFE_TypeDef *) (0x41008480))
