...
/**
  ...
  *                 where x can be 0-10 corresponding to channelx
...
/**
  ...
  *		@arg ADC_COMP_LEVEL_DETECT: Level detection mode. When the comparison criterion matches, bit_adc_it_comp_chx will send interrupt continuously.
  *		@arg ADC_COMP_EDGE_DETECT: Edge detection mode. When the comparison criterion matches, bit_adc_it_comp_chx will send interrupt once at the time of matching.
  * @retval None
  */
