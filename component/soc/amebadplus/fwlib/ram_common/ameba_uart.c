...
const UART_DevTable UART_DEV_TABLE[MAX_UART_INDEX] = {
	...
	{UART2_DEV, GDMA_HANDSHAKE_INTERFACE_UART2_TX, GDMA_HANDSHAKE_INTERFACE_UART2_RX, UART2_BT_IRQ} /*uart2_bt */
};
 ...
 * @internal
 * @note After DISABLE: RTS goes active again once Rx FIFO is completely empty.
 * @endinternal
