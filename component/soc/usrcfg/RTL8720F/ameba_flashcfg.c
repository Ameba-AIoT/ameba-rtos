...
const FlashLayoutInfo_TypeDef Flash_Layout[] = {
	...
	{IMG_APP_OTA1,  CONFIG_FLASH_APP_OTA1_OFFSET,  CALC_END_ADDR(CONFIG_FLASH_APP_OTA1_OFFSET, CONFIG_FLASH_APP_OTA1_SIZE)}, //Certificate(4K) + Manifest(4K) + KM0 & KM4 Application OTA1 + RDP IMG OTA1
	...
	{IMG_APP_OTA2,  CONFIG_FLASH_APP_OTA2_OFFSET,  CALC_END_ADDR(CONFIG_FLASH_APP_OTA2_OFFSET, CONFIG_FLASH_APP_OTA2_SIZE)}, //Certificate(4K) + Manifest(4K) + KM0 & KM4 Application OTA2 + RDP IMG OTA2
