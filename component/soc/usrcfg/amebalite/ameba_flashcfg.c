...
*	0xFFFF: division ratio is 20 => Flash clock = 1/20 PLLM
*	0x7FFF: division ratio is 18 => Flash clock = 1/18 PLLM
*	0x3FFF: division ratio is 16 => Flash clock = 1/16 PLLM
*	0x1FFF: division ratio is 14 => Flash clock = 1/14 PLLM
*	0xFFF: division ratio is 12 => Flash clock = 1/12 PLLM
*	0x7FF: division ratio is 10 => Flash clock = 1/10 PLLM
*	0x3FF: division ratio is 8 => Flash clock = 1/8 PLLM
*	0x1FF: division ratio is 6 => Flash clock = 1/6 PLLM
*	0xFF: division ratio is 4 => Flash clock = 1/4 PLLM
...
FlashLayoutInfo_TypeDef Flash_Layout[] = {
	...
	{IMG_BOOT, 		0x08000000, 0x08013FFF}, //Boot Manifest(4K) + KM4 Bootloader(76K)
	//Users should modify below according to their own memory
	{IMG_APP_OTA1, 0x08014000, 0x081F3FFF}, //Certificate(4K) + Manifest(4K) + KR4 & KM4 Application OTA1 + RDP IMG OTA1
