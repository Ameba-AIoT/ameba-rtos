...
const s8 tx_pwr_limit_2g_fcc[3][14] = {
	...
	{66, 70, 74, 76, 76, 76, 76, 76, 72, 66, 62, 58, 50, 127}, /*OFDM*/
	{62, 68, 72, 76, 76, 76, 76, 74, 70, 64, 60, 56, 44, 127}  /*HE_B20*/
};
const s8 tx_pwr_limit_5g_fcc[2][28] = {
	{72, 72, 72, 72, 72, 72, 72, 72, 68, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72}, /*OFDM*/
	{72, 72, 72, 72, 72, 72, 72, 72, 64, 72, 72, 72, 72, 72, 72, 72, 72, 72, 70, 72, 72, 72, 72, 72, 72, 72, 72, 72}  /*HE_B20*/
};
const u8 tx_shap_fcc[2][3] = {{0, 3, 2}, {3, 2}}; /*{2G{CCK, OFDM, HE_B20}, 5G{OFDM, HE_B20}}*/
...
const u8 tx_shap_ic[2][3] = {{0, 3, 2}, {3, 2}}; /*{2G{CCK, OFDM, HE_B20}, 5G{OFDM, HE_B20}}*/
...
const s8 tx_pwr_limit_2g_ww[3][14] = {
	...
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 56, 50, 127}, /*OFDM*/
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 54, 44, 127}  /*HE_B20*/
};
...
const s8 tx_pwr_limit_ru_5g_fcc[3][28] = {
	{48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 40, 48, 72, 72, 72, 72, 72, 36, 28, 0}, /*HE-RU26*/
	{58, 60, 60, 60, 60, 60, 60, 60, 54, 60, 60, 60, 60, 60, 60, 60, 60, 60, 48, 60, 72, 72, 72, 72, 72, 36, 24, 16}, /*HE-RU52*/
	{70, 72, 72, 72, 72, 72, 72, 70, 66, 72, 72, 72, 72, 72, 72, 72, 72, 72, 60, 72, 72, 72, 72, 72, 72, 36, 24, 16}  /*HE-RU106*/
};
