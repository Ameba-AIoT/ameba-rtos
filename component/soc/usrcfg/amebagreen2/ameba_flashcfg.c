...
FlashLayoutInfo_TypeDef Flash_Layout[] = {
	...
	{IMG_APP_OTA1,  0x08014000, 0x081FFFFF}, //Certificate(4K) + Manifest(4K) + AP Application OTA1 + RDP IMG OTA1

	{IMG_BOOT_OTA2, 0x08200000, 0x08213FFF}, //Boot Manifest(4K) + AP Bootloader(76K) OTA
	{IMG_APP_OTA2,  0x08214000, 0x083DCFFF}, //Certificate(4K) + Manifest(4K) + AP Application OTA2 + RDP IMG OTA2
