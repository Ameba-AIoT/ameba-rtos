...
const s8 tx_pwr_limit_2g_fcc[3][14] = {
	{80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 70, 52, 40, 127}, /*CCK*/
	{58, 66, 80, 80, 80, 80, 80, 80, 80, 72, 60, 44, 28, 127}, /*OFDM*/
	{56, 64, 76, 80, 80, 80, 80, 80, 80, 68, 56, 38, 16, 127}  /*HE_B20*/
};
const s8 tx_pwr_limit_5g_fcc[2][28] = {
	{80, 80, 80, 80, 80, 80, 80, 80, 74, 80, 80, 80, 80, 80, 80, 80, 80, 68, 60, 80, 80, 80, 80, 80, 80, 80, 80, 64}, /*OFDM*/
	{72, 80, 80, 80, 80, 80, 80, 64, 72, 80, 80, 80, 80, 80, 80, 80, 80, 64, 56, 80, 80, 80, 80, 80, 80, 80, 68, 56}  /*HE_B20*/
};
...
const s8 tx_pwr_limit_5g_mkk[2][28] = {
	{64, 64, 64, 64, 52, 52, 52, 52, 76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 127, 127, 127, 127, 127, 127, 127, 127}, /*OFDM*/
	{64, 64, 64, 64, 52, 52, 52, 52, 76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 127, 127, 127, 127, 127, 127, 127, 127}  /*HE_B20*/
};
...
const s8 tx_pwr_limit_5g_ic[2][28] = {
	{80, 80, 80, 80, 80, 80, 80, 80, 74, 80, 80, 80, 80, 127, 127, 127, 80, 68, 60, 80, 80, 80, 80, 80, 80, 127, 127, 127}, /*OFDM*/
	{72, 80, 80, 80, 80, 80, 80, 64, 72, 80, 80, 80, 80, 127, 127, 127, 80, 64, 56, 80, 80, 80, 80, 80, 80, 127, 127, 127}  /*HE_B20*/
};
...
const s8 tx_pwr_limit_5g_cn[2][28] = {
	{64, 64, 64, 64, 64, 64, 64, 64, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 76, 76, 76, 76, 76, 127, 127, 127}, /*OFDM*/
	{64, 64, 64, 64, 64, 64, 64, 64, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 76, 76, 76, 76, 76, 127, 127, 127}  /*HE_B20*/
};
const u8 tx_shap_cn[2][3] = {{0, 3, 3}, {0, 0}}; /*{2G{CCK, OFDM, HE_B20}, 5G{OFDM, HE_B20}}*/

const s8 tx_pwr_limit_2g_ww[3][14] = {
	{52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 40, 68}, /*CCK*/
	{58, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 44, 28, 127}, /*OFDM*/
	{56, 60, 60, 60, 60, 60, 60, 60, 60, 60, 56, 38, 16, 127}  /*HE_B20*/
};
const s8 tx_pwr_limit_5g_ww[2][28] = {
	{60, 60, 60, 60, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 32, 32, 32, 32, 32, 36, 36, 64}, /*OFDM*/
	{60, 60, 60, 60, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 36, 36, 36, 32, 32, 36, 36, 56}  /*HE_B20*/
};
...
const s8 tx_pwr_limit_5g_gl[][CH_NULL] = {{0}};
...
const s8 tx_pwr_limit_ru_2g_fcc[3][14] = {
	{38, 60, 80, 80, 80, 80, 80, 80, 64, 52, 36, 36, -8, 127}, /*HE-RU26*/
	{46, 60, 68, 80, 80, 80, 80, 80, 80, 68, 52, 48, 4, 127}, /*HE-RU52*/
	{62, 65, 72, 80, 80, 80, 80, 80, 80, 68, 56, 52, 8, 127}  /*HE-RU106*/
};
const s8 tx_pwr_limit_ru_5g_fcc[3][28] = {
	{48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 32, 48, 76, 76, 76, 76, 76, 36, 28, 0}, /*HE-RU26*/
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 44, 60, 76, 76, 76, 76, 76, 36, 24, 16}, /*HE-RU52*/
	{72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 62, 72, 76, 76, 76, 76, 76, 36, 24, 16}  /*HE-RU106*/
};
...
const s8 tx_pwr_limit_ru_5g_ic[3][28] = {
	{48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 127, 127, 127, 48, 48, 32, 48, 76, 76, 76, 76, 76, 127, 127, 127}, /*HE-RU26*/
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 127, 127, 127, 60, 60, 44, 60, 76, 76, 76, 76, 76, 127, 127, 127}, /*HE-RU52*/
	{72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 127, 127, 127, 72, 72, 62, 72, 76, 76, 76, 76, 76, 127, 127, 127}  /*HE-RU106*/
};
...
const s8 tx_pwr_limit_ru_5g_cn[3][28] = {
	...
	{40, 40, 40, 40, 40, 40, 40, 40, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 76, 76, 76, 76, 76, 127, 127, 127}, /*HE-RU52*/
	{52, 52, 52, 52, 52, 52, 52, 52, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 76, 76, 76, 76, 76, 127, 127, 127}  /*HE-RU106*/
};
...
const s8 tx_pwr_limit_ru_2g_ww[3][14] = {
	...
	{40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 4, 127}, /*HE-RU52*/
	{52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 52, 8, 127}  /*HE-RU106*/
};
...
const s8 tx_pwr_limit_ru_5g_gl[][CH_NULL] = {{0}};
