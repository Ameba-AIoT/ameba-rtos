...
#define WHC_HOST_CPU_ID		KM4NS_CPU_ID
#define WHC_DEV_CPU_ID		KM4TZ_CPU_ID
#else
#define WHC_HOST_CPU_ID		KM4TZ_CPU_ID
#define WHC_DEV_CPU_ID		KM4NS_CPU_ID
#endif
...
void shell_loguartRx_dispatch(void)
{
	...
	if (CpuId == KM4TZ_CPU_ID) {		/* CMD should processed by AP, inform AP thru IPC */
