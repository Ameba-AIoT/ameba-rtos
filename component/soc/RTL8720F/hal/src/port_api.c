...
/** @defgroup MBED_GPIO_Exported_Constants MBED_GPIO Exported Constants
  * @{
  */
...
/**
  ...
  * @attention  Pin_n must be in the 0~31 range.
  */
...
{
	uint32_t value = GPIO_PortRead(obj->port, obj->mask);
