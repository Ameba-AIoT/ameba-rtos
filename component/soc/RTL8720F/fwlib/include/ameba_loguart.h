...
/** @defgroup LOGUART_UART_LCR
  ...
  * @{
  */
#define LOGUART_BIT_GRAY_MAP_OPT ((u32)0x00000001 << 31)           /*!< R/W 0x0  Txifo wrptr/rdptr gray code map to [4,27] for [0,11]+[16,27] * 0: disable opt * 1: enable opt*/
#define LOGUART_GRAY_MAP_OPT(x)  ((u32)(((x) & 0x00000001) << 31))
#define LOGUART_MASK_DUMMY_0C    ((u32)0x00007FFF << 16)           /*!< R/W 0xFF  dummy_0C*/
#define LOGUART_DUMMY_0C(x)      (((u32)((x) & 0x00007FFF) << 16))
#define LOGUART_GET_DUMMY_0C(x)  ((u32)(((x >> 16) & 0x00007FFF)))
...
#define LOGUART_MASK_RECVTRG    ((u32)0x00000003 << 6)            /*!< R/W 0x3  Define the 32-entry Receiver FIFO Interrupt trigger level (0~31 bytes) * 00: 1 byte * 01: FIFO_DEPTH/4 * 10: FIFO_DEPTH/2 * 11: FIFO_DEPTH-2*/
...
#define LOGUART_MASK_AGG_TO         ((u32)0x00003FFF << 12)           /*!< R/W 0xBB8  AGG timeout Data should be sent from log FIFO to tx_fifo if idle time > AGG timeout, even if there is just only one byte in log FIFO of the path. Unit is one baudrate period of loguart Tx, default is 1ms if Tx baudrate is 3Mbps.*/
...
/** @defgroup LOGUART_INTERRUPT_MASK
  ...
  * @{
  */
#define LOGUART_BIT_INTR_MASK_AP ((u32)0x00000001 << 1)           /*!< R/W 0x1  Mask loguart interrupt to km4tz 1:unmask  0:mask*/
#define LOGUART_INTR_MASK_AP(x)  ((u32)(((x) & 0x00000001) << 1))
#define LOGUART_BIT_INTR_MASK_NP ((u32)0x00000001 << 0)           /*!< R/W 0x1  Mask loguart interrupt to km4ns 1:unmask  0:mask*/
...
#define LOGUART_RX_FIFOTRIG_LEVEL_QUARTER		((u32)0x00000001) // 8
#define LOGUART_RX_FIFOTRIG_LEVEL_HALF			((u32)0x00000002) // 16
#define LOGUART_RX_FIFOTRIG_LEVEL_MINUS2		((u32)0x00000003) // 30
