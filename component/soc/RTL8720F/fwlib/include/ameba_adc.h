...
/** @defgroup ADC_CONF
  ...
  * @{
  */
#define ADC_BIT_ENABLE        ((u32)0x00000001 << 9)           /*!< R/W 1h  This bit is for ADC enable control*/
...
#define ADC_MASK_OP_MOD       ((u32)0x00000007 << 1)           /*!< R/W 1h  These bits selects ADC operation mode. 0: software trigger mode.  1:automatic mode.  2:timer-trigger mode.  3:comparator-assist mode*/
...
#define ADC_MASK_CHSW_0   ((u32)0x0000000F << 0)            /*!< R/W 4'h8  This field defines the number 0 channel to do a conversion when a conversion event takes place.*/
...
#define ADC_BIT_IT_TM_LOW_WT_EN  ((u32)0x00000001 << 21) /*!< R/W 0h  Interrupt control for thermal meter detect low temperature. * 0: Disable low temperature detect interrupt * 1: Enable low temperature detect interrupt*/
#define ADC_BIT_IT_TM_HIGH_WT_EN ((u32)0x00000001 << 20) /*!< R/W 0h  Interrupt control for thermal meter detect over temperature warning. * 0: Disable over temperature warning detect interrupt * 1: Enable over temperature warning detect interrupt*/
#define ADC_BIT_BREAK_TIMEOUT_EN ((u32)0x00000001 << 19) /*!< R/W 0h  When the ADC does not respond for a long time due to CTC occupation, an interrupt will be triggered. 0: This interrupt is disabled. 1: This interrupt is enabled.*/
...
/** @defgroup ADC_INTR_RAW_STS
  ...
  * @{
  */
#define ADC_BIT_IT_TM_LOW_WT_RAW_STS  ((u32)0x00000001 << 21) /*!< R 0h  */
#define ADC_BIT_IT_TM_HIGH_WT_RAW_STS ((u32)0x00000001 << 20) /*!< R 0h  */
#define ADC_BIT_BREAK_TIMEOUT_RAW_STS ((u32)0x00000001 << 19) /*!< R 0h  */
...
/** @defgroup ADC_INTR_STS
  ...
  * @{
  */
#define ADC_BIT_IT_TM_LOW_WT_STS  ((u32)0x00000001 << 21) /*!< RW1C 0h  */
#define ADC_BIT_IT_TM_HIGH_WT_STS ((u32)0x00000001 << 20) /*!< RW1C 0h  */
#define ADC_BIT_BREAK_TIMEOUT_STS ((u32)0x00000001 << 19) /*!< RW1C 0h  */
...
/** @defgroup ADC_SETTLE
  ...
  * @{
  */
#define ADC_MASK_SETTLE_POW_ON      ((u32)0x0000000F << 4)           /*!< R/W 0h  settle count for sample data from power on , the unit is  sample clock. 0 means no need to settle*/
#define ADC_SETTLE_POW_ON(x)        (((u32)((x) & 0x0000000F) << 4))
#define ADC_GET_SETTLE_POW_ON(x)    ((u32)(((x >> 4) & 0x0000000F)))
#define ADC_MASK_SETTLE_CH_SWITCH   ((u32)0x0000000F << 0)           /*!< R/W 0h  settle count for sample data from chn switch, the unit is sample clock. 0 means no need to settle*/
#define ADC_SETTLE_CH_SWITCH(x)     (((u32)((x) & 0x0000000F) << 0))
#define ADC_GET_SETTLE_CH_SWITCH(x) ((u32)(((x >> 0) & 0x0000000F)))
/** @} */
...
/** @defgroup ADC_OVERSAMPLE
  ...
  * @{
  */
#define ADC_MASK_OSF    ((u32)0x00000007 << 6)           /*!< R/W 0x0  oversampling right shift 000: no shift      (raw data) 001: shift 1-bit  (/2) 010: shift 2-bit  (/4) 011: shift 3-bit  (/8) 100: shift 4-bit  (/16)*/
#define ADC_OSF(x)      (((u32)((x) & 0x00000007) << 6))
#define ADC_GET_OSF(x)  ((u32)(((x >> 6) & 0x00000007)))
#define ADC_MASK_OSR    ((u32)0x0000000F << 2)           /*!< R/W 0x0  over sample ratio 000: 1X,  oversample disable 001: 2x 010: 4x 011: 8x 100: 16x 101: 32x 110: 64x 111:128x 1000:256x*/
#define ADC_OSR(x)      (((u32)((x) & 0x0000000F) << 2))
#define ADC_GET_OSR(x)  ((u32)(((x >> 2) & 0x0000000F)))
#define ADC_BIT_OV_MODE ((u32)0x00000001 << 1)           /*!< R/W 0x1  Oversample mode 1-All oversampling conversions done in regular sequence 0-All oversampling conversions done in staggered sequence*/
/** @} */
...
/** @defgroup ADC_BRK_CNT
  * @brief ADC Break Cnt Register
  * @{
  */
#define ADC_MASK_BREAK_TIMEOUT   ((u32)0x0000FFFF << 0)           /*!< R/W 16'h4fff  Set a time threshold for waiting to sample. If exceeded, an interrupt will be triggered.*/
#define ADC_BREAK_TIMEOUT(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define ADC_GET_BREAK_TIMEOUT(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup ADC_TM_TH_CTRL0
  * @brief Thermal Meter Threshold Control Register
  * @{
  */
#define ADC_MASK_TM_HIGH_WT_THR   ((u32)0x0000FFFF << 16)           /*!< R/W 16'd827  Set the over temperature warning threshold for comparison with TEMP_OUT.Only values greater than 0 are supported 100centigrade*/
#define ADC_TM_HIGH_WT_THR(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define ADC_GET_TM_HIGH_WT_THR(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define ADC_MASK_TM_LOW_WT_THR    ((u32)0x0000FFFF << 0)            /*!< R/W 16'd555  Set the Low threshold for comparison with TEMP_OUT. -20centigrade*/
#define ADC_TM_LOW_WT_THR(x)      (((u32)((x) & 0x0000FFFF) << 0))
#define ADC_GET_TM_LOW_WT_THR(x)  ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup ADC_TM_TH_CTRL1
  * @brief Thermal Meter Threshold Control Register
  * @{
  */
#define ADC_MASK_TM_PWR           ((u32)0x000000FF << 24)           /*!< R/W 8'h69  thm protect password. tm_highcmp_pt_en,tm_high_pt_thr can be programed only when this value is 8'h69.*/
#define ADC_TM_PWR(x)             (((u32)((x) & 0x000000FF) << 24))
#define ADC_GET_TM_PWR(x)         ((u32)(((x >> 24) & 0x000000FF)))
#define ADC_BIT_TM_HIGHCMP_PT_EN  ((u32)0x00000001 << 16)           /*!< R/W 0x0  To enable compare tm_out with over temperature protect threshold: When  tm_out > tm_high_pt_thr, it will set aon reset. * 1: Enable the compare; * 0: Disable the compare.*/
#define ADC_MASK_TM_HIGH_PT_THR   ((u32)0x0000FFFF << 0)            /*!< R/W 16'd882  Set over temperature protection threshold for comparison with TEMP_OUT. 125centigrade*/
#define ADC_TM_HIGH_PT_THR(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define ADC_GET_TM_HIGH_PT_THR(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup ADC_TM_MAX_CTRL
  * @brief Thermal Meter Max Temperature Control Register
  * @{
  */
#define ADC_BIT_TM_MAX_EN  ((u32)0x00000001 << 17)          /*!< R/W 0x0  Enable  max temperature function*/
#define ADC_BIT_TM_MAX_CLR ((u32)0x00000001 << 16)          /*!< WA0 0x0  This bit defines clear max temperature * 0: not clear * 1: clear tm_max value*/
#define ADC_MASK_TM_MAX    ((u32)0x0000FFFF << 0)           /*!< R 16'd200  These bits define max temperature.*/
#define ADC_TM_MAX(x)      (((u32)((x) & 0x0000FFFF) << 0))
#define ADC_GET_TM_MAX(x)  ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup ADC_TM_MIN_CTRL
  * @brief Thermal Meter Min Temperature Control Register
  * @{
  */
#define ADC_BIT_TM_MIN_EN  ((u32)0x00000001 << 17)          /*!< R/W 0x0  Enable  min temperature function*/
#define ADC_BIT_TM_MIN_CLR ((u32)0x00000001 << 16)          /*!< WA0 0x0  This bit defines clear min temperature * 0: not clear * 1: clear tm_min value*/
#define ADC_MASK_TM_MIN    ((u32)0x0000FFFF << 0)           /*!< R 16'd1000  These bits define min temperature.*/
#define ADC_TM_MIN(x)      (((u32)((x) & 0x0000FFFF) << 0))
#define ADC_GET_TM_MIN(x)  ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup ADC_TM_POW_CTRL
  * @brief Thermal power ctrl
  * @{
  */
#define ADC_BIT_TM_POW_LAT_ST   ((u32)0x00000001 << 1) /*!< RW1C 0x0  Indicates that there is an ADC enable during the power-on process to latch the pow on temperature. The enable state needs to be cleared after taking the temperature data.*/
#define ADC_BIT_TM_POW_FORCE_EN ((u32)0x00000001 << 0) /*!< R/W 0x1  Thermal sensor Force function bit  0: disable force function(default)  1: enable force function*/
/** @} */

/** @defgroup ADC_TM_DBG
  * @brief Thermal debug ctrl
  * @{
  */
#define ADC_BIT_TM_RAW_DBG_EN ((u32)0x00000001 << 0) /*!< R/W 0x0  The temperature channel will output  raw data instead of the average value*/
/** @} */
...
typedef struct {
	...
	__IO uint32_t ADC_COMP_TH_CHx[8]    ;  /*!< ADC CHANNEL x COMPARISON THRESHOLD REGISTER,  Address offset:0x008-0x024 */
	__IO uint32_t RSVD1[3]              ;  /*!< Reserved,  Address offset:0x028-0x033 */
	...
	__IO uint32_t RSVD2                 ;  /*!< Reserved,  Address offset:0x044-0x047 */
	...
	__I  uint32_t ADC_DATA_CHx[9]       ;  /*!< ADC CHANNEL x DATA REGISTER,  Address offset:0x070-0x090 */
	__IO uint32_t RSVD3[2]              ;  /*!< Reserved,  Address offset:0x094-0x09B */
	...
	__IO uint32_t ADC_BRK_CNT           ;  /*!< ADC BREAK CNT REGISTER,  Address offset:0x0B8 */
	__IO uint32_t ADC_TM_TH_CTRL0       ;  /*!< THERMAL METER THRESHOLD CONTROL REGISTER,  Address offset:0x0BC */
	__IO uint32_t ADC_TM_TH_CTRL1       ;  /*!< THERMAL METER THRESHOLD CONTROL REGISTER,  Address offset:0x0C0 */
	__IO uint32_t ADC_TM_MAX_CTRL       ;  /*!< THERMAL METER MAX TEMPERATURE CONTROL REGISTER,  Address offset:0x0C4 */
	__IO uint32_t ADC_TM_MIN_CTRL       ;  /*!< THERMAL METER MIN TEMPERATURE CONTROL REGISTER,  Address offset:0x0C8 */
	__IO uint32_t ADC_TM_POW_CTRL       ;  /*!< THERMAL POWER CTRL Register,  Address offset:0x0CC */
	__IO uint32_t ADC_TM_DBG            ;  /*!< THERMAL DEBUG CTRL Register,  Address offset:0x0D0 */
	__IO uint32_t ADC_DUMMY             ;  /*!< ADC DUMMY REGISTER,  Address offset:0x0D4 */
} ADC_TypeDef;
...
/**
  * @brief  ADC Channel Init Structure Definition
  */
struct ADC_CHInitTypeDef {
	u8 ADC_InputSwing;		/*!< Specifies ADC input swing selection. */
	u16 ADC_SamplePeriodUs;	/*!< Specifies ADC sample period in microseconds. This parameter can be set to 0x1~0x400 (xtal4m clock) or 0x1~0x800 (osc2m clock). */
};
...
/* 6 external + 3 internal channels. */
#define ADC_CH_NUM					(9)  /*!< Total number of ADC channels. */
#define ADC_EXT_CH_NUM			(6)  /*!< Number of external ADC channels. */
...
/** @defgroup ADC_Chn_Pad_Selection ADC Channel Pad Selection
  * @{
  */
#define ADC_CH0_PIN					(_PA_13)  /*!< Pin mapping for ADC channel 0. */
#define ADC_CH1_PIN					(_PA_14)  /*!< Pin mapping for ADC channel 1. */
#define ADC_CH2_PIN					(_PA_15)  /*!< Pin mapping for ADC channel 2. */
#define ADC_CH3_PIN					(_PA_16)  /*!< Pin mapping for ADC channel 3. */
#define ADC_CH4_PIN					(_PA_17)  /*!< Pin mapping for ADC channel 4. */
#define ADC_CH5_PIN					(_PA_18)  /*!< Pin mapping for ADC channel 5. */
/**
  * @}
  */
...
/** @defgroup ADC_Vref_Selection ADC Vref Selection
  * @{
  */
#define ADC_VREF_1P45						((u8)0x00) /*!< ADC reference voltage 1.45 V. */
#define ADC_VREF_1P5						((u8)0x01) /*!< ADC reference voltage 1.50 V. */
#define ADC_VREF_1P55						((u8)0x02) /*!< ADC reference voltage 1.55 V. */
#define ADC_VREF_1P6						((u8)0x03) /*!< ADC reference voltage 1.60 V. */
#define ADC_VREF_1P65						((u8)0x04) /*!< ADC reference voltage 1.65 V. */
#define ADC_VREF_1P7						((u8)0x05) /*!< ADC reference voltage 1.70 V. */
#define ADC_VREF_1P75						((u8)0x06) /*!< ADC reference voltage 1.75 V. */
#define ADC_VREF_1P8						((u8)0x07) /*!< ADC reference voltage 1.80 V. */
#define ADC_VREF_1P85						((u8)0x08) /*!< ADC reference voltage 1.85 V. */
#define ADC_VREF_1P875						((u8)0x09) /*!< ADC reference voltage 1.875 V. */
#define ADC_VREF_1P9						((u8)0x0A) /*!< ADC reference voltage 1.90 V. */
#define ADC_VREF_1P95						((u8)0x0B) /*!< ADC reference voltage 1.95 V. */
#define ADC_VREF_2P0						((u8)0x0C) /*!< ADC reference voltage 2.00 V. */
#define ADC_VREF_2P05						((u8)0x0D) /*!< ADC reference voltage 2.05 V. */
#define ADC_VREF_2P1						((u8)0x0E) /*!< ADC reference voltage 2.10 V. */
#define ADC_VREF_2P15						((u8)0x0F) /*!< ADC reference voltage 2.15 V. */
/**
  * @}
  */
...
#define VREF_SEL_ADDR			0x7E4 /*!< OTP address for voltage reference selection. */
/**
  * @}
  */
...
_LONG_CALL_ void ADC_SetChanHCnt(u8 ADC_channel, u16 HCnt);
_LONG_CALL_ void ADC_SetConvTime(u8 ConvMode);
