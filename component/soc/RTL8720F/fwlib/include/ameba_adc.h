...
struct ADC_CHInitTypeDef {
	u8 ADC_InputSwing; // @ref ADC_Input_Swing_Selection
	u16 ADC_SamplePeriodUs; // 0x1-0x400 when adc clk is xtal4m or 0x1-0x800 when adc clk is osc2m
};
...
#define VREF_SEL_ADDR			0x7E4 // OTP address for vref selection
/**
  * @}
  */
