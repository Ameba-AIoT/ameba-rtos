...
#ifndef _CRYPTO_SM4_GCM_H_
#define _CRYPTO_SM4_GCM_H_
...
/**
 * @brief SM4-GCM context typedef
 */
typedef crypto_sym_gcm_context crypto_sm4_gcm_context;

/**
 * @brief Initialize GCM context
 * @param ctx Pointer to GCM context structure
 */
void crypto_sm4_gcm_init(crypto_sm4_gcm_context *ctx);

/**
 * @brief Free GCM context
 * @param ctx Pointer to GCM context structure
 */
void crypto_sm4_gcm_free(crypto_sm4_gcm_context *ctx);
 ...
 * @param key_len_bits Key length in bits (128)
 * @return RTK_SUCCESS on success, error code on failure
 */
int crypto_sm4_gcm_setkey(crypto_sm4_gcm_context *ctx, u8 key_id, u8 *key_addr, u32 key_len_bits);
 ...
 * @return RTK_SUCCESS on success, error code on failure
 */
int crypto_sm4_gcm_starts(crypto_sm4_gcm_context *ctx, u8 mode, u8 *iv_addr, u32 iv_len);
 ...
 * @return RTK_SUCCESS on success, error code on failure
 */
int crypto_sm4_gcm_update_ad(crypto_sm4_gcm_context *ctx, const u8 *aad_addr, u32 aad_len);
 ...
 * @return RTK_SUCCESS on success, error code on failure
 */
int crypto_sm4_gcm_update(crypto_sm4_gcm_context *ctx, const u8 *input, u32 input_length,
 ...
 * @return RTK_SUCCESS on success, error code on failure
 */
int crypto_sm4_gcm_finish(crypto_sm4_gcm_context *ctx, u8 *output, u32 output_size,
 ...
 * @return RTK_SUCCESS on success, error code on failure
 */
int crypto_sm4_gcm_crypt_and_tag(crypto_sm4_gcm_context *ctx, u8 mode, u8 *iv_addr, u32 iv_len, u8 *aad_addr, u32 aad_len,
 ...
 * @return RTK_SUCCESS on success, error code on failure
 */
int crypto_sm4_gcm_auth_decrypt(crypto_sm4_gcm_context *ctx, u8 *iv_addr, u32 iv_len, u8 *aad_addr, u32 aad_len,
								const u8 *input, u8 *output, u32 len, u32 tag_len, u8 *tag);
