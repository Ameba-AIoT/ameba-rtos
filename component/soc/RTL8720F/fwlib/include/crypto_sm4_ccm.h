...
#ifndef _CRYPTO_SM4_CCM_H_
#define _CRYPTO_SM4_CCM_H_
...
/**
 * @brief SM4-CCM context typedef
 */
typedef crypto_sym_ccm_context crypto_sm4_ccm_context;
