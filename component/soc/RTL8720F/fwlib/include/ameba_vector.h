...
typedef void(*Crash_Patch)(uint32_t *MSP, uint32_t lr, uint32_t fault_id);
/**
  * @}
  */
...
extern _LONG_CALL_ bool PreFaultPatch_register(Fault_Patch PatchFun);
extern _LONG_CALL_ bool PostFaultPatch_register(Fault_Patch PatchFun);
extern _LONG_CALL_ bool Crashmain_register(Crash_Patch PatchFun);
...
extern _LONG_CALL_ void NMI_Handler_set(void (*pfunc)(void));
extern _LONG_CALL_ void DebugMonitor_irqfunc_set(void (*pfunc)(void));
