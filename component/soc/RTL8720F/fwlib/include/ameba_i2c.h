...
/** @defgroup IC_INTR_STAT
  ...
  * @{
  */
#define I2C_BIT_R_RXFIFO_TIMEOUT ((u32)0x00000001 << 14) /*!< R 0x0  */
...
/** @defgroup IC_INTR_MASK
  ...
  * @{
  */
#define I2C_BIT_M_RXFIFO_TIMEOUT ((u32)0x00000001 << 14) /*!< R/W 0x0  */
...
/** @defgroup IC_RAW_INTR_STAT
  ...
  * @{
  */
#define I2C_BIT_RXFIFO_TIMEOUT ((u32)0x00000001 << 14) /*!< R 0x0  This intr occurs when rxdma owner is I2C and I2C rx idle time counter greater than RXFIFO_TIMEOUT_TH.*/
...
/** @defgroup IC_DMA_CR
  ...
  * @{
  */
#define I2C_BIT_TDMA_OWNER ((u32)0x00000001 << 3) /*!< R/W 0x0  Tx DMA flow controller: 0: gdma 1: i2c*/
#define I2C_BIT_RDMA_OWNER ((u32)0x00000001 << 2) /*!< R/W 0x0  Rx DMA flow controller: 0: gdma 1: i2c*/
...
/** @defgroup IC_DMA_DATA_LEN
  ...
  * @{
  */
#define I2C_MASK_DMA_DAT_LEN   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Tx DMA transfer data length*/
...
/** @defgroup IC_RDMA_DAT_LEN
  * @brief I2C RDMA Mode Transfer Data Length Register
  * @{
  */
#define I2C_MASK_RDMA_REMAIN_LEN   ((u32)0x0000FFFF << 16)           /*!< R 0x0  Rx DMA transfer remain data counter*/
#define I2C_RDMA_REMAIN_LEN(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define I2C_GET_RDMA_REMAIN_LEN(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define I2C_MASK_RDMA_DAT_LEN      ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  Rx DMA transfer data max length*/
#define I2C_RDMA_DAT_LEN(x)        (((u32)((x) & 0x0000FFFF) << 0))
#define I2C_GET_RDMA_DAT_LEN(x)    ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup IC_CLR_RXFIFO_TIMEOUT
  * @brief Clear RXFIFO TIMEOUT Interrupt Register
  * @{
  */
#define I2C_BIT_CLR_RXFIFO_TIMEOUT ((u32)0x00000001 << 0) /*!< R 0x0  Read this register to clear the RXFIFO_TIMEOUT interrupt (bit 14) of IC_RAW_INTR_STAT register.*/
/** @} */

/** @defgroup IC_RXFIFO_TIMEOUT_CTRL
  * @brief RXFIFO TIMEOUT control Register
  * @{
  */
#define I2C_BIT_RXFIFO_TIMEOUT_EN    ((u32)0x00000001 << 31)          /*!< R/W 0x0  Enable rxfifo timeout counter*/
#define I2C_MASK_RXFIFO_TIMEOUT_TH   ((u32)0x3FFFFFFF << 0)           /*!< R/W 0x0  When rxfifo timeout counter is greater than RXFIFO_TIMEOUT_TH, rxfifo timeout intr occurs*/
#define I2C_RXFIFO_TIMEOUT_TH(x)     (((u32)((x) & 0x3FFFFFFF) << 0))
#define I2C_GET_RXFIFO_TIMEOUT_TH(x) ((u32)(((x >> 0) & 0x3FFFFFFF)))
/** @} */
...
#define I2C_MASK_IC_DIG_FLTR_DEG   ((u32)0x0000003F << 0)           /*!< R/W 0x0  DIG_FLTR_DEG is to define frequency range of filter. A greater value of DIG_FLTR_DEG results in a slower transfer speed and hardware would be able to filter a lower frequency. Valid value of IC_DIG_FLTR_DEG is 6'd0~6'd62.*/
...
typedef struct {
	...
	__IO uint32_t RSVD0                 ;  /*!< Reserved,  Address offset:0x0AC-0x0AF */
	...
	__IO uint32_t IC_RDMA_DAT_LEN       ;  /*!< I2C RDMA MODE TRANSFER DATA LENGTH REGISTER,  Address offset:0x0B8 */
	__I  uint32_t IC_CLR_RXFIFO_TIMEOUT ;  /*!< CLEAR RXFIFO TIMEOUT INTERRUPT REGISTER,  Address offset:0x0BC */
	__IO uint32_t IC_RXFIFO_TIMEOUT_CTRL;  /*!< RXFIFO TIMEOUT CONTROL REGISTER,  Address offset:0x0C0 */
	__IO uint32_t RSVD1[8]              ;  /*!< Reserved,  Address offset:0x0C4-0x0E3 */
	...
	__IO uint32_t RSVD3                 ;  /*!< Reserved,  Address offset:0x0F8-0x0FB */
