...
/** @defgroup SM4_Cipher_Mode SM4 Cipher Mode
  * @{
  */
#define SM4_ENCRYPTION_MODE  ((u8)0x01)	/*!< SM4 encryption direction */
#define SM4_DECRYPTION_MODE  ((u8)0x00)	/*!< SM4 decryption direction */

#define SM4_MODE_ECB			((u8)0x00)	/*!< Electronic Codebook mode */
#define SM4_MODE_CBC			((u8)0x01)	/*!< Cipher Block Chaining mode */
#define SM4_MODE_CFB			((u8)0x02)	/*!< Cipher Feedback mode */
#define SM4_MODE_OFB			((u8)0x03)	/*!< Output Feedback mode */
#define SM4_MODE_CTR			((u8)0x04)	/*!< Counter mode */
/** @} */
...
/**
 * @brief Perform SM4-ECB mode encryption and decryption in DMA mode.
 ...
 *         - SM4 only supports 128-bit key length.
...
/**
 * @brief Perform SM4-CBC mode encryption and decryption in DMA mode.
 * @param  key_id Value of @ref KM_KEY
 * @param is_encryption
 * 		 @arg 1: Encryption
 * 		 @arg 0: Decryption
...
/**
 * @brief Perform SM4-CFB mode encryption and decryption in DMA mode.
 * @param  key_id Value of @ref KM_KEY
 * @param is_encryption
 * 		 @arg 1: Encryption
 * 		 @arg 0: Decryption
...
/**
 * @brief Perform SM4-OFB mode encryption and decryption in DMA mode.
 * @param  key_id Value of @ref KM_KEY
 * @param is_encryption
 * 		 @arg 1: Encryption
 * 		 @arg 0: Decryption
...
/**
 * @brief Perform SM4-CTR mode encryption and decryption in DMA mode.
 * @param  key_id Value of @ref KM_KEY
 * @param is_encryption
 * 		 @arg 1: Encryption
 * 		 @arg 0: Decryption
...
/**
 * @brief Compute SM4-CMAC authentication tag in DMA mode.
 * @param  key_id Value of @ref KM_KEY
 * @param  input The address of the input data.
 * @param  len The length of the data.
...
/**
 * @brief Perform SM4-GCM mode encryption and tag generation in DMA mode.
 * @param  key_id Value of @ref KM_KEY
...
/**
 * @brief Perform SM4-GCM mode authenticated decryption in DMA mode.
 * @param  key_id Value of @ref KM_KEY
...
/**
 * @brief Perform SM4-CCM mode encryption and tag generation in DMA mode.
 * @param  key_id Value of @ref KM_KEY
 * @param  key_addr Software key address, set to NULL if using a hardware key
...
/**
 * @brief Perform SM4-CCM mode authenticated decryption in DMA mode.
 * @param  key_id Value of @ref KM_KEY
 * @param  key_addr Software key address, set to NULL if using a hardware key
...
/**
 * @brief Perform SM4-ECB mode encryption and decryption in slave mode.
 * @param  key_id Value of @ref KM_KEY
 * @param  key_addr Software key address, set to NULL if using a hardware key
 * @param is_encryption
 * 		 @arg 1: Encryption
...
/**
 * @brief Perform SM4-CTR mode encryption and decryption in slave mode.
 * @param  key_id Value of @ref KM_KEY
 * @param  key_addr Software key address, set to NULL if using a hardware key
 * @param is_encryption
 * 		 @arg 1: Encryption
