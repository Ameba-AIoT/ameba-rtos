...
/** @defgroup TRNG_EN_CTRL0
  * @brief Ring Enable Control Register 0
  * @{
  */
...
/** @defgroup TRNG_EN_CTRL1
  * @brief Ring Enable Control Register 1
  * @{
  */
...
/** @defgroup TRNG_RING_SAMPLE_CLK_CTRL
  ...
  * @{
  */
#define TRNG_MASK_CLOCK_SAMPLE_RATE_CONTROL   ((u32)0x0000000F << 8)           /*!< R/W 0x0  For fine-tune rocs sample clock ROSC sample clock frequency = TRNG APB clock frequency/(Clock sample rate control + 1)*/
...
typedef struct {
	...
	__I  uint32_t TRNG_VALID               ;  /*!< RNG VALID REGISTER,  Address offset:0x00C */
	__I  uint32_t TRNG_DATAx[8]            ;  /*!< RNG DATA REGISTER x Register,  Address offset:0x010-0x02C */
	__I  uint32_t TRNG_STATUS              ;  /*!< RNG STATUS REGISTER,  Address offset:0x030 */
	...
	__IO uint32_t RSVD2[54]                ;  /*!< Reserved,  Address offset:0x11C-0x1F3 */
	__IO uint32_t TRNG_EN_CTRL0            ;  /*!< RING ENABLE CONTROL REGISTER 0 Register,  Address offset:0x1F4 */
	__IO uint32_t TRNG_EN_CTRL1            ;  /*!< RING ENABLE CONTROL REGISTER 1 Register,  Address offset:0x1F8 */
...
/** @defgroup TRNG_Maximum_value_of_integer_type
  * @{
  */
