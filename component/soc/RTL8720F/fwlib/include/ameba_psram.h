...
#define PSRAM_PDX_CMD_LEN(x)	integer_ceil(x * 60 , 1000)		//160M*60ns/1000=20
...
#define PSRAM_CHECK_INT(x) (PSPHY_BIT_CFG_CAL_NBDR_OVF & x)||\
							(PSPHY_BIT_CFG_CAL_NBDR_ALMOST & x)||\
							(PSPHY_BIT_CFG_CAL_ERR_UNSURE & x)||\
							(PSPHY_BIT_CFG_CAL_ERR_ALREADY & x) ||\
							(PSPHY_BIT_CFG_CAL_ERR_ALMOST & x)
...
#define Psram_WB_CSH			0x1	//spec 0 ns
