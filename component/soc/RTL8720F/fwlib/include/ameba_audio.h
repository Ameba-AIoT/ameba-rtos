...
/** @defgroup CODEC_AUDIO_CONTROL_0
  ...
  * @{
  */
#define AUD_BIT_AUDIO_IP_EN           ((u32)0x00000001 << 0)            /*!< R/W 0x0  */
#define AUD_BIT_AUDIO_CONTROL_0_DUMMY ((u32)0x00000001 << 3)            /*!< R/W 0x0  DUMMY*/
#define AUD_MASK_SYS_CLK_RATE_SEL     ((u32)0x00000003 << 4)            /*!< R/W 0x2  Audio sys_clk selection*/
#define AUD_SYS_CLK_RATE_SEL(x)       (((u32)((x) & 0x00000003) << 4))
#define AUD_GET_SYS_CLK_RATE_SEL(x)   ((u32)(((x >> 4) & 0x00000003)))
#define AUD_MASK_AUDIO_DBG_SEL        ((u32)0x0000001F << 13)           /*!< R/W 0x0  Debug probe selection*/
...
/** @defgroup CODEC_AUDIO_CONTROL_1
  ...
  * @{
  */
#define AUD_BIT_I2S_DATA_RND_EN          ((u32)0x00000001 << 12)           /*!< R/W 0x1  i2s_data_rnd_en*/
#define AUD_MASK_AUDIO_CONTROL_1_DUMMY   ((u32)0x0000000F << 13)           /*!< R/W 0x0  Dummy*/
...
/** @defgroup CODEC_CLOCK_CONTROL_1
  ...
  * @{
  */
#define AUD_BIT_AD_0_EN      ((u32)0x00000001 << 6)  /*!< R/W 0x0  ADC channel 0 clock enable*/
#define AUD_BIT_AD_1_EN      ((u32)0x00000001 << 7)  /*!< R/W 0x0  ADC channel 1 clock enable*/
#define AUD_BIT_AD_0_FIFO_EN ((u32)0x00000001 << 14) /*!< R/W 0x0  ADC channel 0 FIFO clock enable*/
#define AUD_BIT_AD_1_FIFO_EN ((u32)0x00000001 << 15) /*!< R/W 0x0  ADC channel 1 FIFO clock enable*/
/** @} */
...
/** @defgroup CODEC_CLOCK_CONTROL_2
  ...
  * @{
  */
#define AUD_BIT_DMIC_0_EN  ((u32)0x00000001 << 8)  /*!< R/W 0x0  ADC filter channel 0 clock enable: DMIC path*/
#define AUD_BIT_DMIC_1_EN  ((u32)0x00000001 << 9)  /*!< R/W 0x0  ADC filter channel 1 clock enable: DMIC path*/
#define AUD_BIT_AD_0_EQ_EN ((u32)0x00000001 << 16) /*!< R/W 0x0  ADC channel 0 EQ clock enable*/
#define AUD_BIT_AD_1_EQ_EN ((u32)0x00000001 << 17) /*!< R/W 0x0  ADC channel 1 EQ clock enable*/
/** @} */
...
/** @defgroup CODEC_CLOCK_CONTROL_3
  ...
  * @{
  */
#define AUD_MASK_DMIC1_CLK_SEL   ((u32)0x00000007 << 0)           /*!< R/W 0x1  Set clock of digital microphone 3'b000: 5MHz 3'b001: 2.5MHz 3'b010: 1.25MHz 3'b011: 625kHz 3'b100: 312.5kHz 3'b101: Reserved 3'b110: Reserved 3'b111: 769.2kHz*/
#define AUD_DMIC1_CLK_SEL(x)     (((u32)((x) & 0x00000007) << 0))
#define AUD_GET_DMIC1_CLK_SEL(x) ((u32)(((x >> 0) & 0x00000007)))
#define AUD_BIT_DMIC1_CLK_EN     ((u32)0x00000001 << 3)           /*!< R/W 0x0  Digital microphone clock enable*/
/** @} */
...
/** @defgroup CODEC_CLOCK_CONTROL_4
  ...
  * @{
  */
#define AUD_MASK_SAMPLE_RATE_0   ((u32)0x0000000F << 0)           /*!< R/W 0x0  Set sample rate source 0 4'h0: 48K 4'h1: 96K 4'h2: 192K 4'h3: 32K 4'h4: 176.4K 4'h5: 16K 4'h6: Reserved 4'h7: 8K 4'h8: 44.1K 4'h9: 88.2K 4'ha:24K 4'hb: 12K 4'hc: 22.05K 4'hd: 11.025K 4'he~4'hf: Reserved*/
#define AUD_SAMPLE_RATE_0(x)     (((u32)((x) & 0x0000000F) << 0))
#define AUD_GET_SAMPLE_RATE_0(x) ((u32)(((x >> 0) & 0x0000000F)))
#define AUD_MASK_SAMPLE_RATE_1   ((u32)0x0000000F << 4)           /*!< R/W 0x0  Set sample rate source 1 4'h0: 48K 4'h1: 96K 4'h2: 192K 4'h3: 32K 4'h4: 176.4K 4'h5: 16K 4'h6: Reserved 4'h7: 8K 4'h8: 44.1K 4'h9: 88.2K 4'ha:24K 4'hb: 12K 4'hc: 22.05K 4'hd: 11.025K 4'he~4'hf: Reserved*/
...
/** @defgroup CODEC_CLOCK_CONTROL_5
  ...
  * @{
  */
#define AUD_MASK_ADC_0_FS_SRC_SEL   ((u32)0x00000003 << 0)           /*!< R/W 0x0  Channel 0 ADC path sample rate source selection 2'b00: Source 0 2'b01: Source 1 2'b10: Source 2*/
#define AUD_ADC_0_FS_SRC_SEL(x)     (((u32)((x) & 0x00000003) << 0))
#define AUD_GET_ADC_0_FS_SRC_SEL(x) ((u32)(((x >> 0) & 0x00000003)))
#define AUD_MASK_ADC_1_FS_SRC_SEL   ((u32)0x00000003 << 2)           /*!< R/W 0x0  Channel 1 ADC path sample rate source selection 2'b00: Source 0 2'b01: Source 1 2'b10: Source 2*/
...
/** @defgroup CODEC_CLOCK_CONTROL_6
  ...
  * @{
  */
#define AUD_BIT_ADC_0_ASRC_EN ((u32)0x00000001 << 0) /*!< R/W 0x0  Channel 0 ADC path ASRC enable 0: Disable 1: Enable If ASRC is enabled, sample_rate becomes useless.*/
#define AUD_BIT_ADC_1_ASRC_EN ((u32)0x00000001 << 1) /*!< R/W 0x0  Channel 1 ADC path ASRC enable 0: Disable 1: Enable If ASRC is enabled, sample_rate becomes useless.*/
/** @} */
...
/** @defgroup CODEC_CLOCK_CONTROL_7
  ...
  * @{
  */
#define AUD_MASK_ADC_0_DMIC_LPF_CLK_SEL   ((u32)0x00000003 << 7)           /*!< R/W 0x0  Channel 0 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K*/
#define AUD_ADC_0_DMIC_LPF_CLK_SEL(x)     (((u32)((x) & 0x00000003) << 7))
#define AUD_GET_ADC_0_DMIC_LPF_CLK_SEL(x) ((u32)(((x >> 7) & 0x00000003)))
#define AUD_MASK_ADC_1_DMIC_LPF_CLK_SEL   ((u32)0x00000003 << 9)           /*!< R/W 0x0  Channel 1 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K*/
...
/** @defgroup CODEC_ASRC_CONTROL_2
  ...
  * @{
  */
#define AUD_MASK_ASRC_RATE_SEL_RX_0   ((u32)0x00000003 << 0)           /*!< R/W 0x0  0: fs supports 4kHz ~ 60kHz 1: fs supports 60kHz ~ 120kHz 2/3: Reserved*/
...
#define AUD_BIT_ASRC_AUTO_ADJUST_RX_0 ((u32)0x00000001 << 4)           /*!< R/W 0x1  HW auto adjust convergence rate 0: Disable 1: Enable*/
/** @} */
...
/** @defgroup CODEC_ASRC_CONTROL_3
  ...
  * @{
  */
#define AUD_MASK_ASRC_SDM_INTI_RX_0   ((u32)0x00FFFFFF << 0)           /*!< R/W 0x0  Set initial value of tracked frequency*/
...
/** @defgroup CODEC_I2S_0_CONTROL
  ...
  * @{
  */
#define AUD_BIT_I2S_0_RST_N_REG             ((u32)0x00000001 << 0)            /*!< R/W 0x0  1'b1: rst_n to audio digital IP is de-asserted 1'b0: rst_n to audio digital IP is asserted*/
#define AUD_BIT_I2S_0_INV_SCLK              ((u32)0x00000001 << 1)            /*!< R/W 0x0  1'b1: I2S/PCM bit clock is inverted*/
#define AUD_BIT_I2S_0_SELF_LPBK_EN          ((u32)0x00000001 << 2)            /*!< R/W 0x0  1'b1: internal loopback mode is enabled*/
#define AUD_BIT_I2S_0_SAME_LRC_EN           ((u32)0x00000001 << 3)            /*!< R/W 0x0  1'b1: LRC_TX share to LRC_RX*/
#define AUD_MASK_I2S_0_TDM_MODE_RX          ((u32)0x00000003 << 4)            /*!< R/W 0x0  I2S 0 Rx channel TDM mode 0: 2 channels  1: 4 channels 2/3: Reserved*/
#define AUD_I2S_0_TDM_MODE_RX(x)            (((u32)((x) & 0x00000003) << 4))
#define AUD_GET_I2S_0_TDM_MODE_RX(x)        ((u32)(((x >> 4) & 0x00000003)))
#define AUD_MASK_I2S_0_DATA_FORMAT_SEL_TX   ((u32)0x00000003 << 6)            /*!< R/W 0x0  I2S 0 Tx channel data format 2'b00: I2S 2'b01: Left-justified 2'b10: PCM mode A 2'b11: PCM mode B*/
#define AUD_I2S_0_DATA_FORMAT_SEL_TX(x)     (((u32)((x) & 0x00000003) << 6))
#define AUD_GET_I2S_0_DATA_FORMAT_SEL_TX(x) ((u32)(((x >> 6) & 0x00000003)))
#define AUD_MASK_I2S_0_DATA_FORMAT_SEL_RX   ((u32)0x00000003 << 8)            /*!< R/W 0x0  I2S 0 Rx channel data format 2'b00: I2S 2'b01: Left-justified 2'b10: PCM mode A 2'b11: PCM mode B*/
#define AUD_I2S_0_DATA_FORMAT_SEL_RX(x)     (((u32)((x) & 0x00000003) << 8))
#define AUD_GET_I2S_0_DATA_FORMAT_SEL_RX(x) ((u32)(((x >> 8) & 0x00000003)))
#define AUD_MASK_I2S_0_DATA_LEN_SEL_TX      ((u32)0x00000003 << 10)           /*!< R/W 0x0  I2S 0 Tx channel data length 2'b00: 16 bits 2'b10: 24 bits 2'b11: 8 bits*/
#define AUD_I2S_0_DATA_LEN_SEL_TX(x)        (((u32)((x) & 0x00000003) << 10))
#define AUD_GET_I2S_0_DATA_LEN_SEL_TX(x)    ((u32)(((x >> 10) & 0x00000003)))
#define AUD_MASK_I2S_0_DATA_LEN_SEL_RX      ((u32)0x00000003 << 12)           /*!< R/W 0x0  I2S 0 Rx channel data length 2'b00: 16 bits 2'b10: 24 bits 2'b11: 8 bits*/
#define AUD_I2S_0_DATA_LEN_SEL_RX(x)        (((u32)((x) & 0x00000003) << 12))
#define AUD_GET_I2S_0_DATA_LEN_SEL_RX(x)    ((u32)(((x >> 12) & 0x00000003)))
#define AUD_MASK_I2S_0_CH_LEN_SEL_TX        ((u32)0x00000003 << 14)           /*!< R/W 0x0  I2S 0 Tx channel length 2'b00: 16 bits 2'b01: 32 bits 2'b10: 24 bits 2'b11: 8 bits*/
#define AUD_I2S_0_CH_LEN_SEL_TX(x)          (((u32)((x) & 0x00000003) << 14))
#define AUD_GET_I2S_0_CH_LEN_SEL_TX(x)      ((u32)(((x >> 14) & 0x00000003)))
#define AUD_MASK_I2S_0_CH_LEN_SEL_RX        ((u32)0x00000003 << 16)           /*!< R/W 0x0  I2S 0 Rx channel length 2'b00: 16 bits 2'b01: 32 bits 2'b10: 24 bits 2'b11: 8 bits*/
#define AUD_I2S_0_CH_LEN_SEL_RX(x)          (((u32)((x) & 0x00000003) << 16))
#define AUD_GET_I2S_0_CH_LEN_SEL_RX(x)      ((u32)(((x >> 16) & 0x00000003)))
#define AUD_MASK_I2S_0_DATA_CH_SEL_TX       ((u32)0x00000003 << 18)           /*!< R/W 0x0  I2S 0 Tx channel data 2'b00: L/R 2'b01: R/L 2'b10: L/L 2'b11: R/R*/
#define AUD_I2S_0_DATA_CH_SEL_TX(x)         (((u32)((x) & 0x00000003) << 18))
#define AUD_GET_I2S_0_DATA_CH_SEL_TX(x)     ((u32)(((x >> 18) & 0x00000003)))
#define AUD_BIT_I2S_0_MASTER_SEL            ((u32)0x00000001 << 20)           /*!< R/W 0x0  I2S 0 master source selection 1'b0: internal SPORT 1'b1: external I2S*/
/** @} */
...
/** @defgroup CODEC_I2S_0_CONTROL_1
  ...
  * @{
  */
#define AUD_MASK_I2S_0_DATA_CH0_SEL_RX    ((u32)0x00000007 << 0)            /*!< R/W 0x0  I2S 0 Rx channel data channel 0 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH0_SEL_RX(x)      (((u32)((x) & 0x00000007) << 0))
#define AUD_GET_I2S_0_DATA_CH0_SEL_RX(x)  ((u32)(((x >> 0) & 0x00000007)))
#define AUD_MASK_I2S_0_DATA_CH1_SEL_RX    ((u32)0x00000007 << 3)            /*!< R/W 0x1  I2S 0 Rx channel data channel 1 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH1_SEL_RX(x)      (((u32)((x) & 0x00000007) << 3))
#define AUD_GET_I2S_0_DATA_CH1_SEL_RX(x)  ((u32)(((x >> 3) & 0x00000007)))
#define AUD_MASK_I2S_0_DATA_CH2_SEL_RX    ((u32)0x00000007 << 6)            /*!< R/W 0x2  I2S 0 Rx channel data channel 2 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH2_SEL_RX(x)      (((u32)((x) & 0x00000007) << 6))
#define AUD_GET_I2S_0_DATA_CH2_SEL_RX(x)  ((u32)(((x >> 6) & 0x00000007)))
#define AUD_MASK_I2S_0_DATA_CH3_SEL_RX    ((u32)0x00000007 << 9)            /*!< R/W 0x3  I2S 0 Rx channel data channel 3 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH3_SEL_RX(x)      (((u32)((x) & 0x00000007) << 9))
#define AUD_GET_I2S_0_DATA_CH3_SEL_RX(x)  ((u32)(((x >> 9) & 0x00000007)))
#define AUD_MASK_I2S_0_DATA_CH4_SEL_RX    ((u32)0x00000007 << 12)           /*!< R/W 0x4  I2S 0 Rx channel data channel 4 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH4_SEL_RX(x)      (((u32)((x) & 0x00000007) << 12))
#define AUD_GET_I2S_0_DATA_CH4_SEL_RX(x)  ((u32)(((x >> 12) & 0x00000007)))
#define AUD_MASK_I2S_0_DATA_CH5_SEL_RX    ((u32)0x00000007 << 15)           /*!< R/W 0x5  I2S 0 Rx channel data channel 5 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH5_SEL_RX(x)      (((u32)((x) & 0x00000007) << 15))
#define AUD_GET_I2S_0_DATA_CH5_SEL_RX(x)  ((u32)(((x >> 15) & 0x00000007)))
#define AUD_MASK_I2S_0_DATA_CH6_SEL_RX    ((u32)0x00000007 << 18)           /*!< R/W 0x0  I2S 0 Rx channel data channel 6 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH6_SEL_RX(x)      (((u32)((x) & 0x00000007) << 18))
#define AUD_GET_I2S_0_DATA_CH6_SEL_RX(x)  ((u32)(((x >> 18) & 0x00000007)))
#define AUD_MASK_I2S_0_DATA_CH7_SEL_RX    ((u32)0x00000007 << 21)           /*!< R/W 0x0  I2S 0 Rx channel data channel 7 0: CH0 1: CH1 2/3/4/5/6/7: reserved*/
#define AUD_I2S_0_DATA_CH7_SEL_RX(x)      (((u32)((x) & 0x00000007) << 21))
#define AUD_GET_I2S_0_DATA_CH7_SEL_RX(x)  ((u32)(((x >> 21) & 0x00000007)))
#define AUD_BIT_I2S_0_DATA_CH0_RX_DISABLE ((u32)0x00000001 << 24)           /*!< R/W 0x0  I2S 0 Rx channel data channel 0 1: disable 0: enable*/
#define AUD_BIT_I2S_0_DATA_CH1_RX_DISABLE ((u32)0x00000001 << 25)           /*!< R/W 0x0  I2S 0 Rx channel data channel 1 1: disable 0: enable*/
#define AUD_BIT_I2S_0_DATA_CH2_RX_DISABLE ((u32)0x00000001 << 26)           /*!< R/W 0x0  I2S 0 Rx channel data channel 2 1: disable 0: enable*/
#define AUD_BIT_I2S_0_DATA_CH3_RX_DISABLE ((u32)0x00000001 << 27)           /*!< R/W 0x0  I2S 0 Rx channel data channel 3 1: disable 0: enable*/
#define AUD_BIT_I2S_0_DATA_CH4_RX_DISABLE ((u32)0x00000001 << 28)           /*!< R/W 0x0  I2S 0 Rx channel data channel 4 1: disable 0: enable*/
#define AUD_BIT_I2S_0_DATA_CH5_RX_DISABLE ((u32)0x00000001 << 29)           /*!< R/W 0x0  I2S 0 Rx channel data channel 5 1: disable 0: enable*/
#define AUD_BIT_I2S_0_DATA_CH6_RX_DISABLE ((u32)0x00000001 << 30)           /*!< R/W 0x0  I2S 0 Rx channel data channel 6 1: disable 0: enable*/
#define AUD_BIT_I2S_0_DATA_CH7_RX_DISABLE ((u32)0x00000001 << 31)           /*!< R/W 0x0  I2S 0 Rx channel data channel 7 1: disable 0: enable*/
/** @} */
...
/** @defgroup CODEC_ADC_x_CONTROL_0
  ...
  * @{
  */
#define AUD_MASK_ADC_x_DMIC_SRC_SEL         ((u32)0x00000007 << 0)            /*!< R/W 0x0  Channel x DMIC source selection 3'b000: MIC 1 rising 3'b001: MIC 1 falling 3'b010: MIC 2 rising 3'b011: MIC 2 falling other: reserved*/
#define AUD_ADC_x_DMIC_SRC_SEL(x)           (((u32)((x) & 0x00000007) << 0))
#define AUD_GET_ADC_x_DMIC_SRC_SEL(x)       ((u32)(((x >> 0) & 0x00000007)))
#define AUD_BIT_ADC_x_DMIC_LPF2ND_EN        ((u32)0x00000001 << 3)            /*!< R/W 0x1  Channel x DMIC path SRC 2nd LPF control 0: Disable 1: Enable*/
#define AUD_BIT_ADC_x_DMIC_LPF1ST_EN        ((u32)0x00000001 << 4)            /*!< R/W 0x1  Channel x DMIC path SRC 1st LPF control 0: Disable 1: Enable*/
#define AUD_MASK_ADC_x_DMIC_LPF1ST_FC_SEL   ((u32)0x00000003 << 5)            /*!< R/W 0x0  Channel x DMIC path SRC 1st LPF FC*/
#define AUD_ADC_x_DMIC_LPF1ST_FC_SEL(x)     (((u32)((x) & 0x00000003) << 5))
#define AUD_GET_ADC_x_DMIC_LPF1ST_FC_SEL(x) ((u32)(((x >> 5) & 0x00000003)))
#define AUD_BIT_ADC_x_DMIC_MIX_MUTE         ((u32)0x00000001 << 7)            /*!< R/W 0x1  Channel x DMIC input path mute 0: Un-Mute 1: Mute*/
...
#define AUD_MASK_ADC_x_AD_ZDET_TOUT         ((u32)0x00000003 << 20)           /*!< R/W 0x0  Channel x ADC path zero detection time out selection 2'b00: 1024*16 samples 2'b01: 1024*32 samples 2'b10: 1024*64 samples 2'b11: 64 samples*/
#define AUD_ADC_x_AD_ZDET_TOUT(x)           (((u32)((x) & 0x00000003) << 20))
#define AUD_GET_ADC_x_AD_ZDET_TOUT(x)       ((u32)(((x >> 20) & 0x00000003)))
#define AUD_BIT_ADC_x_AD_MUTE               ((u32)0x00000001 << 22)           /*!< R/W 0x0  Channel x ADC path mute 0: Un-Mute 1: Mute*/
#define AUD_BIT_ADC_x_HPF_RSVD              ((u32)0x00000001 << 23)           /*!< R/W 0x0  Channel x ADC path reserved*/
#define AUD_BIT_ADC_x_DCHPF_EN              ((u32)0x00000001 << 26)           /*!< R/W 0x0  Channel x ADC path high pass filter enable control (filter DC) 0: Disable 1: Enable*/
...
#define AUD_MASK_ADC_x_DMIC_LPF2ND_FC_SEL   ((u32)0x00000003 << 30)           /*!< R/W 0x0  Uplink Channel x DMIC path SRC 2nd LPF FC*/
...
#define AUD_MASK_ADC_x_BOOST_GAIN   ((u32)0x00000003 << 8)            /*!< R/W 0x0  Channel x ADC path boost gain control 00: 0dB 01: 12dB 10: 24dB 11: 36dB*/
#define AUD_ADC_x_BOOST_GAIN(x)     (((u32)((x) & 0x00000003) << 8))
#define AUD_GET_ADC_x_BOOST_GAIN(x) ((u32)(((x >> 8) & 0x00000003)))
#define AUD_MASK_ADC_x_RPTR_HOLD    ((u32)0x0000000F << 12)           /*!< R/W 0x0  Channel x I2S read point hold number rptr_hold = (I2S_fs/ad_fs) - 1*/
#define AUD_ADC_x_RPTR_HOLD(x)      (((u32)((x) & 0x0000000F) << 12))
#define AUD_GET_ADC_x_RPTR_HOLD(x)  ((u32)(((x >> 12) & 0x0000000F)))
#define AUD_BIT_ADC_x_FIFO_KEEP_ONE ((u32)0x00000001 << 16)           /*!< R/W 0x0  Channel x I2S sample buffering 0: 4 samples 1: 1 sample*/
/** @} */

/** @defgroup CODEC_ADC_ALIGN_CONTROL_REG_0
  * @brief ADC Align Control Register 0
  * @{
  */
#define AUD_BIT_SP_AD_FIFO_ALIGN_EN ((u32)0x00000001 << 0) /*!< R/W 0x0  1: Uplink FIFO will align with I2S 0: Disable*/
#define AUD_BIT_SP_AD_ALIGN_EN      ((u32)0x00000001 << 2) /*!< R/W 0x0  1: Uplink channel will align with I2S 0: Disable*/
/** @} */

/** @defgroup CODEC_ADC_ALIGN_CONTROL_REG
  * @brief ADC Align Control Register
  * @{
  */
#define AUD_MASK_ADC_0_ALIGN_CH_SEL   ((u32)0x00000007 << 0)           /*!< R/W 0x0  Uplink CH0 align channel selection 0: CH0 1: CH1 Others: reserved*/
#define AUD_ADC_0_ALIGN_CH_SEL(x)     (((u32)((x) & 0x00000007) << 0))
#define AUD_GET_ADC_0_ALIGN_CH_SEL(x) ((u32)(((x >> 0) & 0x00000007)))
#define AUD_BIT_ADC_0_ALIGN_EN        ((u32)0x00000001 << 3)           /*!< R/W 0x0  Uplink CH0 align enable*/
#define AUD_MASK_ADC_1_ALIGN_CH_SEL   ((u32)0x00000007 << 4)           /*!< R/W 0x0  Uplink CH1 align channel selection 0: CH0 1: CH1 Others: reserved*/
#define AUD_ADC_1_ALIGN_CH_SEL(x)     (((u32)((x) & 0x00000007) << 4))
#define AUD_GET_ADC_1_ALIGN_CH_SEL(x) ((u32)(((x >> 4) & 0x00000007)))
#define AUD_BIT_ADC_1_ALIGN_EN        ((u32)0x00000001 << 7)           /*!< R/W 0x0  Uplink CH1 align enable*/
/** @} */
...
/** @defgroup CODEC_ADC_x_SILENCE_CONTROL
  ...
  * @{
  */
#define AUD_BIT_ADC_x_SILENCE_DET_EN          ((u32)0x00000001 << 0)           /*!< R/W 0x0  Channel x ADC path silence detection enable 0: Disable 1: Enable*/
#define AUD_MASK_ADC_x_SILENCE_LEVEL_SEL      ((u32)0x00000007 << 1)           /*!< R/W 0x1  Channel x ADC path silence detection threshold 3'b000: -54db 3'b001: -60db 3'b010: -66db 3'b011: -72db 3'b100: -78db 3'b101: -84db 3'b110: -90db 3'b111: -96db*/
...
/** @defgroup CODEC_ADC_0_EQ_CTRL
  ...
  * @{
  */
#define AUD_BIT_ADC_0_BIQUAD_EN_0 ((u32)0x00000001 << 0) /*!< R/W 0x0  ADC channel 0 EQ 0-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_0_BIQUAD_EN_1 ((u32)0x00000001 << 1) /*!< R/W 0x0  ADC channel 0 EQ 1-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_0_BIQUAD_EN_2 ((u32)0x00000001 << 2) /*!< R/W 0x0  ADC channel 0 EQ 2-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_0_BIQUAD_EN_3 ((u32)0x00000001 << 3) /*!< R/W 0x0  ADC channel 0 EQ 3-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_0_BIQUAD_EN_4 ((u32)0x00000001 << 4) /*!< R/W 0x0  ADC channel 0 EQ 4-band biquad enable 0: disable 1: enable*/
/** @} */
...
/** @defgroup CODEC_ADC_0_BIQUAD_B1_x
  ...
  * @{
  */
#define AUD_MASK_ADC_0_BIQUAD_B1_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 0 EQ x-band coef. B1 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_0_BIQUAD_B2_x
  ...
  * @{
  */
#define AUD_MASK_ADC_0_BIQUAD_B2_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 0 EQ x-band coef. B2 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_0_BIQUAD_A1_x
  ...
  * @{
  */
#define AUD_MASK_ADC_0_BIQUAD_A1_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 0 EQ x-band coef. A1 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_0_BIQUAD_A2_x
  ...
  * @{
  */
#define AUD_MASK_ADC_0_BIQUAD_A2_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 0 EQ x-band coef. A2 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_1_EQ_CTRL
  ...
  * @{
  */
#define AUD_BIT_ADC_1_BIQUAD_EN_0 ((u32)0x00000001 << 0) /*!< R/W 0x0  ADC channel 1 EQ 0-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_1_BIQUAD_EN_1 ((u32)0x00000001 << 1) /*!< R/W 0x0  ADC channel 1 EQ 1-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_1_BIQUAD_EN_2 ((u32)0x00000001 << 2) /*!< R/W 0x0  ADC channel 1 EQ 2-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_1_BIQUAD_EN_3 ((u32)0x00000001 << 3) /*!< R/W 0x0  ADC channel 1 EQ 3-band biquad enable 0: disable 1: enable*/
#define AUD_BIT_ADC_1_BIQUAD_EN_4 ((u32)0x00000001 << 4) /*!< R/W 0x0  ADC channel 1 EQ 4-band biquad enable 0: disable 1: enable*/
/** @} */
...
/** @defgroup CODEC_ADC_1_BIQUAD_B1_x
  ...
  * @{
  */
#define AUD_MASK_ADC_1_BIQUAD_B1_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 1 EQ x-band coef. b1 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_1_BIQUAD_B2_x
  ...
  * @{
  */
#define AUD_MASK_ADC_1_BIQUAD_B2_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 1 EQ x-band coef. b2 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_1_BIQUAD_A1_x
  ...
  * @{
  */
#define AUD_MASK_ADC_1_BIQUAD_A1_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 1 EQ x-band coef. a1 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_1_BIQUAD_A2_x
  ...
  * @{
  */
#define AUD_MASK_ADC_1_BIQUAD_A2_x   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x0  ADC channel 1 EQ x-band coef. a2 2's complement in 4.25 format, i.e. the range is from -8~7.99.*/
...
/** @defgroup CODEC_ADC_0_LPF_RD
  * @brief ADC Channel 0 LPF RD Register
  * @{
  */
#define AUD_MASK_ADC_0_LPF_RD   ((u32)0x0007FFFF << 0)           /*!< R   CH 0 ADC LPF out values*/
#define AUD_ADC_0_LPF_RD(x)     (((u32)((x) & 0x0007FFFF) << 0))
#define AUD_GET_ADC_0_LPF_RD(x) ((u32)(((x >> 0) & 0x0007FFFF)))
/** @} */

/** @defgroup CODEC_ADC_1_LPF_RD
  * @brief ADC Channel 1 LPF RD Register
  * @{
  */
#define AUD_MASK_ADC_1_LPF_RD   ((u32)0x0007FFFF << 0)           /*!< R   CH 1 ADC LPF out values*/
...
/** @defgroup CODEC_AUDIO_RO_DUMMY1
  ...
  * @{
  */
#define AUD_MASK_AUDIO_RO_DUMMY1   ((u32)0xFFFFFFFF << 0)           /*!< R   Dummy register*/
...
/** @brief AUDIO Port
  */
typedef struct {
	__IO uint32_t CODEC_ADC_0_BIQUAD_H0_x;  /*!< ADC CHANNEL 0 EQ x BAND BIQUAD H0 REGISTER */
	__IO uint32_t CODEC_ADC_0_BIQUAD_B1_x;  /*!< ADC CHANNEL 0 EQ x BAND BIQUAD B1 REGISTER */
	__IO uint32_t CODEC_ADC_0_BIQUAD_B2_x;  /*!< ADC CHANNEL 0 EQ x BAND BIQUAD B2 REGISTER */
	__IO uint32_t CODEC_ADC_0_BIQUAD_A1_x;  /*!< ADC CHANNEL 0 EQ x BAND BIQUAD A1 REGISTER */
	__IO uint32_t CODEC_ADC_0_BIQUAD_A2_x;  /*!< ADC CHANNEL 0 EQ x BAND BIQUAD A2 REGISTER */
...
typedef struct {
	__IO uint32_t CODEC_AUDIO_CONTROL_0                         ;  /*!< AUDIO CONTROL REGISTER 0 Register,  Address offset:0x000 */
	__IO uint32_t CODEC_AUDIO_CONTROL_1                         ;  /*!< AUDIO CONTROL REGISTER 1 Register,  Address offset:0x004 */
	__IO uint32_t CODEC_CLOCK_CONTROL_1                         ;  /*!< CLOCK CONTROL REGISTER 1 Register,  Address offset:0x008 */
	__IO uint32_t CODEC_CLOCK_CONTROL_2                         ;  /*!< CLOCK CONTROL REGISTER 2 Register,  Address offset:0x00C */
	__IO uint32_t CODEC_CLOCK_CONTROL_3                         ;  /*!< CLOCK CONTROL REGISTER 3 Register,  Address offset:0x010 */
	__IO uint32_t CODEC_CLOCK_CONTROL_4                         ;  /*!< CLOCK CONTROL REGISTER 4 Register,  Address offset:0x014 */
	__IO uint32_t CODEC_CLOCK_CONTROL_5                         ;  /*!< CLOCK CONTROL REGISTER 5 Register,  Address offset:0x018 */
	__IO uint32_t CODEC_CLOCK_CONTROL_6                         ;  /*!< CLOCK CONTROL REGISTER 6 Register,  Address offset:0x01C */
	__IO uint32_t CODEC_CLOCK_CONTROL_7                         ;  /*!< CLOCK CONTROL REGISTER 7 Register,  Address offset:0x020 */
	__IO uint32_t CODEC_ASRC_CONTROL_0                          ;  /*!< ASRC CONTROL REGISTER 0 Register,  Address offset:0x024 */
	__IO uint32_t CODEC_ASRC_CONTROL_1                          ;  /*!< ASRC CONTROL REGISTER 1 Register,  Address offset:0x028 */
	__IO uint32_t CODEC_ASRC_CONTROL_2                          ;  /*!< ASRC CONTROL REGISTER 2 Register,  Address offset:0x02C */
	__IO uint32_t CODEC_ASRC_CONTROL_3                          ;  /*!< ASRC CONTROL REGISTER 3 Register,  Address offset:0x030 */
	__IO uint32_t RSVD0[2]                                      ;  /*!< Reserved,  Address offset:0x034-0x03B */
	__IO uint32_t CODEC_I2S_0_CONTROL                           ;  /*!< I2S 0 CONTROL REGISTER,  Address offset:0x03C */
	__IO uint32_t CODEC_I2S_0_CONTROL_1                         ;  /*!< I2S 0 CONTROL REGISTER 1 Register,  Address offset:0x040 */
	...
	__IO uint32_t RSVD2[19]                                     ;  /*!< Reserved,  Address offset:0x060-0x0AB */
	__IO uint32_t CODEC_ADC_ALIGN_CONTROL_REG_0                 ;  /*!< ADC ALIGN CONTROL REGISTER 0 Register,  Address offset:0x0AC */
	__IO uint32_t CODEC_ADC_ALIGN_CONTROL_REG                   ;  /*!< ADC ALIGN CONTROL REGISTER,  Address offset:0x0B0 */
	__IO uint32_t RSVD3[19]                                     ;  /*!< Reserved,  Address offset:0x0B4-0x0FF */
	__IO uint32_t CODEC_ADC_x_SILENCE_CONTROL[2]                ;  /*!< ADC CHANNEL x SILENCE CONTROL REGISTER,  Address offset:0x100-0x104 */
	__IO uint32_t RSVD4[190]                                    ;  /*!< Reserved,  Address offset:0x108-0x3FF */
	...
	__IO uint32_t RSVD5[204]                                    ;  /*!< Reserved,  Address offset:0x4D0-0x7FF */
	...
	__IO uint32_t RSVD6[6]                                      ;  /*!< Reserved,  Address offset:0x80C-0x823 */
