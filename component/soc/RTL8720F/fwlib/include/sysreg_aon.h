...
/** @defgroup REG_AON_PWC
  ...
  * @{
  */
#define AON_BIT_LPPAD_SHDN_CORE ((u32)0x00000001 << 26)          /*!< R/W 0x1  1: Release LP PAD SHDN CORE 0: Global Assert LP PAD RSTB33 Note:G5 is aon pad, when all LP pad's IO power is ready , aon pmc will release this bit , only in power on init seq . DD_SEC: bpc_pmc*/
...
#define AON_BIT_G0_PAD_RSTB     ((u32)0x00000001 << 16)          /*!< R/W 0x1  1: Enable G0 group pad 0: Reset PAD DD_SEC: bpc_pmc*/
...
#define AON_BIT_G0_PAD_SHDN     ((u32)0x00000001 << 8)           /*!< R/W 0x1  1: Enable G0 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_DUAL_MODE       ((u32)0x00000001 << 7)           /*!< R/W 0x0  1: CPU0/CPU1 work separate 0: default mode DD_SEC: bpc_pmc*/
...
#define AON_BIT_G1_PAD_SHDN_CORE ((u32)0x00000001 << 9)  /*!< R/W 0x1  1: Enable G1 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G0_PAD_SHDN_CORE ((u32)0x00000001 << 8)  /*!< R/W 0x1  1: Enable G0 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
...
#define APBPeriph_RTC  ((u32)(3 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: Enable RTC function 0: Disable Move to rtc reg block DD_SEC: S*/
...
/** @defgroup REG_AON_BOOT_REASON_HW
  ...
  * @{
  */
#define AON_BIT_RSTF_PLFM1      ((u32)0x00000001 << 17) /*!< RW1C 0h  This bit will be set to 1 when plfm1 resets . Write 1 to clear.*/
...
#define AON_BIT_BOOT_SW    ((u32)0x00000001 << 19)           /*!< R/W 0x0  boot from internal MCM flash DD_SEC: S*/
#define AON_BIT_BOOT_NOR   ((u32)0x00000001 << 18)           /*!< R/W 0x0  boot from external DD_SEC: S*/
#define AON_BIT_IBOOT_SW   ((u32)0x00000001 << 17)           /*!< R/W 0x0  iboot configured by SIC/SW DD_SEC: S*/
#define AON_BIT_IBOOT_SEL  ((u32)0x00000001 << 16)           /*!< R/W 0x0  If 1, using iboot_sw to replace trapped iboot value. DD_SEC: S*/
/** @} */
...
/** @defgroup REG_AON_GPIO_CTRL
  ...
  * @{
  */
#define AON_MASK_GPIO_WAK_SEL       ((u32)0x00000007 << 28)           /*!< R/W 0h  Wake pin0 selection 0: PA19 (default) 1: PA20 2: PA21 3: PA22 other: Not used*/
#define AON_GPIO_WAK_SEL(x)         (((u32)((x) & 0x00000007) << 28))
#define AON_GET_GPIO_WAK_SEL(x)     ((u32)(((x >> 28) & 0x00000007)))
...
/** @defgroup REG_AON_PMC_OPT
  ...
  * @{
  */
#define AON_MASK_THM_RESUME_CNT   ((u32)0x000000FF << 24)           /*!< R/W 8'h8  After thermal reset happen , it will wait a timer then reboot itself .  This count unit in 0.65s (2^16 * 10us) DD_SEC: bpc_pmc*/
...
/** @defgroup REG_AON_PMC_ADDR01
  ...
  * @{
  */
#define AON_MASK_PMC_PATCH_ADDR0   ((u32)0x00000FFF << 0)            /*!< R/W 12'hF0  used for BOD enable addr DD_SEC: S*/
...
/** @defgroup REG_AON_SYSRST_MSK
  ...
  * @{
  */
#define AON_BIT_WDG0_RST_OPT    ((u32)0x00000001 << 4) /*!< R/W 0x0  0:by default , km4ns wdg reset only reset syson1 and plfm1 1:km4ns wdg reset will reset syson all*/
...
/** @defgroup REG_AON_DUMMY_AIP_CTRL0
  ...
  * @{
  */
#define AON_MASK_PMC_OPT_DMY    ((u32)0x0000000F << 12)           /*!< R/W 0x0  HW used only , these are for pmc patch*/
#define AON_PMC_OPT_DMY(x)      (((u32)((x) & 0x0000000F) << 12))
#define AON_GET_PMC_OPT_DMY(x)  ((u32)(((x >> 12) & 0x0000000F)))
#define AON_BIT_PMC_OPT_SRST    ((u32)0x00000001 << 9)            /*!< R/W 0x0  1:soft reset(wdg/sys) will trigger aon pmc*/
#define AON_BIT_OSC4M_REQ_FORCE ((u32)0x00000001 << 8)            /*!< R/W 0x0  force to request osc4m 1:osc4m will never shutdown 0:osc4m will auto shutdown when no IP use it*/
/** @} */
...
/** @defgroup REG_AON_DUMMY_AIP_INFO0
  ...
  * @{
  */
#define AON_BIT_THM_LATCH_EN   ((u32)0x00000001 << 31)           /*!< R/W 1'b1  Enable the power-on temperature latching function*/
#define AON_MASK_ADC_OSR       ((u32)0x0000000F << 27)           /*!< R/W 4'b101  over sample ratio 000: 1X,  oversample disable 001: 2x 010: 4x 011: 8x 100: 16x 101: 32x 110: 64x 111:128x 1000:256x*/
#define AON_ADC_OSR(x)         (((u32)((x) & 0x0000000F) << 27))
#define AON_GET_ADC_OSR(x)     ((u32)(((x >> 27) & 0x0000000F)))
#define AON_MASK_ADC_HCNT      ((u32)0x00000003 << 25)           /*!< R/W 2'b01  This field defines clock driver high level of  chn in ADC module. clk_source osc2M  00:HCNT=9 cycle 01:HCNT=14 cycle 10:HCNT=19 cycle 11:HCNT=24 cycle*/
#define AON_ADC_HCNT(x)        (((u32)((x) & 0x00000003) << 25))
#define AON_GET_ADC_HCNT(x)    ((u32)(((x >> 25) & 0x00000003)))
#define AON_MASK_CKD_OSC_2M    ((u32)0x0000000F << 2)            /*!< R/W 4'd11  osc_2m divider  0: div 2 1: div 4 2: div 6 ...... n:div2*(n+1)*/
#define AON_CKD_OSC_2M(x)      (((u32)((x) & 0x0000000F) << 2))
#define AON_GET_CKD_OSC_2M(x)  ((u32)(((x >> 2) & 0x0000000F)))
#define AON_BIT_DBG_SCAN_BYP   ((u32)0x00000001 << 1)            /*!< R 0x0  Used for scan byp point connect to scan chain. HW used only*/
#define AON_BIT_IWDG_RESET_OPT ((u32)0x00000001 << 0)            /*!< R/W 0x0  0: when iwdg reset happened , it will reset all aon domain except some special register 1: iwdg reset domain same as ls wdg*/
/** @} */
