...
/** @defgroup SEC_OTP_SYSCFG0
  ...
  * @{
  */
#define SEC_BIT_SW_RSVD_09            ((u32)0x00000001 << 31)           /*!< R/W 0x0  RSVD for SW usage*/
#define SEC_BIT_SW_RSVD_08            ((u32)0x00000001 << 30)           /*!< R/W 0x0  RSVD for SW usage*/
#define SEC_BIT_LOGIC_PQC_EN          ((u32)0x00000001 << 29)           /*!< R/W 0x0  */
...
#define SEC_MASK_SW_RSVD_06           ((u32)0x00000003 << 22)           /*!< R/W 0x0  RSVD for SW usage*/
#define SEC_SW_RSVD_06(x)             (((u32)((x) & 0x00000003) << 22))
#define SEC_GET_SW_RSVD_06(x)         ((u32)(((x >> 22) & 0x00000003)))
#define SEC_BIT_BOOT_CNT_LMT_EN       ((u32)0x00000001 << 21)           /*!< R/W 0x0  Enable boot count limit 0: disable 1: enable*/
#define SEC_BIT_SW_RSVD_07            ((u32)0x00000001 << 20)           /*!< R/W 0x0  RSVD for SW usage*/
...
#define SEC_BIT_SW_RSVD_05            ((u32)0x00000001 << 7)            /*!< R/W 0x0  RSVD for SW usage*/
#define SEC_BIT_BOOT_EXT_FLASH        ((u32)0x00000001 << 6)            /*!< R/W 0x0  Boot from internal flash or external flash 0: internal flash 1: external flash*/
#define SEC_MASK_SDIO_PINMUX          ((u32)0x00000003 << 4)            /*!< R/W 0x0  "0:PINMUX Index 0 (group 1: PA4-PA5,PA18-PA21) 1:PINMUX Index 1 (group 6: PC2-PC7) 2:PINMUX Index 2 (rsvd) 3:PINMUX Index 3 (rsvd)"*/
#define SEC_SDIO_PINMUX(x)            (((u32)((x) & 0x00000003) << 4))
#define SEC_GET_SDIO_PINMUX(x)        ((u32)(((x >> 4) & 0x00000003)))
#define SEC_BIT_BT_FUNCTION_EN        ((u32)0x00000001 << 3)            /*!< R/W 0x0  "0 Disable BT function for NIC mode 1 Enable BT function for NIC mode"*/
...
/** @defgroup SEC_PKKEY_x
  * @brief
  * @{
  */
#define SEC_MASK_KEY_x   ((u32)0xFFFFFFFF << 0)           /*!< PROT/R 32'hffffffff  */
#define SEC_KEY_x(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define SEC_GET_KEY_x(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
#define SEC_BIT_PQC_EN                       ((u32)0x00000001 << 1)            /*!< PROT/R 1'b0  */
