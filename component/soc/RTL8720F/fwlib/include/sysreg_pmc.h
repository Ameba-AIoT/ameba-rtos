...
/** @defgroup WLPMC_ISR
  ...
  * @{
  */
#define PMC_BIT_WL_OFF_IMR ((u32)0x00000001 << 17) /*!< R/W 0x0  interrup mask for WL_OFF_ISR DD_SEC: S*/
#define PMC_BIT_WL_ON_IMR  ((u32)0x00000001 << 16) /*!< R/W 0x0  interrup mask for WL_ON_ISR DD_SEC: S*/
#define PMC_BIT_WL_OFF_ISR ((u32)0x00000001 << 1)  /*!< RW1CB 0x0  The falling edge of WL_REQ2ACT indicates the flow of WiFi off DD_SEC: S*/
#define PMC_BIT_WL_ON_ISR  ((u32)0x00000001 << 0)  /*!< RW1CB 0x0  The rising edge of WL_REQ2ACT indicates the flow of WiFi on DD_SEC: S*/
/** @} */
...
/** @defgroup WLAN_PWRCTL
  ...
  * @{
  */
#define PMC_BIT_SW_CLR_RDY2ACT ((u32)0x00000001 << 17) /*!< R/WA0 0x0  System infrom WLAN ready to enter lps DD_SEC: S*/
#define PMC_BIT_SW_SET_RDY2ACT ((u32)0x00000001 << 16) /*!< R/WA0 0x0  System infrom WLAN ready to power on DD_SEC: S*/
#define PMC_BIT_WL_RDY2ACT     ((u32)0x00000001 << 9)  /*!< R 0x0  System infrom WLAN ready to active,tie 1 in RL7098 DD_SEC: S*/
#define PMC_BIT_WL_REQ2ACT     ((u32)0x00000001 << 8)  /*!< R 0x0  When the WiFi PMC starts to go off/on flow, it will send a request signal to the system (request=1 when on, request=0 when off) DD_SEC: S*/
#define PMC_BIT_WL_HW_RESP_FEN ((u32)0x00000001 << 0)  /*!< R/W 0x1  1: enable HW auto response to wifi's power switch request instead of writing 0x24[17:16] DD_SEC: S*/
/** @} */
...
/** @defgroup SYSPMC_CTRL
  ...
  * @{
  */
#define PMC_BIT_CPU_IS_NP     ((u32)0x00000001 << 28)           /*!< R 0x0  This bit indicate if current cpu who read this bit is used as NP 1: is NP 0: is AP*/
...
#define PMC_MASK_TUTIME       ((u32)0x0000003F << 16)           /*!< R/W 0xF  PMC timeunit setting,  in cycles of osc2M  e.g, default 0xF,  timeunit = 8us DD_SEC: bpc_pmc*/
#define PMC_TUTIME(x)         (((u32)((x) & 0x0000003F) << 16))
#define PMC_GET_TUTIME(x)     ((u32)(((x >> 16) & 0x0000003F)))
#define PMC_BIT_CPU0_NMI_MASK ((u32)0x00000001 << 8)            /*!< R/W 0x1  Interrupt mask for CPU0 NVIC[0]: plfm1 reset 1.mask interrupt 0:enable interrupt DD_SEC: bpc_pmc*/
...
/** @defgroup PMC_ADDR45
  ...
  * @{
  */
#define PMC_MASK_PATCH_ADDR0   ((u32)0x00000FFF << 0)            /*!< R/W 12'h2FC  used for trig otp dslp by pmc 0xfc[4] DD_SEC: S*/
...
#define PMC_BIT_SYS_PLL_REQ          ((u32)0x00000001 << 5)            /*!< R/W 0x0  require pll by system . pll ready can polling 0xA8 SYSTEM_CFG0 DD_SEC: bpc_pmc*/
...
/** @defgroup CLK_FORCE
  ...
  * @{
  */
#define PMC_MASK_OPT_DMY           ((u32)0x0000000F << 4)           /*!< R/W 0x0  HW used only , these are for pmc patch DD_SEC: S*/
#define PMC_OPT_DMY(x)             (((u32)((x) & 0x0000000F) << 4))
#define PMC_GET_OPT_DMY(x)         ((u32)(((x >> 4) & 0x0000000F)))
...
#define WAKE_SRC_AP_WAKE_IRQ                         ((u32)0x00000001 << 1)
#define WAKE_SRC_IPC_KM4NS                           ((u32)0x00000001 << 2)
#define WAKE_SRC_IPC_KM4TZ                           ((u32)0x00000001 << 3)
#define WAKE_SRC_IWDG                                ((u32)0x00000001 << 4)
#define WAKE_SRC_Timer0                              ((u32)0x00000001 << 5)
#define WAKE_SRC_Timer1                              ((u32)0x00000001 << 6)
#define WAKE_SRC_Timer2                              ((u32)0x00000001 << 7)
#define WAKE_SRC_Timer3                              ((u32)0x00000001 << 8)
#define WAKE_SRC_pmc_timer0                          ((u32)0x00000001 << 9)
#define WAKE_SRC_pmc_timer1                          ((u32)0x00000001 << 10)
#define WAKE_SRC_UART0                               ((u32)0x00000001 << 11)
#define WAKE_SRC_UART1                               ((u32)0x00000001 << 12)
#define WAKE_SRC_UART2                               ((u32)0x00000001 << 13)
#define WAKE_SRC_UART_LOG                            ((u32)0x00000001 << 14)
#define WAKE_SRC_GPIOA                               ((u32)0x00000001 << 15)
#define WAKE_SRC_GPIOB                               ((u32)0x00000001 << 16)
#define WAKE_SRC_RTC                                 ((u32)0x00000001 << 17)
#define WAKE_SRC_ADC                                 ((u32)0x00000001 << 18)
#define WAKE_SRC_BOR                                 ((u32)0x00000001 << 19)
#define WAKE_SRC_PWR_DOWN                            ((u32)0x00000001 << 20)
#define WAKE_SRC_AON_TIM                             ((u32)0x00000001 << 21)
#define WAKE_SRC_AON_WAKEPIN                         ((u32)0x00000001 << 22)
#define WAKE_SRC_SDIO_WIFI                           ((u32)0x00000001 << 23)
#define WAKE_SRC_SDIO_BT                             ((u32)0x00000001 << 24)
#define WAKE_SRC_BT_CTRL_HIGH                        ((u32)0x00000001 << 25)
#define WAKE_SRC_BT_CTRL_LOW                         ((u32)0x00000001 << 26)
/** @} */
...
/** @defgroup PowerCut_Stable_Time_define
  ...
  */
enum Power_State {
	STATE2_LDOSLP_08 = 0x2,
	STATE4_LDOSLP_09   = 0x4,
	STATE6_LDONORM_09  = 0x6,
	STATE7_LDONORM_10  = 0x7,
};
/** @} */
...
/** @defgroup Memory_LO_State_define
  * @{
  */
enum MemLdo_Sys_Req {
	MemLDO_OFF = 0x00,
	MemLDO_Sleep_WITHOUT_DUMMY = 0x01,
	MemLDO_Normal_WITH_DUMMY = 0x02,
	MemLDO_Normal_WHITHOUT_DUMMY = 0x03,
};
/** @} */
#ifdef __cplusplus
}
