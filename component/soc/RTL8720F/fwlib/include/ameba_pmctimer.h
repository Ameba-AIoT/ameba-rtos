...
/** @defgroup PMCT_TIM_CNTx
  ...
  * @{
  */
#define PMCT_MASK_CNTx   ((u32)0x00FFFFFF << 0)           /*!< R 0xFFFFFF  counter value, counter will stop automatically when it counts down to zero.*/
#define PMCT_CNTx(x)     (((u32)((x) & 0x00FFFFFF) << 0))
#define PMCT_GET_CNTx(x) ((u32)(((x >> 0) & 0x00FFFFFF)))
/** @} */
...
/** @defgroup PMCT_TIM_SETx
  ...
  * @{
  */
#define PMCT_MASK_TIM_SETx   ((u32)0x00FFFFFF << 0)           /*!< R/WP 0x0  Set a countdown value. This value come into force when TIM_EN register bit is enabled. counter will count down from this value immediately.*/
#define PMCT_TIM_SETx(x)     (((u32)((x) & 0x00FFFFFF) << 0))
#define PMCT_GET_TIM_SETx(x) ((u32)(((x >> 0) & 0x00FFFFFF)))
/** @} */
...
/** @defgroup PMCT_TIM_COM_EN
  ...
  * @{
  */
#define PMCT_MASK_COM_EN   ((u32)0x00000007 << 0)           /*!< R/W 0x7  enable compare option.The set cnt value takes effect only when it is greater than the actual cnt value 0:disable 1:enable [0] : control tim0 set ...... [2]: control tim2 set*/
#define PMCT_COM_EN(x)     (((u32)((x) & 0x00000007) << 0))
#define PMCT_GET_COM_EN(x) ((u32)(((x >> 0) & 0x00000007)))
/** @} */
...
typedef struct {
	...
	__I  uint32_t PMCT_TIM_CNTx[3] ;  /*!< TIM COUNTERx Register,  Address offset:0x00C-0x014 */
	__IO uint32_t RSVD0            ;  /*!< Reserved,  Address offset:0x018-0x01B */
	__IO uint32_t PMCT_TIM_SETx[3] ;  /*!< TIM SET REGISTERx Register,  Address offset:0x01C-0x024 */
	__IO uint32_t RSVD1            ;  /*!< Reserved,  Address offset:0x028-0x02B */
