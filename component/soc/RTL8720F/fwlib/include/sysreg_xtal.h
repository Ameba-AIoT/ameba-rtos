...
/** @defgroup XTAL_ANAPAR_XTAL_ON_0
  ...
  * @{
  */
#define XTAL_MASK_SC_INIT   ((u32)0x0000007F << 24)           /*!< R/W/ES 0x0000000  0: reduce cap, 1: increase cap. (220fF per unit) [efuse for BT only ] 有外掛電容設全0*/
#define XTAL_SC_INIT(x)     (((u32)((x) & 0x0000007F) << 24))
#define XTAL_GET_SC_INIT(x) ((u32)(((x >> 24) & 0x0000007F)))
#define XTAL_MASK_SC_XO     ((u32)0x0000007F << 17)           /*!< R/W/ES 0x1000000  1: reduce cap, 0: increase cap. (220fF per unit) [efuse for BT only ]*/
#define XTAL_SC_XO(x)       (((u32)((x) & 0x0000007F) << 17))
#define XTAL_GET_SC_XO(x)   ((u32)(((x >> 17) & 0x0000007F)))
#define XTAL_MASK_SC_XI     ((u32)0x0000007F << 10)           /*!< R/W/ES 0x1000000  1: reduce cap, 0: increase cap. (220fF per unit) [efuse for BT only ]*/
#define XTAL_SC_XI(x)       (((u32)((x) & 0x0000007F) << 10))
#define XTAL_GET_SC_XI(x)   ((u32)(((x >> 10) & 0x0000007F)))
#define XTAL_MASK_GMN       ((u32)0x0000001F << 5)            /*!< R/W/ES 0x11111  GMN: 0~31*/
#define XTAL_GMN(x)         (((u32)((x) & 0x0000001F) << 5))
#define XTAL_GET_GMN(x)     ((u32)(((x >> 5) & 0x0000001F)))
#define XTAL_MASK_GMP       ((u32)0x0000001F << 0)            /*!< R/W/ES 0x11111  GMP: 0~31*/
...
/** @defgroup XTAL_ANAPAR_XTAL_ON_1
  ...
  * @{
  */
#define XTAL_MASK_DUMMY2          ((u32)0x00000003 << 30)           /*!< R/W/ES 0x11  Reserved for future use.*/
#define XTAL_DUMMY2(x)            (((u32)((x) & 0x00000003) << 30))
#define XTAL_GET_DUMMY2(x)        ((u32)(((x >> 30) & 0x00000003)))
#define XTAL_MASK_AAC_OPCUR       ((u32)0x00000003 << 28)           /*!< R/W/ES 0x11  00: 200nA , 200n/step   For AAC robust 11*/
#define XTAL_AAC_OPCUR(x)         (((u32)((x) & 0x00000003) << 28))
#define XTAL_GET_AAC_OPCUR(x)     ((u32)(((x >> 28) & 0x00000003)))
#define XTAL_MASK_VREF_SEL        ((u32)0x0000001F << 23)           /*!< R/W/ES 0x11000  Analog AAC VREF, 390mV~700mV, 10mV/step 11000: Vpp 500mV*/
#define XTAL_VREF_SEL(x)          (((u32)((x) & 0x0000001F) << 23))
#define XTAL_GET_VREF_SEL(x)      ((u32)(((x >> 23) & 0x0000001F)))
#define XTAL_BIT_LPS_DIVISOR      ((u32)0x00000001 << 22)           /*!< R/W/ES 0x0  XTAL LPS clock divider  0: XTAL/128(40M), 1: XTAL/64*/
#define XTAL_BIT_CKDIGI_SEL       ((u32)0x00000001 << 21)           /*!< R/W/ES 0x1  1: DIGI CLK from self-bias 0: DIGI CLK from Schmitt*/
#define XTAL_BIT_EN_XTAL_LPS_CLK  ((u32)0x00000001 << 20)           /*!< R/W/ES 0x1  1: enable XTAL LPS clock  與anapar_xtal_on[43]都是312.5KHz enable*/
#define XTAL_BIT_EN_XTAL_SCHMITT  ((u32)0x00000001 << 19)           /*!< R/W/ES 0x1  1: enable XTAL SCHMITT*/
#define XTAL_MASK_LDO_VREF        ((u32)0x00000007 << 16)           /*!< R/W/ES 0x011  (起震前) 111: 1.1V  110: 1.05V  101:1V  100:0.95V 011: 0.9V  010: 0.85V   001: 0.8V  000: 0.75V*/
#define XTAL_LDO_VREF(x)          (((u32)((x) & 0x00000007) << 16))
#define XTAL_GET_LDO_VREF(x)      ((u32)(((x >> 16) & 0x00000007)))
#define XTAL_MASK_SEL_TOK         ((u32)0x00000007 << 13)           /*!< R/W/ES 0x100  xtal起振过程 reg value: cycles / 40MHz / 26MHz 000: 2^10 / 0.025m / 0.05 001: 2^11 / 0.05m / 0.1m 010: 2^12 / 0.1m / 0.2m 011: 2^13 / 0.2m / 0.3m 100: 2^14 / 0.4m / 0.6m 101: 2^15 / 0.8m / 1.2m 110: 2^16 / 1.6m / 2.5m 111: 2^17 / 3.2m / 4.9m xtal mode switch过程 reg value: cycles / 40MHz / 26MHz 000: 2^10 / 0.0125m / 0.025 001: 2^11 / 0.025m / 0.05m 010: 2^12 / 0.05m / 0.1m 011: 2^13 / 0.1m / 0.2m 100: 2^14 / 0.2m / 0.3m 101: 2^15 / 0.4m / 0.6m 110: 2^16 / 0.8m / 1.25m 111: 2^17 / 1.6m / 2.45m*/
#define XTAL_SEL_TOK(x)           (((u32)((x) & 0x00000007) << 13))
#define XTAL_GET_SEL_TOK(x)       ((u32)(((x >> 13) & 0x00000007)))
#define XTAL_BIT_EN_XTAL_DRV_LPS  ((u32)0x00000001 << 12)           /*!< R/W/ES 0x1  LPS enable clock source control, 1:enable, 0: gated 與anapar_xtal_on[51]都是312.5KHz enable*/
#define XTAL_BIT_EN_XTAL_DRV_DIGI ((u32)0x00000001 << 11)           /*!< R/W/ES 0x1  DIGI enable clock source control, 1:enable, 0: gated*/
#define XTAL_BIT_EN_XTAL_DRV_USB  ((u32)0x00000001 << 10)           /*!< R/W/ES 0x1  USB enable clock source control, 1:enable, 0: gated*/
#define XTAL_BIT_EN_XTAL_DRV_AFE  ((u32)0x00000001 << 9)            /*!< R/W/ES 0x0  AFE enable clock source control, 1:enable, 0: gated (for WL AFE PLL)*/
#define XTAL_BIT_EN_XTAL_DRV_RF2  ((u32)0x00000001 << 8)            /*!< R/W/ES 0x0  RF2 enable clock source control, 1:enable, 0: gated (for BT)*/
#define XTAL_BIT_EN_XTAL_DRV_RF1  ((u32)0x00000001 << 7)            /*!< R/W/ES 0x1  RF1 enable clock source control, 1:enable, 0: gated (for WL SYN)*/
#define XTAL_MASK_SC_LPS          ((u32)0x0000007F << 0)            /*!< R/W/ES 0x0000000  0: reduce cap, 1: increase cap. (160fF per unit) [efuse for BT only ] 若有頻偏再修改*/
...
/** @defgroup XTAL_ANAPAR_XTAL_ON_2
  ...
  * @{
  */
#define XTAL_MASK_SEL_TOK_FST          ((u32)0x00000007 << 29)           /*!< R/W/ES 0x0  used for HP2NM or NM2HP xtal起振过程 reg value: cycles / 40MHz / 26MHz 000: 2^10 / 0.025m / 0.05 001: 2^11 / 0.05m / 0.1m 010: 2^12 / 0.1m / 0.2m 011: 2^13 / 0.2m / 0.3m 100: 2^14 / 0.4m / 0.6m 101: 2^15 / 0.8m / 1.2m 110: 2^16 / 1.6m / 2.5m 111: 2^17 / 3.2m / 4.9m xtal mode switch过程 reg value: cycles / 40MHz / 26MHz 000: 2^10 / 0.0125m / 0.025 001: 2^11 / 0.025m / 0.05m 010: 2^12 / 0.05m / 0.1m 011: 2^13 / 0.1m / 0.2m 100: 2^14 / 0.2m / 0.3m 101: 2^15 / 0.4m / 0.6m 110: 2^16 / 0.8m / 1.25m 111: 2^17 / 1.6m / 2.45m*/
#define XTAL_SEL_TOK_FST(x)            (((u32)((x) & 0x00000007) << 29))
#define XTAL_GET_SEL_TOK_FST(x)        ((u32)(((x >> 29) & 0x00000007)))
#define XTAL_BIT_BK_BG                 ((u32)0x00000001 << 17)           /*!< R/W/ES 0x0  RFTOP BG的 BK开关*/
#define XTAL_BIT_EN_TESTMUX_BG         ((u32)0x00000001 << 16)           /*!< R/W/ES 0x0  RFTOP BG的温度参数设定*/
...
#define XTAL_BIT_EN_XTAL_DRV_IQK_BCN   ((u32)0x00000001 << 3)            /*!< R/W/ES 0x1  IQKPLL enable clock source control, 1:enable, 0: gate*/
#define XTAL_BIT_EN_XTAL_DRV_DIGI_DIV2 ((u32)0x00000001 << 2)            /*!< R/W/ES 0x0  IQKPLL enable clock source control, 1:enable, 0: gate*/
#define XTAL_MASK_AAC_MODE             ((u32)0x00000003 << 0)            /*!< R/W/ES 0x01  AAC_MODE for LPS 00: all XOXI cap off 01: cap from XTAL_SC_LPS 10: cap from XTAL_SC_INIT 11: cap from XTAL_SC_XI/XO*/
...
typedef struct {
	...
	__IO uint32_t RSVD0[2]                      ;  /*!< Reserved,  Address offset:0x024-0x02B */
