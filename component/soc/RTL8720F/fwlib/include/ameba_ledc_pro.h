...
_LONG_CALL_ void pseudo_i2c_init(LEDC_PRO_TypeDef *PI2Cx, u32 div);
_LONG_CALL_ void pseudo_i2c_write_ram(LEDC_PRO_TypeDef *PI2Cx, u8 cmd, u8 *data, int len);
_LONG_CALL_ void pseudo_i2c_reset(void);
_LONG_CALL_ void pseudo_i2c_protect(LEDC_PRO_TypeDef *PI2Cx, u32 sequence);
_LONG_CALL_ void pseudo_i2c_set_clkdiv(LEDC_PRO_TypeDef *PI2Cx, u32 div);
_LONG_CALL_ void pseudo_i2c_set_len(LEDC_PRO_TypeDef *PI2Cx, u32 len);
