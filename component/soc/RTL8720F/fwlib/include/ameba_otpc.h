...
/** @defgroup OTPC_OTP_TIME
  ...
  * @{
  */
#define OTPC_MASK_EF_PRER   ((u32)0x000000FF << 18)           /*!< R/W 8'd50  It can be configured for the time to wait in the read state, which helps accelerate continuous read scenarios.The unit is cycle.*/
#define OTPC_EF_PRER(x)     (((u32)((x) & 0x000000FF) << 18))
#define OTPC_GET_EF_PRER(x) ((u32)(((x >> 18) & 0x000000FF)))
