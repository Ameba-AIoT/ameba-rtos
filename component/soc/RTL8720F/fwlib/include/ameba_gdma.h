...
#define GDMA_HANDSHAKE_INTERFACE_SPORT0F0_TX (10) /*!< Handshake interface for SPORT0 FIFO0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT0F0_RX (11) /*!< Handshake interface for SPORT0 FIFO0 RX. */

#define GDMA_HANDSHAKE_INTERFACE_I2C0_TX (12) /*!< Handshake interface for I2C0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C0_RX (13) /*!< Handshake interface for I2C0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_TX (14) /*!< Handshake interface for I2C1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_RX (15) /*!< Handshake interface for I2C1 RX. */

#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_RX (16) /*!< Handshake interface for UART log RX. */
#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_TX (17) /*!< Handshake interface for UART log TX. */
