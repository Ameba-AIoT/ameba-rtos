...
/** @defgroup GDMA_Increment_Mode GDMA Increment Mode
  * @{
  */
#define IncType								        ((u32)0x00000000)  /*!< Address increment after each transfer. */
#define DecType								        ((u32)0x00000001)  /*!< Address decrement after each transfer. */
#define NoChange							        ((u32)0x00000002)  /*!< Address unchanged after each transfer. */
...
/** @defgroup GDMA_Reload_Definition GDMA Reload Definition
  * @{
  */
#define CLEAN_RELOAD_SRC					    ((u32)0x00000001)  /*!< Clean source auto-reload configuration. */
#define CLEAN_RELOAD_DST					    ((u32)0x00000002)  /*!< Clean destination auto-reload configuration. */
...
#define GDMA_INT_STATUS(raw_reg, reg, channel)    (GDMA_INT_GET(raw_reg, channel) && GDMA_INT_GET(reg, channel))  /*!< Check interrupt active status for a channel. */
...
/** @defgroup GDMA_Channel_Status GDMA Channel Status
  * @{
  */
#define GDMA_GET_CH_STATUS(cfg_reg)		(((cfg_reg) & (GDMA_BIT_CFGx_L_DST_PCTL_OVER | GDMA_BIT_CFGx_L_SRC_PCTL_OVER | GDMA_BIT_CFGx_L_INACTIVE)))  /*!< Get GDMA channel inactive and bus protocol status. */
/**
  * @}
  */
...
/** @defgroup GDMA0_HS_HandShake_Interface GDMA0 HS HandShake Interface
  * @{
  */
#define GDMA_HANDSHAKE_INTERFACE_UART0_TX (0)  /*!< GDMA handshake interface for UART0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_UART0_RX (1) /*!< GDMA handshake interface for UART0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_UART1_TX (2) /*!< GDMA handshake interface for UART1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_UART1_RX (3) /*!< GDMA handshake interface for UART1 RX. */
#define GDMA_HANDSHAKE_INTERFACE_UART2_TX (4) /*!< GDMA handshake interface for UART2 TX. */
#define GDMA_HANDSHAKE_INTERFACE_UART2_RX (5) /*!< GDMA handshake interface for UART2 RX. */

#define GDMA_HANDSHAKE_INTERFACE_SPI0_TX (6) /*!< GDMA handshake interface for SPI0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPI0_RX (7) /*!< GDMA handshake interface for SPI0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_SPI1_TX (8) /*!< GDMA handshake interface for SPI1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPI1_RX (9) /*!< GDMA handshake interface for SPI1 RX. */

#define GDMA_HANDSHAKE_INTERFACE_SPORT0F0_TX (10) /*!< GDMA handshake interface for SPORT0 FIFO0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_SPORT0F0_RX (11) /*!< GDMA handshake interface for SPORT0 FIFO0 RX. */

#define GDMA_HANDSHAKE_INTERFACE_I2C0_TX (12) /*!< GDMA handshake interface for I2C0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C0_RX (13) /*!< GDMA handshake interface for I2C0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_TX (14) /*!< GDMA handshake interface for I2C1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_RX (15) /*!< GDMA handshake interface for I2C1 RX. */

#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_RX (16) /*!< GDMA handshake interface for UART log RX. */
#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_TX (17) /*!< GDMA handshake interface for UART log TX. */

#define GDMA_HANDSHAKE_INTERFACE_PWM1_TX (18) /*!< GDMA handshake interface for PWM1 TX. */
/**
  * @}
  */
