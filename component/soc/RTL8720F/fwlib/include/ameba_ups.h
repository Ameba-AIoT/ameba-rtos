...
/** @defgroup TIM_UPS_CTRLx
  * @brief
  * @{
  */
#define TIM_MASK_UPSx_SRC_SEL     ((u32)0x0000000F << 28)           /*!< R/W 0x0  UPS trigger source select: 000: none 001: gpio trigger 010: comparator output 011: audio zcd_0 100: audio zcd_1 101: audio zcd_2*/
#define TIM_UPSx_SRC_SEL(x)       (((u32)((x) & 0x0000000F) << 28))
#define TIM_GET_UPSx_SRC_SEL(x)   ((u32)(((x >> 28) & 0x0000000F)))
#define TIM_BIT_UPSx_OUT_PWM_TRIG ((u32)0x00000001 << 21)           /*!< R/W 0x0  Enable for output trigger to pwm*/
#define TIM_BIT_UPSx_OUT_TIM_EN   ((u32)0x00000001 << 20)           /*!< R/W 0x0  Enable for output en signal to basic timer*/
#define TIM_BIT_UPSx_IN_TIM_OF    ((u32)0x00000001 << 19)           /*!< R/W 0x0  Enable for basic timer overflow input*/
#define TIM_BIT_UPSx_RVS_EN       ((u32)0x00000001 << 18)           /*!< R/W 0x0  Invert polarity for UPS input 0: posedge polarity 1: negedge polarity*/
#define TIM_MASK_UPSx_DBC_CNT     ((u32)0x0000FFFF << 2)            /*!< R/W 0x0  Debounce count for UPS funciton*/
#define TIM_UPSx_DBC_CNT(x)       (((u32)((x) & 0x0000FFFF) << 2))
#define TIM_GET_UPSx_DBC_CNT(x)   ((u32)(((x >> 2) & 0x0000FFFF)))
/** @} */
...
/** @defgroup UREG_LSYS_UPS_CTRLx addr offset
  * @{
  */
