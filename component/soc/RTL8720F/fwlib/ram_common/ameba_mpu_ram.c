...
/**
  ...
  * @param  region_num: where x < MPU_MAX_REGION
...
/**
  ...
  * @param  entry_index: KM4_NS: 0~7, KM4TZ_NS: 0~7; KM4TZ_S: 0~7.
  * @retval   None
  */
...
/**
  ...
  * @param  NA.
  * @retval value: mpu entry index KM4_NS: 0~7, KM4TZ_NS: 0~7; KM4TZ_S: 0~7, -1 is fail.
  */
