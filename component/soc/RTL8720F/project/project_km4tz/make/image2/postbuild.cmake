...
set(t_USER_CUSTOM_LOG_PREFIX "${c_MCU_PROJECT_NAME}_IMG2_POSTBUILD")
...
if ((NOT CONFIG_WHC_INTF_IPC) AND CONFIG_WHC_DEV)
    ...
    ameba_axf2bin_fw_pack(
        ...
        p_FULLMAC_IMAGE
            ${c_SDK_IMAGE_TARGET_DIR}/fullmac_ram_1_prepend.bin
    )
    ...
    # FW_2 (combined km4tz + km4ns) is assembled in project/postbuild.cmake using c_IMAGE2_ALL_FILES which already contains both image2_all.bin
