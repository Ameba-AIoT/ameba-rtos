...
set(t_USER_CUSTOM_LOG_PREFIX "KM4TZ_IMG1_POSTBUILD")
...
if (FINAL_IMAGE_DIR)
    set(KM4TZ_BOOT_ALL ${c_SDK_IMAGE_TARGET_DIR}/${c_BOOT_BINARY_NAME})
    if(EXISTS ${KM4TZ_BOOT_ALL})
        ameba_execute_process(
            COMMAND ${CMAKE_COMMAND} -E copy ${KM4TZ_BOOT_ALL} ${FINAL_IMAGE_DIR}
        )
    endif()
endif()
