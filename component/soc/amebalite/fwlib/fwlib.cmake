...
if(${c_CURRENT_IMAGE_TYPE} STREQUAL "image1")
    ...
    ameba_list_append(private_sources
        ram_${c_MCU_TYPE}/ameba_flashclk.c
        ram_${c_MCU_TYPE}/ameba_arch.c
...
elseif(${c_CURRENT_IMAGE_TYPE} STREQUAL "image2")
    ameba_list_append(private_sources
        ...
        ram_${c_MCU_TYPE}/ameba_app_start.c
        ram_${c_MCU_TYPE}/ameba_arch.c
        ram_${c_MCU_TYPE}/ameba_npcap.c
        ram_${c_MCU_TYPE}/ameba_npcdsp.c
        ram_${c_MCU_TYPE}/ameba_pmc_ram.c
        ram_common/ameba_ipc_ram.c
    ...
    if("${c_MCU_PROJECT_NAME}" STREQUAL "km4")
        ameba_list_append(private_sources
            ...
            ram_common/ameba_vad_handler.c
            ram_common/ameba_clk.c
            ram_common/ameba_fault_handle.c
        )
    elseif("${c_MCU_PROJECT_NAME}" STREQUAL "kr4")
        ameba_list_append(private_sources
            ram_${c_MCU_TYPE}/ameba_plic_ram.c
            ram_${c_MCU_TYPE}/ameba_pinmap.c
            ram_common/ameba_sram_swap.c
        )
    endif()
endif()
