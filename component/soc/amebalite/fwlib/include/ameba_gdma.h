...
/**
  ...
  */
typedef struct {
	u8	GDMA_Index;                   /*!< Specifies the GDMA index. This parameter can be the value 0.*/

	u8	GDMA_ChNum;                   /*!< Specifies the GDMA channel number. This parameter can be the value 0 ~ 7.*/
	...
	u32	GDMA_SrcHandshakeInterface;   /*!< Specifies the GDMA hardware handshaking interface for the source peripheral of a GDMA channel.
							                           This parameter can be a value of @ref GDMA0_HS_HandShake_Interface */

	u32	GDMA_DstHandshakeInterface;   /*!< Specifies the GDMA hardware handshaking interface for the destination peripheral of a GDMA channel.
							                           This parameter can be a value of @ref GDMA0_HS_HandShake_Interface */

	u32	MuliBlockCunt;                /*!< Specifies the GDMA Multi-block counter. This parameter is used in multi-block transmission.*/

	u32	MaxMuliBlock;                 /*!< Specifies the GDMA Max block number in Multi-block transmission. This parameter is used in multi-block transmission.*/
...
/** @defgroup GDMA_Index_Channel_Definition GDMA Index Channel Definition
  * @{
  */
#define MAX_GDMA_INDX		              (0) /*!< Maximum GDMA controller index. */
...
/** @brief Check if GDMA transfer direction is valid. */
