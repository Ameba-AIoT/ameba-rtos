...
#define DBGT_MASK_CLKSEL         ((u32)0x00000007 << 1)          /*!<R/W 0h  Clock source selection 2~7: Reserved 1: Select 32K as clock source. 0: Select Xtal as clock source. */
 ...
 * @brief debugtimer atom read increase register
 * @{
 **/
...
/** @defgroup DBGT_ATOM
 * @brief debugtimer atom register
 * @{
 **/
 ...
 * @brief debugtimer scratch register
 * @{
 **/
#define DBGT_MASK_SCRATCH        ((u32)0xFFFFFFFF << 0)          /*!<R/W 0h  Reserved for users */
...
typedef struct {
	...
	__IO uint32_t DBGT_CRV;                               /*!< DEBUGTIMER COUNT REGISTER,  Address offset: 0x004 */
	__IO uint32_t DBGT_ATOM_INC;                          /*!< DEBUGTIMER ATOM READ INCREASE REGISTER,  Address offset: 0x008 */
	__IO uint32_t DBGT_ATOM;                              /*!< DEBUGTIMER ATOM REGISTER,  Address offset: 0x00C */
