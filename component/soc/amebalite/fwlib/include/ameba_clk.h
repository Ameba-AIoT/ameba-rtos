...
#define PLL_393P216M	((u32)393216000)	/* generate 98.304M for I2S CPUPLL */
#define PLL_491P520M	((u32)491520000)	/* generate 98.304M for I2S DSPPLL */
#define PLL_361P2672M	((u32)361267200)	/* generate 45.1584M for I2S CPUPLL */
#define PLL_496P7424M	((u32)496742400)	/* generate 45.1584M for I2S DSPPLL */
...
/** @defgroup PLL_Exported_Functions PLL Exported Functions
  * @{
  */
_LONG_CALL_ void PLL_I2S_Div(u32 div);
_LONG_CALL_ void PLL_I2S_98P304M(u32 pll_sel, u32 NewState);
_LONG_CALL_ void PLL_I2S_45P158M(u32 pll_sel, u32 NewState);
