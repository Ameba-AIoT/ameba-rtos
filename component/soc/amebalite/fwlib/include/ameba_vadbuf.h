...
/** @defgroup VAD_BUF_Register_Definitions VAD_BUF Register Definitions
 * @{
 *****************************************************************************/

/** @defgroup VAD_BUF_VAD_BUF_CTRL0
 * @brief
 * @{
 **/
...
/** @defgroup VAD_BUF_VAD_ASSERT_W_SRAM_ADDRSS
 * @brief
 * @{
 **/
...
/** @defgroup VAD_BUF_VAD_SECURE_SEL
 * @brief
 * @{
 **/
...
/** @defgroup VAD_BUF_BUF_CTRL_W_ADDRESS
 * @brief
 * @{
 **/
...
/** @defgroup VAD_BUF_Exported_Types VAD_BUF Exported Types
  * @{
*****************************************************************************/


/**
 * @brief VAD_BUF Register Declaration
 *****************************************************************************/
typedef struct {
