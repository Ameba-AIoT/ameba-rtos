...
#define RUART_BIT_OUT1                    ((u32)0x00000001 << 2)          /*!<R/W 0x0  Auxiliary output 1 Bit[3] affects the OUT1_ output in a manner identical to that described above set to 0 In loopback mode, connected to Ring Indicator (RI) */
...
#define RUART_BIT_DMA_MODE                ((u32)0x00000001 << 3)          /*!<R/W 0x0  Support dma mode (cooperating with DW DDMA in the data path) */
...
/** @defgroup UART_FIFO_Size_UART012
  * @{
  */
...
/** @defgroup UART_FIFO_Size_UART3
  * @{
  */
#define UART3_BT_TX_FIFO_SIZE	32
#define UART3_BT_RX_FIFO_SIZE	32
/**
  * @}
  */
