...
#define RSIP_BIT_KEY_SOURCE           ((u32)0x00000001 << 11)          /*!<R   Indicates the key source 0: from dedicated key port (only supporting this configuration currently) 1: from APB register */
...
#define RSIP_MASK_TAG_SIZE            ((u32)0x00000003 << 0)          /*!<R/W 0x0  The size of the tag will affect the length of each tag command. 0: 32 bits 1: 64 bits 2: 128bits */
 ...
 * @{
 **/
#define RSIP_MASK_LOCK                ((u32)0x000000FF << 0)          /*!<W 0x0  When this field is set to 0xDC, all registers except clr_intr and Maintenance are not allowed to be written. */
