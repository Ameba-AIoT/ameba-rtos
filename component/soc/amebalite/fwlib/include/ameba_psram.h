...
/** @defgroup PSRAMP_Latency_Type
  * @{
  */
#define PSRAMC_RD_FIX_LATENCY	0x0 //spic rd, 0 for variable, 1 for fix
#define PSRAMC_WR_FIX_LATENCY	0x1 //spic er, 0 for variable, 1 for fix
#define DEVICE_FIX_LATENCY		0x1 //device 0 for variable, 1 for fix
...
#define PSPHY_RFIFO_READY_DELAY_FIX		0x7
/**
  * @}
  */
