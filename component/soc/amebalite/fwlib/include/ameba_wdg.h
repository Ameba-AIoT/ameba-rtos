...
#define WDG_BIT_LPEN     ((u32)0x00000001 << 24)          /*!<R/WE 0h  Low power enable 0: WDG will be gating when system goes into sleep mode 1: WDG keeps running when system goes into sleep mode */
...
/** @defgroup WDG_RLR
 * @brief WDG Reload Register
 * @{
 **/
#define WDG_MASK_PRER    ((u32)0x000000FF << 16)          /*!<R/WE 63h  Prescaler counter, configuration only allowed before watchdog enable WDG: 0x63 System WDG: 0x1F */
...
typedef struct {
	...
	__IO uint32_t WDG_RLR;                                /*!< WDG RELOAD REGISTER,  Address offset: 0x008 */
	__IO uint32_t WDG_WINR;                               /*!< WDG WINDOW REGISTER,  Address offset: 0x00C */
	__IO uint32_t IWDG_DUMMY;                             /*!< DUMMY REGISTER,  Address offset: 0x010 */
} WDG_TypeDef;
/** @} */
/* AUTO_GEN_END */
