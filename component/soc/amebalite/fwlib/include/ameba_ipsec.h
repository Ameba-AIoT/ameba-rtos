...
#define IPSEC_MASK_MST_BAD_SEL                ((u32)0x00000003 << 28)          /*!<R/W 0  <For debug port> select Lexra master data bus (optional) 2'd0: mst_ipsec_bad[07:00] 2'd1: mst_ipsec_bad[15:08] 2'd2: mst_ipsec_bad[23:16] 2'd3: mst_ipsec_bad[31:24] */
...
#define IPSEC_MASK_DMA_BURST_LENGTH           ((u32)0x0000003F << 16)          /*!<R/W 0x10  Set DMA burst length The maximum setting length is 16 bursts, and the minimum setting length is 1 burst. Note: If all bits are zero (6'd0), it means maximum burst size or undefined burst size. */
...
typedef struct {
	...
	__I  uint32_t ENG_DBG;                                /*!< DEBUG REGISTER,  Address offset: 0x040 */
	__I  uint32_t DMA_LX_DBG;                             /*!< LX BUS DEBUG REGISTER,  Address offset: 0x044 */
	__I  uint32_t DMA_RX_DBG;                             /*!< DMA RX DEBUG REGISTER,  Address offset: 0x048 */
	__I  uint32_t DMA_TX_DBG;                             /*!< DMA TX DEBUG REGISTER,  Address offset: 0x04C */
