...
#define CT_MASK_AFIFO_RD_CH_NUM          ((u32)0x0000000F << 12)          /*!<RP 0h  Read data from raw code FIFO channel number */
#define CT_AFIFO_RD_CH_NUM(x)            (((u32)((x) & 0x0000000F) << 12))
#define CT_GET_AFIFO_RD_CH_NUM(x)        ((u32)(((x >> 12) & 0x0000000F)))
#define CT_MASK_AFIFO_RD_DATA            ((u32)0x00000FFF << 0)          /*!<RP 0h  Read data from raw code FIFO data */
...
/** @defgroup CapTouch_Chn_Pad_Selection
  * @{
  */
#define CTC_CH0_PIN						(_PB_5)
#define CTC_CH1_PIN						(_PB_4)
#define CTC_CH2_PIN						(_PB_3)
#define CTC_CH3_PIN						(_PB_2)
#define CTC_CH4_PIN						(_PB_1)
#define CTC_CH5_PIN						(_PA_31)
#define CTC_CH6_PIN						(_PA_30)
#define CTC_CH7_PIN						(_PA_29)
#define CTC_CH8_PIN						(_PA_28)
/**
  * @}
  */
