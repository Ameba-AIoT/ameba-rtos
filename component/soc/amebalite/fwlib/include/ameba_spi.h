...
typedef struct {
	...
	__IO uint32_t RSVD1[2];                               /*!<  Reserved,  Address offset:0xF4-0xF8 */
	__IO uint32_t SPI_DUMMY;                              /*!<  Register,  Address offset: 0xFC */
} SPI_TypeDef;
/** @} */
/* AUTO_GEN_END */
...
/* SPI_Exported_Normal_Functions SPI Exported Normal Functions */
