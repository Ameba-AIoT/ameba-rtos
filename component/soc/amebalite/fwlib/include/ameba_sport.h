 ...
 * @{
 **/
#define SP_MASK_REG_MUX                ((u32)0xFFFFFFFF << 0)          /*!<R/W 0xFFFFFFFF  Mux of register write with different base address of the same SPORT. This register can be set as different value with four different base address in one SPORT, but other registers share the same value with four different base addresses in one SPORT. */
...
#define SP_MASK_SEL_I2S_RX_CH          ((u32)0x00000003 << 28)          /*!<R/W 0x0  ADC path 2’b00: L/R 2’b01: R/L 2’b10: L/L 2’b11: R/R */
#define SP_SEL_I2S_RX_CH(x)            (((u32)((x) & 0x00000003) << 28))
#define SP_GET_SEL_I2S_RX_CH(x)        ((u32)(((x >> 28) & 0x00000003)))
#define SP_MASK_SEL_I2S_TX_CH          ((u32)0x00000003 << 26)          /*!<R/W 0x0  DAC path 2’b00: L/R 2’b01: R/L 2’b10: L/L 2’b11: R/R */
...
#define SP_BIT_RX_FIFO_0_REG_0_EN      ((u32)0x00000001 << 28)          /*!<R/W 1  1’b1: Enable first two channel of RX_FIFO_0. Disable 0x0008[28] ~ 0x0008[31] at the same time to reset Rx FIFO. */
...
#define SP_BIT_TX_FIFO_0_REG_0_EN      ((u32)0x00000001 << 24)          /*!<R/W 1  1’b1: Enable first two channel of TX_FIFO_0. Disable 0x0008[24] ~ 0x0008[27] at the same time to reset Tx FIFO. */
 ...
 * @{
 **/
#define SP_MASK_RX_BCLK_DIV_RATIO      ((u32)0x000000FF << 24)          /*!<R/W 0x3F  Rx bclk even-bit integer divider. Used in “mode_40mhz” to set as 1’b1. (rx_bclk_div_ratio + 1) is the number of “sck_out” cycles within a “ws_out_rx” cycle (1/fs). Default of (rx_bclk_div_ratio + 1) is 64. Set as 64 – 1 = 63. Only odd number supported. Maximum is 255. */
...
#define SP_MASK_DUMMY1                 ((u32)0x00000003 << 14)          /*!<R/W 0x0  Dummy */
...
#define SP_MASK_DUMMY2                 ((u32)0x00000003 << 6)          /*!<R/W 0x0  Dummy */
...
#define SP_BIT_DUMMY3                  ((u32)0x00000001 << 27)          /*!<R/W 0  Dummy */
...
#define SP_BIT_DUMMY4                  ((u32)0x00000001 << 15)          /*!<R/W 0  Dummy */
...
#define SP_BIT_DUMMY5                  ((u32)0x00000001 << 4)          /*!<R/W 0  Dummy */
...
#define SP_MASK_DUMMY6                 ((u32)0x00000003 << 27)          /*!<R/W 0x0  Dummy */
#define SP_DUMMY6(x)                   (((u32)((x) & 0x00000003) << 27))
#define SP_GET_DUMMY6(x)               ((u32)(((x >> 27) & 0x00000003)))
#define SP_MASK_TX_SPORT_COMPARE_VAL   ((u32)0x07FFFFFF << 0)          /*!<R/W 0x40  X = (tx_sport_compare_val). When counter equal X, SPORT will send tx_sport_interrupt to DSP. FW should take care X={32~8191}. */
...
#define SP_MASK_DUMMY7                 ((u32)0x000003FF << 16)          /*!<R/W 0x0  Dummy */
 ...
 * @{
 **/
#define SP_MASK_DUMMY8                 ((u32)0x00000007 << 29)          /*!<R/W 0x0  Dummy */
...
#define SP_MASK_DUMMY9                 ((u32)0x00000007 << 21)          /*!<R/W 0x0  Dummy */
...
#define SP_MASK_DUMMY10                ((u32)0x00000007 << 13)          /*!<R/W 0x0  Dummy */
...
#define SP_MASK_DUMMY11                ((u32)0x00000007 << 5)          /*!<R/W 0x0  Dummy */
 ...
 * @{
 **/
#define SP_MASK_DUMMY12                ((u32)0x00000007 << 29)          /*!<R/W 0x0  Dummy */
...
#define SP_MASK_DUMMY13                ((u32)0x00000007 << 21)          /*!<R/W 0x0  Dummy */
...
#define SP_MASK_DUMMY14                ((u32)0x00000007 << 13)          /*!<R/W 0x0  Dummy */
...
#define SP_MASK_DUMMY15                ((u32)0x00000007 << 5)          /*!<R/W 0x0  Dummy */
 ...
 * @{
 **/
#define SP_BIT_CLR_RX_SPORT_RDY        ((u32)0x00000001 << 31)          /*!<WA0 0  X = (tx_sport_compare_val). When counter equals X, SPORT will send tx_sport_interrupt to DSP. FW should take care X={32~8191}. */
#define SP_BIT_EN_RX_SPORT_INTERRUPT   ((u32)0x00000001 << 30)          /*!<R/W 0  Enable Rx SPORT interrupt */
#define SP_MASK_DUMMY16                ((u32)0x00000007 << 27)          /*!<R/W 0x0  Dummy */
#define SP_DUMMY16(x)                  (((u32)((x) & 0x00000007) << 27))
#define SP_GET_DUMMY16(x)              ((u32)(((x >> 27) & 0x00000007)))
#define SP_MASK_RX_SPORT_COMPARE_VAL   ((u32)0x07FFFFFF << 0)          /*!<R/W 0x40  X = (rx_sport_compare_val). When counter equals X, SPORT will send rx_sport_interrupt to DSP. FW should take care X={32~8191}. */
 ...
 * @{
 **/
#define SP_MASK_TX_FIFO_0_WR_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<W 0x0  Tx FIFO 0 write address */
 ...
 * @{
 **/
#define SP_MASK_RX_FIFO_0_RD_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  Rx FIFO 0 read address */
 ...
 * @{
 **/
#define SP_MASK_TX_FIFO_1_WR_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<W 0x0  Tx FIFO 1 write address */
 ...
 * @{
 **/
#define SP_MASK_RX_FIFO_1_RD_ADDR      ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  Rx FIFO 1 read address */
...
_LONG_CALL_ void AUDIO_SP_TXDirectRegSel(u32 index, u32 src_index, u32 reg_chn, u32 direct_in_chn);
