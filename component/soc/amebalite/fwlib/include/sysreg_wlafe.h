...
#define WLAFE_BIT_WLRFC_RETAIN_EN            ((u32)0x00000001 << 2)          /*!<R/W 0  1: backup(save) 0: restore this reg is usleless in lite,because no retention dff used in rfc */
...
#define WLAFE_BASE ((WLAFE_TypeDef *) (0x4100C480))
