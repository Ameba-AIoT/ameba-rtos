...
#define I2C_BIT_MASTER_MODE              ((u32)0x00000001 << 0)          /*!<R/W 0x0  This bit controls whether the I2C master is enabled. *0: master is disabled *1: master is enabled */
/** @} */
 ...
 * @brief I2C Sample Delay Register
 * @{
 **/
#define I2C_MASK_IC_OUT_SMP_DLY          ((u32)0x00000007 << 0)          /*!<R/W 0x2  Delay cycles for sample of master drived SCL value. The sample of master drived SCL is used for slave stretch. Slave stretch is valid when master drive SCL High, but slave drives SCL low. Valid value of IC_OUT_SMP_DLY is 0-7. Indicate a delay of 1-8 cycles. */
...
typedef struct {
	...
	__IO uint32_t IC_OUT_SMP_DLY;                         /*!< I2C SAMPLE DELAY REGISTER,  Address offset: 0x0B4 */
...
/** @defgroup I2C_Clock I2C Clock
  ...
  */
/* 120M */
#define I2C0_1_IPCLK			PLL_GetHBUSClk() /*!< I2C0/I2C1 IP clock frequency in Hz. */
/**
  * @}
  */
