...
/** @defgroup SPIC_Clock_Source_define
  * @{
  */
#define BIT_LSYS_CKSL_SPIC_DSPPLL		0x00
#define BIT_LSYS_CKSL_SPIC_CPUPLL		0x01
#define BIT_LSYS_CKSL_SPIC_LBUS			0x02
/**
  * @}
  */
...
/** @defgroup PLFM_Clock_Source_define
  * @{
  */
#define CKSL_PLFM_XTAL				0x00
#define CKSL_PLFM_CPUPLL			0x10
#define CKSL_PLFM_DSPPLL			0x11
/**
  * @}
  */
...
#define UART_RX_CLK_XTAL_20M	((u32)0x00000002) //(20M)
/**
  * @}
  */
...
#define LOGUART_CLK_OSC_LP		((u32)0x00000001) //(2M)
#define LOGUART_CLK_XTAL_20M		((u32)0x00000002) //(20M)
/**
  * @}
  */
...
_LONG_CALL_ void RCC_PeriphClockSource_SPORT(u32 Source);
