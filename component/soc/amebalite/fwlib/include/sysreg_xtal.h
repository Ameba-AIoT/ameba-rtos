...
#define XTAL_BIT_EN_XTAL_DRV_DIGI_DIV2   ((u32)0x00000001 << 2)          /*!<R/W 0  DIGI_DIV2 enable clock source control, 1:enable, 0: gated */
...
typedef struct {
	...
	__IO uint32_t XTAL_DUMMY;                             /*!<  Register,  Address offset: 0x03C */
} XTAL_TypeDef;

#define XTAL_BASE ((XTAL_TypeDef *) (0x4100C400))
