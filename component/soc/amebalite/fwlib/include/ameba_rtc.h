...
#define RTC_BIT_DOVTHIE     ((u32)0x00000001 << 16)          /*!<R/W 0  Day over threshold interrupt enable * 0: Day over threshold interrupt is disabled. * 1: Day over threshold interrupt is enabled. */
#define RTC_DOVTHIE(x)      ((u32)(((x) & 0x00000001) << 16))
#define RTC_BIT_WUTIE       ((u32)0x00000001 << 14)          /*!<R/W 0  Wakeup timer interrupt enable * 0: Wakeup timer interrupt is disabled. * 1: Wakeup timer interrupt is enabled. */
#define RTC_WUTIE(x)        ((u32)(((x) & 0x00000001) << 14))
#define RTC_BIT_ALMIE       ((u32)0x00000001 << 12)          /*!<R/W 0  Alarm interrupt enable * 0: Alarm interrupt is disabled. * 1: Alarm interrupt is enabled. */
#define RTC_ALMIE(x)        ((u32)(((x) & 0x00000001) << 12))
#define RTC_BIT_WUTE        ((u32)0x00000001 << 10)          /*!<R/W 0  Wakeup timer enable * 0: Wakeup timer is disabled. * 1: Wakeup timer is enabled. */
#define RTC_WUTE(x)         ((u32)(((x) & 0x00000001) << 10))
#define RTC_BIT_ALME        ((u32)0x00000001 << 8)          /*!<R/W 0  Alarm enable * 0: Alarm is disabled. * 1: Alarm is enabled. */
...
#define RTC_MASK_OSEL       ((u32)0x00000003 << 5)          /*!<R/W 0  Output selection. These bits are used to select the flag to be routed to RTC_OUT output. * 00: Output is disabled. * 01: Alarm output is enabled. * 10: Clock output is clk_spre (default: 1Hz) * 11: Clock output is clk_apre (default: 256Hz) */
...
#define RTC_BIT_DCE         ((u32)0x00000001 << 15)          /*!<R/W 0  Digital calibration enable * 0: Digital calibration is disabled. * 1: Digital calibration is enabled. */
...
/** @defgroup RTC_WPR
 * @brief RTC Write Protect Register
 * @{
 **/
...
typedef struct {
	...
	__IO uint32_t RTC_CR;                                 /*!< RTC CTRL REGISTER,  Address offset: 0x004 */
	__IO uint32_t RTC_ISR;                                /*!< RTC INITIALIZATION AND STATUS REGISTER,  Address offset: 0x008 */
	...
	__IO uint32_t RTC_WPR;                                /*!< RTC WRITE PROTECT REGISTER,  Address offset: 0x01C */
