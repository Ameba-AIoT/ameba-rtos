...
static const PinMap PinMap_ADC[] = {
	{AD_0,			ADC_CH0,		PINMUX_FUNCTION_AUXIN},
	{AD_1,			ADC_CH1,		PINMUX_FUNCTION_AUXIN},
	{AD_2,			ADC_CH2,		PINMUX_FUNCTION_AUXIN},
	{AD_3,			ADC_CH3,		PINMUX_FUNCTION_AUXIN},
	{AD_4,			ADC_CH4,		PINMUX_FUNCTION_AUXIN},
	{AD_5,			ADC_CH5,		PINMUX_FUNCTION_AUXIN},
	{NC,			NC,				0}
};
/* end of group  */
...
void analogin_init(analogin_t *obj, PinName pin)
{
	...
	/* Initialize ADC pin */
	Pinmux_Config(obj->adc_pin, PINMUX_FUNCTION_AUXIN);
	PAD_PullCtrl(obj->adc_pin, PullNone);
	PAD_SleepPullCtrl(obj->adc_pin, PullNone);
