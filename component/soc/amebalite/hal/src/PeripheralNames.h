...
/** @addtogroup MBED_UART_Enumeration_Type Enumeration Type
  * @{
  */
...
/** @addtogroup MBED_ADC_Enumeration_Type Enumeration Type
  * @{
  */
...
/** @addtogroup MBED_I2C_Enumeration_Type Enumeration Type
  * @{
  */
typedef enum {
#ifdef __cplusplus
...
/** @addtogroup MBED_PWM_Enumeration_Type Enumeration Type
  * @{
  */
typedef enum {
	PWM_0 = 1,
...
/** @addtogroup MBED_WDG_Enumeration_Type Enumeration Type
  * @{
  */
typedef enum {
	IWDG = 0,
