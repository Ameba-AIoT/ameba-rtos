...
#define GDMA_HANDSHAKE_INTERFACE_I2C0_TX		  (16) /*!< Handshake interface for I2C0 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C0_RX		  (17) /*!< Handshake interface for I2C0 RX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_TX		  (18) /*!< Handshake interface for I2C1 TX. */
#define GDMA_HANDSHAKE_INTERFACE_I2C1_RX		  (19) /*!< Handshake interface for I2C1 RX. */
...
#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_RX	(22) /*!< Handshake interface for UART log RX. */
#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_TX	(23) /*!< Handshake interface for UART log TX. */

#define GDMA_HANDSHAKE_INTERFACE_UART3_TX		  (24) /*!< Handshake interface for UART3 TX. */
#define GDMA_HANDSHAKE_INTERFACE_UART3_RX		  (25) /*!< Handshake interface for UART3 RX. */
