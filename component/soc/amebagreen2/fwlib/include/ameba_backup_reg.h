...
#define BKUP_BIT_UARTBURN_DEBUG				BIT(15)	/*!<  this is SW set bit before reboot, for uart download debug */

#define BKUP_MASK_UARTBURN_BOOT				((u32)0x0000007F << 8)
#define BKUP_UARTBURN_TO_PATTERN			((u32)(0x35 << 8))
#define BKUP_BIT_UARTBURN_BOOT				((u32)(0x5A << 8))
