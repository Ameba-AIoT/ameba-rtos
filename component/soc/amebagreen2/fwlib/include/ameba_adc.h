...
#define ADC_CH14					((u8)0x0E)  /*!< ADC channel 14 index (internal). */
#define ADC_DUMMY_CYCLE				((u8)0x0F)  /*!< ADC dummy cycle channel. */
#define ADC_CH_NUM					(12)  /*!< Total number of ADC channels. */
#define ADC_EXT_CH_NUM				(8)  /*!< Number of external ADC channels. */
...
/** @defgroup ADC_Chn_Pad_Selection ADC Channel Pad Selection
  * @{
  */
#define ADC_CH0_PIN					(_PA_20)  /*!< Pin mapping for ADC channel 0. */
#define ADC_CH1_PIN					(_PA_19)  /*!< Pin mapping for ADC channel 1. */
#define ADC_CH2_PIN					(_PA_18)  /*!< Pin mapping for ADC channel 2. */
#define ADC_CH3_PIN					(_PA_17)  /*!< Pin mapping for ADC channel 3. */
#define ADC_CH4_PIN					(_PA_15)  /*!< Pin mapping for ADC channel 4. */
#define ADC_CH5_PIN					(_PA_14)  /*!< Pin mapping for ADC channel 5. */
#define ADC_CH6_PIN					(_PA_13)  /*!< Pin mapping for ADC channel 6. */
#define ADC_CH7_PIN					(_PA_12)  /*!< Pin mapping for ADC channel 7. */
/**
  * @}
  */
...
#define VREF_SEL_ADDR			0x7EC  /*!< OTP address for voltage reference selection. */
#define INTER_R_ADDR			0x7ED  /*!< OTP address for internal resistance calibration. */
/**
  * @}
  */
