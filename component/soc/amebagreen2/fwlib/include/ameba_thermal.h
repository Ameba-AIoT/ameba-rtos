...
/** @defgroup TM_CALIB_VAL TM Calibration Value
  * @{
  */
#define TM_CALIB_GAIN		((u32)0x834D000)   /*!< Default calibration gain value for thermal meter. */
#define TM_CALIB_OFFSET	((u32)0x370E00)   /*!< Default calibration offset value for thermal meter. */
