...
/** @defgroup TIM_Peripheral_Count TIM Peripheral Count
  * @{
  */
#define TimerNum	9   /*!< Total number of TIM peripherals. */
/** @} */
...
#define PWM_TIMER_NUM 4   /*!< Number of PWM timer instances available. */
...
#define PWM_CHAN_MAX			4   /*!< Maximum number of PWM output channels per timer. */
