...
if (CONFIG_WHC_INTF_SDIO)
    if (CONFIG_MP_INCLUDED)
        ameba_execute_process(COMMAND ${CMAKE_COMMAND} -E rename ${FINAL_IMAGE_DIR}/km4tz_fullmac_img_1.bin ${FINAL_IMAGE_DIR}/RTL8851FS_FW_1_MP.bin)
        ameba_execute_process(COMMAND ${CMAKE_COMMAND} -E rename ${FINAL_IMAGE_DIR}/km4tz_fullmac_img_2.bin ${FINAL_IMAGE_DIR}/RTL8851FS_FW_2_MP.bin)
    else()
...
elseif (CONFIG_WHC_INTF_USB)
    if (CONFIG_MP_INCLUDED)
        ameba_execute_process(COMMAND ${CMAKE_COMMAND} -E rename ${FINAL_IMAGE_DIR}/km4tz_fullmac_img_1.bin ${FINAL_IMAGE_DIR}/RTL8851FU_FW_1_MP.bin)
        ameba_execute_process(COMMAND ${CMAKE_COMMAND} -E rename ${FINAL_IMAGE_DIR}/km4tz_fullmac_img_2.bin ${FINAL_IMAGE_DIR}/RTL8851FU_FW_2_MP.bin)
    else()
