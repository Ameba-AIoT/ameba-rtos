...
if(${SUITE} STREQUAL "IPC")
	...
	list(APPEND PAL_SRC_C_NSPE
		...
		${PSA_ROOT_DIR}/platform/drivers/uart/rtk/pal_uart.c
		${PSA_ROOT_DIR}/platform/drivers/watchdog/rtk/pal_wd_rtk.c
	)
endif()
...
list(APPEND PAL_DRIVER_INCLUDE_PATHS
	${PSA_ROOT_DIR}/platform/drivers/uart/rtk
	${PSA_ROOT_DIR}/platform/drivers/watchdog/rtk
)
