...
void FLASH_TxData(u32 StartAddr, u32 DataPhaseLen, const u8 *pData);
...
void FLASH_WriteStream(u32 address, u32 len, const u8 *pbuf)
{
...
#else
	FLASH_WriteStream(addr, cnt, data);
#endif
