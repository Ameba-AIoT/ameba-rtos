...
#error "all requests shall be handled in one iteration"
#endif
#endif
...
uint8_t fs_ctx_is_its(its_flash_fs_ctx_t *fs_ctx)
{
#ifndef PS_ENCRYPTION
#error PS_ENCRYPTION Shall Enable for ITS GCM
#endif
	return fs_ctx == &fs_ctx_its;
}
