...
extern void SOCPS_Core_Backup(void);
...
static psa_status_t platform_sp_pmc_bkup_psa_api(const psa_msg_t *msg)
{
    (void)msg; /* unused parameter */
...
psa_status_t tfm_platform_service_sfn(const psa_msg_t *msg)
{
    ...
    case TFM_PLATFORM_API_ID_PMC_BKUP:
        return platform_sp_pmc_bkup_psa_api(msg);
    default:
