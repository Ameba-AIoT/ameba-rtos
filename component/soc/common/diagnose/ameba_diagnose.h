...
#elif defined(CONFIG_AMEBAGREEN2) || defined(CONFIG_AMEBAL2) || defined(CONFIG_AMEBASMART) || defined(CONFIG_AMEBAPRO3) || (defined(CONFIG_RTL8720F) || defined(CONFIG_RLE1509))
