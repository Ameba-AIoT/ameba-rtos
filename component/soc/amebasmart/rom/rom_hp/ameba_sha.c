...
/**
  ...
  * @param    msglen 	: input buffer length, len < 128*1024 bytes
...
int rtl_crypto_sha1_update_rom(IN const u8 *message, IN const u32 msglen, hw_sha_context *ctx)
{
	...
	assert_param((pIE != NULL) && (pIE->isInit == TRUE));
