...
/**
  ...
  *  @param PinName: Value of @ref PINMUX_Pin_Name_definitions.
  *  @param PullType: Pull type for the pin. This parameter can be one of the following values:
...
/**
  ...
  *    HW will switch to the sleep pull ctrl automatically when system enters sleep or deepsleep mode.
  *    HW will switch to function pull ctrl automatically when system wakes up from sleep mode.
  *  @param PinName: Value of @ref PINMUX_Pin_Name_definitions.
  *  @param PullType: Pull type for the pin. This parameter can be one of the following values
  *		 @arg GPIO_PuPd_NOPULL
  *		 @arg GPIO_PuPd_DOWN
...
/**
  ...
  *  @param PinName: Value of @ref PINMUX_Pin_Name_definitions.
  *  @param PullType: Pull type for the pin. This parameter can be one of the following values:
  *		 @arg PAD_Resistor_LARGE
  *		 @arg PAD_Resistor_SMALL
  *  @retval None
...
/* Exported functions --------------------------------------------------------*/
/** @addtogroup PINMUX_Exported_Functions PINMUX Exported Functions
  * @{
  */
...
/**
  ...
  *  @retval None
  *  @NOTE: when multiplexing share_swd pins to other functions. this function must be called.
  */
HAL_ROM_TEXT_SECTION
