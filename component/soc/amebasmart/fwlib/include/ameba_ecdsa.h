...
/** @defgroup ENG_X_Px
  ...
  * @{
  */
#define ECDSA_MASK_ENG_X_Px   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Date register Verification mode: Public key x Signature mode: Private key Scalar multiplication mode: Base point x Basic function mode: Operand*/
...
/** @defgroup ENG_Y_Px
  ...
  * @{
  */
#define ECDSA_MASK_ENG_Y_Px   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Date register Verification mode: Public key y Signature mode: Random k Scalar multiplication mode: Base point y Basic function mode: Operand*/
...
/** @defgroup ENG_XO_Px
  ...
  * @{
  */
#define ECDSA_MASK_ENG_XO_Px   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  Date register Verification mode: R_x Signature mode: Public x Scalar multiplication mode: Public x Basic function mode: Coordinate x*/
...
/** @defgroup ENG_YO_Px
  ...
  * @{
  */
#define ECDSA_MASK_ENG_YO_Px   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  Date register Verification mode: R_y Signature mode: Public y Scalar multiplication mode: Public y Basic function mode: Coordinate y*/
...
/** @defgroup ENG_SIGN_R_Sx
  ...
  * @{
  */
#define ECDSA_MASK_ENG_SIGN_R_Sx   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  Date register Verification mode: Signature mode: R Scalar multiplication mode:  Basic function mode:*/
...
/** @defgroup ENG_SIGN_S_Sx
  ...
  * @{
  */
#define ECDSA_MASK_ENG_SIGN_S_Sx   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  Date register Verification mode: Signature mode: S Scalar multiplication mode:  Basic function mode:*/
...
/** @defgroup ENG_VERIFY_R_Px
  ...
  * @{
  */
#define ECDSA_MASK_ENG_VERIFY_R_Px   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Date register Verification mode: R Signature mode:  Scalar multiplication mode:  Basic function mode:*/
...
/** @defgroup ENG_VERIFY_S_Px
  ...
  * @{
  */
#define ECDSA_MASK_ENG_VERIFY_S_Px   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Date register Verification mode: S Signature mode:  Scalar multiplication mode:  Basic function mode:*/
...
/** @defgroup ENG_H_Px
  ...
  * @{
  */
#define ECDSA_MASK_ENG_H_Px   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  ECDSA "hash" parameter Verification mode: Hash Signature mode: Hash Scalar multiplication mode: Private key Basic function mode:*/
...
/** @defgroup COR_A_Px
  ...
  * @{
  */
#define ECDSA_MASK_COR_A_Px   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  ECDSA "a" parameter Verification mode: cor_a Signature mode: cor_a Scalar multiplication mode: cor_a Basic function mode: cor_a*/
...
typedef struct {
	...
	__IO uint32_t RSVD0[12]         ;  /*!< Reserved,  Address offset:0x1D0-0x1FF */
...
#define ECDSA_ERR_SHARE_KEY_ERROR                   -0x1A00  /**< key error. */
/**
  * @}
  */
