...
#define RTC_BIT_DOVTHF  ((u32)0x00000001 << 15)           /*!< R/W1C 0x0  Day over threshold flag This flag is set by hardware when the Day in RTC_TR over the DAY_THRES set in RTC_CR register.*/
#define RTC_DOVTHF(x)   ((u32)(((x) & 0x00000001) << 15))
#define RTC_BIT_WUTF    ((u32)0x00000001 << 10)           /*!< R/W1C 0x0  Wakeup timer flag This flag is set by hardware when the wakeup auto-reload counter reaches to. This flag must be cleared by software at least 2 RTCCLK periods before WUTF is set to '1' again.*/
#define RTC_WUTF(x)     ((u32)(((x) & 0x00000001) << 10))
#define RTC_BIT_ALMF    ((u32)0x00000001 << 8)            /*!< R/W1C 0x0  Alarm flag This flag is set by hardware when the time register (RTC_TR) matches the Alarm registers (RTC_ALMR1L and RTC_ALMR1H).*/
