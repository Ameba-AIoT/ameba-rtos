...
/** @defgroup LEDC_WAIT_TIME0_CTRL_REG
  ...
  * @{
  */
#define LEDC_BIT_WAIT_TIME0_EN       ((u32)0x00000001 << 9)           /*!< R/W 0x0  Wait time0 enable.  When set this bit, the controller automatically insert waiting time before next LED package data. 0: Disable 1: Enable*/
...
/** @defgroup LEDC_WAIT_TIME1_CTRL_REG
  ...
  * @{
  */
#define LEDC_BIT_WAIT_TIME1_EN       ((u32)0x00000001 << 31)          /*!< R/W 0x0  Wait time1 enable.  When set this bit, the controller automatically insert waiting time before next LED frame data. 0: Disable 1: Enable*/
...
/** @defgroup LEDC_DATA_REG
  ...
  * @{
  */
#define LEDC_MASK_DATA   ((u32)0x00FFFFFF << 0)           /*!< WPD 0x0  LEDC display data, the lower 24-bit is valid. Write this register means push data to LEDC FIFO. Register LEDC_EN toggle from 0->1 will clear LEDC FIFO. Thus, only data pushed when LEDC_EN=1 will be send to LED.*/
...
/** @defgroup LEDC_LED_INTERRUPT_CTRL_REG
  ...
  * @{
  */
#define LEDC_BIT_GLOBAL_INT_EN           ((u32)0x00000001 << 4) /*!< R/W 0x0  Global interrupt enable. 0: Disable 1: Enable*/
#define LEDC_BIT_FIFO_OVERFLOW_INT_EN    ((u32)0x00000001 << 3) /*!< R/W 0x0  FIFO overflow interrupt enable. When the data wriiten by software is more than internal FIFO level of LEDC, LEDC is in data loss state. 0: Disable 1: Enable*/
#define LEDC_BIT_WAITDATA_TIMEOUT_INT_EN ((u32)0x00000001 << 2) /*!< R/W 0x0  The internal FIFO in LEDC can`t get data after the LED_WAIT_DATA_TIME, the interrupt will be enable. 0: Disable 1: Enable*/
#define LEDC_BIT_FIFO_CPUREQ_INT_EN      ((u32)0x00000001 << 1) /*!< R/W 0x0  FIFO request CPU data interrupt enable. 0: Disable 1: Enable*/
#define LEDC_BIT_LED_TRANS_FINISH_INT_EN ((u32)0x00000001 << 0) /*!< R/W 0x0  Data transmission complete interrupt enable. 0: Disable 1: Enable*/
/** @} */
...
/** @defgroup LEDC_DEBUG_SEL_REG
  ...
  * @{
  */
#define LEDC_MASK_DEBUG_SEL_DRIVE   ((u32)0x00000003 << 7)           /*!< R/W 0x0  drive module debug out select.*/
#define LEDC_DEBUG_SEL_DRIVE(x)     (((u32)((x) & 0x00000003) << 7))
#define LEDC_GET_DEBUG_SEL_DRIVE(x) ((u32)(((x >> 7) & 0x00000003)))
#define LEDC_MASK_DEBUG_SEL_FIFO    ((u32)0x0000000F << 3)           /*!< R/W 0x0  fifo module debug out select. [6:5] select debug_data of ledc_txfifo, valid range 0,1 [4:3] select output data byte when [6:5] is 0. 2'b00: byte0 2'b01: byte1 2'b1x: byte2*/
#define LEDC_DEBUG_SEL_FIFO(x)      (((u32)((x) & 0x0000000F) << 3))
#define LEDC_GET_DEBUG_SEL_FIFO(x)  ((u32)(((x >> 3) & 0x0000000F)))
#define LEDC_MASK_DEBUG_SEL_TOP     ((u32)0x00000007 << 0)           /*!< R/W 0x0  ledc top module debug out select.*/
...
typedef struct {
	...
	__IO uint32_t RSVD0[2]                      ;  /*!< Reserved,  Address offset:0x028-0x02F */
