...
#ifndef _AMEBA_VAD_PC_H_
#define _AMEBA_VAD_PC_H_
...
/** @defgroup VAD_PC_Register_Definitions VAD_PC Register Definitions
  * @{
  */

/** @defgroup VAD_CODEC_CTRLx
  * @brief VAD CODEC Control Register
  * @{
  */
#define VAD_BIT_PC_ADC_x_DMIC_MIX_MUTE         ((u32)0x00000001 << 27)           /*!< R/W 0x1  DMIC input path mute control 0: Unmute  1: Mute*/
...
#define VAD_BIT_PC_ADC_x_AD_MUTE               ((u32)0x00000001 << 14)           /*!< R/W 0x1  Digital Mute at Digital Volme 0: Unmute  1: Mute*/
#define VAD_BIT_PC_ADC_x_AD_MIX_MUTE           ((u32)0x00000001 << 13)           /*!< R/W 0x1  analog ADC input path mute control 0: Unmute  1: Mute*/
...
/** @defgroup VAD_PITCH_DET_CTRL0
  * @brief Pitch Detection Control Register 0
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL1
  * @brief Pitch Detection Control Register 1
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL2
  * @brief Pitch Detection Control Register 2
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL3
  * @brief Pitch Detection Control Register 3
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL4
  * @brief Pitch Detection Control Register 4
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL5
  * @brief Pitch Detection Control Register 5
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL6
  * @brief Pitch Detection Control Register 6
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL7
  * @brief Pitch Detection Control Register 7
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL8
  * @brief Pitch Detection Control Register 8
  * @{
  */
...
/** @defgroup VAD_PITCH_DET_CTRL9
  * @brief Pitch Detection Control Register 9
  * @{
  */
...
#define VAD_BIT_PITCH_DET_CLR             ((u32)0x00000001 << 1)            /*!< WA0 0x0  Clear VAD flag 0: Bypass vad flag 1: Clear vad flag (force output = 0)*/
#define VAD_BIT_FLAG                      ((u32)0x00000001 << 0)            /*!< R 0x0  VAD flag 0: detection on-going 1: hit*/
/** @} */

/** @defgroup VAD_CLK_CTRL
  * @brief VAD Clock Control Register
  * @{
  */
...
/** @defgroup VAD_FILTER_CTRL
  * @brief VAD Filter Control Register
  * @{
  */
...
/** @defgroup VAD_SEL_CTRL
  * @brief VAD Selection Control Register
  * @{
  */
...
/** @defgroup VAD_BUF_CTRL0
  * @brief VAD Buffer Control Register 0
  * @{
  */
...
/** @defgroup VAD_ASSERT_W_SRAM_ADDRSS
  * @brief VAD Assert Writing SRAM Address Register
  * @{
  */
...
/** @defgroup VAD_BUF_CTRL_W_ADDRESS
  * @brief Buffer Control Write SRAM Address Register
  * @{
  */
#define VAD_MASK_BUF_CTRL_W_ADDRESS   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  Record VAD_BUF_CTRL write SRAM address. When MCU reads VAD_BUF data, refer to this address to avoid reading the wrong data*/
...
/** @defgroup VAD_PC_Exported_Types VAD_PC Exported Types
  * @{
  */

/** @brief VAD_PC Register Declaration
  */

typedef struct {
	__IO uint32_t VAD_CODEC_CTRLx[4]      ;  /*!< VAD CODEC CONTROL REGISTER,  Address offset:0x000-0x00C */
	__IO uint32_t VAD_PITCH_DET_CTRL0     ;  /*!< PITCH DETECTION CONTROL REGISTER 0 Register,  Address offset:0x010 */
	__IO uint32_t VAD_PITCH_DET_CTRL1     ;  /*!< PITCH DETECTION CONTROL REGISTER 1 Register,  Address offset:0x014 */
	__IO uint32_t VAD_PITCH_DET_CTRL2     ;  /*!< PITCH DETECTION CONTROL REGISTER 2 Register,  Address offset:0x018 */
	__IO uint32_t VAD_PITCH_DET_CTRL3     ;  /*!< PITCH DETECTION CONTROL REGISTER 3 Register,  Address offset:0x01C */
	__IO uint32_t VAD_PITCH_DET_CTRL4     ;  /*!< PITCH DETECTION CONTROL REGISTER 4 Register,  Address offset:0x020 */
	__IO uint32_t VAD_PITCH_DET_CTRL5     ;  /*!< PITCH DETECTION CONTROL REGISTER 5 Register,  Address offset:0x024 */
	__IO uint32_t VAD_PITCH_DET_CTRL6     ;  /*!< PITCH DETECTION CONTROL REGISTER 6 Register,  Address offset:0x028 */
	__IO uint32_t VAD_PITCH_DET_CTRL7     ;  /*!< PITCH DETECTION CONTROL REGISTER 7 Register,  Address offset:0x02C */
	__IO uint32_t VAD_PITCH_DET_CTRL8     ;  /*!< PITCH DETECTION CONTROL REGISTER 8 Register,  Address offset:0x030 */
	__IO uint32_t VAD_PITCH_DET_CTRL9     ;  /*!< PITCH DETECTION CONTROL REGISTER 9 Register,  Address offset:0x034 */
	__IO uint32_t VAD_CLK_CTRL            ;  /*!< VAD CLOCK CONTROL REGISTER,  Address offset:0x038 */
	__IO uint32_t VAD_FILTER_CTRL         ;  /*!< VAD FILTER CONTROL REGISTER,  Address offset:0x03C */
	__IO uint32_t VAD_SEL_CTRL            ;  /*!< VAD SELECTION CONTROL REGISTER,  Address offset:0x040 */
	__IO uint32_t RSVD0[3]                ;  /*!< Reserved,  Address offset:0x044-0x04F */
	__IO uint32_t VAD_BUF_CTRL0           ;  /*!< VAD BUFFER CONTROL REGISTER 0 Register,  Address offset:0x050 */
	__I  uint32_t VAD_ASSERT_W_SRAM_ADDRSS;  /*!< VAD ASSERT WRITING SRAM ADDRESS REGISTER,  Address offset:0x054 */
	__IO uint32_t RSVD1                   ;  /*!< Reserved,  Address offset:0x058-0x05B */
	__I  uint32_t VAD_BUF_CTRL_W_ADDRESS  ;  /*!< BUFFER CONTROL WRITE SRAM ADDRESS REGISTER,  Address offset:0x05C */
	__IO uint32_t VAD_AUDIO_TEST          ;  /*!< AUDIO TEST REGISTER,  Address offset:0x060 */
} VAD_TypeDef;
