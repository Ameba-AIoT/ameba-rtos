...
/** @addtogroup VAD_Common
* @brief VAD_Common driver modules
* @{
*/
 ...
 *****************************************************************************/
typedef struct {
	__IO uint32_t VAD_CODEC_CTRLx[4];                     /*!< VAD CODEC CONTROL REGISTER,  Address offset: 0x00-0x0C */
	__IO uint32_t VAD_PITCH_DET_CTRL0;                    /*!< PITCH DETECTION CONTROL REGISTER 0 Register,  Address offset: 0x10 */
	__IO uint32_t VAD_PITCH_DET_CTRL1;                    /*!< PITCH DETECTION CONTROL REGISTER 1 Register,  Address offset: 0x14 */
	__IO uint32_t VAD_PITCH_DET_CTRL2;                    /*!< PITCH DETECTION CONTROL REGISTER 2 Register,  Address offset: 0x18 */
	__IO uint32_t VAD_PITCH_DET_CTRL3;                    /*!< PITCH DETECTION CONTROL REGISTER 3 Register,  Address offset: 0x1C */
	__IO uint32_t VAD_PITCH_DET_CTRL4;                    /*!< PITCH DETECTION CONTROL REGISTER 4 Register,  Address offset: 0x20 */
	__IO uint32_t VAD_PITCH_DET_CTRL5;                    /*!< PITCH DETECTION CONTROL REGISTER 5 Register,  Address offset: 0x24 */
	__IO uint32_t VAD_PITCH_DET_CTRL6;                    /*!< PITCH DETECTION CONTROL REGISTER 6 Register,  Address offset: 0x28 */
	__IO uint32_t VAD_PITCH_DET_CTRL7;                    /*!< PITCH DETECTION CONTROL REGISTER 7 Register,  Address offset: 0x2C */
	__IO uint32_t VAD_PITCH_DET_CTRL8;                    /*!< PITCH DETECTION CONTROL REGISTER 8 Register,  Address offset: 0x30 */
	__IO uint32_t VAD_PITCH_DET_CTRL9;                    /*!< PITCH DETECTION CONTROL REGISTER 9 Register,  Address offset: 0x34 */
	__IO uint32_t VAD_CLK_CTRL;                           /*!< VAD CLOCK CONTROL REGISTER,  Address offset: 0x38 */
	__IO uint32_t VAD_FILTER_CTRL;                        /*!< VAD FILTER CONTROL REGISTER,  Address offset: 0x3C */
	__IO uint32_t VAD_SEL_CTRL;                           /*!< VAD SELECTION CONTROL REGISTER,  Address offset: 0x40 */
	__IO uint32_t RSVD0[3];                               /*!<  Reserved,  Address offset:0x44-0x4C */
	__IO uint32_t VAD_BUF_CTRL0;                          /*!< VAD BUFFER CONTROL REGISTER 0 Register,  Address offset: 0x50 */
	__I  uint32_t VAD_ASSERT_W_SRAM_ADDRSS;               /*!< VAD ASSERT WRITING SRAM ADDRESS REGISTER,  Address offset: 0x54 */
	__IO uint32_t RSVD1;                                  /*!<  Reserved,  Address offset:0x58 */
	__I  uint32_t VAD_BUF_CTRL_W_ADDRESS;                 /*!< BUFFER CONTROL WRITE SRAM ADDRESS REGISTER,  Address offset: 0x5C */
	__IO uint32_t VAD_AUDIO_TEST;                         /*!< AUDIO TEST REGISTER,  Address offset: 0x60 */
} VAD_TypeDef;
/** @} */
/* AUTO_GEN_END */
