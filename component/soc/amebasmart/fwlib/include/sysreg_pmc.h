...
/** @defgroup WAK_STATUS0
  ...
  * @{
  */
#define PMC_MASK_WAK_STA_31_0   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  wak evt status. It can't be cleare here, clear at IP side . Bit0: WIFI_FISR_FESR_IRQ_LP Bit1: WIFI_FTSR_MAILBOX_IRQ_LP Bit2: AON Timer Bit3: NP_WAKE_IRQ_LP Bit4: AP_WAKE_IRQ_LP Bit5: WDG0_IRQ_LP Bit6: Timer0 Bit7: Timer1 Bit8: Timer2 Bit9: Timer3 Bit10: Timer4 Bit11: Timer5 Bit12: Timer6 Bit13: Timer7 Bit14: UART_LOG Bit15: GPIOA Bit16: GPIOB Bit17: GPIOC Bit18: RTC Bit19: CTOUCH Bit20: ADC Bit21: ADC_COMP Bit22: BOR Bit23: PWR_DOWN Bit24: VAD Bit25: IPC_NP Bit26: IPC_AP Bit27: USB_OTG Bit28: SPI0 Bit29: SPI1 Bit30: UART0 Bit31: UART1*/
...
/** @defgroup WAK_STATUS1
  ...
  * @{
  */
#define PMC_MASK_WAK_STA_63_32   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  wak evt status. It can't be cleare here, clear at IP side . Bit0: UART2 Bit1: WDG1 Bit2: WDG2 Bit3: WDG3 Bit4: WDG4 Bit5: AON_GPIO_WAKE Bit6: BT_WAKE_HOST Bit7: nFIQOUT0_OR_nIRQOUT0 Bit8: nFIQOUT1_OR_nIRQOUT1 Bit9~31: Reserved*/
...
/** @defgroup WAK_MASK0_LP
  ...
  * @{
  */
#define PMC_MASK_WAK_LP_IMR_31_0   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  1:mask enable for wake KM0, this used to wak pmc*/
...
/** @defgroup WAK_MASK1_LP
  ...
  * @{
  */
#define PMC_MASK_WAK_LP_IMR_63_32   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  1:mask enable for wake KM0*/
...
/** @defgroup WAK_MASK0_NP
  ...
  * @{
  */
#define PMC_MASK_WAK_NP_IMR_31_0   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  1:mask enable for wake NP*/
...
/** @defgroup WAK_MASK1_NP
  ...
  * @{
  */
#define PMC_MASK_WAK_NP_IMR_63_32   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  1:mask enable for wake NP*/
...
/** @defgroup WAK_MASK0_AP
  ...
  * @{
  */
#define PMC_MASK_WAK_AP_IMR_31_0   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  1:mask enable for wake AP*/
...
/** @defgroup WAK_MASK1_AP
  ...
  * @{
  */
#define PMC_MASK_WAK_AP_IMR_63_32   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  1:mask enable for wake AP*/
...
/** @defgroup WLPMC_ISR
  ...
  * @{
  */
#define PMC_BIT_WL_OFF_IMR ((u32)0x00000001 << 17) /*!< R/W 0x0  */
#define PMC_BIT_WL_ON_IMR  ((u32)0x00000001 << 16) /*!< R/W 0x0  */
#define PMC_BIT_WL_OFF_ISR ((u32)0x00000001 << 1)  /*!< RW1CB 0x0  */
#define PMC_BIT_WL_ON_ISR  ((u32)0x00000001 << 0)  /*!< RW1CB 0x0  */
/** @} */
...
/** @defgroup WLAN_PWRCTL
  ...
  * @{
  */
#define PMC_BIT_SW_CLR_RDY2ACT ((u32)0x00000001 << 17) /*!< R/WA0 0x0  System infrom WLAN ready to active*/
#define PMC_BIT_SW_SET_RDY2ACT ((u32)0x00000001 << 16) /*!< R/WA0 0x0  */
#define PMC_BIT_WL_RDY2ACT     ((u32)0x00000001 << 9)  /*!< R 0x0  System infrom WLAN ready to active*/
#define PMC_BIT_WL_REQ2ACT     ((u32)0x00000001 << 8)  /*!< R 0x0  */
#define PMC_BIT_WL_HW_RESP_FEN ((u32)0x00000001 << 0)  /*!< R/W 0x1  1: enable HW auto response*/
/** @} */
...
#define PMC_BIT_PST_TMODE_MSEL ((u32)0x00000001 << 5)            /*!< R/W 0x0  Set ls plfm msel option . 0: when test mode , msel will set to 0 for SIC 1: when test mode , pmc will not set msel , remain as km0 master.*/
#define PMC_BIT_PAD_PST_MODE   ((u32)0x00000001 << 4)            /*!< R/W/ES 0x0  Pad pu/pd param selection 1: HW select pu/pd slp param for PAD 0: HW select pu/pd active param for PAD HW will auto-set this bit when enter or exit DSLP , SW can set for debug also .*/
#define PMC_BIT_POF_WAIT_SLEP  ((u32)0x00000001 << 3)            /*!< R/W 0x1  1.when SW set pmen_slep or pmen_dslp , hw pmc will wait km0 enter sleep mode , then begin to pof seq 0.Not wait km0 sleep*/
#define PMC_BIT_LP_IRQ_MASK    ((u32)0x00000001 << 2)            /*!< R/W 0x0  1.mask all LP interrupt 0:release all LP interrupt*/
#define PMC_BIT_PMEN_SLEP      ((u32)0x00000001 << 1)            /*!< R/W 0x0  1: Request PMC to enter sleep state, auto clear to 0 after PMC finishes*/
#define PMC_BIT_PMEN_DSLP      ((u32)0x00000001 << 0)            /*!< R/W 0x0  1: Request PMC to enter deep-sleep state, auto clear to 0 after PMC finishes*/
/** @} */
...
#define PMC_MASK_PST_NORM_VOLT   ((u32)0x00000003 << 18)           /*!< R/W 0x1  Normal setting for SWR volt selection 00: SWR switch to LPS (0.8v) 01: SWR switch to NM (0.9v) 10/11: SWR switch to HP (1.0v)*/
...
#define PMC_MASK_PST_SLEP_VOLT   ((u32)0x00000003 << 10)           /*!< R/W 0x0  Sleep setting for SWR volt selection 00: SWR switch to LPS (0.8v) 01: SWR switch to NM (0.9v) 10/11: SWR switch to HP (1.0v)*/
#define PMC_PST_SLEP_VOLT(x)     (((u32)((x) & 0x00000003) << 10))
#define PMC_GET_PST_SLEP_VOLT(x) ((u32)(((x >> 10) & 0x00000003)))
#define PMC_BIT_PST_SLEP_EPWM    ((u32)0x00000001 << 8)            /*!< R/W 0x0  Sleep setting for SWR mode selection 1: SWR keeps at PWM mode when PMC enter into sleep mode 0: SWR switch to PFM when PMC enter into sleep mode*/
#define PMC_BIT_PST_SLEP_ERCK    ((u32)0x00000001 << 4)            /*!< R/W 0x0  1: Enable osc4m platform clock when PMC enter into sleep mode 0: Gate osc4m platform clock when PMC enter into sleep mode*/
#define PMC_BIT_PST_SLEP_EMPM    ((u32)0x00000001 << 3)            /*!< R/W 0x0  1: Enable LS system mem still in active when pmc enter sleep 0: LS system mem will in DSLP when pmc enter sleep*/
#define PMC_BIT_PST_SLEP_EBUS    ((u32)0x00000001 << 2)            /*!< R/W 0x0  1: Enable platform clock when PMC entro into sleep mode 0: Gate platform clock when PMC entro into sleep mode*/
#define PMC_BIT_PST_SLEP_ESOC    ((u32)0x00000001 << 0)            /*!< R/W 0x0  1: power enable SOC platform when PMC enter into sleep mode (clock-gating) 0: power off SoC domain when PMC enter into sleep mode (power-gating)*/
/** @} */
...
/** @defgroup MEM_PWR_CTRL
  ...
  * @{
  */
#define PMC_BIT_SLEP_RET_RAM_LS ((u32)0x00000001 << 22) /*!< R/W 0x0  1: Enable Retention RAM light-sleep when KM0 in sleep state 0: Disable*/
#define PMC_BIT_SLEP_RET_RAM_DS ((u32)0x00000001 << 21) /*!< R/W 0x0  1: Enable Retention RAM deep-sleep when KM0 in sleep state 0: Disable*/
#define PMC_BIT_SLEP_RET_RAM_SD ((u32)0x00000001 << 20) /*!< R/W 0x0  1: Shut-down Retention RAM when KM0 in sleep state 0: Power on Retention RAM when KM0 in sleep state*/
#define PMC_BIT_SLEP_IDCACHE_LS ((u32)0x00000001 << 19) /*!< R/W 0x0  1: Enable ICACHE/DCACHE light-sleep when KM0 in sleep state 0: Disable*/
#define PMC_BIT_SLEP_K0_RAM_LS  ((u32)0x00000001 << 18) /*!< R/W 0x0  1: Enable CPU RAM light-sleep when KM0 in sleep state 0: Disable*/
#define PMC_BIT_SLEP_K0_RAM_DS  ((u32)0x00000001 << 17) /*!< R/W 0x0  1: Enable CPU RAM deep-sleep when KM0 in sleep state 0: Disable*/
#define PMC_BIT_SLEP_K0_RAM_SD  ((u32)0x00000001 << 16) /*!< R/W 0x0  1: Shut-down CPU RAM when KM0 in sleep state 0: Power on CPU RAM when KM0 in sleep state*/
#define PMC_BIT_NORM_RET_RAM_LS ((u32)0x00000001 << 6)  /*!< R/W 0x0  1: Enable Retention RAM light-sleep when KM0 in active state 0: Disable*/
#define PMC_BIT_NORM_RET_RAM_DS ((u32)0x00000001 << 5)  /*!< R/W 0x0  1: Enable Retention RAM deep-sleep when KM0 in active state 0: Disable*/
#define PMC_BIT_NORM_RET_RAM_SD ((u32)0x00000001 << 4)  /*!< R/W 0x0  1: Shut-down Retention RAM when KM0 in active state 0: Power on Retention RAM when KM0 in active state*/
#define PMC_BIT_NORM_IDCACHE_LS ((u32)0x00000001 << 3)  /*!< R/W 0x0  1: Enable ICACHE/DCACHE light-sleep when KM0 in active state 0: Disable*/
#define PMC_BIT_NORM_K0_RAM_LS  ((u32)0x00000001 << 2)  /*!< R/W 0x0  1: Enable CPU RAM light-sleep when KM0 in active state 0: Disable*/
#define PMC_BIT_NORM_K0_RAM_DS  ((u32)0x00000001 << 1)  /*!< R/W 0x0  1: Enable CPU RAM deep-sleep when KM0 in active state 0: Disable*/
#define PMC_BIT_NORM_K0_RAM_SD  ((u32)0x00000001 << 0)  /*!< R/W 0x0  ECO_137 : KM0 itcm rom SLP*/
/** @} */
...
/** @defgroup PMC_PATCH_GRP0_0
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP0_INSTR1_5_0   ((u32)0x0000003F << 26)           /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group0,bit[5:0]*/
#define PMC_PATCH_GRP0_INSTR1_5_0(x)     (((u32)((x) & 0x0000003F) << 26))
#define PMC_GET_PATCH_GRP0_INSTR1_5_0(x) ((u32)(((x >> 26) & 0x0000003F)))
#define PMC_MASK_PATCH_GRP0_INSTR0       ((u32)0x0003FFFF << 8)            /*!< R/W 0x0  instruction0 of  LSYSON PMC patch group0*/
#define PMC_PATCH_GRP0_INSTR0(x)         (((u32)((x) & 0x0003FFFF) << 8))
#define PMC_GET_PATCH_GRP0_INSTR0(x)     ((u32)(((x >> 8) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP0_SADDR        ((u32)0x000000FF << 0)            /*!< R/W 0x0  Start address of the first instruction of  LSYSON PMC patch group0*/
...
/** @defgroup PMC_PATCH_GRP0_1
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP0_INSTR2        ((u32)0x0003FFFF << 12)           /*!< R/W 0x0  instruction2 of  LSYSON PMC patch group0*/
#define PMC_PATCH_GRP0_INSTR2(x)          (((u32)((x) & 0x0003FFFF) << 12))
#define PMC_GET_PATCH_GRP0_INSTR2(x)      ((u32)(((x >> 12) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP0_INSTR1_17_6   ((u32)0x00000FFF << 0)            /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group0,bit[17:6]*/
...
/** @defgroup PMC_PATCH_GRP1_0
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP1_INSTR1_5_0   ((u32)0x0000003F << 26)           /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group1,bit[5:0]*/
#define PMC_PATCH_GRP1_INSTR1_5_0(x)     (((u32)((x) & 0x0000003F) << 26))
#define PMC_GET_PATCH_GRP1_INSTR1_5_0(x) ((u32)(((x >> 26) & 0x0000003F)))
#define PMC_MASK_PATCH_GRP1_INSTR0       ((u32)0x0003FFFF << 8)            /*!< R/W 0x0  instruction0 of  LSYSON PMC patch group1*/
#define PMC_PATCH_GRP1_INSTR0(x)         (((u32)((x) & 0x0003FFFF) << 8))
#define PMC_GET_PATCH_GRP1_INSTR0(x)     ((u32)(((x >> 8) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP1_SADDR        ((u32)0x000000FF << 0)            /*!< R/W 0x0  Start address of the first instruction of  LSYSON PMC patch group1*/
...
/** @defgroup PMC_PATCH_GRP1_1
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP1_INSTR2        ((u32)0x0003FFFF << 12)           /*!< R/W 0x0  instruction2 of  LSYSON PMC patch group1*/
#define PMC_PATCH_GRP1_INSTR2(x)          (((u32)((x) & 0x0003FFFF) << 12))
#define PMC_GET_PATCH_GRP1_INSTR2(x)      ((u32)(((x >> 12) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP1_INSTR1_17_6   ((u32)0x00000FFF << 0)            /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group1,bit[17:6]*/
...
/** @defgroup PMC_PATCH_GRP2_0
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP2_INSTR1_5_0   ((u32)0x0000003F << 26)           /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group2,bit[5:0]*/
#define PMC_PATCH_GRP2_INSTR1_5_0(x)     (((u32)((x) & 0x0000003F) << 26))
#define PMC_GET_PATCH_GRP2_INSTR1_5_0(x) ((u32)(((x >> 26) & 0x0000003F)))
#define PMC_MASK_PATCH_GRP2_INSTR0       ((u32)0x0003FFFF << 8)            /*!< R/W 0x0  instruction0 of  LSYSON PMC patch group2*/
#define PMC_PATCH_GRP2_INSTR0(x)         (((u32)((x) & 0x0003FFFF) << 8))
#define PMC_GET_PATCH_GRP2_INSTR0(x)     ((u32)(((x >> 8) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP2_SADDR        ((u32)0x000000FF << 0)            /*!< R/W 0x0  Start address of the first instruction of  LSYSON PMC patch group2*/
...
/** @defgroup PMC_PATCH_GRP2_1
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP2_INSTR2        ((u32)0x0003FFFF << 12)           /*!< R/W 0x0  instruction2 of  LSYSON PMC patch group2*/
#define PMC_PATCH_GRP2_INSTR2(x)          (((u32)((x) & 0x0003FFFF) << 12))
#define PMC_GET_PATCH_GRP2_INSTR2(x)      ((u32)(((x >> 12) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP2_INSTR1_17_6   ((u32)0x00000FFF << 0)            /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group2,bit[17:6]*/
...
/** @defgroup PMC_PATCH_GRP3_0
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP3_INSTR1_5_0   ((u32)0x0000003F << 26)           /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group3,bit[5:0]*/
#define PMC_PATCH_GRP3_INSTR1_5_0(x)     (((u32)((x) & 0x0000003F) << 26))
#define PMC_GET_PATCH_GRP3_INSTR1_5_0(x) ((u32)(((x >> 26) & 0x0000003F)))
#define PMC_MASK_PATCH_GRP3_INSTR0       ((u32)0x0003FFFF << 8)            /*!< R/W 0x0  instruction0 of  LSYSON PMC patch group3*/
#define PMC_PATCH_GRP3_INSTR0(x)         (((u32)((x) & 0x0003FFFF) << 8))
#define PMC_GET_PATCH_GRP3_INSTR0(x)     ((u32)(((x >> 8) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP3_SADDR        ((u32)0x000000FF << 0)            /*!< R/W 0x0  Start address of the first instruction of  LSYSON PMC patch group3*/
...
/** @defgroup PMC_PATCH_GRP3_1
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP3_INSTR2        ((u32)0x0003FFFF << 12)           /*!< R/W 0x0  instruction2 of  LSYSON PMC patch group3*/
#define PMC_PATCH_GRP3_INSTR2(x)          (((u32)((x) & 0x0003FFFF) << 12))
#define PMC_GET_PATCH_GRP3_INSTR2(x)      ((u32)(((x >> 12) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP3_INSTR1_17_6   ((u32)0x00000FFF << 0)            /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group3,bit[17:6]*/
...
/** @defgroup PMC_PATCH_GRP4_0
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP4_INSTR1_5_0   ((u32)0x0000003F << 26)           /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group4,bit[5:0]*/
#define PMC_PATCH_GRP4_INSTR1_5_0(x)     (((u32)((x) & 0x0000003F) << 26))
#define PMC_GET_PATCH_GRP4_INSTR1_5_0(x) ((u32)(((x >> 26) & 0x0000003F)))
#define PMC_MASK_PATCH_GRP4_INSTR0       ((u32)0x0003FFFF << 8)            /*!< R/W 0x0  instruction0 of  LSYSON PMC patch group4*/
#define PMC_PATCH_GRP4_INSTR0(x)         (((u32)((x) & 0x0003FFFF) << 8))
#define PMC_GET_PATCH_GRP4_INSTR0(x)     ((u32)(((x >> 8) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP4_SADDR        ((u32)0x000000FF << 0)            /*!< R/W 0x0  Start address of the first instruction of  LSYSON PMC patch group4*/
...
/** @defgroup PMC_PATCH_GRP4_1
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP4_INSTR2        ((u32)0x0003FFFF << 12)           /*!< R/W 0x0  instruction2 of  LSYSON PMC patch group4*/
#define PMC_PATCH_GRP4_INSTR2(x)          (((u32)((x) & 0x0003FFFF) << 12))
#define PMC_GET_PATCH_GRP4_INSTR2(x)      ((u32)(((x >> 12) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP4_INSTR1_17_6   ((u32)0x00000FFF << 0)            /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group4,bit[17:6]*/
...
/** @defgroup PMC_PATCH_GRP5_0
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP5_INSTR1_5_0   ((u32)0x0000003F << 26)           /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group5,bit[5:0]*/
#define PMC_PATCH_GRP5_INSTR1_5_0(x)     (((u32)((x) & 0x0000003F) << 26))
#define PMC_GET_PATCH_GRP5_INSTR1_5_0(x) ((u32)(((x >> 26) & 0x0000003F)))
#define PMC_MASK_PATCH_GRP5_INSTR0       ((u32)0x0003FFFF << 8)            /*!< R/W 0x0  instruction0 of  LSYSON PMC patch group5*/
#define PMC_PATCH_GRP5_INSTR0(x)         (((u32)((x) & 0x0003FFFF) << 8))
#define PMC_GET_PATCH_GRP5_INSTR0(x)     ((u32)(((x >> 8) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP5_SADDR        ((u32)0x000000FF << 0)            /*!< R/W 0x0  Start address of the first instruction of  LSYSON PMC patch group5*/
...
/** @defgroup PMC_PATCH_GRP5_1
  ...
  * @{
  */
#define PMC_MASK_PATCH_GRP5_INSTR2        ((u32)0x0003FFFF << 12)           /*!< R/W 0x0  instruction2 of  LSYSON PMC patch group5*/
#define PMC_PATCH_GRP5_INSTR2(x)          (((u32)((x) & 0x0003FFFF) << 12))
#define PMC_GET_PATCH_GRP5_INSTR2(x)      ((u32)(((x >> 12) & 0x0003FFFF)))
#define PMC_MASK_PATCH_GRP5_INSTR1_17_6   ((u32)0x00000FFF << 0)            /*!< R/W 0x0  instruction1 of  LSYSON PMC patch group5,bit[17:6]*/
...
#define WAK_MASK0_LP              0x008
#define WAK_MASK1_LP              0x00C
#define WAK_MASK0_NP              0x010
#define WAK_MASK1_NP              0x014
#define WAK_MASK0_AP              0x018
#define WAK_MASK1_AP              0x01C
#define WLPMC_ISR                 0x020
#define WLAN_PWRCTL               0x024
#define SYSPMC_CTRL               0x028
#define SYSPMC_OPT                0x02C
#define MEM_PWR_CTRL              0x030
