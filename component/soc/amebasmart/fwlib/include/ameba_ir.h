...
/** @defgroup IR_Rx_Filter_Time IR Rx Filter Time
  * @{
  */
#define IR_RX_FILTER_TIME_20NS					(0) /*!< RX glitch filter time 20 ns. */
#define IR_RX_FILTER_TIME_30NS					(1) /*!< RX glitch filter time 30 ns. */
#define IR_RX_FILTER_TIME_40NS					(2) /*!< RX glitch filter time 40 ns. */
#define IR_RX_FILTER_TIME_50NS					(3) /*!< RX glitch filter time 50 ns. */
#define IR_RX_FILTER_TIME_60NS					(4) /*!< RX glitch filter time 60 ns. */
#define IR_RX_FILTER_TIME_70NS					(5) /*!< RX glitch filter time 70 ns. */
#define IR_RX_FILTER_TIME_80NS					(6) /*!< RX glitch filter time 80 ns. */
#define IR_RX_FILTER_TIME_90NS					(7) /*!< RX glitch filter time 90 ns. */
/**
  * @}
  */
