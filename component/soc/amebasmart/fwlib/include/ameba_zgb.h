...
#ifndef _AMEBA_ZGB_H_
#define _AMEBA_ZGB_H_
...
/** @defgroup ZGB_FUN_EN
  ...
  * @{
  */
#define ZGB_BIT_R_ZGB_RX_EN ((u32)0x00000001 << 1) /*!< R/W 0x0  zigbee mac rx enable*/
#define ZGB_BIT_R_ZGB_TX_EN ((u32)0x00000001 << 0) /*!< R/W 0x0  zigbee mac tx enable*/
/** @} */
...
#define ZGB_BIT_R_ZGB_TXDMA_EN      ((u32)0x00000001 << 0)            /*!< R/W 0x0  GDMA enable for Zigbee Txbuf*/
/** @} */
...
#define ZGB_BIT_R_ZGB_RXDMA_EN     ((u32)0x00000001 << 0)            /*!< R/W 0x0  GDMA enable for Zigbee Rxbuf*/
/** @} */
...
/** @defgroup ZGB_IMR0
  ...
  * @{
  */
#define ZGB_MASK_R_ZGB_IMR0   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  interrupt mask register of zigbee*/
...
/** @defgroup ZGB_TRXBUF_INFO
  ...
  * @{
  */
#define ZGB_MASK_TXBUF_EMPTY_ENTRY   ((u32)0x000007FF << 10)           /*!< R 0x0  empty entry size of txbuf, unit is 4byte*/
#define ZGB_TXBUF_EMPTY_ENTRY(x)     (((u32)((x) & 0x000007FF) << 10))
#define ZGB_GET_TXBUF_EMPTY_ENTRY(x) ((u32)(((x >> 10) & 0x000007FF)))
#define ZGB_MASK_RXBUF_VALID_ENTRY   ((u32)0x000003FF << 0)            /*!< R 0x0  valid entry size of rxbuf, unit is 4byte*/
...
/** @defgroup ZGB_TRX_REQ
  ...
  * @{
  */
#define ZGB_BIT_TX_REQ  ((u32)0x00000001 << 2) /*!< R/W 0x0  zigbee tx request*/
#define ZGB_BIT_RX_REQ  ((u32)0x00000001 << 1) /*!< R/W 0x0  zigbee rx request*/
#define ZGB_BIT_PRI_REQ ((u32)0x00000001 << 0) /*!< R/W 0x0  zigbee priority request*/
/** @} */
...
/** @defgroup ZGB_ISR1
  ...
  * @{
  */
#define ZGB_MASK_R_ZGB_ISR1   ((u32)0xFFFFFFFF << 0)           /*!< RW1CB 0x0  interrupt status register of zigbee [31:8],dummy [7:0],INTER_ZIGBEE_INTR_O, zigbee_intr_o[7:0] posedge pulse*/
...
/** @defgroup ZGB_IMR1
  ...
  * @{
  */
#define ZGB_MASK_R_ZGB_IMR1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  interrupt mask register of zigbee*/
...
typedef struct {
	...
	__I  uint32_t ZGB_TRXBUF_INFO;  /*!< ZIGBEE TX/RX BUFFER INFORMATION Register,  Address offset:0x014 */
