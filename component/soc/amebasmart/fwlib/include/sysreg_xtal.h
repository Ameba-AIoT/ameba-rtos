...
/** @defgroup XTAL_ANAPAR_POW_XTAL_0
  ...
  * @{
  */
#define XTAL_MASK_DBNC_CYC         ((u32)0x000000FF << 24)           /*!< R/W 0x0111  XTAL arb debounce cycle x4M*/
...
#define XTAL_BIT_DBNC_FEN          ((u32)0x00000001 << 15)           /*!< R/W 0x1  XTAL arb debounce fen*/
#define XTAL_MASK_TUTIME           ((u32)0x0000003F << 8)            /*!< R/W 0x0111  XTAL arb fine timing setting*/
#define XTAL_TUTIME(x)             (((u32)((x) & 0x0000003F) << 8))
#define XTAL_GET_TUTIME(x)         ((u32)(((x >> 8) & 0x0000003F)))
#define XTAL_BIT_SYS_XTAL_MODE_REQ ((u32)0x00000001 << 5)            /*!< R/W/ES 0x0  system request xtal mode 0:lps 1:normal*/
#define XTAL_BIT_SYS_XTAL_EN_REQ   ((u32)0x00000001 << 4)            /*!< R/W/ES 0x0  system request xtal enable 0:disable 1:enable*/
...
/** @defgroup XTAL_ANAPAR_XTAL_ON_0
  ...
  * @{
  */
#define XTAL_MASK_SC_INIT   ((u32)0x0000007F << 24)           /*!< R/W 0x0000000  0: reduce cap, 1: increase cap. (140fF per unit) [efuse for BT only ] 有外掛電容設全0*/
#define XTAL_SC_INIT(x)     (((u32)((x) & 0x0000007F) << 24))
#define XTAL_GET_SC_INIT(x) ((u32)(((x >> 24) & 0x0000007F)))
#define XTAL_MASK_SC_XO     ((u32)0x0000007F << 17)           /*!< R/W 0x1000000  1: reduce cap, 0: increase cap. (140fF per unit) [efuse for BT only ]*/
#define XTAL_SC_XO(x)       (((u32)((x) & 0x0000007F) << 17))
#define XTAL_GET_SC_XO(x)   ((u32)(((x >> 17) & 0x0000007F)))
#define XTAL_MASK_SC_XI     ((u32)0x0000007F << 10)           /*!< R/W 0x1000000  1: reduce cap, 0: increase cap. (140fF per unit) [efuse for BT only ]*/
...
/** @defgroup XTAL_ANAPAR_XTAL_ON_1
  ...
  * @{
  */
#define XTAL_MASK_CFIX            ((u32)0x00000003 << 30)           /*!< R/W 0x11  11: 5.88pF(42*140fF), 10: 3.78pF(27*140fF), 01: 2.1pF(15*140fF), 00: off CFIX会叠加在XI&XO cap上作为固定cap存在.*/
...
#define XTAL_MASK_SEL_TOK         ((u32)0x00000007 << 13)           /*!< R/W 0x100  For cycles / 40MHz / 26MHz 000: 2^10 / 0.025m / 0.05m 001: 2^11 / 0.05m / 0.1m 010: 2^12 / 0.1m / 0.2m 011: 2^13 / 0.2m / 0.3m 100: 2^14 / 0.4m / 0.6m 101: 2^15 / 0.8m / 1.2m 110: 2^16 / 1.6m / 2.5m 111: 2^17 / 3.2m / 4.9m*/
...
/** @defgroup XTAL_ANAPAR_XTAL_ON_2
  ...
  * @{
  */
#define XTAL_MASK_DUMMY              ((u32)0x00000007 << 11)           /*!< R/W 0x000  Dummy control bits [0]: used by analog  [1]: not used yet [2]: used by digital , option for XTAL LPS gating digi 40M     when xtal enter lps , EN_XTAL_DRV_DIGI will gated by this bit     when xtal not om lps , this bit no use*/
#define XTAL_DUMMY(x)                (((u32)((x) & 0x00000007) << 11))
#define XTAL_GET_DUMMY(x)            ((u32)(((x >> 11) & 0x00000007)))
#define XTAL_MASK_GM_MANUAL          ((u32)0x0000001F << 4)            /*!< R/W 0x11111  Gm manual at EN_XTAL_AAC_DIGI=0*/
#define XTAL_GM_MANUAL(x)            (((u32)((x) & 0x0000001F) << 4))
#define XTAL_GET_GM_MANUAL(x)        ((u32)(((x >> 4) & 0x0000001F)))
#define XTAL_BIT_EN_XTAL_AAC_GM      ((u32)0x00000001 << 3)            /*!< R/W 0x0  1: enable xtal aac gm control*/
#define XTAL_BIT_EN_XTAL_DRV_IQK_BCN ((u32)0x00000001 << 2)            /*!< R/W 0x1  IQKPLL enable clock source control, 1:enable, 0: gate*/
...
/** @defgroup XTAL_ANAPAR_XTAL_OFF_2
  ...
  * @{
  */
#define XTAL_MASK_OFF_DUMMY   ((u32)0x000003FF << 0)           /*!< R/W 0x0  HW used only*/
...
#define XTAL_MASK_VREF_MANUAL      ((u32)0x0000001F << 6)            /*!< R/W 0x11111  VREF manual at EN_XTAL_PDCK_DIGI=0*/
...
#define XTAL_MASK_OV_UNIT        ((u32)0x00000007 << 7)            /*!< R/W 0x011  overlap time settling cycles (4M CLK)  000: 10us 001: 20us  010: 40us 011: 80us 100: 160us 101: 320us 110: 640us 111: 1280us*/
...
#define XTAL_BIT_AUTO_PDCK         ((u32)0x00000001 << 1)            /*!< R/W 0x0  Auto PDCK enable signal. If set this bit, arbiter will do PDCK before XTAL enter LPS mode.*/
...
#define XTAL_MASK_ARB_CKON_TIM   ((u32)0x000000FF << 0)           /*!< R/W 0x1  After enter one xtal state , still req ana clock for this count cycles . HW will use CAP_CTRL_READY for clock req , this timer is for debug.*/
