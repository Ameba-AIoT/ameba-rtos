...
/** @defgroup PLL_NPPLL_CTRL0
  ...
  * @{
  */
#define PLL_BIT_NPLL_POW_ERC                ((u32)0x00000001 << 31)           /*!< R/W/ES 0x0  erc enable.  0 -> 1*/
#define PLL_BIT_NPLL_POW_DIV_IN             ((u32)0x00000001 << 30)           /*!< R/W/ES 0x0  input divider enable  (need pwl signal) 0 -> 1*/
#define PLL_BIT_NPLL_POW_PLL                ((u32)0x00000001 << 29)           /*!< R/W/ES 0x0  (need pwl signal) 0 -> 1*/
#define PLL_MASK_NPLL_REG_CP_BIA            ((u32)0x00000007 << 26)           /*!< R/W 0x000  charge pump current selection . Default=10uA                      CP current select :  000: Icp=10uA,  001: Icp=15uA,  010: Icp=20uA,  011: Icp=25uA;    100: Icp=30uA,  101: Icp=35uA,  110: Icp=40uA,  111: Icp=450uA;*/
#define PLL_NPLL_REG_CP_BIA(x)              (((u32)((x) & 0x00000007) << 26))
#define PLL_GET_NPLL_REG_CP_BIA(x)          ((u32)(((x >> 26) & 0x00000007)))
#define PLL_BIT_NPLL_DOGENB                 ((u32)0x00000001 << 25)           /*!< R/W 0x0  0: watch dog on, 1: watch dog off*/
#define PLL_MASK_NPLL_PS                    ((u32)0x00000007 << 22)           /*!< R/W 0x000  */
#define PLL_NPLL_PS(x)                      (((u32)((x) & 0x00000007) << 22))
#define PLL_GET_NPLL_PS(x)                  ((u32)(((x >> 22) & 0x00000007)))
#define PLL_BIT_NPLL_PSEN                   ((u32)0x00000001 << 21)           /*!< R/W 0x1  phase selector enable*/
#define PLL_MASK_NPLL_CP_SET                ((u32)0x00000003 << 19)           /*!< R/W 0x10  Cp selection. Default=6p                                         00: Cp=4p, 01: Cp=5p, 10: Cp=6p, 11: Cp=7p                                      40M = 6p(10),  26M = 6p(10)*/
#define PLL_NPLL_CP_SET(x)                  (((u32)((x) & 0x00000003) << 19))
#define PLL_GET_NPLL_CP_SET(x)              ((u32)(((x >> 19) & 0x00000003)))
#define PLL_MASK_NPLL_RS_SET                ((u32)0x00000007 << 16)           /*!< R/W 0x110  Rs selection. Default=5k                                          000: Rs=15k,   001: Rs=13k,   010: Rs=11k,   011: Rs=9k,          100: Rs=7k,    101: Rs=5k,    110: Rs=3k,    111: Rs=1k;           40M = 3k(110),  26M = 3k(110)*/
#define PLL_NPLL_RS_SET(x)                  (((u32)((x) & 0x00000007) << 16))
#define PLL_GET_NPLL_RS_SET(x)              ((u32)(((x >> 16) & 0x00000007)))
#define PLL_MASK_NPLL_CS_SEL                ((u32)0x00000003 << 14)           /*!< R/W 0x10  Cs selection. Default=60p                                          00: Cs=40p, 01: Cs=50p, 10: Cs=60p, 11: Cs=70p                                                      40M = 60p(10),  26M = 60p(10)*/
#define PLL_NPLL_CS_SEL(x)                  (((u32)((x) & 0x00000003) << 14))
#define PLL_GET_NPLL_CS_SEL(x)              ((u32)(((x >> 14) & 0x00000003)))
#define PLL_BIT_NPLL_FREF_EDGE              ((u32)0x00000001 << 13)           /*!< R/W 0x1  0:fref, 1:frefb*/
#define PLL_BIT_NPLL_CK_EN                  ((u32)0x00000001 << 12)           /*!< R/W 0x1  output clk enable*/
#define PLL_BIT_NPLL_CK_EN_D4               ((u32)0x00000001 << 11)           /*!< R/W 0x0  output clk div 4 enable*/
#define PLL_MASK_NPLL_DUMMY0                ((u32)0x00000007 << 8)            /*!< R/W 0x000  HW used only , these are for reserved*/
#define PLL_NPLL_DUMMY0(x)                  (((u32)((x) & 0x00000007) << 8))
#define PLL_GET_NPLL_DUMMY0(x)              ((u32)(((x >> 8) & 0x00000007)))
#define PLL_BIT_NPLL_XTAL_MANUAL_MODE       ((u32)0x00000001 << 7)            /*!< R/W 0x1  reg_xtal_maunal_mode.  Default=0                                            0: reg_xtal_sel<3:0> is controlled by REG,                                 xtal_div_sel is controlled by mapping table.                      1: reg_xtal_sel<3:0>=4'b1111,                                    xtal_div_sel is controlled by reg_xtal_div_sel_maunal<1:0>*/
#define PLL_MASK_NPLL_XTAL_DIV_SEL_MANUAL   ((u32)0x00000003 << 5)            /*!< R/W 0x00  input divider selection in xtal maunal mode. Default=00                                                                00=/1,  10=/2,  11=/4*/
#define PLL_NPLL_XTAL_DIV_SEL_MANUAL(x)     (((u32)((x) & 0x00000003) << 5))
#define PLL_GET_NPLL_XTAL_DIV_SEL_MANUAL(x) ((u32)(((x >> 5) & 0x00000003)))
#define PLL_MASK_NPLL_VC_THL                ((u32)0x00000003 << 3)            /*!< R/W 0x00  VC voltage, Default=00                                           00: VC=1/4Vdd,  01: VC=1/2Vdd,  10=3/4Vdd,  11: VC=Vdd*/
#define PLL_NPLL_VC_THL(x)                  (((u32)((x) & 0x00000003) << 3))
#define PLL_GET_NPLL_VC_THL(x)              ((u32)(((x >> 3) & 0x00000003)))
#define PLL_MASK_NPLL_C3_SET                ((u32)0x00000003 << 1)            /*!< R/W 0x01  C3 selection. Default=1p                                          00: 0.5p, 01: 1p, 10: Cs=1.5p, 11: 2p*/
#define PLL_NPLL_C3_SET(x)                  (((u32)((x) & 0x00000003) << 1))
#define PLL_GET_NPLL_C3_SET(x)              ((u32)(((x >> 1) & 0x00000003)))
#define PLL_BIT_NPLL_R3_SET                 ((u32)0x00000001 << 0)            /*!< R/W 0x1  Rs selection. Default=1k                                          0: 0 Ohm, 1: 1k Ohm*/
/** @} */
...
/** @defgroup PLL_NPPLL_CTRL1
  ...
  * @{
  */
#define PLL_MASK_NPLL_XTAL_SEL             ((u32)0x0000000F << 28)           /*!< R/W 0x0000  xtal selection, Default=40MHz                                                                                        0000= 40MHz, 0001= 25MHz,      0010= 13MHz,    0011= 19.2MHz                                      0100= 20MHz, 0101= 26MHz,      0110= 38.4MHz,  0111= 17.664MHz                              1000= 16MHz, 1001= 14.138MHz,  1010= 12MHz,    1011= 52MHz                             1100= 48MHz, 1101= 27MHz,      1110= 24MHz,    1111= none*/
#define PLL_NPLL_XTAL_SEL(x)               (((u32)((x) & 0x0000000F) << 28))
#define PLL_GET_NPLL_XTAL_SEL(x)           ((u32)(((x >> 28) & 0x0000000F)))
#define PLL_MASK_NPLL_FREQ_SEL             ((u32)0x0000000F << 24)           /*!< R/W 0x0000  output clk selection, Default=400MHz                            0000= 400MHz,  0001= X,         0010= X,       0011= X,                    0100= 216MHz,  0101=196.608MHz, 0110=192MHz,   0111= 180.632MHz, 1000= 148.5MHz,1001= X,         1010= X,       1011= X,        1100= X,       1101= X,         1110= X,       1111= 500MHz*/
#define PLL_NPLL_FREQ_SEL(x)               (((u32)((x) & 0x0000000F) << 24))
#define PLL_GET_NPLL_FREQ_SEL(x)           ((u32)(((x >> 24) & 0x0000000F)))
#define PLL_MASK_NPLL_TBASE_FREQ           ((u32)0x0000000F << 20)           /*!< R/W 0x1000  now is empty*/
#define PLL_NPLL_TBASE_FREQ(x)             (((u32)((x) & 0x0000000F) << 20))
#define PLL_GET_NPLL_TBASE_FREQ(x)         ((u32)(((x >> 20) & 0x0000000F)))
#define PLL_MASK_NPLL_STEP_FREQ            ((u32)0x0000000F << 16)           /*!< R/W 0x0101  step size selection for switching freq.                           0000: 2^5                                                          0001: 2^6                                                    0010: 2^7                                                          0011: 2^8                                                     0100: 2^9                                                    0101: 2^10                                                    0110: 2^11                                                    0111: 2^12*/
#define PLL_NPLL_STEP_FREQ(x)              (((u32)((x) & 0x0000000F) << 16))
#define PLL_GET_NPLL_STEP_FREQ(x)          ((u32)(((x >> 16) & 0x0000000F)))
#define PLL_BIT_NPLL_TRIG_FREQ             ((u32)0x00000001 << 15)           /*!< R/W 0x0  freq. step up or step down enable*/
#define PLL_MASK_NPLL_BB_DBG_SEL_AFE_SDM   ((u32)0x0000000F << 11)           /*!< R/W 0x0000  */
#define PLL_NPLL_BB_DBG_SEL_AFE_SDM(x)     (((u32)((x) & 0x0000000F) << 11))
#define PLL_GET_NPLL_BB_DBG_SEL_AFE_SDM(x) ((u32)(((x >> 11) & 0x0000000F)))
#define PLL_MASK_NPLL_DIVN_SDM             ((u32)0x0000003F << 5)            /*!< R/W 0x10110  600M                                                     40M: 001101                                                          26M: 010101*/
#define PLL_NPLL_DIVN_SDM(x)               (((u32)((x) & 0x0000003F) << 5))
#define PLL_GET_NPLL_DIVN_SDM(x)           ((u32)(((x >> 5) & 0x0000003F)))
#define PLL_MASK_NPLL_CK_OUT_SEL           ((u32)0x0000000F << 1)            /*!< R/W 0x0000  output divider selection. Default=0000(/1)                                                                0000=/1,  1000=/2,  1100=/8,  1110=/16,   1111=/32*/
#define PLL_NPLL_CK_OUT_SEL(x)             (((u32)((x) & 0x0000000F) << 1))
#define PLL_GET_NPLL_CK_OUT_SEL(x)         ((u32)(((x >> 1) & 0x0000000F)))
#define PLL_BIT_NPLL_ICP_HALF              ((u32)0x00000001 << 0)            /*!< R/W 0x0  charge pump current half or not                                    0: no half    1: half*/
/** @} */
...
/** @defgroup PLL_NPPLL_CTRL2
  ...
  * @{
  */
#define PLL_MASK_NPLL_STEP     ((u32)0x00001FFF << 19)           /*!< R/W 0x0  ssc step size selection.*/
#define PLL_NPLL_STEP(x)       (((u32)((x) & 0x00001FFF) << 19))
#define PLL_GET_NPLL_STEP(x)   ((u32)(((x >> 19) & 0x00001FFF)))
#define PLL_MASK_NPLL_TBASE    ((u32)0x00000FFF << 7)            /*!< R/W 0x0  ssc freq selection*/
#define PLL_NPLL_TBASE(x)      (((u32)((x) & 0x00000FFF) << 7))
#define PLL_GET_NPLL_TBASE(x)  ((u32)(((x >> 7) & 0x00000FFF)))
#define PLL_BIT_NPLL_EN_SSC    ((u32)0x00000001 << 6)            /*!< R/W 0x0  ssc enable. Default=0*/
#define PLL_MASK_NPLL_DUMMY2   ((u32)0x0000003F << 0)            /*!< R/W 0x0  HW used only , these are for reserved*/
...
/** @defgroup PLL_NPPLL_CTRL3
  ...
  * @{
  */
#define PLL_MASK_NPLL_F0F_SDM   ((u32)0x00001FFF << 19)           /*!< R/W 0x0  600M                                                      40M: 0 0000 0000 0000                                                          26M: 1 0011 1011 0001*/
#define PLL_NPLL_F0F_SDM(x)     (((u32)((x) & 0x00001FFF) << 19))
#define PLL_GET_NPLL_F0F_SDM(x) ((u32)(((x >> 19) & 0x00001FFF)))
#define PLL_MASK_NPLL_F0N_SDM   ((u32)0x00000007 << 16)           /*!< R/W 0x0  600M                                                        40M: 000                                                          26M: 000*/
#define PLL_NPLL_F0N_SDM(x)     (((u32)((x) & 0x00000007) << 16))
#define PLL_GET_NPLL_F0N_SDM(x) ((u32)(((x >> 16) & 0x00000007)))
#define PLL_BIT_NPLL_ORDER_SDM  ((u32)0x00000001 << 15)           /*!< R/W 0x0  SDM order*/
#define PLL_MASK_NPLL_DUMMY1    ((u32)0x00007FFF << 0)            /*!< R/W 0x0  HW used only , these are for reserved*/
...
/** @defgroup PLL_I2SPLL1_CTRL2
  ...
  * @{
  */
#define PLL_MASK_IPLL1_STEP    ((u32)0x00001FFF << 19)           /*!< R/W 0x0000000000000  ssc step size selection.*/
#define PLL_IPLL1_STEP(x)      (((u32)((x) & 0x00001FFF) << 19))
#define PLL_GET_IPLL1_STEP(x)  ((u32)(((x >> 19) & 0x00001FFF)))
#define PLL_MASK_IPLL1_TBASE   ((u32)0x00000FFF << 7)            /*!< R/W 0x000000000000  ssc freq selection*/
#define PLL_IPLL1_TBASE(x)     (((u32)((x) & 0x00000FFF) << 7))
#define PLL_GET_IPLL1_TBASE(x) ((u32)(((x >> 7) & 0x00000FFF)))
#define PLL_BIT_IPLL1_EN_SSC   ((u32)0x00000001 << 6)            /*!< R/W 0x0  ssc enable. Default=0*/
/** @} */
...
/** @defgroup PLL_I2SPLL2_CTRL2
  ...
  * @{
  */
#define PLL_MASK_IPLL2_STEP    ((u32)0x00001FFF << 19)           /*!< R/W 0x0000000000000  ssc step size selection.*/
#define PLL_IPLL2_STEP(x)      (((u32)((x) & 0x00001FFF) << 19))
#define PLL_GET_IPLL2_STEP(x)  ((u32)(((x >> 19) & 0x00001FFF)))
#define PLL_MASK_IPLL2_TBASE   ((u32)0x00000FFF << 7)            /*!< R/W 0x000000000000  ssc freq selection*/
#define PLL_IPLL2_TBASE(x)     (((u32)((x) & 0x00000FFF) << 7))
#define PLL_GET_IPLL2_TBASE(x) ((u32)(((x >> 7) & 0x00000FFF)))
#define PLL_BIT_IPLL2_EN_SSC   ((u32)0x00000001 << 6)            /*!< R/W 0x0  ssc enable. Default=0*/
/** @} */
...
/** @defgroup PLL_PS
  ...
  * @{
  */
#define PLL_BIT_PS_DUMMY         ((u32)0x00000001 << 15)          /*!< R/W 0x0  HW used only , these are for reserved*/
#define PLL_BIT_POW_CKGEN        ((u32)0x00000001 << 14)          /*!< R/W 0x0  pow of ckgen*/
#define PLL_MASK_REG_CKGEN_DIV   ((u32)0x000001FF << 5)           /*!< R/W 0x000111010  DIV9B , N=DIV<8:0>+2*/
#define PLL_REG_CKGEN_DIV(x)     (((u32)((x) & 0x000001FF) << 5))
#define PLL_GET_REG_CKGEN_DIV(x) ((u32)(((x >> 5) & 0x000001FF)))
#define PLL_BIT_EN_CK600M_PS     ((u32)0x00000001 << 4)           /*!< R/W 0x1  enable shifted clk source for flash*/
#define PLL_BIT_EN_CK600M        ((u32)0x00000001 << 3)           /*!< R/W 0x1  enable not shift clk source for flash*/
#define PLL_MASK_PHASE_SEL       ((u32)0x00000007 << 0)           /*!< R/W 0x000  AGPIO driving sel*/
...
#define PLL_BIT_POW_I          ((u32)0x00000001 << 1)            /*!< R/W/ES 0x1  power on BG current*/
#define PLL_BIT_POW_MBIAS      ((u32)0x00000001 << 2)            /*!< R/W/ES 0x0  power on mbias*/
#define PLL_BIT_BG_DUMMY0      ((u32)0x00000001 << 3)            /*!< R/W 0x0  HW used only , these are for reserved*/
#define PLL_MASK_R1_TUNE       ((u32)0x00000007 << 4)            /*!< R/W 0x100  Add 200k per step fine tune BG (Efuse)*/
#define PLL_R1_TUNE(x)         (((u32)((x) & 0x00000007) << 4))
#define PLL_GET_R1_TUNE(x)     ((u32)(((x >> 4) & 0x00000007)))
#define PLL_BIT_BG_DUMMY1      ((u32)0x00000001 << 7)            /*!< R/W 0x0  HW used only , these are for reserved*/
#define PLL_MASK_R2_TUNE       ((u32)0x00000007 << 8)            /*!< R/W 0x100  Add 20k per step fine tune BG (Efuse)*/
#define PLL_R2_TUNE(x)         (((u32)((x) & 0x00000007) << 8))
#define PLL_GET_R2_TUNE(x)     ((u32)(((x >> 8) & 0x00000007)))
#define PLL_BIT_BG_DUMMY2      ((u32)0x00000001 << 11)           /*!< R/W 0x0  HW used only , these are for reserved*/
#define PLL_MASK_VR1200_TUNE   ((u32)0x00000007 << 12)           /*!< R/W 0x100  Add 40k per step fine tune BG (Efuse)*/
#define PLL_VR1200_TUNE(x)     (((u32)((x) & 0x00000007) << 12))
#define PLL_GET_VR1200_TUNE(x) ((u32)(((x >> 12) & 0x00000007)))
#define PLL_BIT_BG_DUMMY3      ((u32)0x00000001 << 15)           /*!< R/W 0x0  HW used only , these are for reserved*/
/** @} */
