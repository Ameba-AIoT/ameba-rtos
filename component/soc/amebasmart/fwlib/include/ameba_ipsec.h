...
#define IPSEC_BIT_EFUSE_HMAC_KEY_ID           ((u32)0x00000001 << 30)          /*!<R/W 0  SHA HMAC: 1'b0: Load key from OTP key1, 1'b1: Load key from OTP key2 */
#define IPSEC_BIT_EFUSE_AES_KEY_ID(x)             ((u32)(((x) & 0x00000003) << 29)) /*!<R/W 0  AES: (29:30) 2'b00: Load key from OTP key1, 2'b01: Load key from OTP key2, 2'b10 for RSIP key_ecb, 2'b11 for RSIP key_ctr. */
/** @} */
...
typedef struct {
	...
	__IO uint32_t RSVD1[1010];                              /*!<  Reserved,  Address offset:0x38-0xFFC */
