...
#define CT_BIT_ADC_REG0X_LPAD2           ((u32)0x00000001 << 2)          /*!<R/W 0h  Bit[2] of analog ADC port REG0X_LPAD, pow_ref, pow ADC refgen */
#define CT_BIT_ADC_REG0X_LPAD1           ((u32)0x00000001 << 1)          /*!<R/W 0h  Bit[1] of analog ADC port REG0X_LPAD, pow, pow adc */
#define CT_BIT_ADC_REG0X_LPAD0           ((u32)0x00000001 << 0)          /*!<R/W 0h  Bit[0] of analog ADC port REG0X_LPAD, power LDO/mbias/res ladder, enable power cut/ldo */
/** @} */
 ...
 * @{
 **/
#define CT_BIT_ADC_REG0X_LPSD13          ((u32)0x00000001 << 13)          /*!<R/W 0h  POW_I, power on BG current */
#define CT_BIT_ADC_REG0X_LPSD12          ((u32)0x00000001 << 12)          /*!<R/W 0h  POW_BG, power on BG */
/** @} */
...
#define CT_MASK_ADC_DUMMY_SET            ((u32)0x0000007F << 16)          /*!<R/W 0h  Time between REG0X_LPAD[0] and REG0X_LPAD[2] , unit is 128K clock. This time is valid only when adc_dummy_ctrl is 0. time = (adc_dummy_set+1)*cycle */
#define CT_ADC_DUMMY_SET(x)              (((u32)((x) & 0x0000007F) << 16))
#define CT_GET_ADC_DUMMY_SET(x)          ((u32)(((x >> 16) & 0x0000007F)))
#define CT_MASK_ADC_PC_SET               ((u32)0x000000FF << 8)          /*!<R/W 16h  Time between REG0X_LPSD12 and REG0X_LPAD[0] power LDO/mbias/res ladder, unit is 128K clock. time = (adc_pc_set+2)*cycle */
#define CT_ADC_PC_SET(x)                 (((u32)((x) & 0x000000FF) << 8))
#define CT_GET_ADC_PC_SET(x)             ((u32)(((x >> 8) & 0x000000FF)))
#define CT_MASK_ADC_REF_SET              ((u32)0x000000FF << 0)          /*!<R/W 6h  Time between REG0X_LPAD[2] power_ref and REG0X_LPAD[1] pow_adc, unit is 128K clock. time = (adc_ref_set+2)*cycle */
...
typedef struct {
	...
	__I  uint32_t CT_RAW_CODE_FIFO_STATUS;                /*!< FIFO STATUS REGISTER,  Address offset: 0x014 */
