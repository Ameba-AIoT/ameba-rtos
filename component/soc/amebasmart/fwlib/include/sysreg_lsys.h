...
/** @defgroup REG_LSYS_PWC
  ...
  * @{
  */
#define LSYS_BIT_PWC_HP_DDRPHY    ((u16)0x00000001 << 12)           /*!< R/W 0x0  1: Enable ddr phy core power cut 0: Disable*/
#define LSYS_PWC_HP_DDRPHY(x)     ((u16)(((x) & 0x00000001) << 12))
#define LSYS_GET_PWC_HP_DDRPHY(x) ((u16)(((x >> 12) & 0x00000001)))
#define LSYS_BIT_PWC_LP_BTON      ((u16)0x00000001 << 9)            /*!< R/W 0x0  This is BT function total power cut control , the BT off power cut is follow it , and is controlled by BT IP . 1: Enable BT power cut 0: Disable*/
#define LSYS_PWC_LP_BTON(x)       ((u16)(((x) & 0x00000001) << 9))
#define LSYS_GET_PWC_LP_BTON(x)   ((u16)(((x >> 9) & 0x00000001)))
#define LSYS_BIT_PWC_HP_PLAT      ((u16)0x00000001 << 3)            /*!< R/W 0x0  This is the default power dommain. 1: Enable HP plat power cut 0: Disable*/
#define LSYS_PWC_HP_PLAT(x)       ((u16)(((x) & 0x00000001) << 3))
#define LSYS_GET_PWC_HP_PLAT(x)   ((u16)(((x >> 3) & 0x00000001)))
#define LSYS_BIT_PWC_LP_PLAT      ((u16)0x00000001 << 1)            /*!< R/W 0x0  1: Enable Lp plat power cut 0: Disable*/
#define LSYS_PWC_LP_PLAT(x)       ((u16)(((x) & 0x00000001) << 1))
#define LSYS_GET_PWC_LP_PLAT(x)   ((u16)(((x >> 1) & 0x00000001)))
/** @} */
...
/** @defgroup REG_LSYS_POR
  ...
  * @{
  */
#define LSYS_BIT_POR_HP_DDRPHY    ((u16)0x00000001 << 12)           /*!< R/W 0x0  0: global reset PD_HP_DDRPHY power domain 1: release reset*/
#define LSYS_POR_HP_DDRPHY(x)     ((u16)(((x) & 0x00000001) << 12))
#define LSYS_GET_POR_HP_DDRPHY(x) ((u16)(((x >> 12) & 0x00000001)))
#define LSYS_BIT_POR_LP_BTON      ((u16)0x00000001 << 9)            /*!< R/W 0x0  0: global reset PD_LP_BTON power domain 1: release por*/
#define LSYS_POR_LP_BTON(x)       ((u16)(((x) & 0x00000001) << 9))
#define LSYS_GET_POR_LP_BTON(x)   ((u16)(((x >> 9) & 0x00000001)))
#define LSYS_BIT_POR_HP_PLAT      ((u16)0x00000001 << 3)            /*!< R/W 0x0  0: global reset PD_HP_PLFM power domain 1: release por*/
#define LSYS_POR_HP_PLAT(x)       ((u16)(((x) & 0x00000001) << 3))
#define LSYS_GET_POR_HP_PLAT(x)   ((u16)(((x >> 3) & 0x00000001)))
#define LSYS_BIT_POR_LP_PLAT      ((u16)0x00000001 << 1)            /*!< R/W 0x0  0: global reset PD_LP_PLAT power domain 1: release por*/
#define LSYS_POR_LP_PLAT(x)       ((u16)(((x) & 0x00000001) << 1))
#define LSYS_GET_POR_LP_PLAT(x)   ((u16)(((x >> 1) & 0x00000001)))
/** @} */
...
/** @defgroup REG_LSYS_ISO
  ...
  * @{
  */
#define LSYS_BIT_ISO_HP_DDRPHY    ((u32)0x00000001 << 12)           /*!< R/W 0x1  1: isolate signals from PD_HP_DDRPHY to other power domain 0: release iso*/
#define LSYS_ISO_HP_DDRPHY(x)     ((u32)(((x) & 0x00000001) << 12))
#define LSYS_GET_ISO_HP_DDRPHY(x) ((u32)(((x >> 12) & 0x00000001)))
#define LSYS_BIT_ISO_LP_BTON      ((u32)0x00000001 << 9)            /*!< R/W 0x1  1: isolate signals from PD_LP_BTON to other power domain 0: release iso*/
#define LSYS_ISO_LP_BTON(x)       ((u32)(((x) & 0x00000001) << 9))
#define LSYS_GET_ISO_LP_BTON(x)   ((u32)(((x >> 9) & 0x00000001)))
#define LSYS_BIT_ISO_HP_PLAT      ((u32)0x00000001 << 3)            /*!< R/W 0x1  1: isolate signals from PD_HP_PLFM to other power domain 0: release iso*/
#define LSYS_ISO_HP_PLAT(x)       ((u32)(((x) & 0x00000001) << 3))
#define LSYS_GET_ISO_HP_PLAT(x)   ((u32)(((x >> 3) & 0x00000001)))
#define LSYS_BIT_ISO_LP_PLAT      ((u32)0x00000001 << 1)            /*!< R/W 0x1  1: isolate signals from PD_LP_PLAT to other power domain 0: release iso*/
...
/** @defgroup REG_LSYS_FEN_GRP0
  ...
  * @{
  */
#define APBPeriph_I2C2    ((u32)(0 << 30) | (0x00000001<< 27)) /*!< R/W 0x0  1: enable HS I2C1 function 0: reset*/
#define APBPeriph_I2C1    ((u32)(0 << 30) | (0x00000001<< 26)) /*!< R/W 0x0  1: enable HS I2C0 function 0: reset*/
#define APBPeriph_I2C0    ((u32)(0 << 30) | (0x00000001<< 25)) /*!< R/W 0x0  1: enable LS I2C function 0: reset*/
#define APBPeriph_WLAFE   ((u32)(0 << 30) | (0x00000001<< 24)) /*!< R/W 0x0  1: enable WL RFAFE control circuit, shall be 1 when enable WL or BT use WL RFAFE 0: reset*/
#define APBPeriph_GPIO    ((u32)(0 << 30) | (0x00000001<< 23)) /*!< R/W 0x0  1: enable LS GPIO function 0: reset*/
#define APBPeriph_CTC     ((u32)(0 << 30) | (0x00000001<< 21)) /*!< R/W 0x0  1: enable Captouch ADC function 0: reset*/
#define APBPeriph_ADC     ((u32)(0 << 30) | (0x00000001<< 20)) /*!< R/W 0x0  1: enable LS ADC function 0: reset*/
#define APBPeriph_LOGUART ((u32)(0 << 30) | (0x00000001<< 19) | (0x00000001 << 18)) /*!< R/W 0x0  Uartlog function reset 1: enable 0: reset*/
#define APBPeriph_IPC_LP  ((u32)(0 << 30) | (0x00000001<< 16)) /*!< R/W 0x0  1: enable LS IPC function 0: reset*/
#define APBPeriph_BTON    ((u32)(0 << 30) | (0x00000001<< 13)) /*!< R/W 0x0  BTON function enable 1: enable 0: disable*/
#define APBPeriph_AIP     ((u32)(0 << 30) | (0x00000001<< 12)) /*!< R/W 0x1  Debug thermal function enable*/
#define APBPeriph_THM     ((u32)(0 << 30) | (0x00000001<< 11)) /*!< R/W 0x1  Debug thermal function enable*/
#define APBPeriph_DTIM    ((u32)(0 << 30) | (0x00000001<< 10)) /*!< R/W 0x1  Debug timer function enable*/
#define APBPeriph_SCE     ((u32)(0 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  Flash sce function enable 1: enable sce 0: disable*/
#define APBPeriph_FLASH   ((u32)(0 << 30) | (0x00000001<< 8))  /*!< R/W 0x0  Flash spic function enable 1: enable flash 0: disable flash*/
#define APBPeriph_WLON    ((u32)(0 << 30) | (0x00000001<< 7))  /*!< R/W 0x0  WLON function enable 1: enable 0: disable*/
#define APBPeriph_NP      ((u32)(0 << 30) | (0x00000001<< 6))  /*!< R/W 0x0  1: enable KM4 0: reset*/
#define APBPeriph_LP      ((u32)(0 << 30) | (0x00000001<< 5))  /*!< R/W 0x0  1: enable KM0 0: reset*/
#define APBPeriph_HPLFM   ((u32)(0 << 30) | (0x00000001<< 4))  /*!< R/W 0x0  1: enable HP platform 0: reset*/
#define APBPeriph_LPLFM   ((u32)(0 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: enable LP platform 0: reset*/
#define APBPeriph_SIC     ((u32)(0 << 30) | (0x00000001<< 2))  /*!< R/W 0x0  1: enable SIC function 0: reset*/
#define APBPeriph_HPON    ((u32)(0 << 30) | (0x00000001<< 1))  /*!< R/W 0x0  1: enable HS SYSON Function 0: reset*/
/** @} */
...
/** @defgroup REG_LSYS_FEN_GRP1
  ...
  * @{
  */
#define APBPeriph_ZGB     ((u32)(1 << 30) | (0x00000001<< 28)) /*!< R/W 0x0  1: enable zgb function 0: disable Note: for zgb is in wlan off domain , after turn wlan off , it need an 0->1 transiton*/
#define APBPeriph_PSRAM   ((u32)(1 << 30) | (0x00000001<< 27)) /*!< R/W 0x0  1: enable PSRAM function 0: disable*/
#define APBPeriph_AUDIO   ((u32)(1 << 30) | (0x00000001<< 26)) /*!< R/W 0x0  When audio function enable , HS_SYSON_RAM domain must be on , for HSRAM memory at least in retention mode . 1: enable audio function 0: disable*/
#define APBPeriph_AC      ((u32)(1 << 30) | (0x00000001<< 25)) /*!< R/W 0x0  1: enable audio codec active function 0: disable*/
#define APBPeriph_DDRP    ((u32)(1 << 30) | (0x00000001<< 24)) /*!< R/W 0x0  1: enable ddr phy function 0: disable*/
#define APBPeriph_DDRC    ((u32)(1 << 30) | (0x00000001<< 23)) /*!< R/W 0x0  1: enable ddr controller function 0: disable*/
#define APBPeriph_IRDA    ((u32)(1 << 30) | (0x00000001<< 22)) /*!< R/W 0x0  1: enable girda function 0: disable*/
#define APBPeriph_ECDSA   ((u32)(1 << 30) | (0x00000001<< 21)) /*!< R/W 0x0  1: enable ecdsa function 0: disable*/
#define APBPeriph_ED25519 ((u32)(1 << 30) | (0x00000001<< 20)) /*!< R/W 0x0  1: enable ed25519 function 0: disable*/
#define APBPeriph_RSA     ((u32)(1 << 30) | (0x00000001<< 19)) /*!< R/W 0x0  1: enable rsa function 0: disable*/
#define APBPeriph_IPC_HP  ((u32)(1 << 30) | (0x00000001<< 18)) /*!< R/W 0x0  1: enable IPC function 0: disable*/
#define APBPeriph_LEDC    ((u32)(1 << 30) | (0x00000001<< 15)) /*!< R/W 0x0  1: enable SPORT function 0: disable*/
#define APBPeriph_TRNG    ((u32)(1 << 30) | (0x00000001<< 14)) /*!< R/W 0x0  1: enable TRNG function 0: disable*/
#define APBPeriph_USB     ((u32)(1 << 30) | (0x00000001<< 12)) /*!< R/W 0x0  1: enable USB function 0: disable*/
#define APBPeriph_SDH     ((u32)(1 << 30) | (0x00000001<< 11)) /*!< R/W 0x0  1: enable SDH function 0: disable*/
#define APBPeriph_SPI1    ((u32)(1 << 30) | (0x00000001<< 10)) /*!< R/W 0x0  1: enable SPI1 function 0: disable*/
#define APBPeriph_SPI0    ((u32)(1 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  1: enable SPI0 function 0: disable*/
#define APBPeriph_GDMA    ((u32)(1 << 30) | (0x00000001<< 5))  /*!< R/W 0x0  1: enable GDMA0 function 0: disable*/
#define APBPeriph_LCDC    ((u32)(1 << 30) | (0x00000001<< 4))  /*!< R/W 0x0  1: enable LCDC function 0: disable*/
#define APBPeriph_IPSEC   ((u32)(1 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: enable IPSEC function 0: disable*/
#define APBPeriph_LX1     ((u32)(1 << 30) | (0x00000001<< 2))  /*!< R/W 0x0  1: enable LX1 system function 0: disable*/
/** @} */
...
#define APBPeriph_SPORT0 ((u32)(2 << 30) | (0x00000001<< 8))  /*!< R/W 0x0  1: enable SPORT function 0: disable*/
#define APBPeriph_SPORT1 ((u32)(2 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  1: enable SPORT function 0: disable*/
#define APBPeriph_SPORT2 ((u32)(2 << 30) | (0x00000001<< 10)) /*!< R/W 0x0  1: enable SPORT function 0: disable*/
#define APBPeriph_SPORT3 ((u32)(2 << 30) | (0x00000001<< 11)) /*!< R/W 0x0  1: enable SPORT function 0: disable*/
#define APBPeriph_UART0  ((u32)(2 << 30) | (0x00000001<< 4) | (0x00000001 << 0))  /*!< R/W 0x0  Uart function reset (Note uart3 if for BT)*/
#define APBPeriph_UART1  ((u32)(2 << 30) | (0x00000001<< 5) | (0x00000001 << 1))  /*!< R/W 0x0  Uart function reset (Note uart3 if for BT)*/
#define APBPeriph_UART2  ((u32)(2 << 30) | (0x00000001<< 6) | (0x00000001 << 2))  /*!< R/W 0x0  Uart function reset (Note uart3 if for BT)*/
#define APBPeriph_UART3  ((u32)(2 << 30) | (0x00000001<< 7) | (0x00000001 << 3))  /*!< R/W 0x0  Uart function reset (Note uart3 if for BT)*/
/** @} */
...
/** @defgroup REG_LSYS_CKE_GRP0
  ...
  * @{
  */
#define APBPeriph_I2C2_CLOCK    ((u32)(0 << 30) | (0x00000001<< 27)) /*!< R/W 0x0  1: Enable HS I2C1 clock*/
#define APBPeriph_I2C1_CLOCK    ((u32)(0 << 30) | (0x00000001<< 26)) /*!< R/W 0x0  1: Enable HS I2C0 clock*/
#define APBPeriph_I2C0_CLOCK    ((u32)(0 << 30) | (0x00000001<< 25)) /*!< R/W 0x0  1: Enable LS I2C clock*/
#define APBPeriph_DTIM_CLOCK    ((u32)(0 << 30) | (0x00000001<< 23)) /*!< R/W 0x1  1: Enable LS dtim clk*/
#define APBPeriph_ECDSA_CLOCK   ((u32)(0 << 30) | (0x00000001<< 21)) /*!< R/W 0x0  1: Enable ecdsa engine clock*/
#define APBPeriph_ED25519_CLOCK ((u32)(0 << 30) | (0x00000001<< 20)) /*!< R/W 0x0  1: Enable ed25519 engine clock*/
#define APBPeriph_AIP_CLOCK     ((u32)(0 << 30) | (0x00000001<< 18)) /*!< R/W 0x1  1: Enable apb clk for aip use , include xtal/pll/regu control*/
#define APBPeriph_THM_CLOCK     ((u32)(0 << 30) | (0x00000001<< 17)) /*!< R/W 0x1  1: Enable LS thm clock*/
#define APBPeriph_ADC_CLOCK     ((u32)(0 << 30) | (0x00000001<< 15)) /*!< R/W 0x0  1: Enable LS ADC clock*/
#define APBPeriph_CTC_CLOCK     ((u32)(0 << 30) | (0x00000001<< 14)) /*!< R/W 0x0  1: Enable Captouch clock*/
#define APBPeriph_LOGUART_CLOCK ((u32)(0 << 30) | (0x00000001<< 13)) /*!< R/W 0x0  1: Enable Uartlog clock*/
#define APBPeriph_IPC_LP_CLOCK  ((u32)(0 << 30) | (0x00000001<< 12)) /*!< R/W 0x0  1: Enable LS IPC clock*/
#define APBPeriph_PX_CLOCK      ((u32)(0 << 30) | (0x00000001<< 11)) /*!< R/W 0x1  1: Enable Pinmux clock*/
#define APBPeriph_BTON_CLOCK    ((u32)(0 << 30) | (0x00000001<< 10)) /*!< R/W 0x0  1: Enable BT AON clock*/
#define APBPeriph_WLON_CLOCK    ((u32)(0 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  1: Enable WLAN AON clock*/
#define APBPeriph_GPIO_CLOCK    ((u32)(0 << 30) | (0x00000001<< 8))  /*!< R/W 0x0  1: Enable GPIO clock*/
#define APBPeriph_FLASH_CLOCK   ((u32)(0 << 30) | (0x00000001<< 7))  /*!< R/W 0x0  1: Enable SPIC source clock*/
#define APBPeriph_NP_CLOCK      ((u32)(0 << 30) | (0x00000001<< 6))  /*!< R/W 0x0  1: Enable KM4 clock*/
#define APBPeriph_LP_CLOCK      ((u32)(0 << 30) | (0x00000001<< 5))  /*!< R/W 0x0  1: Enable KM0 clock*/
#define APBPeriph_HPLFM_CLOCK   ((u32)(0 << 30) | (0x00000001<< 4))  /*!< R/W 0x0  1: Enable hs platform clock*/
#define APBPeriph_LPLFM_CLOCK   ((u32)(0 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: Enable ls platform clock*/
#define APBPeriph_SIC_CLOCK     ((u32)(0 << 30) | (0x00000001<< 2))  /*!< R/W 0x0  1: Enable SIC clock*/
#define APBPeriph_HPON_CLOCK    ((u32)(0 << 30) | (0x00000001<< 1))  /*!< R/W 0x0  1: Enable HSYSON register clock; 0: gated SYSON Register clock*/
/** @} */
...
/** @defgroup REG_LSYS_CKE_GRP1
  ...
  * @{
  */
#define APBPeriph_ZGB_CLOCK      ((u32)(1 << 30) | (0x00000001<< 27)) /*!< R/W 0x0  1: Enable zgb bus clock 0: Disable*/
#define APBPeriph_PSRAM_CLOCK    ((u32)(1 << 30) | (0x00000001<< 26)) /*!< R/W 0x0  1: Enable PSRAM bus clock 0: Disable*/
#define APBPeriph_AC_CLOCK       ((u32)(1 << 30) | (0x00000001<< 24)) /*!< R/W 0x0  1: Enable audio codec clock 0: Disable*/
#define APBPeriph_DDRP_CLOCK     ((u32)(1 << 30) | (0x00000001<< 19)) /*!< R/W 0x0  1: Enable ddr phy clock 0: Disable*/
#define APBPeriph_DDRC_CLOCK     ((u32)(1 << 30) | (0x00000001<< 18)) /*!< R/W 0x0  1: Enable ddrc clock 0: Disable*/
#define APBPeriph_IRDA_CLOCK     ((u32)(1 << 30) | (0x00000001<< 17)) /*!< R/W 0x0  1: Enable irda clock 0: Disable*/
#define APBPeriph_IPC_HP_CLOCK   ((u32)(1 << 30) | (0x00000001<< 16)) /*!< R/W 0x0  1: Enable IPC clock 0: Disable*/
#define APBPeriph_SDH_CLOCK      ((u32)(1 << 30) | (0x00000001<< 13)) /*!< R/W 0x0  1: Enable SD HOST bus clock 0: Disable*/
#define APBPeriph_TRNG_CLOCK     ((u32)(1 << 30) | (0x00000001<< 12)) /*!< R/W 0x0  1: Enable trng bus clock 0: Disable*/
#define APBPeriph_LEDC_CLOCK     ((u32)(1 << 30) | (0x00000001<< 11)) /*!< R/W 0x0  1: Enable ledc bus clock 0: Disable*/
#define APBPeriph_USB_CLOCK      ((u32)(1 << 30) | (0x00000001<< 10)) /*!< R/W 0x0  1: Enable USB bus clock 0: Disable*/
#define APBPeriph_SPI1_CLOCK     ((u32)(1 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  1: Enable SPI1 clock 0: Disable*/
#define APBPeriph_SPI0_CLOCK     ((u32)(1 << 30) | (0x00000001<< 8))  /*!< R/W 0x0  1: Enable SPI0 clock 0: Disable*/
#define APBPeriph_WMAC_CLOCK     ((u32)(1 << 30) | (0x00000001<< 5))  /*!< R/W 0x0  */
#define APBPeriph_GDMA_CLOCK     ((u32)(1 << 30) | (0x00000001<< 4))  /*!< R/W 0x0  1: Enable GDMA0 clock 0: Disable*/
#define APBPeriph_LCDCMIPI_CLOCK ((u32)(1 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: Enable LCDC&MIPI clock 0: Disable*/
#define APBPeriph_IPSEC_CLOCK    ((u32)(1 << 30) | (0x00000001<< 2))  /*!< R/W 0x0  1: Enable ipsec clock 0: Disable*/
#define APBPeriph_LX1_CLOCK      ((u32)(1 << 30) | (0x00000001<< 1))  /*!< R/W 0x0  1: Enable lx1 bus clock 0: Disable*/
#define APBPeriph_HPERI_CLOCK    ((u32)(1 << 30) | (0x00000001<< 0))  /*!< R/W 0x1  1: Enable hperi clock . If IP using hperi clk , this bit must be set . 0: Disable*/
/** @} */
...
#define APBPeriph_SPORT0_CLOCK ((u32)(2 << 30) | (0x00000001<< 4))  /*!< R/W 0x0  1: Enable 4path sport clock 0: Disable*/
#define APBPeriph_SPORT1_CLOCK ((u32)(2 << 30) | (0x00000001<< 5))  /*!< R/W 0x0  1: Enable 4path sport clock 0: Disable*/
#define APBPeriph_SPORT2_CLOCK ((u32)(2 << 30) | (0x00000001<< 6))  /*!< R/W 0x0  1: Enable 4path sport clock 0: Disable*/
#define APBPeriph_SPORT3_CLOCK ((u32)(2 << 30) | (0x00000001<< 7))  /*!< R/W 0x0  1: Enable 4path sport clock 0: Disable*/
#define APBPeriph_UART0_CLOCK  ((u32)(2 << 30) | (0x00000001<< 0))  /*!< R/W 0x0  1: Enable Uart1 clock  0: Disable*/
#define APBPeriph_UART1_CLOCK  ((u32)(2 << 30) | (0x00000001<< 1))  /*!< R/W 0x0  1: Enable Uart1 clock  0: Disable*/
#define APBPeriph_UART2_CLOCK  ((u32)(2 << 30) | (0x00000001<< 2))  /*!< R/W 0x0  1: Enable Uart1 clock  0: Disable*/
#define APBPeriph_UART3_CLOCK  ((u32)(2 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: Enable Uart1 clock  0: Disable*/
/** @} */
...
#define LSYS_MASK_CKD_NP                           ((u32)0x00000007 << 0)          /*!<R/WPD 3h  NP clock divider, it is based on np pll (800M). 0: not valid 1: div2 2: div3 3/other: divider by this value + 1 */
...
/** @defgroup REG_LSYS_SW_RST_CTRL
  ...
  * @{
  */
#define LSYS_BIT_APSYS_RST          ((u32)0x00000001 << 31)           /*!< R/WE 0x0  Only when REG_SW_RST_TRIG is 0x69696969 , this reg can be write*/
#define LSYS_APSYS_RST(x)           ((u32)(((x) & 0x00000001) << 31))
#define LSYS_GET_APSYS_RST(x)       ((u32)(((x >> 31) & 0x00000001)))
#define LSYS_BIT_NPSYS_RST          ((u32)0x00000001 << 30)           /*!< R/WE 0x0  Only when REG_SW_RST_TRIG is 0x69696969 , this reg can be write*/
#define LSYS_NPSYS_RST(x)           ((u32)(((x) & 0x00000001) << 30))
#define LSYS_GET_NPSYS_RST(x)       ((u32)(((x >> 30) & 0x00000001)))
#define LSYS_BIT_LPSYS_RST          ((u32)0x00000001 << 29)           /*!< R/WE 0x0  Only when REG_SW_RST_TRIG is 0x69696969 , this reg can be write*/
#define LSYS_LPSYS_RST(x)           ((u32)(((x) & 0x00000001) << 29))
#define LSYS_GET_LPSYS_RST(x)       ((u32)(((x >> 29) & 0x00000001)))
#define LSYS_BIT_PERIALL_RST_EN     ((u32)0x00000001 << 1)            /*!< R/W 0x0  1. warm reset request by one cpu will reset all peri and local cpu 0. warm reset request by one cpu will only reset local cpu Note : peri rst will use sysrst mst also*/
#define LSYS_PERIALL_RST_EN(x)      ((u32)(((x) & 0x00000001) << 1))
#define LSYS_GET_PERIALL_RST_EN(x)  ((u32)(((x >> 1) & 0x00000001)))
#define LSYS_BIT_OTHERCPU_RST_EN    ((u32)0x00000001 << 0)            /*!< R/W 0x0  1. warm reset request by one cpu will reset other cpu's core and local cpu 0. warm reset request by one cpu will only reset local cpu*/
...
/** @defgroup REG_LSYS_SW_RST_TRIG
  ...
  * @{
  */
#define LSYS_MASK_TRIG_RST   ((u32)0xFFFFFFFF << 0)           /*!< R/WPD 0x0  System reset trigger register Write 0x96969696 to enable the write of reset control Write 0x69696969 will trigger the system if REG_SW_RST_CTRL set .*/
...
#define LSYS_BIT_PLFM_AUTO_ICG_EN      ((u32)0x00000001 << 24)           /*!< R/W 0x0  1: Enable LS platform auto clock-gating for power save 0: Disable*/
...
#define LSYS_BIT_KM0_RETENTION_MODE    ((u32)0x00000001 << 16)           /*!< R/W 0x0  1: Enable, when KM0 reset, Cache will not be cleared  0: Disable, when KM0 reset, Cache will be cleared by HW*/
#define LSYS_KM0_RETENTION_MODE(x)     ((u32)(((x) & 0x00000001) << 16))
#define LSYS_GET_KM0_RETENTION_MODE(x) ((u32)(((x >> 16) & 0x00000001)))
#define LSYS_BIT_HUK_PROT              ((u32)0x00000001 << 0)            /*!< R/WH 0x0  0: only cpu can read HUK key 1: no one can read HUK key This bit will be latch to high when it was write to 1 until reset again .*/
...
/** @defgroup REG_LSYS_BT_CTRL0
  ...
  * @{
  */
#define LSYS_BIT_BT_PWM_NM                          ((u32)0x00000001 << 31)           /*!< R/W 0x0  ECO Add. SWR mode of BT active 1: PWM Mode 0: PFM Mode*/
#define LSYS_BT_PWM_NM(x)                           ((u32)(((x) & 0x00000001) << 31))
#define LSYS_GET_BT_PWM_NM(x)                       ((u32)(((x >> 31) & 0x00000001)))
#define LSYS_BIT_WL_MP_STATUS                       ((u32)0x00000001 << 26)           /*!< R/W 0x0  Wi-Fi MP status*/
#define LSYS_WL_MP_STATUS(x)                        ((u32)(((x) & 0x00000001) << 26))
#define LSYS_GET_WL_MP_STATUS(x)                    ((u32)(((x >> 26) & 0x00000001)))
#define LSYS_BIT_WL_USE_REQ                         ((u32)0x00000001 << 25)           /*!< R/W 0x0  who uses loguart  trx pad depends on the xor of WL_USE_REQ and BT_USE_REQ, wifi can send use request by change the value of WL_USE_REQ*/
...
#define LSYS_BIT_FORCE_LOGUART_USE_LOGUART_PAD_B    ((u32)0x00000001 << 23)           /*!< R/W 0x0  Force wifi soc to use loguart pad mandatory if necessary 0: loguart use loguart trx pad 1: who uses loguart trx pad depends on BTWL_USE_LOGUART_PAD_ST*/
...
#define LSYS_BIT_BT_HW_EN_BTAFE_2REGU               ((u32)0x00000001 << 22)           /*!< R/W 0x0  Control 3.3V power reset of BT afe, need level shift to 3.3V by regu, SW shall set the bit to1 when BT use BT AFE*/
#define LSYS_BT_HW_EN_BTAFE_2REGU(x)                ((u32)(((x) & 0x00000001) << 22))
#define LSYS_GET_BT_HW_EN_BTAFE_2REGU(x)            ((u32)(((x >> 22) & 0x00000001)))
#define LSYS_BIT_BT_HW_EN_BTAFE                     ((u32)0x00000001 << 21)           /*!< R/W 0x0  Core power reset of BT afe, SW shall set the bit to1 when BT use BT AFE*/
#define LSYS_BT_HW_EN_BTAFE(x)                      ((u32)(((x) & 0x00000001) << 21))
#define LSYS_GET_BT_HW_EN_BTAFE(x)                  ((u32)(((x >> 21) & 0x00000001)))
#define LSYS_BIT_BT_EN_TST_SI_CTRL_RFC              ((u32)0x00000001 << 20)           /*!< R/W 0x1  */
#define LSYS_BT_EN_TST_SI_CTRL_RFC(x)               ((u32)(((x) & 0x00000001) << 20))
#define LSYS_GET_BT_EN_TST_SI_CTRL_RFC(x)           ((u32)(((x >> 20) & 0x00000001)))
#define LSYS_BIT_BT_USE_EXT_UART                    ((u32)0x00000001 << 19)           /*!< R/W 0x0  1: BT use external uart 0: BT use internal uart*/
#define LSYS_BT_USE_EXT_UART(x)                     ((u32)(((x) & 0x00000001) << 19))
#define LSYS_GET_BT_USE_EXT_UART(x)                 ((u32)(((x >> 19) & 0x00000001)))
#define LSYS_MASK_BT_GPIO_FUN_SEL                   ((u32)0x00000007 << 16)           /*!< R/W 0x0  BT GPIO function select, 5:I2C mode*/
#define LSYS_BT_GPIO_FUN_SEL(x)                     (((u32)((x) & 0x00000007) << 16))
#define LSYS_GET_BT_GPIO_FUN_SEL(x)                 ((u32)(((x >> 16) & 0x00000007)))
#define LSYS_BIT_BT_WAKE_HOST_POL                   ((u32)0x00000001 << 15)           /*!< R/W 0x1  1: BT_WAKE_HOST to CPU and pinmux 0: pinmux to CPU for external trig*/
#define LSYS_BT_WAKE_HOST_POL(x)                    ((u32)(((x) & 0x00000001) << 15))
#define LSYS_GET_BT_WAKE_HOST_POL(x)                ((u32)(((x >> 15) & 0x00000001)))
#define LSYS_BIT_HOST_WAKE_BT_POL                   ((u32)0x00000001 << 14)           /*!< R/W 0x1  1: HOST_WAKE_BT to BT and pinmux 0: pinmux to BT for external trig*/
#define LSYS_HOST_WAKE_BT_POL(x)                    ((u32)(((x) & 0x00000001) << 14))
#define LSYS_GET_HOST_WAKE_BT_POL(x)                ((u32)(((x >> 14) & 0x00000001)))
#define LSYS_BIT_HOST_WAKE_BT                       ((u32)0x00000001 << 13)           /*!< R/W 0x0  CPU set this bit to 1 to wake BT*/
#define LSYS_HOST_WAKE_BT(x)                        ((u32)(((x) & 0x00000001) << 13))
#define LSYS_GET_HOST_WAKE_BT(x)                    ((u32)(((x >> 13) & 0x00000001)))
#define LSYS_BIT_BT_AHB_ACCESS_GNT                  ((u32)0x00000001 << 12)           /*!< R 0x0  Access grant for system master access BT reg through AHB bus*/
#define LSYS_BT_AHB_ACCESS_GNT(x)                   ((u32)(((x) & 0x00000001) << 12))
#define LSYS_GET_BT_AHB_ACCESS_GNT(x)               ((u32)(((x >> 12) & 0x00000001)))
#define LSYS_BIT_BT_AHB_ACCESS_REQ                  ((u32)0x00000001 << 11)           /*!< R/W 0x0  System master set this bit to 1 and wait  BT_AHB_ACCESS_GNT=1 before access BT reg through AHB bus, when access finish, shall set this bit to 0*/
#define LSYS_BT_AHB_ACCESS_REQ(x)                   ((u32)(((x) & 0x00000001) << 11))
#define LSYS_GET_BT_AHB_ACCESS_REQ(x)               ((u32)(((x >> 11) & 0x00000001)))
#define LSYS_BIT_BT_PLL_LDO_MODE                    ((u32)0x00000001 << 10)           /*!< R/W 0x0  1: system force AFE PLL LDO to Power cut mode 0: AFE PLL LDO mode is controlled by BTON parameter*/
#define LSYS_BT_PLL_LDO_MODE(x)                     ((u32)(((x) & 0x00000001) << 10))
#define LSYS_GET_BT_PLL_LDO_MODE(x)                 ((u32)(((x >> 10) & 0x00000001)))
#define LSYS_BIT_BT_AFEPLL_EN                       ((u32)0x00000001 << 9)            /*!< R/W 0x0  1: system force AFE PLL enable 0: AFE PLL enable by BT PMC*/
#define LSYS_BT_AFEPLL_EN(x)                        ((u32)(((x) & 0x00000001) << 9))
#define LSYS_GET_BT_AFEPLL_EN(x)                    ((u32)(((x >> 9) & 0x00000001)))
#define LSYS_BIT_BT_AFELDO_EN                       ((u32)0x00000001 << 8)            /*!< R/W 0x0  1: system force AFE LDO enable 0: AFE LDO enable by BT PMC*/
#define LSYS_BT_AFELDO_EN(x)                        ((u32)(((x) & 0x00000001) << 8))
#define LSYS_GET_BT_AFELDO_EN(x)                    ((u32)(((x >> 8) & 0x00000001)))
#define LSYS_MASK_BT_OFF_PC_WT                      ((u32)0x00000003 << 6)            /*!< R/W 0x0  Wait time select for BT off power cut stable*/
#define LSYS_BT_OFF_PC_WT(x)                        (((u32)((x) & 0x00000003) << 6))
#define LSYS_GET_BT_OFF_PC_WT(x)                    ((u32)(((x >> 6) & 0x00000003)))
#define LSYS_BIT_ASWR_REF_BT_AUD                    ((u32)0x00000001 << 5)            /*!< R/W 0x0  Audio swr parameter refer BT status*/
#define LSYS_ASWR_REF_BT_AUD(x)                     ((u32)(((x) & 0x00000001) << 5))
#define LSYS_GET_ASWR_REF_BT_AUD(x)                 ((u32)(((x >> 5) & 0x00000001)))
#define LSYS_BIT_ASWR_REF_BT_MEM                    ((u32)0x00000001 << 4)            /*!< R/W 0x0  Memory swr parameter refer BT status*/
#define LSYS_ASWR_REF_BT_MEM(x)                     ((u32)(((x) & 0x00000001) << 4))
#define LSYS_GET_ASWR_REF_BT_MEM(x)                 ((u32)(((x >> 4) & 0x00000001)))
#define LSYS_BIT_DSWR_REF_BT                        ((u32)0x00000001 << 3)            /*!< R/W 0x1  Core swr parameter refer BT status*/
#define LSYS_DSWR_REF_BT(x)                         ((u32)(((x) & 0x00000001) << 3))
#define LSYS_GET_DSWR_REF_BT(x)                     ((u32)(((x >> 3) & 0x00000001)))
#define LSYS_BIT_BT_HW_EN_BTRF_2REGU                ((u32)0x00000001 << 2)            /*!< R/W 0x0  Control 3.3V power reset of BT rfc, need level shift to 3.3V by regu, SW shall set the bit to1 when BT use BT RFC*/
#define LSYS_BT_HW_EN_BTRF_2REGU(x)                 ((u32)(((x) & 0x00000001) << 2))
#define LSYS_GET_BT_HW_EN_BTRF_2REGU(x)             ((u32)(((x >> 2) & 0x00000001)))
#define LSYS_BIT_BT_HW_EN_BTRF                      ((u32)0x00000001 << 1)            /*!< R/W 0x0  Core power reset of BT rfc, SW shall set the bit to1 when BT use BT RFC*/
#define LSYS_BT_HW_EN_BTRF(x)                       ((u32)(((x) & 0x00000001) << 1))
#define LSYS_GET_BT_HW_EN_BTRF(x)                   ((u32)(((x >> 1) & 0x00000001)))
#define LSYS_BIT_BT_USE_WL_RFAFE                    ((u32)0x00000001 << 0)            /*!< R/W 0x0  Indicate BT select WL RFAFE, shall not switch when BT is on*/
...
/** @defgroup REG_LSYS_BT_CTRL1
  ...
  * @{
  */
#define LSYS_BIT_BT_PLLCLK_SEL      ((u32)0x00000001 << 31)           /*!< R/W 0x0  ECO ADD 0: select BTS0_ANAPAR_PLL0[10]&[4] from BT 1: select from REG 0x54[30:29]*/
#define LSYS_BT_PLLCLK_SEL(x)       ((u32)(((x) & 0x00000001) << 31))
#define LSYS_GET_BT_PLLCLK_SEL(x)   ((u32)(((x >> 31) & 0x00000001)))
#define LSYS_BIT_BT_FREF_EDGE_S0    ((u32)0x00000001 << 30)           /*!< R/W 0x0  ECO ADD BTS0_ANAPAR_PLL0[10]. Valid when 0x54[31] = 1*/
#define LSYS_BT_FREF_EDGE_S0(x)     ((u32)(((x) & 0x00000001) << 30))
#define LSYS_GET_BT_FREF_EDGE_S0(x) ((u32)(((x >> 30) & 0x00000001)))
#define LSYS_BIT_BT_FREF_SEL_S0     ((u32)0x00000001 << 29)           /*!< R/W 0x0  ECO ADD BTS0_ANAPAR_PLL0[4].   Valid when 0x54[31] = 1*/
#define LSYS_BT_FREF_SEL_S0(x)      ((u32)(((x) & 0x00000001) << 29))
#define LSYS_GET_BT_FREF_SEL_S0(x)  ((u32)(((x >> 29) & 0x00000001)))
#define LSYS_MASK_BT_PMC_STATE      ((u32)0x00007FFF << 0)            /*!< R 0x0  Indicate BT PMC current state, for debug*/
...
/** @defgroup REG_LSYS_AIP_CTRL1
  ...
  * @{
  */
#define LSYS_BIT_BG_PWR        ((u32)0x00000001 << 8)           /*!< R/W 0x1  1: power on ddrphy bandgap 0: shutdown bg*/
#define LSYS_BG_PWR(x)         ((u32)(((x) & 0x00000001) << 8))
#define LSYS_GET_BG_PWR(x)     ((u32)(((x >> 8) & 0x00000001)))
#define LSYS_BIT_BG_ON_USB2    ((u32)0x00000001 << 5)           /*!< R/W 0x1  Bandgap USB2 current enable*/
#define LSYS_BG_ON_USB2(x)     ((u32)(((x) & 0x00000001) << 5))
#define LSYS_GET_BG_ON_USB2(x) ((u32)(((x >> 5) & 0x00000001)))
#define LSYS_BIT_BG_ON_MIPI    ((u32)0x00000001 << 4)           /*!< R/W 0x1  Bandgap MIPI current enable*/
#define LSYS_BG_ON_MIPI(x)     ((u32)(((x) & 0x00000001) << 4))
#define LSYS_GET_BG_ON_MIPI(x) ((u32)(((x >> 4) & 0x00000001)))
#define LSYS_BIT_BG_LPF        ((u32)0x00000001 << 2)           /*!< R/W 0x1  Bandgap low pass filter*/
...
/** @defgroup REG_LSYS_AIP_CTRL2
  ...
  * @{
  */
#define LSYS_BIT_XTAL_LPS_EN_DIGI_CK    ((u32)0x00000001 << 24)           /*!< R/W 0x0  0: disable XTAL clock for digital when XTAL enter LPS mode 1: enable XTAL clock for digital when XTAL enter LPS mode*/
...
/** @defgroup REG_LSYS_FPGA_CLK_INFO
  ...
  * @{
  */
#define LSYS_MASK_FPGA_AP_CLK      ((u32)0x000000FF << 24)           /*!< R 0x0  FPGA AP clock*/
#define LSYS_FPGA_AP_CLK(x)        (((u32)((x) & 0x000000FF) << 24))
#define LSYS_GET_FPGA_AP_CLK(x)    ((u32)(((x >> 24) & 0x000000FF)))
#define LSYS_MASK_FPGA_NP_CLK      ((u32)0x000000FF << 16)           /*!< R 0x0  FPGA NP clock*/
...
#define LSYS_MASK_FPGA_FLASH_CLK   ((u32)0x000000FF << 0)            /*!< R 0x0  FPGA Flash clock*/
...
/** @defgroup REG_LSYS_SCAN_CTRL
  ...
  * @{
  */
#define LSYS_MASK_CHIP_INFO_EN   ((u32)0x0000000F << 28)           /*!< R/W 0x0  Only when this field set to 4'hA, rl_ver/rl_no can be read out .*/
#define LSYS_CHIP_INFO_EN(x)     (((u32)((x) & 0x0000000F) << 28))
#define LSYS_GET_CHIP_INFO_EN(x) ((u32)(((x >> 28) & 0x0000000F)))
#define LSYS_MASK_RL_VER         ((u32)0x0000000F << 16)           /*!< RMSK0 0x0  CHIP cut verison : 0:  A-cut 1:  B-cut ...*/
...
#define LSYS_BIT_ENG_MODE_AON    ((u32)0x00000001 << 30)           /*!< R/WA0 0x0  Wrtie 1 to set aon enter eng_mode*/
#define LSYS_ENG_MODE_AON(x)     ((u32)(((x) & 0x00000001) << 30))
#define LSYS_GET_ENG_MODE_AON(x) ((u32)(((x >> 30) & 0x00000001)))
#define LSYS_BIT_BD_OPT1         ((u32)0x00000001 << 29)           /*!< R 0x0  Bonding option-ext_clk*/
#define LSYS_BD_OPT1(x)          ((u32)(((x) & 0x00000001) << 29))
#define LSYS_GET_BD_OPT1(x)      ((u32)(((x >> 29) & 0x00000001)))
#define LSYS_BIT_BD_OPT0         ((u32)0x00000001 << 28)           /*!< R 0x0  Bonding option-ext_rstb*/
#define LSYS_BD_OPT0(x)          ((u32)(((x) & 0x00000001) << 28))
#define LSYS_GET_BD_OPT0(x)      ((u32)(((x >> 28) & 0x00000001)))
#define LSYS_BIT_PTRP_BOOTSEL    ((u32)0x00000001 << 20)           /*!< R 0x0  Power on trapped bootsel value*/
...
#define LSYS_MASK_HW_CPU_ID      ((u32)0x00000003 << 6)            /*!< R 0x0  Different CPU reading this register will return different value. If read by LP: return 0 If read by NP: return 1 if read by AP: return 2*/
#define LSYS_HW_CPU_ID(x)        (((u32)((x) & 0x00000003) << 6))
#define LSYS_GET_HW_CPU_ID(x)    ((u32)(((x >> 6) & 0x00000003)))
#define LSYS_MASK_HW_VER_ID      ((u32)0x00000003 << 4)            /*!< R 0x0  Vendor ID Download FW version 00: UMC 01: SMIC 10: TSMC*/
...
/** @defgroup REG_LSYS_SYSTEM_CFG1
  ...
  * @{
  */
#define LSYS_MASK_PTRP_ICFG        ((u32)0x0000000F << 28)           /*!< R 0x0  Trapped ICFG data value 0: normall mode XXXX: the other mode (Test Mode)*/
...
#define LSYS_BIT_ICFG_SEL          ((u32)0x00000001 << 20)           /*!< R/W 0x0  If 1, using icfg_sw to replace trapped icfg value.*/
#define LSYS_ICFG_SEL(x)           ((u32)(((x) & 0x00000001) << 20))
#define LSYS_GET_ICFG_SEL(x)       ((u32)(((x >> 20) & 0x00000001)))
#define LSYS_BIT_SYSPLL_CLKRDY     ((u32)0x00000001 << 12)           /*!< R 0x0  System pll ready flag 1: ready*/
#define LSYS_SYSPLL_CLKRDY(x)      ((u32)(((x) & 0x00000001) << 12))
#define LSYS_GET_SYSPLL_CLKRDY(x)  ((u32)(((x >> 12) & 0x00000001)))
#define LSYS_BIT_OSC32K_CLKRDY     ((u32)0x00000001 << 10)           /*!< R 0x0  OSC 128k ready flag 1: ready*/
#define LSYS_OSC32K_CLKRDY(x)      ((u32)(((x) & 0x00000001) << 10))
#define LSYS_GET_OSC32K_CLKRDY(x)  ((u32)(((x >> 10) & 0x00000001)))
#define LSYS_BIT_XTAL32K_CLKRDY    ((u32)0x00000001 << 9)            /*!< R 0x0  XTAL 32k ready flag 1: ready*/
#define LSYS_XTAL32K_CLKRDY(x)     ((u32)(((x) & 0x00000001) << 9))
#define LSYS_GET_XTAL32K_CLKRDY(x) ((u32)(((x >> 9) & 0x00000001)))
#define LSYS_BIT_XTAL_CLKRDY       ((u32)0x00000001 << 8)            /*!< R 0x0  XTAL clock stable 1: Clock Stable*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL0
  ...
  * @{
  */
#define LSYS_MASK_CM0_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  ls cm0 read expirytimestamp control*/
#define LSYS_CM0_AREXPIRYTIMESTAMP(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define LSYS_GET_CM0_AREXPIRYTIMESTAMP(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define LSYS_MASK_CM0_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  ls cm0 write expirytimestamp control*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL1
  ...
  * @{
  */
#define LSYS_MASK_GDMA_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  gdma read expirytimestamp control*/
#define LSYS_GDMA_AREXPIRYTIMESTAMP(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define LSYS_GET_GDMA_AREXPIRYTIMESTAMP(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define LSYS_MASK_GDMA_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  gdma write expirytimestamp control*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL2
  ...
  * @{
  */
#define LSYS_MASK_LCDC_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  lcdc read expirytimestamp control*/
#define LSYS_LCDC_AREXPIRYTIMESTAMP(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define LSYS_GET_LCDC_AREXPIRYTIMESTAMP(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define LSYS_MASK_LCDC_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  lcdc write expirytimestamp control*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL3
  ...
  * @{
  */
#define LSYS_MASK_LX_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  lx read expirytimestamp control*/
#define LSYS_LX_AREXPIRYTIMESTAMP(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define LSYS_GET_LX_AREXPIRYTIMESTAMP(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define LSYS_MASK_LX_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  lx write expirytimestamp control*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL4
  ...
  * @{
  */
#define LSYS_MASK_M1_TO_OTHER_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  m1 to other read expirytimestamp control*/
...
#define LSYS_MASK_M1_TO_OTHER_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  m1 to other write expirytimestamp control*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL5
  ...
  * @{
  */
#define LSYS_MASK_M1_TO_S0_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  m1 to sys read expirytimestamp control*/
...
#define LSYS_MASK_M1_TO_S0_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  m1 to sys write expirytimestamp control*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL6
  ...
  * @{
  */
#define LSYS_MASK_NP_CPU_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  np cpu read expirytimestamp control*/
#define LSYS_NP_CPU_AREXPIRYTIMESTAMP(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define LSYS_GET_NP_CPU_AREXPIRYTIMESTAMP(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define LSYS_MASK_NP_CPU_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  np cpu write expirytimestamp control*/
...
/** @defgroup REG_LSYS_BUS_EXPSTAMP_CTRL7
  ...
  * @{
  */
#define LSYS_MASK_WIFI_AREXPIRYTIMESTAMP   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  wlan read expirytimestamp control*/
#define LSYS_WIFI_AREXPIRYTIMESTAMP(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define LSYS_GET_WIFI_AREXPIRYTIMESTAMP(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define LSYS_MASK_WIFI_AWEXPIRYTIMESTAMP   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  wlan write expirytimestamp control*/
...
/** @defgroup REG_LSYS_SYSRST_MSK0
  ...
  * @{
  */
#define APBPeriph_MSK_I2C2   ((u32)(0 << 30) | (0x00000001<< 27)) /*!< R/W 0x0  1: mask HS I2C1 reset when sys reset happen  0: reset*/
#define APBPeriph_MSK_I2C1   ((u32)(0 << 30) | (0x00000001<< 26)) /*!< R/W 0x0  1: mask HS I2C0 reset when sys reset happen  0: reset*/
#define APBPeriph_MSK_I2C0   ((u32)(0 << 30) | (0x00000001<< 25)) /*!< R/W 0x0  1: mask LS I2C reset when sys reset happen  0: reset*/
#define APBPeriph_WLAFE      ((u32)(0 << 30) | (0x00000001<< 24)) /*!< R/W 0x0  1: mask WL RFAFE control circuit, shall be 1 when mask WL or BT use WL RFAFE 0: reset*/
#define APBPeriph_MSK_GPIO   ((u32)(0 << 30) | (0x00000001<< 23)) /*!< R/W 0x1  1: mask LS GPIO reset when sys reset happen  0: reset*/
#define APBPeriph_MSK_CTC    ((u32)(0 << 30) | (0x00000001<< 21)) /*!< R/W 0x0  1: mask Captouch ADC reset when sys reset happen  0: reset*/
#define APBPeriph_MSK_ADC    ((u32)(0 << 30) | (0x00000001<< 20)) /*!< R/W 0x0  1: mask LS ADC reset when sys reset happen  0: reset*/
#define APBPeriph_LOGUART    ((u32)(0 << 30) | (0x00000001<< 19) | (0x00000001 << 18)) /*!< R/W 0x0  mask reset when sys reset happen  reset 1: mask 0: reset*/
#define APBPeriph_MSK_IPC_LP ((u32)(0 << 30) | (0x00000001<< 16)) /*!< R/W 0x0  1: mask LS IPC reset when sys reset happen  0: reset*/
#define APBPeriph_MSK_BTON   ((u32)(0 << 30) | (0x00000001<< 13)) /*!< R/W 0x0  mask reset when sys reset happen  mask 1: mask 0: disable*/
#define APBPeriph_MSK_AIP    ((u32)(0 << 30) | (0x00000001<< 12)) /*!< R/W 0x1  mask aip reset when sys reset happen  mask*/
#define APBPeriph_MSK_THM    ((u32)(0 << 30) | (0x00000001<< 11)) /*!< R/W 0x0  mask thml reset when sys reset happen  mask*/
#define APBPeriph_MSK_DTIM   ((u32)(0 << 30) | (0x00000001<< 10)) /*!< R/W 0x0  mask dtim reset when sys reset happen  mask*/
#define APBPeriph_MSK_SCE    ((u32)(0 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  mask rsip reset when sys reset happen  mask 1: mask sce 0: disable*/
#define APBPeriph_FLASH      ((u32)(0 << 30) | (0x00000001<< 8))  /*!< R/W 0x0  mask Flash spic reset when sys reset happen  mask 1: mask flash 0: disable flash*/
#define APBPeriph_MSK_WLON   ((u32)(0 << 30) | (0x00000001<< 7))  /*!< R/W 0x0  mask WLON reset when sys reset happen  mask 1: mask 0: disable*/
#define APBPeriph_MSK_NP     ((u32)(0 << 30) | (0x00000001<< 6))  /*!< R/W 0x0  1: mask KM4 0: reset*/
#define APBPeriph_MSK_LP     ((u32)(0 << 30) | (0x00000001<< 5))  /*!< R/W 0x0  1: mask KM0 0: reset*/
#define APBPeriph_MSK_HPLFM  ((u32)(0 << 30) | (0x00000001<< 4))  /*!< R/W 0x0  1: mask HP platform 0: reset*/
#define APBPeriph_MSK_LPLFM  ((u32)(0 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: mask LP platform 0: reset*/
#define APBPeriph_MSK_SIC    ((u32)(0 << 30) | (0x00000001<< 2))  /*!< R/W 0x0  1: mask SIC reset when sys reset happen  0: reset*/
#define APBPeriph_MSK_HPON   ((u32)(0 << 30) | (0x00000001<< 1))  /*!< R/W 0x1  1: mask HS SYSON reset when sys reset happen  0: reset*/
/** @} */
...
/** @defgroup REG_LSYS_SYSRST_MSK1
  ...
  * @{
  */
#define APBPeriph_MSK_ZGB     ((u32)(1 << 30) | (0x00000001<< 28)) /*!< R/W 0x0  1: mask zgb reset when sys reset happen  0: disable Note: for zgb is in wlan off domain , after turn wlan off , it need an 0->1 transiton*/
#define APBPeriph_MSK_PSRAM   ((u32)(1 << 30) | (0x00000001<< 27)) /*!< R/W 0x0  1: mask PSRAM reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_AUDIO   ((u32)(1 << 30) | (0x00000001<< 26)) /*!< R/W 0x0  When audio reset when sys reset happen  mask , HS_SYSON_RAM domain must be on , for HSRAM memory at least in retention mode . 1: mask audio reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_AC      ((u32)(1 << 30) | (0x00000001<< 25)) /*!< R/W 0x0  1: mask audio codec active reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_DDRP    ((u32)(1 << 30) | (0x00000001<< 24)) /*!< R/W 0x0  1: mask ddr phy reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_DDRC    ((u32)(1 << 30) | (0x00000001<< 23)) /*!< R/W 0x0  1: mask ddr controller reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_IRDA    ((u32)(1 << 30) | (0x00000001<< 22)) /*!< R/W 0x0  1: mask girda reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_ECDSA   ((u32)(1 << 30) | (0x00000001<< 21)) /*!< R/W 0x0  1: mask ecdsa reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_ED25519 ((u32)(1 << 30) | (0x00000001<< 20)) /*!< R/W 0x0  1: mask ed25519 reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_RSA     ((u32)(1 << 30) | (0x00000001<< 19)) /*!< R/W 0x0  1: mask rsa reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_IPC_HP  ((u32)(1 << 30) | (0x00000001<< 18)) /*!< R/W 0x0  1: mask IPC reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_LEDC    ((u32)(1 << 30) | (0x00000001<< 15)) /*!< R/W 0x0  1: mask SPORT reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_TRNG    ((u32)(1 << 30) | (0x00000001<< 14)) /*!< R/W 0x0  1: mask TRNG reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_USB     ((u32)(1 << 30) | (0x00000001<< 12)) /*!< R/W 0x0  1: mask USB reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_SDH     ((u32)(1 << 30) | (0x00000001<< 11)) /*!< R/W 0x0  1: mask SDH reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_SPI1    ((u32)(1 << 30) | (0x00000001<< 10)) /*!< R/W 0x0  1: mask SPI1 reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_SPI0    ((u32)(1 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  1: mask SPI0 reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_GDMA    ((u32)(1 << 30) | (0x00000001<< 5))  /*!< R/W 0x0  1: mask GDMA0 reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_LCDC    ((u32)(1 << 30) | (0x00000001<< 4))  /*!< R/W 0x0  1: mask LCDC reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_IPSEC   ((u32)(1 << 30) | (0x00000001<< 3))  /*!< R/W 0x0  1: mask IPSEC reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_LX1     ((u32)(1 << 30) | (0x00000001<< 2))  /*!< R/W 0x0  1: mask LX1 system reset when sys reset happen  0: disable*/
/** @} */
...
#define APBPeriph_MSK_SPORT0 ((u32)(2 << 30) | (0x00000001<< 8))  /*!< R/W 0x0  1: mask SPORT reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_SPORT1 ((u32)(2 << 30) | (0x00000001<< 9))  /*!< R/W 0x0  1: mask SPORT reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_SPORT2 ((u32)(2 << 30) | (0x00000001<< 10)) /*!< R/W 0x0  1: mask SPORT reset when sys reset happen  0: disable*/
#define APBPeriph_MSK_SPORT3 ((u32)(2 << 30) | (0x00000001<< 11)) /*!< R/W 0x0  1: mask SPORT reset when sys reset happen  0: disable*/
#define APBPeriph_UART0      ((u32)(2 << 30) | (0x00000001<< 4) | (0x00000001 << 0))  /*!< R/W 0x0  Uart reset when sys reset happen  reset (Note uart3 if for BT)*/
#define APBPeriph_UART1      ((u32)(2 << 30) | (0x00000001<< 5) | (0x00000001 << 1))  /*!< R/W 0x0  Uart reset when sys reset happen  reset (Note uart3 if for BT)*/
#define APBPeriph_UART2      ((u32)(2 << 30) | (0x00000001<< 6) | (0x00000001 << 2))  /*!< R/W 0x0  Uart reset when sys reset happen  reset (Note uart3 if for BT)*/
#define APBPeriph_UART3      ((u32)(2 << 30) | (0x00000001<< 7) | (0x00000001 << 3))  /*!< R/W 0x0  Uart reset when sys reset happen  reset (Note uart3 if for BT)*/
/** @} */
...
/** @defgroup REG_LSYS_DUMMY_098
  ...
  * @{
  */
#define LSYS_BIT_PWDPAD15N_CA          ((u32)0x00000001 << 0)            /*!< R/W 0x0  ECO: control DDRPHY CA pad power down 0: power down 1: enable Before DDRPHY ready , this bit must set 1 to iso DRAM*/
#define LSYS_PWDPAD15N_CA(x)           ((u32)(((x) & 0x00000001) << 0))
#define LSYS_GET_PWDPAD15N_CA(x)       ((u32)(((x >> 0) & 0x00000001)))
#define LSYS_BIT_PWDPAD15N_DQ          ((u32)0x00000001 << 1)            /*!< R/W 0x0  ECO: control DDRPHY DQ pad power down 0: power down 1: enable Before DDRPHY ready , this bit must set 1 to iso DRAM Note: DQ pad is shared as psram*/
...
#define REG_LSYS_POR                         0x202
#define REG_LSYS_ISO                         0x204
#define REG_LSYS_FEN_GRP0                    0x208
#define REG_LSYS_FEN_GRP1                    0x20C
#define REG_LSYS_FEN_GRP2                    0x210
#define REG_LSYS_CKE_GRP0                    0x214
#define REG_LSYS_CKE_GRP1                    0x218
#define REG_LSYS_CKE_GRP2                    0x21C
#define REG_LSYS_CKE_GRP                     0x220
#define REG_LSYS_CKSL_GRP0                   0x224
#define REG_LSYS_CKD_GRP0                    0x228
#define REG_LSYS_CKD_GRP1                    0x22C
#define REG_LSYS_SW_RST_CTRL                 0x238
#define REG_LSYS_SW_RST_TRIG                 0x23C
#define REG_LSYS_LPLAT_CTRL                  0x240
#define REG_LSYS_LPLAT_STATUS                0x244
#define REG_LSYS_SW_PATCH                    0x248
#define REG_LSYS_SPORT_CLK                   0x24C
#define REG_LSYS_BT_CTRL0                    0x250
#define REG_LSYS_BT_CTRL1                    0x254
#define REG_LSYS_AIP_CTRL0                   0x258
#define REG_LSYS_AIP_CTRL1                   0x25C
#define REG_LSYS_AIP_CTRL2                   0x260
#define REG_LSYS_BOOT_REASON_SW              0x264
#define REG_LSYS_BOOT_CFG                    0x268
#define REG_LSYS_FPGA_CLK_INFO               0x26C
#define REG_LSYS_FLASH_PARA_ADDR             0x270
#define REG_LSYS_SCAN_CTRL                   0x274
#define REG_LSYS_SYSTEM_CFG0                 0x27C
#define REG_LSYS_SYSTEM_CFG1                 0x280
#define REG_LSYS_BUS_PRI_CTRL                0x290
#define REG_LSYS_BUS_EXPSTAMP_CTRL0          0x2A0
#define REG_LSYS_BUS_EXPSTAMP_CTRL1          0x2A4
#define REG_LSYS_BUS_EXPSTAMP_CTRL2          0x2A8
#define REG_LSYS_BUS_EXPSTAMP_CTRL3          0x2AC
#define REG_LSYS_BUS_EXPSTAMP_CTRL4          0x2B0
#define REG_LSYS_BUS_EXPSTAMP_CTRL5          0x2B4
#define REG_LSYS_BUS_EXPSTAMP_CTRL6          0x2B8
#define REG_LSYS_BUS_EXPSTAMP_CTRL7          0x2BC
#define REG_LSYS_DUMMY_088                   0x2C0
#define REG_LSYS_DUMMY_089                   0x2C4
#define REG_LSYS_SYSRST_MSK0                 0x2D0
#define REG_LSYS_SYSRST_MSK1                 0x2D4
#define REG_LSYS_SYSRST_MSK2                 0x2D8
#define REG_LSYS_BOUNDARY_CHK                0x2F0
#define REG_LSYS_DUMMY_090                   0x2F4
#define REG_LSYS_DUMMY_094                   0x2F8
#define REG_LSYS_DUMMY_098                   0x2FC
