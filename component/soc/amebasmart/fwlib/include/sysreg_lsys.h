 ...
 * @{
 **/
#define LSYS_BIT_BT_PWM_NM                         ((u32)0x00000001 << 31)          /*!<R/W 0  ECO Add. SWR mode of BT active 1: PWM Mode 0: PFM Mode */
#define LSYS_BT_PWM_NM(x)                          ((u32)(((x) & 0x00000001) << 31))
#define LSYS_GET_BT_PWM_NM(x)                      ((u32)(((x >> 31) & 0x00000001)))
#define LSYS_BIT_WL_MP_STATUS                      ((u32)0x00000001 << 26)          /*!<R/W 0  Wi-Fi MP status */
 ...
 * @{
 **/
#define LSYS_BIT_BT_PLLCLK_SEL                     ((u32)0x00000001 << 31)          /*!<R/W 0  ECO ADD 0: select BTS0_ANAPAR_PLL0[10]&[4] from BT 1: select from REG 0x54[30:29] */
#define LSYS_BT_PLLCLK_SEL(x)                      ((u32)(((x) & 0x00000001) << 31))
#define LSYS_GET_BT_PLLCLK_SEL(x)                  ((u32)(((x >> 31) & 0x00000001)))
#define LSYS_BIT_BT_FREF_EDGE_S0                   ((u32)0x00000001 << 30)          /*!<R/W 0  ECO ADD BTS0_ANAPAR_PLL0[10]. Valid when 0x54[31] = 1 */
#define LSYS_BT_FREF_EDGE_S0(x)                    ((u32)(((x) & 0x00000001) << 30))
#define LSYS_GET_BT_FREF_EDGE_S0(x)                ((u32)(((x >> 30) & 0x00000001)))
#define LSYS_BIT_BT_FREF_SEL_S0                    ((u32)0x00000001 << 29)          /*!<R/W 0  ECO ADD BTS0_ANAPAR_PLL0[4]. Valid when 0x54[31] = 1 */
