...
#ifndef _SYSREG_AUD_H_
#define _SYSREG_AUD_H_
...
/** @defgroup AUD_ADDA_CTL
  * @brief ADC And DAC Control Register
  * @{
  */
...
/** @defgroup AUD_HPO_CTL
  * @brief Headphone Out Control Register
  * @{
  */
...
/** @defgroup AUD_MICBIAS_CTL0
  * @brief MICBIAS Control Register 0
  * @{
  */
...
/** @defgroup AUD_MICBIAS_CTL1
  * @brief MICBIAS Control Register 1
  * @{
  */
...
/** @defgroup AUD_MICBST_CTL0
  * @brief MICBST Control Register 0
  * @{
  */
...
/** @defgroup AUD_MICBST_CTL1
  * @brief MICBST Control Register 1
  * @{
  */
...
/** @defgroup RSVD0
  * @brief Analog Reserved Register
  * @{
  */
#define AUD_MASK_CODEC_RESERVE_31_19     ((u32)0x00001FFF << 19)           /*!< R/W 0x0  reserve*/
#define AUD_CODEC_RESERVE_31_19(x)       (((u32)((x) & 0x00001FFF) << 19))
#define AUD_GET_CODEC_RESERVE_31_19(x)   ((u32)(((x >> 19) & 0x00001FFF)))
#define AUD_MASK_LDO_CUR_SEL             ((u32)0x00000007 << 16)           /*!< R/W 0x0  LDO current control: if LPMODE_EN=1 000:1uA 001:1.5uA 010:2uA 011:2.5uA 100 3uA 101:3.5uA 110:4uA 111:4.5uA if LPMODE_EN=0 000:2uA 001:3uA 010:4uA 011:5uA 100 6uA 101:7uA 110:8uA 111:9uA*/
#define AUD_LDO_CUR_SEL(x)               (((u32)((x) & 0x00000007) << 16))
#define AUD_GET_LDO_CUR_SEL(x)           ((u32)(((x >> 16) & 0x00000007)))
#define AUD_BIT_CODEC_RESERVE_15         ((u32)0x00000001 << 15)           /*!< R/W 0x0  reserve*/
#define AUD_MASK_VCM_CUR_SEL             ((u32)0x00000007 << 12)           /*!< R/W 0x0  DAC VCM Buffer current control: if LPMODE_EN=1 000:1uA 001:1.5uA 010:2uA 011:2.5uA 100 3uA 101:3.5uA 110:4uA 111:4.5uA if LPMODE_EN=0 000:2uA 001:3uA 010:4uA 011:5uA 100 6uA 101:7uA 110:8uA 111:9uA*/
#define AUD_VCM_CUR_SEL(x)               (((u32)((x) & 0x00000007) << 12))
#define AUD_GET_VCM_CUR_SEL(x)           ((u32)(((x >> 12) & 0x00000007)))
#define AUD_MASK_DPRAMP_CUR_SEL          ((u32)0x00000007 << 9)            /*!< R/W 0x0  DPRAMP current control: if LPMODE_EN=1 000:1uA 001:1.5uA 010:2uA 011:2.5uA 100 3uA 101:3.5uA 110:4uA 111:4.5uA if LPMODE_EN=0 000:2uA 001:3uA 010:4uA 011:5uA 100 6uA 101:7uA 110:8uA 111:9uA*/
#define AUD_DPRAMP_CUR_SEL(x)            (((u32)((x) & 0x00000007) << 9))
#define AUD_GET_DPRAMP_CUR_SEL(x)        ((u32)(((x >> 9) & 0x00000007)))
#define AUD_BIT_CODEC_RESERVE_8          ((u32)0x00000001 << 8)            /*!< R/W 0x0  reserve*/
#define AUD_BIT_LDO_CODEC_DISCHARGE_PATH ((u32)0x00000001 << 7)            /*!< R/W 0x1  REG_LDO_DISCHARGE_PATH selection for discharge path of LDO_CODEC 0: discharge path is turn off (default) 1: 1.8kohm discharge path is turned on*/
#define AUD_BIT_LDO_CODEC_DRIVING_PATH   ((u32)0x00000001 << 6)            /*!< R/W 0x0  LDO_CODEC_DRIVING_PATH selection for driving path of LDO_CODEC 0:select strong driving path PMOS w=240um, L=0.44um 1:select 1.8kohm driving path(default)*/
#define AUD_MASK_REG_HPO_RESERVE         ((u32)0x0000003F << 0)            /*!< R/W 0x0  REG_HPO_RESERVE<5:0>*/
#define AUD_REG_HPO_RESERVE(x)           (((u32)((x) & 0x0000003F) << 0))
#define AUD_GET_REG_HPO_RESERVE(x)       ((u32)(((x >> 0) & 0x0000003F)))
/** @} */

/** @defgroup AUD_DTS_CTL
  * @brief DTS Control Register
  * @{
  */
...
/** @defgroup AUD_MBIAS_CTL0
  * @brief MBIAS Control Register 0
  * @{
  */
...
/** @defgroup AUD_MBIAS_CTL1
  * @brief MBIAS Control Register 1
  * @{
  */
...
/** @defgroup AUD_MBIAS_CTL2
  * @brief MBIAS Control Register 2
  * @{
  */
...
/** @defgroup AUD_HPO_BIAS_CTL
  * @brief Headphone Out Bias Control Register
  * @{
  */
...
#define AUD_MASK_HPO_RESERVED   ((u32)0x000000FF << 16)           /*!< R/W 0x0  */
...
typedef struct {
	__IO uint32_t AUD_ADDA_CTL    ;  /*!< ADC AND DAC CONTROL REGISTER,  Address offset:0x000 */
	__IO uint32_t AUD_HPO_CTL     ;  /*!< HEADPHONE OUT CONTROL REGISTER,  Address offset:0x004 */
	__IO uint32_t AUD_MICBIAS_CTL0;  /*!< MICBIAS CONTROL REGISTER 0 Register,  Address offset:0x008 */
	__IO uint32_t AUD_MICBIAS_CTL1;  /*!< MICBIAS CONTROL REGISTER 1 Register,  Address offset:0x00C */
	__IO uint32_t AUD_MICBST_CTL0 ;  /*!< MICBST CONTROL REGISTER 0 Register,  Address offset:0x010 */
	__IO uint32_t AUD_MICBST_CTL1 ;  /*!< MICBST CONTROL REGISTER 1 Register,  Address offset:0x014 */
	__IO uint32_t RSVD0;  /*!< ANALOG RESERVED REGISTER,  Address offset:0x018 */
	__IO uint32_t AUD_DTS_CTL     ;  /*!< DTS CONTROL REGISTER,  Address offset:0x01C */
	__IO uint32_t AUD_MBIAS_CTL0  ;  /*!< MBIAS CONTROL REGISTER 0 Register,  Address offset:0x020 */
	__IO uint32_t AUD_MBIAS_CTL1  ;  /*!< MBIAS CONTROL REGISTER 1 Register,  Address offset:0x024 */
	__IO uint32_t AUD_MBIAS_CTL2  ;  /*!< MBIAS CONTROL REGISTER 2 Register,  Address offset:0x028 */
	__IO uint32_t AUD_HPO_BIAS_CTL;  /*!< HEADPHONE OUT BIAS CONTROL REGISTER,  Address offset:0x02C */
} AUD_TypeDef;
