...
#define ADC_BIT_IN_TYPE_CH7 ((u32)0x00000001 << 7) /*!< R 0x0  This bit reflects which kind of input type channel 7 is. Since channel 7 is a fixed internal channel.*/
#define ADC_BIT_IN_TYPE_CH6 ((u32)0x00000001 << 6) /*!< R 0x0  This bit reflects which kind of input type channel 6 is. Since channel 6 is a fixed internal channel.*/
#define ADC_BIT_IN_TYPE_CH5 ((u32)0x00000001 << 5) /*!< R/W 0x0  This bit controls channel 5 input type. If it's set to differential type(value of this bit is 1), channel 4 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 5 is single-end input. 1: ADC channel 5 is differential input which is paired with channel 4.*/
#define ADC_BIT_IN_TYPE_CH4 ((u32)0x00000001 << 4) /*!< R/W 0x0  This bit controls channel 4 input type. If it's set to differential type(value of this bit is 1), channel 5 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 4 is single-end input. 1: ADC channel 4 is differential input which is paired with channel 5.*/
#define ADC_BIT_IN_TYPE_CH3 ((u32)0x00000001 << 3) /*!< R/W 0x0  This bit controls channel 3 input type. If it's set to differential type(value of this bit is 1), channel 2 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 3 is single-end input. 1: ADC channel 3 is differential input which is paired with channel 2.*/
#define ADC_BIT_IN_TYPE_CH2 ((u32)0x00000001 << 2) /*!< R/W 0x0  This bit controls channel 2 input type. If it's set to differential type(value of this bit is 1), channel 3 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 2 is single-end input. 1: ADC channel 2 is differential input which is paired with channel 3.*/
#define ADC_BIT_IN_TYPE_CH1 ((u32)0x00000001 << 1) /*!< R/W 0x0  This bit controls channel 1 input type. If it's set to differential type(value of this bit is 1), channel 0 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 1 is single-end input. 1: ADC channel 1 is differential input which is paired with channel 0.*/
#define ADC_BIT_IN_TYPE_CH0 ((u32)0x00000001 << 0) /*!< R/W 0x0  This bit controls channel 0 input type. If it's set to differential type(value of this bit is 1), channel 1 should also be set to differential type since they are hardware-fixed differential pair. 0: ADC channel 0 is single-end input. 1: ADC channel 0 is differential input which is paired with channel 1.*/
/** @} */
...
/** @defgroup ADC_DATA_CHx
  ...
  * @{
  */
#define ADC_BIT_DAT_RDY_CHx ((u32)0x00000001 << 17)           /*!< R 0x0  This bit indicates that a conversion is done. Every time a conversion is done, this bit should be set to 1 and it would be cleared to 0 when a read operation of reg_adc_data_chx.*/
#define ADC_BIT_DAT_OVW_CHx ((u32)0x00000001 << 16)           /*!< R 0x0  This bit indicates that there is a data overwritten situation in bit_adc_data_global takeing place. A data overwritten situation is that a former conversion data is NOT read before a new conversion is written to data field. It would be cleared to 0 when a read operation of reg_adc_data_chx. 0: There is no data overwritten case. 1: There is a data overwritten case.*/
#define ADC_MASK_NUM_CHx    ((u32)0x0000000F << 12)           /*!< R 0x0  This field contains the newsest conversion data of channel x [15:12]: which channel in channel list the data belongs to, only valid when bit_adc_ch_unmask=1*/
#define ADC_NUM_CHx(x)      (((u32)((x) & 0x0000000F) << 12))
#define ADC_GET_NUM_CHx(x)  ((u32)(((x >> 12) & 0x0000000F)))
#define ADC_MASK_DATA_CHx   ((u32)0x00000FFF << 0)            /*!< R 0x0  This field contains the newsest conversion data of channel x [11:0]: newest data*/
...
/** @defgroup ADC_DATA_GLOBAL
  ...
  * @{
  */
#define ADC_MASK_DAT_CH          ((u32)0x0000000F << 18)           /*!< R 0x0  This field indicates which channel data is procedd right now*/
#define ADC_DAT_CH(x)            (((u32)((x) & 0x0000000F) << 18))
#define ADC_GET_DAT_CH(x)        ((u32)(((x >> 18) & 0x0000000F)))
#define ADC_BIT_DAT_RDY_GLOBAL   ((u32)0x00000001 << 17)           /*!< R 0x0  This bit indicates that a conversion is done. Every time a conversion is done, this bit should be set to 1 and it would be cleared to 0 when a read operation of reg_adc_data_global*/
#define ADC_BIT_DAT_OVW_GLOBAL   ((u32)0x00000001 << 16)           /*!< R 0x0  This bit indicates that there is a data overwritten situation in bit_adc_data_global takes place. A data overwritten situation is that a former conversion data is NOT read before a new conversion is written to data field. 0: there is no data overwritten case. 1: there is a data overwritten case.*/
#define ADC_MASK_CH_NUM_GLOBAL   ((u32)0x0000000F << 12)           /*!< R 0x0  This field contains the newsest conversion data of channel in the list. [15:12]: which channel in channel list the data belongs to, only valid when bit_adc_ch_unmask=1*/
#define ADC_CH_NUM_GLOBAL(x)     (((u32)((x) & 0x0000000F) << 12))
#define ADC_GET_CH_NUM_GLOBAL(x) ((u32)(((x >> 12) & 0x0000000F)))
#define ADC_MASK_DATA_GLOBAL     ((u32)0x00000FFF << 0)            /*!< R 0x0  This field contains the newsest conversion data of channel in the list. [11:0]: newest data*/
...
/** @defgroup ADC_FLR
  ...
  * @{
  */
#define ADC_MASK_FLR   ((u32)0x0000001F << 0)           /*!< R 0x0  This field records the current ADC FIFO entry number.*/
...
/** @defgroup ADC_DELAY_CNT
  ...
  * @{
  */
#define ADC_BIT_CH_UNMASK     ((u32)0x00000001 << 31)          /*!< R/W 0x0  Enable BIT_ADC_DAT_CHID*/
#define ADC_MASK_CLK_SEL      ((u32)0x00000003 << 8)           /*!< R/W 0x0  Just config to 00*/
#define ADC_CLK_SEL(x)        (((u32)((x) & 0x00000003) << 8))
#define ADC_GET_CLK_SEL(x)    ((u32)(((x >> 8) & 0x00000003)))
#define ADC_MASK_DELAY        ((u32)0x00000003 << 2)           /*!< R/W 0x0  This field defines channel switch data delay count. A value of 0 is for using default count of hardware.*/
#define ADC_DELAY(x)          (((u32)((x) & 0x00000003) << 2))
#define ADC_GET_DELAY(x)      ((u32)(((x >> 2) & 0x00000003)))
#define ADC_MASK_CTRL_DELAY   ((u32)0x00000003 << 0)           /*!< R/W 0x0  This field defines channel switch ctrl delay count. A value of 0 is for using default count of hardware.*/
...
#define ADC_CH_NUM						(10) /*!< Total number of ADC channels. */
...
/** @defgroup ADC_Chn_Pad_Selection ADC Channel Pad Selection
  * @{
  */
#define ADC_CH0_PIN						(_PA_0) /*!< Pin mapping for ADC channel 0. */
#define ADC_CH1_PIN						(_PA_1) /*!< Pin mapping for ADC channel 1. */
#define ADC_CH2_PIN						(_PA_2) /*!< Pin mapping for ADC channel 2. */
#define ADC_CH3_PIN						(_PA_3) /*!< Pin mapping for ADC channel 3. */
#define ADC_CH4_PIN						(_PA_4) /*!< Pin mapping for ADC channel 4. */
#define ADC_CH5_PIN						(_PA_5) /*!< Pin mapping for ADC channel 5. */
/**
  * @}
  */
...
/** @defgroup ADC_Clk_Divider ADC Clock Divider
  * @{
  */
#define ADC_CLK_DIV_2					((u8)0x00) /*!< ADC clock divided by 2. */
#define ADC_CLK_DIV_4					((u8)0x01) /*!< ADC clock divided by 4. */
#define ADC_CLK_DIV_8					((u8)0x02) /*!< ADC clock divided by 8. */
#define ADC_CLK_DIV_12					((u8)0x03) /*!< ADC clock divided by 12. */
#define ADC_CLK_DIV_16					((u8)0x04) /*!< ADC clock divided by 16. */
#define ADC_CLK_DIV_32					((u8)0x05) /*!< ADC clock divided by 32. */
#define ADC_CLK_DIV_64					((u8)0x06) /*!< ADC clock divided by 64. */
...
/** @defgroup ADC_Compare_Threshold ADC Compare Threshold
  * @{
  */
#define IS_ADC_VALID_COMP_TH(x)				((x) < 0x1000) /*!< Check if ADC comparison threshold value is valid. */
/**
  * @}
  */
...
/** @defgroup ADC_Data_Setting ADC Data Setting
  * @{
  */
#define ADC_ID_AND_DATA(x)						((u32)((x) & 0x0000FFFF)) /*!< Extract channel ID and conversion data from ADC register value. */
