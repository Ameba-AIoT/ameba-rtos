...
#ifndef _AMEBA_RSA_H_
#define _AMEBA_RSA_H_
...
typedef struct {
	...
	__IO uint32_t RSVD0          ;  /*!< Reserved,  Address offset:0xF04-0xF07 */
	...
	__IO uint32_t RSVD1[7]       ;  /*!< Reserved,  Address offset:0xF10-0xF2B */
