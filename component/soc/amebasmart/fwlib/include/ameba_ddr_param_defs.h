...
#define DRAM_REF_TIME			7800000//1950000
#else
#define DRAM_REF_TIME			7800000
#endif
...
struct rxi316_dram_mode_reg_info rxi316_ddr2_mode_reg_1066mhz = {
	6,   // dram_wr_lat(CWL=RL-1=AL+CL-1)
	7,   // dram_rd_lat(CAS)
	0,   // dram_add_lat
	0,   // parity_lat
	4,   // =DFI_RATIO*tphy_wd=CWL+phy_cmd_dly–phy_wr_dly
	2,   // =DFI_RATIO*tphy_rd=CAS+phy_cmd_dly–phy_rd_dly
	0,   // mode reg 0 or value
	0,   // mode reg 1 or value
	0,   // mode reg 2 or value
	0,   // mode reg 3 or value
...
struct rxi316_dram_mode_reg_info rxi316_ddr3_mode_reg_1066mhz = {
	...
	0,   // dram_add_lat
	0,   // parity_lat
	2,   // =DFI_RATIO*tphy_wd=CWL+phy_cmd_dly–phy_wr_dly
	2,   // =DFI_RATIO*tphy_rd=CAS+phy_cmd_dly–phy_rd_dly
	0,   // mode reg 0 or value
	0,   // mode reg 1 or value
	0,   // mode reg 2 or value
...
struct slot_starve_reg_info slot_starve_info = {
	...
	// cr_cbctl1
	0,         //cr_dis_wmg
	1,         //cr_pageopen(DDR2=0 to fix srex issue, DDR3=1)
