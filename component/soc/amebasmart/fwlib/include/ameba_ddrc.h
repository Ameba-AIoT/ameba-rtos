...
#define DDRC_BIT_FULLWR       ((u32)0x00000001 << 27)           /*!< R/W 0x0  Always Full Write hint to RXI316. RXI316 will recognize RMW when transaction is not aligned to dram atomic size or it's partial write. * Only available (can write, and be meaningful) when ECC_EN (/FULLWR_EN/DHC_STARK_EN) is defined.*/
...
#define DDRC_BIT_PERF_PARK     ((u32)0x00000001 << 0)            /*!< R/W 0x0  0: Read slot 1: Write slot*/
...
/** @defgroup DDRC_HZD_CTRL0
  ...
  * @{
  */
#define DDRC_MASK_RHZD_THD   ((u32)0x0000001F << 8)           /*!< R/W 0x0  Used to constrain read hazard priority. When RHZD_THD setting and read command number >= RHZD_THD, it would keep the original read hazard priority at command QoS. If the value of RHZD_THD is 0, it would disable this hazard constrain function.*/
#define DDRC_RHZD_THD(x)     (((u32)((x) & 0x0000001F) << 8))
#define DDRC_GET_RHZD_THD(x) ((u32)(((x >> 8) & 0x0000001F)))
#define DDRC_MASK_WHZD_THD   ((u32)0x0000003F << 0)           /*!< R/W 0x0  Used to constrain write hazard priority. When WHZD_THD setting and write command number >= WHZD_THD, it would keep the original write hazard priority at command QoS.  If the value of WHZD_THD is 0, it would disable this hazard constrain function.*/
...
typedef struct {
	__IO uint32_t DDRC_CCR            ;  /*!< CONFIGURATION CONTROL REGISTER,  Address offset:0x000 */
	__IO uint32_t DDRC_DCR            ;  /*!< DRAM CONFIGURATION CONTROL REGISTER,  Address offset:0x004 */
	__IO uint32_t DDRC_IOCR           ;  /*!< I/O CONFIGURATION CONTROL REGISTER,  Address offset:0x008 */
	__IO uint32_t DDRC_CSR            ;  /*!< CONTROLLER STATUS REGISTER,  Address offset:0x00C */
	__IO uint32_t DDRC_DRR            ;  /*!< DRAM REFRESH CONTROL REGISTER,  Address offset:0x010 */
	__IO uint32_t DDRC_TPR0           ;  /*!< DRAM TIMING PARAMETER REGISTER 0 Register,  Address offset:0x014 */
	__IO uint32_t DDRC_TPR1           ;  /*!< DRAM TIMING PARAMETER REGISTER 1 Register,  Address offset:0x018 */
	__IO uint32_t DDRC_TPR2           ;  /*!< DRAM TIMING PARAMETER REGISTER 2 Register,  Address offset:0x01C */
	__IO uint32_t DDRC_TPR3           ;  /*!< DRAM TIMING PARAMETER REGISTER 3 Register,  Address offset:0x020 */
	__IO uint32_t DDRC_CMD_DPIN_NDGE  ;  /*!< COMMAND DATA PIN REGISTER FOR LPDDR2/3 Register,  Address offset:0x024 */
	__IO uint32_t DDRC_CMD_DPIN       ;  /*!< COMMAND DATA PIN REGISTER,  Address offset:0x028 */
	__IO uint32_t DDRC_TIE_DPIN       ;  /*!< TIED DATA PIN REGISTER,  Address offset:0x02C */
	__IO uint32_t DDRC_MR_INFO        ;  /*!< MODE LATENCY INFORMATION REGISTER,  Address offset:0x030 */
	__IO uint32_t DDRC_MR0            ;  /*!< DRAM MODE REGISTER 0 Register,  Address offset:0x034 */
	__IO uint32_t DDRC_MR1            ;  /*!< DRAM MODE REGISTER 1 Register,  Address offset:0x038 */
	__IO uint32_t DDRC_MR2            ;  /*!< DRAM MODE REGISTER 2 Register,  Address offset:0x03C */
	__IO uint32_t DDRC_MR3            ;  /*!< DRAM MODE REGISTER 3 Register,  Address offset:0x040 */
	__IO uint32_t DDRC_MR4            ;  /*!< DRAM MODE REGISTER 4 Register,  Address offset:0x044 */
	__IO uint32_t DDRC_MR5            ;  /*!< DRAM MODE REGISTER 5 Register,  Address offset:0x048 */
	__IO uint32_t DDRC_MR6            ;  /*!< DRAM MODE REGISTER 6 Register,  Address offset:0x04C */
	__IO uint32_t DDRC_MR11           ;  /*!< DRAM MODE REGISTER 11 Register,  Address offset:0x050 */
	__IO uint32_t DDRC_MR12           ;  /*!< DRAM MODE REGISTER 12 Register,  Address offset:0x054 */
	__IO uint32_t DDRC_MR13           ;  /*!< DRAM MODE REGISTER 13 Register,  Address offset:0x058 */
	__IO uint32_t DDRC_MR14           ;  /*!< DRAM MODE REGISTER 14 Register,  Address offset:0x05C */
	__IO uint32_t DDRC_MR22           ;  /*!< DRAM MODE REGISTER 22 Register,  Address offset:0x060 */
	__IO uint32_t RSVD0[11]           ;  /*!< Reserved,  Address offset:0x064-0x08F */
	__IO uint32_t DDRC_TPR4           ;  /*!< DRAM TIMING PARAMETER REGISTER 4 Register,  Address offset:0x090 */
	__IO uint32_t DDRC_TPR5           ;  /*!< DRAM TIMING PARAMETER REGISTER 5 Register,  Address offset:0x094 */
	__IO uint32_t RSVD1[10]           ;  /*!< Reserved,  Address offset:0x098-0x0BF */
	__IO uint32_t DDRC_DPDRI          ;  /*!< IN DPIN DATA FLOW, SET VALUE OF DPDR INDEX Register,  Address offset:0x0C0 */
	__IO uint32_t DDRC_DPDR           ;  /*!< IN DPIN DATA FLOW, SETVALUEACCORDING TO DPDRI Register,  Address offset:0x0C4 */
	__IO uint32_t DDRC_ISR            ;  /*!< CONTROLLER INTERRUPT REGISTER,  Address offset:0x0C8 */
	__IO uint32_t DDRC_IMR            ;  /*!< DRAMC INTERRUPT MASK BITS Register,  Address offset:0x0CC */
	__IO uint32_t DDRC_BCR            ;  /*!< BSTC CONTROL REGISTER,  Address offset:0x0D0 */
	__IO uint32_t DDRC_BECC           ;  /*!< BSTC SIDEBAND ECC REGISTER,  Address offset:0x0D4 */
	__IO uint32_t DDRC_BCM            ;  /*!< BSTC COMPARE BIT MASK REGISTER,  Address offset:0x0D8 */
	__I  uint32_t DDRC_BST            ;  /*!< BSTC STATUS REGISTER,  Address offset:0x0DC */
	__I  uint32_t DDRC_BSRAM0         ;  /*!< BSTC SRAM STATUS REGISTER 0 Register,  Address offset:0x0E0 */
	__I  uint32_t DDRC_BSRAM1         ;  /*!< BSTC SRAM STATUS REGISTER 1 Register,  Address offset:0x0E4 */
	__I  uint32_t DDRC_BER            ;  /*!< BSTC ERROR BIT REGISTER,  Address offset:0x0E8 */
	__IO uint32_t DDRC_BEXPC          ;  /*!< BSTC SRAM EXPECTED EXECUTE NUMBERS OF WORDS REGISTER,  Address offset:0x0EC */
	__IO uint32_t RSVD2               ;  /*!< Reserved,  Address offset:0x0F0-0x0F3 */
	__I  uint32_t DDRC_SVN_ID         ;  /*!< PCTL VERSION ID REGISTER,  Address offset:0x0F4 */
	__I  uint32_t DDRC_IDR            ;  /*!< PCTL IDENTIFICATION REGISTER,  Address offset:0x0F8 */
	__IO uint32_t DDRC_MSG            ;  /*!< RESERVED REGISTER,  Address offset:0x0FC */
	__IO uint32_t DDRC_DPERF0         ;  /*!< DRAM PERFORMANCE REGITSER Register,  Address offset:0x100 */
	__IO uint32_t RSVD3[72]           ;  /*!< Reserved,  Address offset:0x104-0x223 */
	...
	__IO uint32_t RSVD4               ;  /*!< Reserved,  Address offset:0x22C-0x22F */
	...
	__IO uint32_t RSVD5[26]           ;  /*!< Reserved,  Address offset:0x238-0x29F */
	...
	__IO uint32_t RSVD6[22]           ;  /*!< Reserved,  Address offset:0x2A8-0x2FF */
	__IO uint32_t DDRC_ICG_EN         ;  /*!< CLOCK GATING ENABLE CONTROL REGISTER,  Address offset:0x300 */
	__IO uint32_t RSVD7[63]           ;  /*!< Reserved,  Address offset:0x304-0x3FF */
	__IO uint32_t DDRC_ROW_REMAP0     ;  /*!< DRAM ROW ADDRESS REMAP CONTROL REGISTER 0, REMAP ROW ADDRESS BIT 0 ~ BIT 7 Register,  Address offset:0x400 */
	__IO uint32_t DDRC_ROW_REMAP1     ;  /*!< DRAM ROW ADDRESS REMAP CONTROL REGISTER 1, REMAP ROW ADDRESS BIT 8 ~ BIT 15 Register,  Address offset:0x404 */
	__IO uint32_t DDRC_ROW_REMAP2     ;  /*!< DRAM ROW ADDRESS REMAP CONTROL REGISTER 2, REMAP ROW ADDRESS BIT 16 Register,  Address offset:0x408 */
	__IO uint32_t DDRC_BANK_REMAP0    ;  /*!< DRAM BANK ADDRESS REMAP CONTROL REGISTER 0, REMAP BANK ADDRESS BIT 0 ~ BIT 2 Register,  Address offset:0x40C */
	__IO uint32_t DDRC_COLU_REMAP0    ;  /*!< DRAM CLOUADDRESS REMAP CONTROL REGISTER 0, REMAP CLOUADDRESS BIT 2 ~BIT 9 Register,  Address offset:0x410 */
	__IO uint32_t DDRC_COLU_REMAP1    ;  /*!< DRAM CLOUADDRESS REMAP CONTROL REGISTER 1, REMAP CLOUADDRESS BIT 10 Register,  Address offset:0x414 */
	__IO uint32_t DDRC_RANK_REMAP0    ;  /*!< DRAM RANK ADDRESS REMAP CONTROL REGISTER 0, REMAP RANK ADDRESS BIT 0 Register,  Address offset:0x418 */
	__IO uint32_t DDRC_CH_REMAP0      ;  /*!< DRAM CHANNEL ADDRESS REMAP CONTROL REGISTER 0, REMAP CHANNEL ADDRESS BIT 0 Register,  Address offset:0x41C */
	__IO uint32_t DDRC_BG_REMAP0      ;  /*!< DRAM BGADDRESS REMAP CONTROL REGISTER 0, REMAP BGADDRESS BIT 0 ~BIT1 Register,  Address offset:0x420 */
	__IO uint32_t DDRC_ADDR_REMAP_CTRL;  /*!< NONBINARY DRAM DENSITY: 3/6/12/24GB Register,  Address offset:0x424 */
	__IO uint32_t RSVD8[14]           ;  /*!< Reserved,  Address offset:0x428-0x45F */
	...
	__IO uint32_t RSVD9[2]            ;  /*!< Reserved,  Address offset:0x478-0x47F */
	...
	__IO uint32_t RSVD10              ;  /*!< Reserved,  Address offset:0x49C-0x49F */
	__IO uint32_t DDRC_BSCH           ;  /*!< NUMBER OF TIMES FOR COMMAND SCHEDULE KEEPS TO SELECT THE SAME BANK Register,  Address offset:0x4A0 */
} DDRC_TypeDef;
