...
#define BIT_AP_RST_WAIT_DRAM		(0x00000001UL << 17) // LSYS_BIT_AP_RST_WAIT_DRAM
...
#define CA32_C0_CPU_STATUS				(CA32_BASE + 0x8)
#define CA32_STANDBYWFE_CORE1			((uint32_t)0x00000001 << 17)
