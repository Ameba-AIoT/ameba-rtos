...
void bt_hci_evt_le_advertising_report(void *pkt);
void bt_hci_evt_le_ext_adv_report(void *pri_pkt, void *sec_pkt,
								  uint8_t chain_num, uint8_t prim_phy, uint8_t scan_rsp_valid);
void bt_hci_evt_le_ext_adv_legacy_report(void *pkt);
...
void bt_hci_evt_le_scan_timeout(void);
