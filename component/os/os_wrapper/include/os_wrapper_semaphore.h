...
/**
 * @brief  Get a semaphore's count. If the semaphore is a binary semaphore then returns 1 if the semaphore is available, and 0 if the semaphore is not available.
 * @param  p_handle: Address of the semaphore.
