...
static void lcdc_pinmux_config(void)
{
	...
	Pinmux_Config(_PB_31, PINMUX_FUNCTION_LCD_D0);	/*D0 - B0*/
	Pinmux_Config(_PB_29, PINMUX_FUNCTION_LCD_D1);	/*D1*/
	Pinmux_Config(_PB_27, PINMUX_FUNCTION_LCD_D2);	/*D2*/
	Pinmux_Config(_PB_25, PINMUX_FUNCTION_LCD_D3);	/*D3*/
	Pinmux_Config(_PB_24, PINMUX_FUNCTION_LCD_D4);	/*D4*/
	Pinmux_Config(_PB_23, PINMUX_FUNCTION_LCD_D5);	/*D5*/
	Pinmux_Config(_PB_18, PINMUX_FUNCTION_LCD_D6);	/*D6*/
	Pinmux_Config(_PB_14, PINMUX_FUNCTION_LCD_D7);	/*D7 - B7 */

	Pinmux_Config(_PB_13, PINMUX_FUNCTION_LCD_D8);	/*D8 - G0*/
	Pinmux_Config(_PB_0, PINMUX_FUNCTION_LCD_D9);	/*D9*/
	Pinmux_Config(_PA_25, PINMUX_FUNCTION_LCD_D10);	/*D10*/
	Pinmux_Config(_PA_28, PINMUX_FUNCTION_LCD_D11);	/*D11*/
	Pinmux_Config(_PA_19, PINMUX_FUNCTION_LCD_D12);	/*D12*/
	Pinmux_Config(_PA_23, PINMUX_FUNCTION_LCD_D13);	/*D13*/
	Pinmux_Config(_PA_22, PINMUX_FUNCTION_LCD_D14);	/*D14*/
	Pinmux_Config(_PA_21, PINMUX_FUNCTION_LCD_D15);	/*D15 - G7*/

	Pinmux_Config(_PC_0, PINMUX_FUNCTION_LCD_D16);	/*D16 - R0*/
	Pinmux_Config(_PB_30, PINMUX_FUNCTION_LCD_D17);	/*D17 */
	Pinmux_Config(_PB_28, PINMUX_FUNCTION_LCD_D18);	/*D18*/
	Pinmux_Config(_PB_26, PINMUX_FUNCTION_LCD_D19);	/*D19*/
	Pinmux_Config(_PA_27, PINMUX_FUNCTION_LCD_D20);	/*D20*/
	Pinmux_Config(_PB_22, PINMUX_FUNCTION_LCD_D21);	/*D21*/
	Pinmux_Config(_PB_21, PINMUX_FUNCTION_LCD_D22);	/*D22*/
	Pinmux_Config(_PB_17, PINMUX_FUNCTION_LCD_D23);	/*D23 - R7*/

	Pinmux_Config(_PA_30, PINMUX_FUNCTION_LCD_MCU_DCX);
	Pinmux_Config(_PA_31, PINMUX_FUNCTION_LCD_MCU_WR);
	Pinmux_Config(_PA_29, PINMUX_FUNCTION_LCD_MCU_RD);
	Pinmux_Config(_PB_15, PINMUX_FUNCTION_LCD_MCU_CSX);
...
int example_raw_lcdc_display_mcu_ili9806(void)
{
