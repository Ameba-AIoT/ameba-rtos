...
#define LCD_BLEN_RGB			_PB_3
#define LCD_DISPLAY_RGB			_PA_17
...
static void lcdc_pinmux_config(void)
{
	...
	Pinmux_Config(_PA_16, PINMUX_FUNCTION_LCD_RGB_HSYNC);   /* HSYNC */
	Pinmux_Config(_PA_13, PINMUX_FUNCTION_LCD_RGB_VSYNC);   /* VSYNC */
	Pinmux_Config(_PA_9, PINMUX_FUNCTION_LCD_RGB_DCLK);     /* DCLK */
...
int example_raw_lcdc_rgb_st7262(void)
{
