...
3. We offer another example named "`raw_spi_dma_sblk_tx_mstr`", it can be used for SPI master to communicate data with this example.
4. If you use example of "`raw_spi_dma_sblk_tx_mstr`", then you should build its image and download into another EVB board.
