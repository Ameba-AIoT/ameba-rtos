...
int example_raw_gdma_singleblock(void)
{
	if (rtos_task_create(NULL, "GDMA SINGLE BLOCK TRANSFER DEMO", (rtos_task_t)gdma_singleblock_transfer_task, NULL, (3072), (1)) != RTK_SUCCESS) {
