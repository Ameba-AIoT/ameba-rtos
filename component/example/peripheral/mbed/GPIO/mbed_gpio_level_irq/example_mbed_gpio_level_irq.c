...
int example_mbed_gpio_level_irq(void)
{
	if (RTK_SUCCESS != rtos_task_create(NULL, "MBED_GPIO_LEVEL_IRQ_TASK", (rtos_task_t)mbed_gpio_level_irq_demo, (void *)NULL, 128 * 4, (1))) {
