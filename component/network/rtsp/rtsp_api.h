...
/* clock usage */
#define RTSP_DEPEND_CLK_HZ      RTOS_TICK_RATE_HZ
...
struct stream_context {
	...
	rtos_mutex_t input_lock;
	struct list_head output_queue;
	rtos_mutex_t output_lock;
...
struct rtsp_context {
	...
	rtos_sema_t start_proxy_connect_sema;
	rtos_sema_t rtp_input_sema;
	rtos_sema_t rtp_output_sema;
#ifdef SUPPORT_RTCP
	uint8_t is_rtcp_start;
	rtos_sema_t start_rtcp_sema;
