...
struct http_response {
	char *header;                 /*!< HTTP header string parsed in HTTP response */
	...
	char *status;                 /*!< Pointer to HTTP status code in the parsed HTTP header string */
	size_t status_len;               /*!< HTTP status code data length */
	char *location;               /*!< Pointer to HTTP location in the parsed HTTP header string */
...
struct httpc_conn {
	...
	char *request_header;         /*!< Pointer to transmission buffer of HTTP request header */
