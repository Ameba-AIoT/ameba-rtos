...
SDK_TOOLCHAIN = $(TOOLCHAINDIR)/asdk-$(ASDK_VER)/linux/newlib
else
SDK_TOOLCHAIN = $(TOOLCHAINDIR)/asdk-$(ASDK_VER)/mingw32/newlib
endif

tool_dir = $(SDK_TOOLCHAIN)/bin
...
LD_ARG = -L$(SDK_TOOLCHAIN)/arm-none-eabi/lib/v7-a+neon-fp16/fpu/
LD_ARG += -L$(SDK_TOOLCHAIN)/lib/gcc/arm-none-eabi/$(ASDK_VER)/v7-a+neon-fp16/fpu
