...
/* Exported defines ----------------------------------------------------------*/
#ifdef CONFIG_NON_OS
#define CONFIG_USB_PM                    0U  /**< Not support USB power management in flash loader */
#else
#define CONFIG_USB_PM                    1U  /**< Support USB power management. Disable when build zephyr usb library */
#endif
