...
/********************  Bit definition for GHWCFG2 register  ********************/
#define USB_OTG_GHWCFG2_NUMHSTCH_Pos             (14U)
#define USB_OTG_GHWCFG2_NUMHSTCH_Msk             (0xFUL << USB_OTG_GHWCFG2_NUMHSTCH_Pos) /*!< 0x0003C000 */
#define USB_OTG_GHWCFG2_NUMHSTCH                 USB_OTG_GHWCFG2_NUMHSTCH_Msk    /*!< Number of Host Channel */
...
#define USB_OTG_HCTSIZ_PING_Pos                  (31U)
#define USB_OTG_HCTSIZ_PING_Msk                  (0x1UL << USB_OTG_HCTSIZ_PING_Pos) /*!< 0x80000000 */
#define USB_OTG_HCTSIZ_PING                      USB_OTG_HCTSIZ_PING_Msk     /*!< doping issue */
...
/********************  Bit definition for DIEPTSIZ0 register  ********************/
#define USB_OTG_DIEPTSIZ0_XFRSIZ_Pos             (0U)
#define USB_OTG_DIEPTSIZ0_XFRSIZ_Msk             (0x7FUL << USB_OTG_DIEPTSIZ0_XFRSIZ_Pos) /*!< 0x0007F */
#define USB_OTG_DIEPTSIZ0_XFRSIZ                 USB_OTG_DIEPTSIZ0_XFRSIZ_Msk   /*!< Transfer size */
#define USB_OTG_DIEPTSIZ0_PKTCNT_Pos             (19U)
#define USB_OTG_DIEPTSIZ0_PKTCNT_Msk             (0x3UL << USB_OTG_DIEPTSIZ0_PKTCNT_Pos) /*!< 0x180000 */
#define USB_OTG_DIEPTSIZ0_PKTCNT                 USB_OTG_DIEPTSIZ0_PKTCNT_Msk   /*!< Packet count */

/********************  Bit definition for DIEPTSIZn register  ********************/
...
/********************  Bit definition for DOEPTSIZ0 register  ********************/
#define USB_OTG_DOEPTSIZ0_XFRSIZ_Pos             (0U)
#define USB_OTG_DOEPTSIZ0_XFRSIZ_Msk             (0x7FUL << USB_OTG_DOEPTSIZ0_XFRSIZ_Pos) /*!< 0x0007F */
#define USB_OTG_DOEPTSIZ0_XFRSIZ                 USB_OTG_DOEPTSIZ0_XFRSIZ_Msk   /*!< Transfer size */
#define USB_OTG_DOEPTSIZ0_PKTCNT_Pos             (19U)
#define USB_OTG_DOEPTSIZ0_PKTCNT_Msk             (0x1UL << USB_OTG_DOEPTSIZ0_PKTCNT_Pos) /*!< 0x80000 */
#define USB_OTG_DOEPTSIZ0_PKTCNT                 USB_OTG_DOEPTSIZ0_PKTCNT_Msk   /*!< Packet count */
#define USB_OTG_DOEPTSIZ0_STUPCNT_Pos            (29U)
#define USB_OTG_DOEPTSIZ0_STUPCNT_Msk            (0x3UL << USB_OTG_DOEPTSIZ0_STUPCNT_Pos) /*!< 0x60000000 */
#define USB_OTG_DOEPTSIZ0_STUPCNT                USB_OTG_DOEPTSIZ0_STUPCNT_Msk  /*!< SETUP packet count */

/********************  Bit definition for DOEPTSIZn register  ********************/
...
/* USB registers */
#define USB_GLOBAL     ((usb_global_register_t *)(USB_REG_BASE))
#define USB_PCGCCTL    *(__IO u32 *)(USB_REG_BASE + USB_OTG_PCGCCTL_BASE)
#define USB_DEVICE     ((usb_device_register_t *)(USB_REG_BASE + USB_OTG_DEVICE_BASE))
#define USB_INEP(i)    ((usb_device_in_ep_register_t *)(USB_REG_BASE + USB_OTG_IN_ENDPOINT_BASE + ((i) * USB_OTG_EP_REG_SIZE)))
#define USB_OUTEP(i)   ((usb_device_out_ep_register_t *)(USB_REG_BASE + USB_OTG_OUT_ENDPOINT_BASE + ((i) * USB_OTG_EP_REG_SIZE)))
#define USB_DFIFO(i)   *(__IO u32 *)(USB_REG_BASE + USB_OTG_FIFO_BASE + ((i) * USB_OTG_FIFO_SIZE))
#define USB_HOST       ((usb_host_register_t *)(USB_REG_BASE + USB_OTG_HOST_BASE))
#define USB_HC(i)      ((usb_host_ch_register_t *)(USB_REG_BASE + USB_OTG_HOST_CHANNEL_BASE + ((i) * USB_OTG_HOST_CHANNEL_SIZE)))
#define USB_HPRT0      *(__IO u32 *)((u32)USB_REG_BASE + USB_OTG_HOST_PORT_BASE)

#define USB_HAL_CLEAR_GINTSTS_FLAG(__INTERRUPT__)       (((USB_GLOBAL)->GINTSTS) &=  (__INTERRUPT__))

#define USB_MASK_INTERRUPT(__INTERRUPT__)     			((USB_GLOBAL)->GINTMSK &= ~(__INTERRUPT__))
#define USB_UNMASK_INTERRUPT(__INTERRUPT__)  			((USB_GLOBAL)->GINTMSK |= (__INTERRUPT__))

/* USB Device Mode */
#define USB_CLEAR_IN_EP_INTR(__EPNUM__, __INTERRUPT__)  (USB_INEP(__EPNUM__)->DIEPINT = (__INTERRUPT__))
#define USB_CLEAR_OUT_EP_INTR(__EPNUM__, __INTERRUPT__) (USB_OUTEP(__EPNUM__)->DOEPINT = (__INTERRUPT__))
