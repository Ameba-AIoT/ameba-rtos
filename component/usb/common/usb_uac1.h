...
/* A.5 Audio Class-Specific AC Interface Descriptor Subtypes (UAC1-specific) */
...
/* A.6 Audio Class-Specific AS Interface Descriptor Subtypes (UAC1-specific) */
...
/* A.9 Audio Class-Specific Request Codes (UAC1-specific, with direction in bRequest) */
