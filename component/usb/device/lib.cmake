...
ameba_list_append_if(CONFIG_USB_DEVICE_EN public_libraries
    ${c_SDK_LIB_APPLICATION_DIR}/lib_usbd.a
)
...
ameba_add_external_app_library(usbd #target name, will be part of output library name: lib_usbd.a
    p_SOURCES
        ${private_sources}
    p_INCLUDES
        ${private_includes}
