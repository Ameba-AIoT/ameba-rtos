...
} usbh_composite_uac_format_cfg_t;

/**
  * @brief  Audio Streaming (AS) Interface Alternate Setting Information.
  */
typedef struct {
	usbh_composite_uac_format_cfg_t format_info; /**< Audio format details for this alternate setting */
...
} usbh_composite_uac_as_itf_alt_info_t;
