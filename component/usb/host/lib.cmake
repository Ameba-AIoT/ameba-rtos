...
ameba_list_append_if(CONFIG_USB_HOST_EN public_libraries
    ${c_SDK_LIB_APPLICATION_DIR}/lib_usbh.a
)
...
ameba_add_external_app_library(usbh #target name, will be part of output library name: lib_usbh.a
    p_SOURCES
        ${private_sources}
    p_INCLUDES
        ${private_includes}
