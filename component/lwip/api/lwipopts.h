...
#if (defined(CONFIG_AMEBALITE) && defined (CONFIG_AS_INIC_AP)) || (defined(CONFIG_AMEBAGREEN2) &&defined(CONFIG_AS_INIC_AP)) || (defined(CONFIG_AMEBADPLUS) &&defined(CONFIG_AS_INIC_AP))
#undef TCP_WND
