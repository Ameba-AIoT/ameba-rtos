/**
 * RTK:In order to achieve hardware acceleration, only the following three functions are modified:
 * 
 ...
 * 
 * Hardware acceleration is switched on and off by RTK_LALU_MBEDTLS_RSA_CACULATION_ALT macro.
 * For Green2/L2, RSA hardware acceleration is enabled by default.
 */
