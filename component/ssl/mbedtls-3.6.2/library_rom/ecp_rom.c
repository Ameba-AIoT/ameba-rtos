...
HAL_ROM_BSS_SECTION static unsigned long add_count, dbl_count;
#endif /* MBEDTLS_ECP_C */
HAL_ROM_BSS_SECTION static unsigned long mul_count;
#endif
 ...
 */
HAL_ROM_BSS_SECTION static unsigned ecp_max_ops = 0;
...
HAL_ROM_BSS_SECTION static mbedtls_ecp_group_id ecp_supported_grp_id[ECP_NB_CURVES];
...
{
    HAL_ROM_BSS_SECTION static int init_done = 0;
