...
#ifdef CONFIG_CSI
static void wifi_csi_param_dump(struct _rtw_csi_action_parm_t *csi_param)
{
...
{
	at_printf("\r\n");
	at_printf("AT+WLCSI=[<type>,<value>,<type>,<value>......]\r\n");
	at_printf("\t<type>:\tA string as \"mode\",\"trig_period\",\"data_rate\",\"mac_addr\",\"trig_flag\",\"enable\",\"multi_type\",\"group_num\",\"accuracy\\r\n");
	at_printf("\t<value>:\tAny type of <mode>, <trig_period>, <data_rate>, <mac_addr>, <trig_flag>, <enable>, <multi_type>, <group_num>, <accuracy>\r\n");
	at_printf("\t<mode>:\tFor csi mode, must be 0 or 2, mandatory\r\n");
	at_printf("\t<trig_period>:\tCsi sounding peirod[units:320us], optional\r\n");
	at_printf("\t<data_rate>:\tmandatory\r\n");
	at_printf("\t<mac_addr>:\tA hex-number string with colons, e.g. 1a:2b:3c:4d:5e:6f\r\n");
}
...
void at_wlcsi(void *arg)
{
	...
	unsigned int mac[ETH_ALEN];
	char *argv[MAX_ARGC] = {0};
	rtw_csi_action_parm_t csi_param = {0};
