...
/*
 * Tag length must not exceed LOG_TAG_MAX_LEN.
 * Otherwise, retrieving the log level based on tag name will get unexpected value (RTK_LOG_DEFAULT_LEVEL).
 */
static const char *const TAG = "AT-SYSCOM";
