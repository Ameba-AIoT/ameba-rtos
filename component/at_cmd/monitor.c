...
static COMMAND_TABLE   shell_cmd_table[] = {
	...
	(defined(CONFIG_AMEBAGREEN2) && defined(CONFIG_ARM_CORE_CM4_AP))
	{
	...
	(defined(CONFIG_AMEBAGREEN2) && defined(CONFIG_ARM_CORE_CM4_NP))
	{
