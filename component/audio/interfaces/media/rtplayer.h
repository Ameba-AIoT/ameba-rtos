 ...
 * @version 1.0
 */
int32_t RTPlayer_SetSource(RTPlayer *player, const char *url);
 ...
 * @version 1.0
 */
int32_t RTPlayer_SetDataSource(RTPlayer *player, RTDataSource *source);
 ...
 * @version 1.0
 */
int32_t RTPlayer_Prepare(RTPlayer *player);
 ...
 * @version 1.0
 */
int32_t RTPlayer_PrepareAsync(RTPlayer *player);
...
* @version 1.0
*/
int32_t RTPlayer_Start(RTPlayer *player);
...
* @version 1.0
*/
int32_t RTPlayer_SetLooping(RTPlayer *player, int8_t loop);
 ...
 * @version 1.0
 */
int32_t RTPlayer_Stop(RTPlayer *player);
 ...
 * @version 1.0
 */
int32_t RTPlayer_Pause(RTPlayer *player);
 ...
 * @version 1.0
 */
int32_t RTPlayer_Rewind(RTPlayer *player, int64_t msec);
 ...
 * @version 1.0
 */
int32_t RTPlayer_Reset(RTPlayer *player);
 ...
 * @version 1.0
 */
int32_t RTPlayer_GetCurrentTime(RTPlayer *player, int64_t *msec);
 ...
 * @version 1.0
 */
int32_t RTPlayer_GetDuration(RTPlayer *player, int64_t *msec);
 ...
 * @version 1.0
 */
int32_t RTPlayer_SetVolume(RTPlayer *player, float left, float right);
