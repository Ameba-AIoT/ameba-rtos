#ifndef AMEBA_AUDIO_AUDIO_HAL_AMEBASMART_AMEBA_AUDIO_TYPES_H
#define AMEBA_AUDIO_AUDIO_HAL_AMEBASMART_AMEBA_AUDIO_TYPES_H
...
#endif // AMEBA_AUDIO_AUDIO_HAL_AMEBASMART_AMEBA_AUDIO_TYPES_H
/** @} */