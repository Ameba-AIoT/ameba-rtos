...
#ifndef AMEBA_AUDIO_AUDIO_HAL_AMEBAGREEN2_AUDIO_HW_COMPAT_H
#define AMEBA_AUDIO_AUDIO_HAL_AMEBAGREEN2_AUDIO_HW_COMPAT_H
...
int32_t AudioHALAtomicCompareAddSwap(volatile uint32_t *addr, uint32_t *oldvalue, uint32_t *newvalue)
{
...
#endif // AMEBA_AUDIO_AUDIO_HAL_AMEBAGREEN2_AUDIO_HW_COMPAT_H
