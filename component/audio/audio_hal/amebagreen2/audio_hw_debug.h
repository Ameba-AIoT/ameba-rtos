...
#ifndef AMEBA_AUDIO_AUDIO_HAL_AMEBAGREEN2_AUDIO_HW_DEBUG_H
#define AMEBA_AUDIO_AUDIO_HAL_AMEBAGREEN2_AUDIO_HW_DEBUG_H
...
#define HAL_AUDIO_CAPTURE_DUMP_DEBUG          1
