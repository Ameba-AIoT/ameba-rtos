 ...
 */
#ifndef AMEBA_AUDIO_AUDIO_HAL_AMEBALITE_AMEBA_AUDIO_STREAM_CONTROL_H
#define AMEBA_AUDIO_AUDIO_HAL_AMEBALITE_AMEBA_AUDIO_STREAM_CONTROL_H
...
int32_t ameba_audio_ctl_set_adc_mix_mute(StreamControl *control, uint32_t channel, uint32_t type, bool muted);
