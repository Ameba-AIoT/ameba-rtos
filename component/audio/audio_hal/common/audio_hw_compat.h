...
#ifndef AMEBA_AUDIO_AUDIO_HAL_COMMON_AUDIO_HW_COMPAT_H
#define AMEBA_AUDIO_AUDIO_HAL_COMMON_AUDIO_HW_COMPAT_H
...
#endif // AMEBA_AUDIO_AUDIO_HAL_COMMON_AUDIO_HW_COMPAT_H
