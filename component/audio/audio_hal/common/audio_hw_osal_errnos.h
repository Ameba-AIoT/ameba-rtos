...
#ifndef AMEBA_AUDIO_AUDIO_HAL_COMMON_AUDIO_HW_OSAL_ERRNOS_H
#define AMEBA_AUDIO_AUDIO_HAL_COMMON_AUDIO_HW_OSAL_ERRNOS_H
...
#endif // AMEBA_AUDIO_AUDIO_HAL_COMMON_AUDIO_HW_OSAL_ERRNOS_H