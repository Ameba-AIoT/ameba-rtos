...
enum INIC_WIFI_C2H_API_ID {
	...
	INIC_API_AUTO_RECONNECT						= BASIC_API_BASE + 3,
	INIC_API_EAP_AUTO_RECONNECT					= BASIC_API_BASE + 4,
...
enum INIC_WIFI_H2C_API_ID {
	...
	INIC_API_WIFI_GET_DISCONN_REASCON			= BASIC_API_BASE + 8,
	...
	INIC_API_WIFI_CONFIG_AUTORECONNECT			= EXT_API_BASE + 23,
	INIC_API_WIFI_GET_AUTORECONNECT				= EXT_API_BASE + 24,
	...
	INIC_API_WPA_4WAY_FAIL						= INTER_API_BASE + 9,
	...
	INIC_API_BRIDGE_SYNC_HOST_MAC				= SDIO_BRIDGE_BASE + 1,
	INIC_API_BRIDGE_DHCP						= SDIO_BRIDGE_BASE + 2,
	INIC_API_BRIDGE_GET_IP						= SDIO_BRIDGE_BASE + 3,
