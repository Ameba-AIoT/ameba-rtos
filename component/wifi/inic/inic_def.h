...
enum INIC_WIFI_C2H_API_ID {
	...
	INIC_API_WTN_SOCKET_INIT						= WTN_API_BASE + 1,
	INIC_API_WTN_SOCKET_SEND						= WTN_API_BASE + 2,

	/* 0x9001~0xA000 reserved for COEX API */
	INIC_API_COEX_C2H_INFO						= COEX_API_BASE + 1,
};
...
enum INIC_WIFI_H2C_API_ID {
	...
	INIC_API_WTN_IDENTITY_KEY_SET				= WTN_API_BASE + 2,

	/* 0x9001~0xA000 reserved for COEX API */
	INIC_API_COEX_H2C_INFO						= COEX_API_BASE + 1,
};
