...
struct wps_data {
	...
	enum {
		/* Enrollee states */
		SEND_M1/*0*/, RECV_M2/*1*/, SEND_M3/*2*/, RECV_M4/*3*/, SEND_M5/*4*/, RECV_M6/*5*/, SEND_M7/*6*/,
		RECV_M8/*7*/, RECEIVED_M2D/*8*/, WPS_MSG_DONE/*9*/, RECV_ACK/*a*/, WPS_FINISHED/*b*/,
		SEND_WSC_NACK/*c*/,

		/* Registrar states */
		RECV_M1/*d*/, SEND_M2/*e*/, RECV_M3/*f*/, SEND_M4/*10*/, RECV_M5/*11*/, SEND_M6/*12*/,
		RECV_M7/*13*/, SEND_M8/*14*/, RECV_DONE/*15*/, SEND_M2D/*16*/, RECV_M2D_ACK/*17*/
	} state;
...
/* directly use build message M1/M3/M5/M7 */
