...
void rtw_sta_assoc_hdl(u8 *evt_info)
{
	struct rtw_event_sta_assoc *sta_assoc_info = (struct rtw_event_sta_assoc *)evt_info;
	u8 *mac_addr = NULL;
...
void rtw_sta_disassoc_hdl(u8 *evt_info)
{
	struct rtw_event_sta_disassoc *sta_disassoc_info = (struct rtw_event_sta_disassoc *)evt_info;
	u8 *mac_addr = NULL;
