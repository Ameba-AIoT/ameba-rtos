 ...
 *                               Common task size
 *********************************************************************************************/
#define WIFI_LITTLE_TASK_SIZE		                  ((432 + MCC_LITTE_TASK_SIZE + 128 + CONTEXT_SAVE_SIZE) / 4)	/* rtw_if_wifi_create_task: size will *4 */

#if defined (CONFIG_WHC_DEV)
#if defined(CONFIG_WHC_INTF_IPC)
#define WIFI_SINGLE_TASK_SIZE		                  ((1424 + WTN_SINGLE_TASK_SIZE + 128 + CONTEXT_SAVE_SIZE) / 4)	/* max 1648 in lite, rtw_if_wifi_create_task: size will *4 */
#else
