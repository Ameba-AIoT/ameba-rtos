...
#define MCC_LITTE_STACK_SIZE                      432  /* enable MCC need 432 */
#endif
...
#define WIFI_STACK_SIZE_SINGLE_TASKLET	          ((1392 + RCV_WTN_ADD + CONTEXT_SAVE_SIZE_WITH_MARGIN) / 4)	/* max 1648 in lite, rtw_if_wifi_create_task: size will *4 */
#else
...
#define WIFI_STACK_SIZE_INIC_IPC_HST_API          (376 + CONTEXT_SAVE_SIZE_WITH_MARGIN)	// for psp overflow when update group key: jira: https://jira.realtek.com/browse/RSWLANQC-1027
#define WIFI_STACK_SIZE_INIC_IPC_HST_EVT_API      (1880 + EAP_UNBLK_API_SIZE + WPS_UNBLK_API_SIZE + CONTEXT_SAVE_SIZE_WITH_MARGIN)

#if defined(CONFIG_WHC_HOST)
#define WIFI_STACK_SIZE_INIC_MSG_Q	              (512 + CONTEXT_SAVE_SIZE_WITH_MARGIN)
...
#define WIFI_STACK_SIZE_INIC_IPC_DEV_API          (1024*4)
#else
#define WIFI_STACK_SIZE_INIC_IPC_DEV_API          (1072 + CONTEXT_SAVE_SIZE_WITH_MARGIN)	/* max 1072 in lite */
#endif
