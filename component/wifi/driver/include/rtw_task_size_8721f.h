...
#define WIFI_DRIVER_RESUME_TASK_SIZE              ((368 + 128 + CONTEXT_SAVE_SIZE) / 4)	/* rtw_if_wifi_create_task: size will *4 */
...
#define WIFI_WHC_IPC_DEV_API_TASK_SIZE            (1024*4)
#else
#define WIFI_WHC_IPC_DEV_API_TASK_SIZE            (1384 + 128 + CONTEXT_SAVE_SIZE)	/* max 1072 in lite */
#endif
