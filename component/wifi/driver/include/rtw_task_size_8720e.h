...
#define MCC_LITTE_THREAD_SIZE                     544  /* enable MCC need 544 */
#endif
 ...
 *                               Common task size
 *********************************************************************************************/
#define WIFI_TASK_SIZE_LITTLE_THREAD		          ((528 + MCC_LITTE_THREAD_SIZE + CONTEXT_SAVE_SIZE_WITH_MARGIN) / 4)	/* rtw_if_wifi_create_task: size will *4 */

#if defined (CONFIG_WHC_DEV)
#if defined(CONFIG_WHC_INTF_IPC)
#define WIFI_TASK_SIZE_SINGLE_THREAD	            ((1520 + WTN_SINGLE_THREAD_SIZE + CONTEXT_SAVE_SIZE_WITH_MARGIN) / 4)	/* rtw_if_wifi_create_task: size will *4 */
#else
...
#define WIFI_TASK_SIZE_DRIVER_RESUME_THREAD       ((480 + CONTEXT_SAVE_SIZE_WITH_MARGIN) / 4)	/* rtw_if_wifi_create_task: size will *4 */
...
#define WIFI_TASK_SIZE_WHC_IPC_HST_API            (308 + CONTEXT_SAVE_SIZE_WITH_MARGIN)	// for psp overflow when update group key: jira: https://jira.realtek.com/browse/RSWLANQC-1027
#define WIFI_TASK_SIZE_WHC_IPC_HST_EVT_API        (1800 + EAP_UNBLK_API_SIZE + WPS_UNBLK_API_SIZE + CONTEXT_SAVE_SIZE_WITH_MARGIN)

#if defined(CONFIG_WHC_HOST)
#define WIFI_TASK_SIZE_WHC_IPC_MSG_Q	            (468 + CONTEXT_SAVE_SIZE_WITH_MARGIN)
...
#define WIFI_TASK_SIZE_WHC_IPC_DEV_API            (1024*4)
#else
#define WIFI_TASK_SIZE_WHC_IPC_DEV_API            (1360 + CONTEXT_SAVE_SIZE_WITH_MARGIN)
#endif
