...
#ifndef AUTOCONF_8720F_H
#define AUTOCONF_8720F_H

#define CONFIG_G2_WIFI
#define CONFIG_EXTRA_ALLOC_RXBUF
...
#define TXDESC_SIZE	28
#define RXDESC_SIZE	16
#define RXDESC_SIZE_RADAR	8
#define RXPHYSTS_SIZE 32
#define WLAN_HW_INFO_LEN	48/*max(TXDESC_SIZE, RXDESC_SIZE+RXPHYSTS_SIZE)*/
