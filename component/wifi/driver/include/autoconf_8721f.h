...
#ifndef AUTOCONF_8721F_H
#define AUTOCONF_8721F_H
...
#define TX_SHORTCUT /*there's no sw encrypt in tx short right now, wifi logo need htc which needs sw encrypt, g2 has fixed*/
...
#define WIFI_RECV_TASKLET_BASIC_SIZE	            1632
#else
...
#define WIFI_LITTLE_TASKLET_BASIC_SIZE		        424
...
#define WIFI_INIC_IPC_HST_EVT_API_BASIC_SIZE      2296
