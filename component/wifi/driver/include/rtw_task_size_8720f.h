...
#define WIFI_SINGLE_TASK_SIZE	                    ((1056 + WTN_SINGLE_TASK_SIZE + NAN_SINGLE_TASK_SIZE + CONTEXT_SAVE_SIZE_WITH_MARGIN) / 4)	/* rtw_if_wifi_create_task: size will *4 */
#else
...
#define WIFI_DRIVER_RESUME_TASK_SIZE              ((384 + CONTEXT_SAVE_SIZE_WITH_MARGIN) / 4)	/* rtw_if_wifi_create_task: size will *4 */
...
#define WIFI_WHC_IPC_HST_EVT_API_TASK_SIZE        (2152 + EAP_UNBLK_API_SIZE + WPS_UNBLK_API_SIZE + NAN_PASN_UNBLK_API_SIZE + CONTEXT_SAVE_SIZE_WITH_MARGIN)
...
#define WIFI_WHC_IPC_DEV_API_TASK_SIZE            (1024*4)
#else
#define WIFI_WHC_IPC_DEV_API_TASK_SIZE            (1112 + CONTEXT_SAVE_SIZE_WITH_MARGIN)
#endif
