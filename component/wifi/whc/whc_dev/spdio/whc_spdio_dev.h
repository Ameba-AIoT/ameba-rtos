#ifndef _WHC_SPDIO_DEV_H_
#define _WHC_SPDIO_DEV_H_
...
#define whc_dev_intf_init                whc_spdio_dev_init
#define whc_dev_bus_is_idle              whc_spdio_dev_bus_is_idle
#define whc_dev_trigger_rx_handle()      whc_spdio_dev_trigger_rx_handle()
#define whc_dev_send                     whc_spdio_dev_send
...
static inline void whc_spdio_dev_set_rxreq_pin(u8 status)
{
