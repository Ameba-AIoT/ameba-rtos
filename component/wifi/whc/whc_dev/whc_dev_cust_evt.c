...
* @return none.
*/
static inline void whc_dev_recv_cust_evt_hdl(u8 *buf, u32 len)
{
	(void) buf;
	(void) len;
...
* @return none.
*/
void whc_dev_send_cust_evt(u8 *buf_in, u32 len)
{
	u8 *buf = NULL;
