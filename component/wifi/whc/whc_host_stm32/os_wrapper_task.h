...
/**
 * @brief  Each task contains an array of pointers that is dimensioned by the configNUM_THREAD_LOCAL_STORAGE_POINTERS setting
 *         in FreeRTOSConfig.h. The following function is used to set a pointer.
 * @param  p_handle:
 * @param  index:
 * @param  p_param:
 */
...
/**
* @brief  Each task contains an array of pointers that is dimensioned by the configNUM_THREAD_LOCAL_STORAGE_POINTERS setting
 *         in FreeRTOSConfig.h. The following function is used to query a pointer.
 * @param  p_handle:
 * @param  index:
 * @retval
 */
