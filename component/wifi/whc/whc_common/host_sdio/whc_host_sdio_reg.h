#ifndef __WHC_HOST_SDIO_REG_H__
#define __WHC_HOST_SDIO_REG_H__

/* SDIO domain IDs / register offsets / register map / bit definitions.
 * Shared by all whc host SDIO ports (stm32 / threadx / zephyr). */
