...
const struct cmd_func_t rtw_cli_cmd_handlers[] = {
	{"getmac",          rtw_cli_cmd_getmac, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_GET_MAC_ADDR},
	{"set_network",     rtw_cli_cmd_set_network, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_SET_NETWORK},
	{"list_networks",   rtw_cli_cmd_set_network, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_SET_NETWORK},
	{"select_network",  rtw_cli_cmd_set_network, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_SET_NETWORK},
	{"remove_network",  rtw_cli_cmd_set_network, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_SET_NETWORK},
	{"disconnect",      rtw_cli_cmd_set_network, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_SET_NETWORK},
	{"status",          rtw_cli_cmd_set_network, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_SET_NETWORK},
	{"wpas_cmd",        rtw_cli_cmd_set_network, API_WIFI_SEND_TO_DEV, WHC_WPA_OPS_UTIL, WHC_WPA_OPS_UTIL_SET_NETWORK},
	{"scan",            rtw_cli_cmd_scan, API_WIFI_DO_SCAN, WHC_WPA_OPS_CUSTOM_API, WHC_WPA_OPS_CUSTOM_API_SCAN},
	{"scan_result",     rtw_cli_cmd_scan_result, API_WIFI_SCAN_RESULT, 0, 0},
