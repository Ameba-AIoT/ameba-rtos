...
void whc_fullmac_host_event_auth_req(u8 *evt_info)
{
...
void whc_fullmac_host_event_auth_resp(u8 *evt_info)
{
	struct rtw_event_join_status_info *join_status_info = (struct rtw_event_join_status_info *)evt_info;
...
void whc_fullmac_host_event_assoc_req(u8 *evt_info)
{
	struct rtw_event_join_status_info *join_status_info = (struct rtw_event_join_status_info *)evt_info;
...
void whc_fullmac_host_event_assoc_resp(u8 *evt_info)
{
	struct rtw_event_join_status_info *join_status_info = (struct rtw_event_join_status_info *)evt_info;
...
void whc_fullmac_host_event_join_fail(u8 *evt_info)
{
	struct rtw_event_join_status_info *join_status_info = (struct rtw_event_join_status_info *)evt_info;
...
void whc_fullmac_host_event_disconnect_hdl(u8 *evt_info)
{
	struct rtw_event_join_status_info *join_status_info = (struct rtw_event_join_status_info *)evt_info;
...
void whc_fullmac_host_join_status_hdl(u8 *evt_info)
{
	struct rtw_event_join_status_info *join_status_info = (struct rtw_event_join_status_info *)evt_info;
	...
	case RTW_JOINSTATUS_AUTHENTICATING:
		whc_fullmac_host_event_auth_req(evt_info);
		break;
	case RTW_JOINSTATUS_AUTHENTICATED:
		whc_fullmac_host_event_auth_resp(evt_info);
		break;
	case RTW_JOINSTATUS_ASSOCIATING:
		whc_fullmac_host_event_assoc_req(evt_info);
		break;
	case RTW_JOINSTATUS_ASSOCIATED:
		whc_fullmac_host_event_assoc_resp(evt_info);
		break;
	case RTW_JOINSTATUS_FAIL:
		whc_fullmac_host_event_join_fail(evt_info);
		break;
	case RTW_JOINSTATUS_DISCONNECT:
		whc_fullmac_host_event_disconnect_hdl(evt_info);
		break;
	default:
		break;
	}
