...
/*
 * ARC4 + CRC32 helpers for host-side software WEP/TKIP de(en)cryption.
 * Ported from component/wifi/common/secure/rom_arc4.c.
 */
...
static u32 arc4_byte(struct arc4context *parc4ctx)
{
	u32 x;
	u32 y;
	u32 sx, sy;
