...
#ifdef CONFIG_MP_FIRMWARE
#define WHC_FW_1_NAME WHC_FW_1_BASE "_MP.bin"
#define WHC_FW_2_NAME WHC_FW_2_BASE "_MP.bin"
#else
#define WHC_FW_1_NAME WHC_FW_1_BASE ".bin"
#define WHC_FW_2_NAME WHC_FW_2_BASE ".bin"
#endif /* CONFIG_MP_FIRMWARE */

/* Image configuration for RTL8720F */
static const struct whc_image_t rtl8720f_images[] = {
...
/* HAL configuration for RTL8720F */
static const struct whc_hal_config_t rtl8720f_config = {
