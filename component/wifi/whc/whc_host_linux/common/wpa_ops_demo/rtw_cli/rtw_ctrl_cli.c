...
const struct cmd_func_t whc_bridge_api_handlers[] = {
	...
	{"wifion",          whc_host_cli_cmd_wifi_on, CMD_WIFI_SEND_BUF, WHC_WPA_OPS_CUSTOM_API, WHC_WPA_OPS_CUSTOM_API_WIFION},
	{"mp",              whc_host_cli_cmd_mp, CMD_WIFI_MP, 0, 0},
	{"dbg",             whc_host_cli_cmd_dbg, CMD_WIFI_DBG, 0, 0},
	{NULL, NULL, 0, 0},
};
