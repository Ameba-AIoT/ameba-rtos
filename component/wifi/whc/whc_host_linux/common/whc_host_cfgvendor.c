...
#ifdef NAN_CUSTOMER_NANDOW
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_NAN_CLUSTER_CHANGED)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_DISC_RESULT)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_PUBLISH_REPLIED)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_DATAPATH_REQ_RECV)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_DATAPATH_RSP_RECV)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_DATAPATH_CONFIRM_RECV)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_DATAPATH_ESTABLISHED)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_DATAPATH_END)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_DATAPATH_HOST_ASSIST)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_SUBSCRIBE_TERMINATED)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_PUBLISH_TERMINATED)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_FOLLOWUP_RECV)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_FOLLOWUP_TX_COMPLETE)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_BEACON)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_OOB_AF_TX_STATUS)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_OOB_AF_RX)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_RESET_INTERFACE)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_COUNTRY_CODE_CHANGED)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_INFRA_ASSOC_START)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_ASSOC_DONE)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_ASSOC_READY)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_AUTH)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_ASSOC)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_INFRA_SCAN_START)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_INFRA_SCAN_COMPLETE)},
	{ OUI_REALTEK, GET_OVERALL_EVENT_ID(RTW_NAN_EVT_SET_INFRA_CHANNEL)},
#endif
