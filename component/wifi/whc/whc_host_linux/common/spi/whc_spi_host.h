...
#define DEV_TX_REQ_PIN			583
#else
#define DEV_READY_PIN			591
#define DEV_TX_REQ_PIN			592
#endif
...
#define DEV_TX_REQ_PIN			585
#else
#define DEV_READY_PIN			593
#define DEV_TX_REQ_PIN			594
#endif
...
#define DEV_TX_REQ_PIN			14
#else
#define DEV_READY_PIN			22
#define DEV_TX_REQ_PIN			23
#endif
...
#define DEV_TX_REQ_IRQ			gpio_to_irq(DEV_TX_REQ_PIN)
#define DEV_TX_REQ				1
