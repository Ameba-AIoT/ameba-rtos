...
execute_process(
    COMMAND ${PADTOOL} ${c_SDK_IMAGE_TARGET_DIR}/ram_1.bin 32
)
execute_process(
    COMMAND ${PADTOOL} ${c_SDK_IMAGE_TARGET_DIR}/xip_boot.bin 32
)

execute_process(
    COMMAND ${PREPENDTOOL} ${c_SDK_IMAGE_TARGET_DIR}/ram_1.bin  __ram_start_table_start__  ${c_SDK_IMAGE_TARGET_DIR}/target_loader.map
)
if(IMGTOOL_LOADER)
    execute_process(
    ...
    execute_process(
        COMMAND ${PREPENDTOOL} ${c_SDK_IMAGE_TARGET_DIR}/xip_boot.bin  __km4_boot_text_start__  ${c_SDK_IMAGE_TARGET_DIR}/target_loader.map
    )
    execute_process(
        COMMAND ${CMAKE_COMMAND} -E  cat ${c_SDK_IMAGE_TARGET_DIR}/xip_boot_prepend.bin ${c_SDK_IMAGE_TARGET_DIR}/ram_1_prepend.bin
        OUTPUT_FILE ${c_SDK_IMAGE_TARGET_DIR}/km4_boot.bin
    )
    execute_process(
        COMMAND ${IMAGETOOL} ${c_SDK_IMAGE_TARGET_DIR}/km4_boot.bin ${BUILD_TYPE}
        WORKING_DIRECTORY ${c_MCU_PROJECT_DIR}/..
    )
endif()
