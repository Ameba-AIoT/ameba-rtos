...
* The toolchain will be intalled in `/opt/rtk-toolchain` by default. If an error "Error: No Toolchain in `/opt/rtk-toolchain/vsdk-10.3.1/linux/newlib`" appears when building the project, please refer to ApplicationNote chapter **Installing Toolchain** from documentation links for more details.
